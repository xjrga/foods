...
import io.github.xjrga.foods_old.Food_multiplier;
...
import io.github.xjrga.foods_old.Food_summator;
...
public class Food_summatorTest_03 {
    ...
    public static void one_time_setup() {
        ...
        String food_name_03 = The_list.FINFISH_AND_SHELLFISH_PRODUCTS.Fish_sardine_Atlantic_canned_in_oil_drained_solids_with_bone.get_name();
        Interface_food sardine = chef.find_food(food_name_03);
        String food_name_04 = The_list.VEGETABLES_AND_VEGETABLE_PRODUCTS.Tomato_products_canned_puree_without_salt_added.get_name();
        Interface_food tomato = chef.find_food(food_name_04);
