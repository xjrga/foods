 ...
 */
public class Seeds_flaxseed_efasTest {

    private static Interface_food food;

    public Seeds_flaxseed_efasTest() {
    }

    @BeforeClass
    public static void one_time_setup() {
        Chef chef = new Chef();
        String food_name = The_list.OMEGA3.Seeds_flaxseed_EFAs.get_name();
    ...
    public void test_alpha_linolenic_acid_coefficient() {
        assertEquals(food.get_alpha_linolenic_acid_coefficient(), 0.244528, 0.00001);
    }
    ...
    public void test_food_quotient() {
        assertEquals(food.get_food_quotient(), 0.72993, 0.00001);
    }
