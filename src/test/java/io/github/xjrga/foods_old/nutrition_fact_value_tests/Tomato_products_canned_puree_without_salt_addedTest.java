 ...
 */
public class Tomato_products_canned_puree_without_salt_addedTest {

    private static Interface_food food;

    public Tomato_products_canned_puree_without_salt_addedTest() {
    }

    @BeforeClass
    public static void one_time_setup() {
        Chef chef = new Chef();
        String food_name = The_list.VEGETABLES_AND_VEGETABLE_PRODUCTS.Tomato_products_canned_puree_without_salt_added.get_name();
