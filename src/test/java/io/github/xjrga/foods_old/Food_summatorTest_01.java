...
public class Food_summatorTest_01 {
    ...
    public static void one_time_setup() {
        ...
        Interface_food sardine = chef.find_food(food_name_01);
        String food_name_02 = The_list.VEGETABLES_AND_VEGETABLE_PRODUCTS.Tomato_products_canned_puree_without_salt_added.get_name();
        Interface_food tomato = chef.find_food(food_name_02);
