 ...
 */
public class Fish_sardine_atlantic_canned_in_oil_drained_solids_with_boneNGTest {

    private static Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone food;

    public Fish_sardine_atlantic_canned_in_oil_drained_solids_with_boneNGTest() {
    }
    ...
    public void test_calcium() {
        assertEquals(food.get_calcium(), 382.0, 0.00001);
    }

    //carbohydrate_by_difference
    @Test(enabled = true)
    public void test_carbohydrate_by_difference() {
        assertEquals(food.get_carbohydrate_by_difference(), 0.0, 0.00001);
    }

    //cholesterol
    @Test(enabled = true)
    public void test_cholesterol() {
        assertEquals(food.get_cholesterol(), 142.0, 0.00001);
    }

    //choline
    @Test(enabled = true)
    public void test_choline() {
        assertEquals(food.get_choline(), 75.00, 0.00001);
    }

    //complete_protein
    @Test(enabled = true)
    public void test_complete_protein() {
        assertEquals(food.get_complete_protein(), 24.62, 0.00001);
    }

    //copper
    @Test(enabled = true)
    public void test_copper() {
        assertEquals(food.get_copper(), 0.18, 0.00001);
    }
    ...
    public void test_dha() {
        assertEquals(food.get_dha(), 0.50, 0.00001);
    }

    //epa
    @Test(enabled = true)
    public void test_epa() {
        assertEquals(food.get_epa(), 0.47, 0.00001);
    }

    //fat
    @Test(enabled = true)
    public void test_fat() {
        assertEquals(food.get_fat(), 11.45, 0.00001);
    }

    //fiber
    @Test(enabled = true)
    public void test_fiber() {
        assertEquals(food.get_fiber(), 0.0, 0.00001);
    }
    ...
    public void test_folate() {
        assertEquals(food.get_folate(), 10.0, 0.00001);
    }
    ...
    public void test_energy_gross() {
        assertEquals(food.get_energy_gross(), 208.0, 0.00001);
    }

    //iron
    @Test(enabled = true)
    public void test_iron() {
        assertEquals(food.get_iron(), 2.92, 0.00001);
    }
    ...
    public void test_magnesium() {
        assertEquals(food.get_magnesium(), 39.0, 0.00001);
    }

    //manganese
    @Test(enabled = true)
    public void test_manganese() {
        assertEquals(food.get_manganese(), 0.10, 0.00001);
    }

    //monounsaturated_fat
    @Test(enabled = true)
    public void test_monounsaturated_fat() {
        assertEquals(food.get_monounsaturated_fat(), 3.86, 0.00001);
    }

    //niacin
    @Test(enabled = true)
    public void test_niacin() {
        assertEquals(food.get_niacin(), 5.24, 0.00001);
    }

    //pantothenic_acid
    @Test(enabled = true)
    public void test_pantothenic_acid() {
        assertEquals(food.get_pantothenic_acid(), 0.64, 0.00001);
    }

    //phosphorus
    @Test(enabled = true)
    public void test_phosphorus() {
        assertEquals(food.get_phosphorus(), 490.0, 0.00001);
    }

    //polyunsaturated_fat
    @Test(enabled = true)
    public void test_polyunsaturated_fat() {
        assertEquals(food.get_polyunsaturated_fat(), 5.14, 0.00001);
    }

    //potassium
    @Test(enabled = true)
    public void test_potassium() {
        assertEquals(food.get_potassium(), 397.0, 0.00001);
    }

    //protein
    @Test(enabled = true)
    public void test_protein() {
        assertEquals(food.get_protein(), 24.62, 0.00001);
    }

    //riboflavin
    @Test(enabled = true)
    public void test_riboflavin() {
        assertEquals(food.get_riboflavin(), 0.22, 0.00001);
    }

    //saturated_fat
    @Test(enabled = true)
    public void test_saturated_fat() {
        assertEquals(food.get_saturated_fat(), 1.52, 0.00001);
    }

    //selenium
    @Test(enabled = true)
    public void test_selenium() {
        assertEquals(food.get_selenium(), 52.70, 0.00001);
    }

    //sodium
    @Test(enabled = true)
    public void test_sodium() {
        assertEquals(food.get_sodium(), 307.0, 0.00001);
    }

    //thiamin
    @Test(enabled = true)
    public void test_thiamin() {
        assertEquals(food.get_thiamin(), 0.08, 0.00001);
    }

    //vitamin_a
    @Test(enabled = true)
    public void test_vitamin_a() {
        assertEquals(food.get_vitamin_a(), 32.0, 0.00001);
    }

    //vitamin_b12
    @Test(enabled = true)
    public void test_vitamin_b12() {
        assertEquals(food.get_vitamin_b12(), 8.94, 0.00001);
    }

    //vitamin_b6
    @Test(enabled = true)
    public void test_vitamin_b6() {
        assertEquals(food.get_vitamin_b6(), 0.16, 0.00001);
    }

    //vitamin_c
    @Test(enabled = true)
    public void test_vitamin_c() {
        assertEquals(food.get_vitamin_c(), 0.0, 0.00001);
    }

    //vitamin_d
    @Test(enabled = true)
    public void test_vitamin_d() {
        assertEquals(food.get_vitamin_d(), 4.8, 0.00001);
    }

    //vitamin_e
    @Test(enabled = true)
    public void test_vitamin_e() {
        assertEquals(food.get_vitamin_e(), 2.04, 0.00001);
    }

    //vitamin_k
    @Test(enabled = true)
    public void test_vitamin_k() {
        assertEquals(food.get_vitamin_k(), 2.60, 0.00001);
    }

    //water
    @Test(enabled = true)
    public void test_water() {
        assertEquals(food.get_water(), 59.61, 0.00001);
    }
    ...
    public void test_zinc() {
        assertEquals(food.get_zinc(), 1.31, 0.00001);
    }
    ...
    public void test_energy_digestible_carbohydrate() {
        assertEquals(food.get_energy_digestible_carbohydrate(), 0.0, 0.00001);
    }
    ...
    public void test_energy_digestible() {
        assertEquals(food.get_energy_digestible(), 201.53, 0.00001);
    }

    //energy_fat
    @Test(enabled = true)
    public void test_energy_fat() {
        assertEquals(food.get_energy_fat(), 103.05, 0.00001);
    }

    //energy_no_protein
    @Test(enabled = true)
    public void test_energy_no_protein() {
        assertEquals(food.get_energy_no_protein(), 103.05, 0.00001);
    }

    //energy_protein
    @Test(enabled = true)
    public void test_energy_protein() {
        assertEquals(food.get_energy_protein(), 98.48, 0.00001);
    }

    //
    @Test(enabled = true)
    public void test_energy_gross_coefficient() {
        assertEquals(food.get_energy_gross_coefficient(), 2.08, 0.00001);
    }
    ...
    public void test_energy_no_protein_coefficient() {
        assertEquals(food.get_energy_no_protein_coefficient(), 1.0305, 0.00001);
    }
    ...
    public void test_digestible_carbohydrate() {
        assertEquals(food.get_digestible_carbohydrate(), 0.0, 0.00001);
    }
