 ...
 */
public class Food_multiplier_using_food_mutable_object_Test {

    private static Food_multiplier multiplier;

    public Food_multiplier_using_food_mutable_object_Test() {
    }

    @BeforeClass
    public static void one_time_setup() {
        Food_mutable mutable = Food_creator.make_food_mutable_from_food_enum(Finfish_and_shellfish_products.Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone);
        multiplier = new Food_multiplier(mutable, 100.0);
    }
