 ...
 */
public class Food_summator_01Test {

    private static Food_summator summator;

    public Food_summator_01Test() {
    ...
    public void test_energy_digestible_carbohydrate() {
        assertEquals(283.2, summator.get_energy_digestible_carbohydrate(), 0.00001);
    }

    //energy_digestible
    @Test
    public void test_energy_digestible() {
        assertEquals(2383.4, summator.get_energy_digestible(), 0.00001);
    }
