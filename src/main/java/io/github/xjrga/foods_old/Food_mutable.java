...
public class Food_mutable implements Interface_food_mutable, Interface_food {
    ...
    public Food_mutable() {
        ...
        set_water(0.0);
        set_cost(0.0);
        set_protein_atwater_factor(Atwater.PROTEIN.get_factor());
        set_carbohydrate_by_difference_atwater_factor(Atwater.CARBOHYDRATE_BY_DIFFERENCE.get_factor());
        set_fat_atwater_factor(Atwater.FAT.get_factor());
        set_alcohol_atwater_factor(Atwater.ALCOHOL.get_factor());
    }
