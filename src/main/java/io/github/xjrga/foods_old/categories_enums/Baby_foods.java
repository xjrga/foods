...
/**
 * Baby foods subset from USDA National Nutrient Database for Standard
 * Reference, Release 28
 *
 */
public enum Baby_foods implements Interface_food {

    Babyfood_dessert_custard_pudding_vanilla_junior("Babyfood, dessert, custard pudding, vanilla, junior", 100.0, 0.0, 0.0, 0.0, 1.76, 0.98, 17.58, 86.0, 0.0, 79.31, 0.2, 54.0, 0.22, 5.0, 55.0, 68.0, 26.0, 0.3, 0.01, 4.0, 0.01, 2.4, 13.0, 0.09, 0.5, 0.4, 0.01, 0.05, 0.07, 0.23, 0.03, 0.23, 29.9, 0.0, 6.0, 38.0, 0.32, 0.003, 0.0, 0.36, 0.12, 0.0, 0.0);
