 ...
 */
public class Bagels_wheat implements Food {

    private final Bagels_wheat_mutable food;

    public Bagels_wheat() {
        food = new Bagels_wheat_mutable();
    }
    ...
    private class Bagels_wheat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bagels_wheat_mutable() {
            set_food_name("Bagels, wheat");
            set_food_label("bagels_wheat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(20.00000);
            set_carbohydrate_by_difference(48.89000);
            ...
            set_fat(1.53000);
            set_fiber(4.10000);
            set_fluoride(24.10000);
            set_folate(108.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(250.00000);
            set_iron(2.76000);
            set_linoleic_acid(0.00000);
            set_magnesium(51.00000);
            set_manganese(1.43000);
            set_monounsaturated_fat(0.29000);
            set_niacin(3.37000);
            set_pantothenic_acid(0.37000);
            set_phosphorus(142.00000);
            set_polyunsaturated_fat(0.93000);
            set_potassium(165.00000);
            set_protein(10.20000);
            set_riboflavin(0.20000);
            set_saturated_fat(0.00000);
            set_selenium(28.70000);
            set_sodium(439.00000);
            set_thiamin(0.40000);
