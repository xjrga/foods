 ...
 */
public class Bagels_cinnamon_raisin implements Food {

    private final Bagels_cinnamon_raisin_mutable food;

    public Bagels_cinnamon_raisin() {
        food = new Bagels_cinnamon_raisin_mutable();
    }
    ...
    private class Bagels_cinnamon_raisin_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bagels_cinnamon_raisin_mutable() {
            ...
            set_carbohydrate_by_difference(55.20000);
