 ...
 */
public class Bread_white_wheat implements Food {

    private final Bread_white_wheat_mutable food;

    public Bread_white_wheat() {
        food = new Bread_white_wheat_mutable();
    }
    ...
    private class Bread_white_wheat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bread_white_wheat_mutable() {
            set_food_name("Bread, white wheat");
            set_food_label("bread_white_wheat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.08000);
            set_calcium(684.00000);
            set_carbohydrate_by_difference(43.91000);
            ...
            set_folate(162.00000);
            set_glycemic_index(70.00000);
            set_gross_energy(238.00000);
            set_iron(4.89000);
            set_linoleic_acid(0.87000);
            set_magnesium(26.00000);
            set_manganese(0.63000);
            set_monounsaturated_fat(0.39000);
            set_niacin(4.45000);
            set_pantothenic_acid(0.45000);
            set_phosphorus(103.00000);
            set_polyunsaturated_fat(0.97000);
            set_potassium(127.00000);
            set_protein(10.66000);
            set_riboflavin(0.25000);
            set_saturated_fat(0.63000);
            set_selenium(16.10000);
            set_sodium(478.00000);
            set_thiamin(0.51000);
            ...
            set_vitamin_e(0.38000);
            set_vitamin_k(7.70000);
            set_water(39.60000);
