 ...
 */
public class Bread_rye implements Food {

    private final Bread_rye_mutable food;

    public Bread_rye() {
        food = new Bread_rye_mutable();
    }
    ...
    private class Bread_rye_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bread_rye_mutable() {
            set_food_name("Bread, rye");
            set_food_label("bread_rye");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(73.00000);
            set_carbohydrate_by_difference(48.30000);
            ...
            set_fat(3.30000);
            set_fiber(5.80000);
            set_fluoride(51.00000);
            set_folate(151.00000);
            set_glycemic_index(58.00000);
            set_gross_energy(259.00000);
            set_iron(2.83000);
            set_linoleic_acid(0.00000);
            set_magnesium(40.00000);
            set_manganese(0.82000);
            set_monounsaturated_fat(1.31000);
            set_niacin(3.80000);
            set_pantothenic_acid(0.44000);
            set_phosphorus(125.00000);
            set_polyunsaturated_fat(0.79000);
            set_potassium(166.00000);
            set_protein(8.50000);
            set_riboflavin(0.33000);
            set_saturated_fat(0.62000);
            set_selenium(30.90000);
            set_sodium(603.00000);
            set_thiamin(0.43000);
