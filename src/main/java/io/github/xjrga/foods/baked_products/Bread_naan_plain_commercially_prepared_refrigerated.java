 ...
 */
public class Bread_naan_plain_commercially_prepared_refrigerated implements Food {

    private final Bread_naan_plain_commercially_prepared_refrigerated_mutable food;

    public Bread_naan_plain_commercially_prepared_refrigerated() {
        food = new Bread_naan_plain_commercially_prepared_refrigerated_mutable();
    }
    ...
    private class Bread_naan_plain_commercially_prepared_refrigerated_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bread_naan_plain_commercially_prepared_refrigerated_mutable() {
            ...
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.27000);
            set_calcium(84.00000);
            set_carbohydrate_by_difference(50.43000);
            ...
            set_gross_energy(291.00000);
            set_iron(3.25000);
            set_linoleic_acid(1.78000);
            set_magnesium(27.00000);
            set_manganese(0.51000);
            set_monounsaturated_fat(1.80000);
            set_niacin(5.84000);
            set_pantothenic_acid(0.44000);
            set_phosphorus(100.00000);
            set_polyunsaturated_fat(2.09000);
            set_potassium(125.00000);
            set_protein(9.62000);
            set_riboflavin(0.51000);
            set_saturated_fat(1.39000);
            set_selenium(27.90000);
            set_sodium(465.00000);
            set_thiamin(0.78000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.09000);
