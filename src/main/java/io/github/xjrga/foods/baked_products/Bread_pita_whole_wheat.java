 ...
 */
public class Bread_pita_whole_wheat implements Food {

    private final Bread_pita_whole_wheat_mutable food;

    public Bread_pita_whole_wheat() {
        food = new Bread_pita_whole_wheat_mutable();
    }
    ...
    private class Bread_pita_whole_wheat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bread_pita_whole_wheat_mutable() {
            ...
            set_carbohydrate_by_difference(55.89000);
            set_cholesterol(0.00000);
            set_choline(26.50000);
            ...
            set_gross_energy(262.00000);
            set_iron(3.06000);
            set_linoleic_acid(0.00000);
            set_magnesium(69.00000);
            set_manganese(1.74000);
            set_monounsaturated_fat(0.24000);
            set_niacin(2.84000);
            set_pantothenic_acid(0.83000);
            set_phosphorus(180.00000);
            set_polyunsaturated_fat(0.74000);
            set_potassium(170.00000);
            set_protein(9.80000);
            set_riboflavin(0.08000);
            set_saturated_fat(0.14000);
            set_selenium(44.00000);
            set_sodium(527.00000);
            set_thiamin(0.33000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.26000);
