 ...
 */
public class Bagels_multigrain implements Food {

    private final Bagels_multigrain_mutable food;

    public Bagels_multigrain() {
        food = new Bagels_multigrain_mutable();
    }
    ...
    private class Bagels_multigrain_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bagels_multigrain_mutable() {
            set_food_name("Bagels, multigrain");
            set_food_label("bagels_multigrain");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(124.00000);
            set_carbohydrate_by_difference(47.47000);
            set_cholesterol(6.00000);
            set_choline(16.10000);
            ...
            set_folate(114.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(241.00000);
            set_iron(2.23000);
            set_linoleic_acid(0.00000);
            set_magnesium(85.00000);
            set_manganese(1.79000);
            set_monounsaturated_fat(0.31000);
            set_niacin(4.26000);
            set_pantothenic_acid(0.51000);
            set_phosphorus(188.00000);
            set_polyunsaturated_fat(0.70000);
            set_potassium(204.00000);
            set_protein(9.90000);
            set_riboflavin(0.25000);
            set_saturated_fat(0.00000);
            set_selenium(26.90000);
            set_sodium(359.00000);
            set_thiamin(0.42000);
