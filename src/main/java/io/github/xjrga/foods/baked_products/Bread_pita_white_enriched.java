 ...
 */
package io.github.xjrga.foods.baked_products;
 ...
 */
public class Bread_pita_white_enriched implements Food {

    private final Bread_pita_white_enriched_mutable food;

    public Bread_pita_white_enriched() {
        food = new Bread_pita_white_enriched_mutable();
    }
    ...
    private class Bread_pita_white_enriched_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Bread_pita_white_enriched_mutable() {
            set_food_name("Bread, pita, white, enriched");
            set_food_label("bread_pita_white_enriched");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(86.00000);
            set_carbohydrate_by_difference(55.70000);
            set_cholesterol(0.00000);
            set_choline(14.60000);
            ...
            set_folate(165.00000);
            set_glycemic_index(70.00000);
            set_gross_energy(275.00000);
            set_iron(2.62000);
            set_linoleic_acid(0.00000);
            set_magnesium(26.00000);
            set_manganese(0.48000);
            set_monounsaturated_fat(0.10000);
            set_niacin(4.63000);
            set_pantothenic_acid(0.39000);
            set_phosphorus(97.00000);
            set_polyunsaturated_fat(0.53000);
            set_potassium(120.00000);
            set_protein(9.10000);
            set_riboflavin(0.32000);
            set_saturated_fat(0.16000);
            set_selenium(27.10000);
            set_sodium(536.00000);
            set_thiamin(0.59000);
