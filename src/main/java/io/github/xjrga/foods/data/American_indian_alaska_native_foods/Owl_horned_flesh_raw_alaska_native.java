 ...
 */
public class Owl_horned_flesh_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Owl_horned_flesh_raw_alaska_native() {
		set_food_id("35059");
		set_food_name("Owl, horned, flesh, raw (Alaska Native)");
		set_food_label("Owl_horned_flesh_raw_alaska_native");
