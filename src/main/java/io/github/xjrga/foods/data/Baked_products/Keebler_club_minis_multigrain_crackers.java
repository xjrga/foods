 ...
 */
public class Keebler_club_minis_multigrain_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_club_minis_multigrain_crackers() {
		set_food_id("28066");
		set_food_name("KEEBLER, CLUB, Minis Multigrain Crackers");
		set_food_label("Keebler_club_minis_multigrain_crackers");
