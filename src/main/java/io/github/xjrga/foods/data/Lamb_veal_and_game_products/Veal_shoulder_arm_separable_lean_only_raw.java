 ...
 */
public class Veal_shoulder_arm_separable_lean_only_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Veal_shoulder_arm_separable_lean_only_raw() {
		set_food_id("17125");
		set_food_name("Veal, shoulder, arm, separable lean only, raw");
		set_food_label("Veal_shoulder_arm_separable_lean_only_raw");
