 ...
 */
public class Keebler_club_original_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_club_original_crackers() {
		set_food_id("28068");
		set_food_name("KEEBLER, CLUB, Original Crackers");
		set_food_label("Keebler_club_original_crackers");
