 ...
 */
public class Murray_old_fashioned_iced_oatmeal_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_old_fashioned_iced_oatmeal_cookies() {
		set_food_id("28216");
		set_food_name("MURRAY, Old Fashioned Iced Oatmeal Cookies");
		set_food_label("Murray_old_fashioned_iced_oatmeal_cookies");
