 ...
 */
public class Keebler_cheese_cheddar_sandwich_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_cheese_cheddar_sandwich_crackers() {
		set_food_id("28049");
		set_food_name("KEEBLER, Cheese & Cheddar Sandwich Crackers");
		set_food_label("Keebler_cheese_cheddar_sandwich_crackers");
