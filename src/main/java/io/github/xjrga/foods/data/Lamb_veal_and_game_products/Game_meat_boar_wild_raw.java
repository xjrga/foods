 ...
 */
public class Game_meat_boar_wild_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_boar_wild_raw() {
		set_food_id("17158");
		set_food_name("Game meat, boar, wild, raw");
		set_food_label("Game_meat_boar_wild_raw");
