 ...
 */
public class Artificial_blueberry_muffin_mix_dry extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Artificial_blueberry_muffin_mix_dry() {
		set_food_id("18566");
		set_food_name("Artificial Blueberry Muffin Mix, dry");
		set_food_label("Artificial_blueberry_muffin_mix_dry");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(407.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(77.45000);
