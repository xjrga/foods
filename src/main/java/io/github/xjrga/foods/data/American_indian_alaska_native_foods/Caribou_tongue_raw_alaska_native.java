 ...
 */
public class Caribou_tongue_raw_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Caribou_tongue_raw_alaska_native() {
        set_food_id("35025");
        set_food_name("Caribou, tongue, raw (Alaska Native)");
        set_food_label("Caribou_tongue_raw_alaska_native");
