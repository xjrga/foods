 ...
 */
public class Alcoholic_beverage_rice_sake extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Alcoholic_beverage_rice_sake() {
		set_food_id("43479");
		set_food_name("Alcoholic beverage, rice (sake)");
		set_food_label("Alcoholic_beverage_rice_sake");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(134.00000);
		set_alcohol_in_grams(16.10000);
