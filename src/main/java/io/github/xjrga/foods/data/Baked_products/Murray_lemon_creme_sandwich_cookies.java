 ...
 */
public class Murray_lemon_creme_sandwich_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_lemon_creme_sandwich_cookies() {
		set_food_id("28214");
		set_food_name("MURRAY, Lemon Creme Sandwich Cookies");
		set_food_label("Murray_lemon_creme_sandwich_cookies");
