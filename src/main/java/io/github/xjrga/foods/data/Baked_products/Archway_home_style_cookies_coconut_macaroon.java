 ...
 */
public class Archway_home_style_cookies_coconut_macaroon extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Archway_home_style_cookies_coconut_macaroon() {
        set_food_id("18524");
        set_food_name("ARCHWAY Home Style Cookies, Coconut Macaroon");
        set_food_label("Archway_home_style_cookies_coconut_macaroon");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(460.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(61.23000);
        ...
        set_saturated_fat_in_grams(20.10000);
