 ...
 */
public class Walrus_liver_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Walrus_liver_raw_alaska_native() {
		set_food_id("35083");
		set_food_name("Walrus, liver, raw (Alaska Native)");
		set_food_label("Walrus_liver_raw_alaska_native");
		...
		set_iron_in_milligrams(14.40000);
