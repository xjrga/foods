 ...
 */
public class Milk_dessert_frozen_milk_fat_free_chocolate extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Milk_dessert_frozen_milk_fat_free_chocolate() {
        set_food_id("42131");
        set_food_name("Milk dessert, frozen, milk-fat free, chocolate");
        set_food_label("Milk_dessert_frozen_milk_fat_free_chocolate");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(167.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(37.70000);
