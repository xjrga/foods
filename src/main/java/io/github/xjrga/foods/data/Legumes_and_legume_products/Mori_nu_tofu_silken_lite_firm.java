 ...
 */
public class Mori_nu_tofu_silken_lite_firm extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mori_nu_tofu_silken_lite_firm() {
		set_food_id("16164");
		set_food_name("MORI-NU, Tofu, silken, lite firm");
		set_food_label("Mori_nu_tofu_silken_lite_firm");
