 ...
 */
public class Keebler_sweet_cremes_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_sweet_cremes_cookies() {
		set_food_id("28131");
		set_food_name("KEEBLER, Sweet Cremes Cookies");
		set_food_label("Keebler_sweet_cremes_cookies");
