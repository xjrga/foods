 ...
 */
public class Keebler_almond_crescents_cookies_holiday extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_almond_crescents_cookies_holiday() {
		set_food_id("28106");
		set_food_name("KEEBLER, Almond Crescents Cookies, Holiday");
		set_food_label("Keebler_almond_crescents_cookies_holiday");
