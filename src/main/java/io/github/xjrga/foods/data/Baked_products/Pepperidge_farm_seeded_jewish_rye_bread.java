 ...
 */
public class Pepperidge_farm_seeded_jewish_rye_bread extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Pepperidge_farm_seeded_jewish_rye_bread() {
		set_food_id("28391");
		set_food_name("PEPPERIDGE FARM, Seeded Jewish Rye Bread");
		set_food_label("Pepperidge_farm_seeded_jewish_rye_bread");
