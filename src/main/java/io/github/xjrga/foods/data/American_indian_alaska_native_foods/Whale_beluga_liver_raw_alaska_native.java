 ...
 */
public class Whale_beluga_liver_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Whale_beluga_liver_raw_alaska_native() {
		set_food_id("35013");
		set_food_name("Whale, beluga, liver, raw (Alaska Native)");
		set_food_label("Whale_beluga_liver_raw_alaska_native");
