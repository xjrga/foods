 ...
 */
public class Cereals_kashi_go_lean_hot_cereal_creamy_truly_vanilla_dry extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Cereals_kashi_go_lean_hot_cereal_creamy_truly_vanilla_dry() {
        set_food_id("08562");
        set_food_name("Cereals, KASHI GO LEAN Hot Cereal, Creamy TRULY VANILLA, dry");
        set_food_label("Cereals_kashi_go_lean_hot_cereal_creamy_truly_vanilla_dry");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(360.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(61.09000);
        ...
        set_potassium_in_milligrams(661.00000);
