 ...
 */
public class Cereals_oats_regular_and_quick_unenriched_cooked_with_water_includes_boiling_and_microwaving_without_salt extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Cereals_oats_regular_and_quick_unenriched_cooked_with_water_includes_boiling_and_microwaving_without_salt() {
        set_food_id("08121");
        set_food_name("Cereals, oats, regular and quick, unenriched, cooked with water (includes boiling and microwaving), without salt");
        set_food_label("Cereals_oats_regular_and_quick_unenriched_cooked_with_water_includes_boiling_and_microwaving_without_salt");
