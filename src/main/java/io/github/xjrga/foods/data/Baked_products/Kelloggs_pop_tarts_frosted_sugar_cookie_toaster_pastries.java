 ...
 */
public class Kelloggs_pop_tarts_frosted_sugar_cookie_toaster_pastries extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kelloggs_pop_tarts_frosted_sugar_cookie_toaster_pastries() {
		set_food_id("28173");
		set_food_name("KELLOGG'S, POP-TARTS, Frosted Sugar Cookie Toaster Pastries");
		set_food_label("Kelloggs_pop_tarts_frosted_sugar_cookie_toaster_pastries");
