 ...
 */
public class Bear_black_meat_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Bear_black_meat_alaska_native() {
		set_food_id("35007");
		set_food_name("Bear, black, meat (Alaska Native)");
		set_food_label("Bear_black_meat_alaska_native");
