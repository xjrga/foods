 ...
 */
public class Candies_nestle_crunch_bar_and_dessert_topping extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Candies_nestle_crunch_bar_and_dessert_topping() {
		set_food_id("19145");
		set_food_name("Candies, NESTLE, CRUNCH Bar and Dessert Topping");
		set_food_label("Candies_nestle_crunch_bar_and_dessert_topping");
