 ...
 */
public class Mothers_iced_oatmeal_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mothers_iced_oatmeal_cookies() {
		set_food_id("28203");
		set_food_name("MOTHER'S, Iced Oatmeal Cookies");
		set_food_label("Mothers_iced_oatmeal_cookies");
