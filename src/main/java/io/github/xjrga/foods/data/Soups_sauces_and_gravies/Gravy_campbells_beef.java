 ...
 */
public class Gravy_campbells_beef extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Gravy_campbells_beef() {
		set_food_id("06997");
		set_food_name("Gravy, CAMPBELL'S, beef");
		set_food_label("Gravy_campbells_beef");
