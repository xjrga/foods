 ...
 */
public class Keebler_vanilla_wafers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_vanilla_wafers() {
		set_food_id("18609");
		set_food_name("KEEBLER, Vanilla Wafers");
		set_food_label("Keebler_vanilla_wafers");
		...
		set_saturated_fat_in_grams(5.70000);
