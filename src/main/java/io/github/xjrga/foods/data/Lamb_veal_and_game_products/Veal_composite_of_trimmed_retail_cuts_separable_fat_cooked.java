 ...
 */
public class Veal_composite_of_trimmed_retail_cuts_separable_fat_cooked extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Veal_composite_of_trimmed_retail_cuts_separable_fat_cooked() {
		set_food_id("17093");
		set_food_name("Veal, composite of trimmed retail cuts, separable fat, cooked");
		set_food_label("Veal_composite_of_trimmed_retail_cuts_separable_fat_cooked");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(642.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(0.00000);
		set_fat_in_grams(66.74000);
		set_fiber_in_grams(0.00000);
		set_protein_in_grams(9.42000);
		set_cholesterol_in_milligrams(73.00000);
		set_monounsaturated_fat_in_grams(27.98000);
		set_polyunsaturated_fat_in_grams(3.23000);
		set_saturated_fat_in_grams(32.39000);
