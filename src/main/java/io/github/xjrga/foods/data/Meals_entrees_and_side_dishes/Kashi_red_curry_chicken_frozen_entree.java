 ...
 */
public class Kashi_red_curry_chicken_frozen_entree extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_red_curry_chicken_frozen_entree() {
		set_food_id("22989");
		set_food_name("KASHI, Red Curry Chicken, Frozen Entree");
		set_food_label("Kashi_red_curry_chicken_frozen_entree");
