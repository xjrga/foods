 ...
 */
public class Austin_cheddar_cheese_on_wheat_crackers_sandwich_type extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Austin_cheddar_cheese_on_wheat_crackers_sandwich_type() {
        set_food_id("18983");
        set_food_name("AUSTIN, Cheddar Cheese on Wheat Crackers, sandwich-type");
        set_food_label("Austin_cheddar_cheese_on_wheat_crackers_sandwich_type");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(495.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(61.40000);
