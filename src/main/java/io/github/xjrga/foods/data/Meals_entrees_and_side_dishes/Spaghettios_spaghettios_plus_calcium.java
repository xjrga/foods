 ...
 */
public class Spaghettios_spaghettios_plus_calcium extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Spaghettios_spaghettios_plus_calcium() {
		set_food_id("22938");
		set_food_name("SPAGHETTIOS, SpaghettiOs plus Calcium");
		set_food_label("Spaghettios_spaghettios_plus_calcium");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(67.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(13.89000);
