 ...
 */
public class Kashi_steam_meal_roasted_garlic_chicken_farfalle_frozen_entree extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_steam_meal_roasted_garlic_chicken_farfalle_frozen_entree() {
		set_food_id("22990");
		set_food_name("KASHI, STEAM MEAL, Roasted Garlic Chicken Farfalle, Frozen Entree");
		set_food_label("Kashi_steam_meal_roasted_garlic_chicken_farfalle_frozen_entree");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(103.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(14.60000);
