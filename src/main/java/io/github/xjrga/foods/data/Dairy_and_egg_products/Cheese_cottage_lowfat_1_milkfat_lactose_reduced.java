 ...
 */
public class Cheese_cottage_lowfat_1_milkfat_lactose_reduced extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Cheese_cottage_lowfat_1_milkfat_lactose_reduced() {
		set_food_id("42235");
		set_food_name("Cheese, cottage, lowfat, 1% milkfat, lactose reduced");
		set_food_label("Cheese_cottage_lowfat_1_milkfat_lactose_reduced");
