 ...
 */
public class Sourdock_young_leaves_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Sourdock_young_leaves_alaska_native() {
		set_food_id("35074");
		set_food_name("Sourdock, young leaves (Alaska Native)");
		set_food_label("Sourdock_young_leaves_alaska_native");
