 ...
 */
public class Murray_duplex_creme_sandwich_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_duplex_creme_sandwich_cookies() {
		set_food_id("28213");
		set_food_name("MURRAY, Duplex Creme Sandwich Cookies");
		set_food_label("Murray_duplex_creme_sandwich_cookies");
