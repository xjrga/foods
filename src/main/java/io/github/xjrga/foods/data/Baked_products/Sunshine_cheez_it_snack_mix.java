 ...
 */
public class Sunshine_cheez_it_snack_mix extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Sunshine_cheez_it_snack_mix() {
		set_food_id("28253");
		set_food_name("SUNSHINE, CHEEZ-IT, Snack Mix");
		set_food_label("Sunshine_cheez_it_snack_mix");
		...
		set_iron_in_milligrams(3.84000);
