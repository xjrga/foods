 ...
 */
public class Vinegar_red_wine extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Vinegar_red_wine() {
		set_food_id("02068");
		set_food_name("Vinegar, red wine");
		set_food_label("Vinegar_red_wine");
