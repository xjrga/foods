 ...
 */
public class Squirrel_ground_meat_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Squirrel_ground_meat_alaska_native() {
        set_food_id("35075");
        set_food_name("Squirrel, ground, meat (Alaska Native)");
        set_food_label("Squirrel_ground_meat_alaska_native");
