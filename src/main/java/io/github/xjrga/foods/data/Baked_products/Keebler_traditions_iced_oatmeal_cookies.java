 ...
 */
public class Keebler_traditions_iced_oatmeal_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_traditions_iced_oatmeal_cookies() {
		set_food_id("28151");
		set_food_name("KEEBLER, TRADITIONS, Iced Oatmeal Cookies");
		set_food_label("Keebler_traditions_iced_oatmeal_cookies");
