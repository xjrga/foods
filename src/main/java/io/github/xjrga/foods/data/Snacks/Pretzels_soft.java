 ...
 */
public class Pretzels_soft extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Pretzels_soft() {
        set_food_id("43109");
        set_food_name("Pretzels, soft");
        set_food_label("Pretzels_soft");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(338.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(69.39000);
        set_fat_in_grams(3.10000);
        set_fiber_in_grams(1.70000);
        set_protein_in_grams(8.20000);
        set_cholesterol_in_milligrams(0.00000);
        set_monounsaturated_fat_in_grams(1.07100);
