 ...
 */
public class Hormel_always_tender_center_cut_chops_fresh_pork extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Hormel_always_tender_center_cut_chops_fresh_pork() {
        set_food_id("10855");
        set_food_name("HORMEL ALWAYS TENDER, Center Cut Chops, Fresh Pork");
        set_food_label("Hormel_always_tender_center_cut_chops_fresh_pork");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(167.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(0.84000);
        set_fat_in_grams(9.62000);
