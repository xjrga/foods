 ...
 */
public class Keebler_town_house_wheat_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_town_house_wheat_crackers() {
		set_food_id("28148");
		set_food_name("KEEBLER, TOWN HOUSE, Wheat Crackers");
		set_food_label("Keebler_town_house_wheat_crackers");
