 ...
 */
public class Tea_herbal_brewed_hohoysi_hopi extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Tea_herbal_brewed_hohoysi_hopi() {
		set_food_id("35238");
		set_food_name("Tea, herbal, brewed, Hohoysi (Hopi)");
		set_food_label("Tea_herbal_brewed_hohoysi_hopi");
