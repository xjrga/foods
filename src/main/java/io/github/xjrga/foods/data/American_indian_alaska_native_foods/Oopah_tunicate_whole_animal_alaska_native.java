 ...
 */
public class Oopah_tunicate_whole_animal_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Oopah_tunicate_whole_animal_alaska_native() {
		set_food_id("35058");
		set_food_name("Oopah (tunicate), whole animal (Alaska Native)");
		set_food_label("Oopah_tunicate_whole_animal_alaska_native");
		...
		set_iron_in_milligrams(20.70000);
