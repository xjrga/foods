 ...
 */
public class Campbells_healthy_request_cream_of_mushroom_soup_condensed extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Campbells_healthy_request_cream_of_mushroom_soup_condensed() {
		set_food_id("06988");
		set_food_name("CAMPBELL'S HEALTHY REQUEST, Cream of Mushroom Soup, condensed");
		set_food_label("Campbells_healthy_request_cream_of_mushroom_soup_condensed");
