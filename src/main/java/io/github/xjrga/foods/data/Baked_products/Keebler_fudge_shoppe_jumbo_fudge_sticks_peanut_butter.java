 ...
 */
public class Keebler_fudge_shoppe_jumbo_fudge_sticks_peanut_butter extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_fudge_shoppe_jumbo_fudge_sticks_peanut_butter() {
        set_food_id("28095");
        set_food_name("KEEBLER, FUDGE SHOPPE, Jumbo Fudge Sticks, Peanut Butter");
        set_food_label("Keebler_fudge_shoppe_jumbo_fudge_sticks_peanut_butter");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(537.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(60.60000);
        set_fat_in_grams(30.20000);
        ...
        set_saturated_fat_in_grams(15.70000);
