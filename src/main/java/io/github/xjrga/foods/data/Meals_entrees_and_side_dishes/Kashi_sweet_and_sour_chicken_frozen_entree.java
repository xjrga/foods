 ...
 */
public class Kashi_sweet_and_sour_chicken_frozen_entree extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_sweet_and_sour_chicken_frozen_entree() {
		set_food_id("22995");
		set_food_name("KASHI, Sweet and Sour Chicken, Frozen Entree");
		set_food_label("Kashi_sweet_and_sour_chicken_frozen_entree");
