 ...
 */
public class Duck_scoter_white_winged_meat_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Duck_scoter_white_winged_meat_alaska_native() {
        set_food_id("35069");
        set_food_name("Duck, scoter, white-winged, meat (Alaska Native)");
        set_food_label("Duck_scoter_white_winged_meat_alaska_native");
