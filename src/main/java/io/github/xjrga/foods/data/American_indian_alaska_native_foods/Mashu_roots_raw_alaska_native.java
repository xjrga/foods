 ...
 */
public class Mashu_roots_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mashu_roots_raw_alaska_native() {
		set_food_id("35050");
		set_food_name("Mashu roots, raw (Alaska Native)");
		set_food_label("Mashu_roots_raw_alaska_native");
