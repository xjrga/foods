 ...
 */
public class Game_meat_boar_wild_cooked_roasted extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_boar_wild_cooked_roasted() {
		set_food_id("17159");
		set_food_name("Game meat, boar, wild, cooked, roasted");
		set_food_label("Game_meat_boar_wild_cooked_roasted");
		...
		set_monounsaturated_fat_in_grams(1.71000);
