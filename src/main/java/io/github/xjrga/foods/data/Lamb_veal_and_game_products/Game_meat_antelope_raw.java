 ...
 */
public class Game_meat_antelope_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_antelope_raw() {
		set_food_id("17144");
		set_food_name("Game meat, antelope, raw");
		set_food_label("Game_meat_antelope_raw");
