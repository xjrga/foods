 ...
 */
public class Keebler_fudge_shoppe_fudge_sticks extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_fudge_shoppe_fudge_sticks() {
		set_food_id("28086");
		set_food_name("KEEBLER, FUDGE SHOPPE, Fudge Sticks");
		set_food_label("Keebler_fudge_shoppe_fudge_sticks");
