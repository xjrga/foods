 ...
 */
public class Radishes_oriental_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Radishes_oriental_raw() {
		set_food_id("11430");
		set_food_name("Radishes, oriental, raw");
		set_food_label("Radishes_oriental_raw");
