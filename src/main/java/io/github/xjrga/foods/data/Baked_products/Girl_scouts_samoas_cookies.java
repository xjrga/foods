 ...
 */
public class Girl_scouts_samoas_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Girl_scouts_samoas_cookies() {
		set_food_id("28032");
		set_food_name("GIRL SCOUTS, Samoas Cookies");
		set_food_label("Girl_scouts_samoas_cookies");
