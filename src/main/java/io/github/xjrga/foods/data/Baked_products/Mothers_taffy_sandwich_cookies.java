 ...
 */
public class Mothers_taffy_sandwich_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mothers_taffy_sandwich_cookies() {
		set_food_id("28209");
		set_food_name("MOTHER'S, Taffy Sandwich Cookies");
		set_food_label("Mothers_taffy_sandwich_cookies");
