 ...
 */
public class Murray_vanilla_sugar_wafer extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_vanilla_sugar_wafer() {
		set_food_id("28232");
		set_food_name("MURRAY, Vanilla Sugar Wafer");
		set_food_label("Murray_vanilla_sugar_wafer");
		...
		set_polyunsaturated_fat_in_grams(10.10000);
