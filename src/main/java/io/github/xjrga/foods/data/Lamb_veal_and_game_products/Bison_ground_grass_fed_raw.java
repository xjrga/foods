 ...
 */
public class Bison_ground_grass_fed_raw extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Bison_ground_grass_fed_raw() {
        set_food_id("17149");
        set_food_name("Bison, ground, grass-fed, raw");
        set_food_label("Bison_ground_grass_fed_raw");
        ...
        set_protein_in_grams(20.23000);
        set_cholesterol_in_milligrams(55.00000);
        set_monounsaturated_fat_in_grams(2.75300);
        set_polyunsaturated_fat_in_grams(0.33600);
        set_saturated_fat_in_grams(2.91700);
        ...
        set_niacin_in_milligrams(5.32200);
