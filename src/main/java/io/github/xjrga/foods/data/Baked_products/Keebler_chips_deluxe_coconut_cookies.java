 ...
 */
public class Keebler_chips_deluxe_coconut_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_chips_deluxe_coconut_cookies() {
		set_food_id("28054");
		set_food_name("KEEBLER, CHIPS DELUXE, Coconut Cookies");
		set_food_label("Keebler_chips_deluxe_coconut_cookies");
