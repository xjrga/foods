 ...
 */
public class Moose_meat_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Moose_meat_raw_alaska_native() {
		set_food_id("35049");
		set_food_name("Moose, meat, raw (Alaska Native)");
		set_food_label("Moose_meat_raw_alaska_native");
