 ...
 */
public class Murray_sugar_free_shortbread_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_sugar_free_shortbread_cookies() {
		set_food_id("28229");
		set_food_name("MURRAY, SUGAR FREE, Shortbread Cookies");
		set_food_label("Murray_sugar_free_shortbread_cookies");
