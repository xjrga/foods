 ...
 */
public class Murray_jacks_vanilla_wafers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_jacks_vanilla_wafers() {
		set_food_id("28215");
		set_food_name("MURRAY, JACKS Vanilla Wafers");
		set_food_label("Murray_jacks_vanilla_wafers");
