 ...
 */
public class Spaghettios_spaghettios_with_sliced_franks extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Spaghettios_spaghettios_with_sliced_franks() {
		set_food_id("22941");
		set_food_name("SPAGHETTIOS, SpaghettiOs with Sliced Franks");
		set_food_label("Spaghettios_spaghettios_with_sliced_franks");
		...
		set_monounsaturated_fat_in_grams(0.99200);
