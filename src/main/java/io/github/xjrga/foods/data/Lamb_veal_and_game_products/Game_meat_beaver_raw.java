 ...
 */
public class Game_meat_beaver_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_beaver_raw() {
		set_food_id("17150");
		set_food_name("Game meat, beaver, raw");
		set_food_label("Game_meat_beaver_raw");
		...
		set_iron_in_milligrams(6.90000);
