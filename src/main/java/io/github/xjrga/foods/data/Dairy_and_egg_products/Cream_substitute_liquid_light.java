 ...
 */
public class Cream_substitute_liquid_light extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Cream_substitute_liquid_light() {
		set_food_id("42141");
		set_food_name("Cream substitute, liquid, light");
		set_food_label("Cream_substitute_liquid_light");
		...
		set_saturated_fat_in_grams(0.89600);
