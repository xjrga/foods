 ...
 */
public class Keebler_toasteds_onion_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_toasteds_onion_crackers() {
		set_food_id("28135");
		set_food_name("KEEBLER, TOASTEDS, Onion Crackers");
		set_food_label("Keebler_toasteds_onion_crackers");
		...
		set_sodium_in_milligrams(1006.00000);
