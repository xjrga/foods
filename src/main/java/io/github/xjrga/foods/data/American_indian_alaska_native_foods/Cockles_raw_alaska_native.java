 ...
 */
public class Cockles_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Cockles_raw_alaska_native() {
		set_food_id("35028");
		set_food_name("Cockles, raw (Alaska Native)");
		set_food_label("Cockles_raw_alaska_native");
		...
		set_iron_in_milligrams(16.20000);
