 ...
 */
public class Fiddlehead_ferns_frozen_unprepared extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fiddlehead_ferns_frozen_unprepared() {
        set_food_id("11996");
        set_food_name("Fiddlehead ferns, frozen, unprepared");
        set_food_label("Fiddlehead_ferns_frozen_unprepared");
        ...
        set_vitamin_a_in_micrograms(168.00000);
        set_vitamin_b6_in_milligrams(0.00000);
        set_vitamin_b12_in_micrograms(0.00000);
        set_vitamin_c_in_milligrams(17.80000);
