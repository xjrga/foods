 ...
 */
public class Keebler_sandies_pecan_shortbread_cookies_bite_size extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_sandies_pecan_shortbread_cookies_bite_size() {
        set_food_id("28128");
        set_food_name("KEEBLER, SANDIES, Pecan Shortbread Cookies, bite size");
        set_food_label("Keebler_sandies_pecan_shortbread_cookies_bite_size");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(547.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(58.70000);
        set_fat_in_grams(32.60000);
        ...
        set_polyunsaturated_fat_in_grams(11.70000);
