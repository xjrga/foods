 ...
 */
public class Mouse_nuts_seedlings_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mouse_nuts_seedlings_alaska_native() {
		set_food_id("35053");
		set_food_name("Mouse nuts, seedlings (Alaska Native)");
		set_food_label("Mouse_nuts_seedlings_alaska_native");
