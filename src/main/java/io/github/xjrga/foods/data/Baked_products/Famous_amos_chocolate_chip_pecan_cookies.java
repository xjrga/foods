 ...
 */
public class Famous_amos_chocolate_chip_pecan_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Famous_amos_chocolate_chip_pecan_cookies() {
		set_food_id("28028");
		set_food_name("FAMOUS AMOS, Chocolate Chip Pecan Cookies");
		set_food_label("Famous_amos_chocolate_chip_pecan_cookies");
		...
		set_saturated_fat_in_grams(9.70000);
