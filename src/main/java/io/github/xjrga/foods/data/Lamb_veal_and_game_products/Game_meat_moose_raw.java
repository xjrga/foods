 ...
 */
public class Game_meat_moose_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_moose_raw() {
		set_food_id("17172");
		set_food_name("Game meat, moose, raw");
		set_food_label("Game_meat_moose_raw");
