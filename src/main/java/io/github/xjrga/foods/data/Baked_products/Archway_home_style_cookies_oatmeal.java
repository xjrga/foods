 ...
 */
public class Archway_home_style_cookies_oatmeal extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Archway_home_style_cookies_oatmeal() {
        set_food_id("18537");
        set_food_name("ARCHWAY Home Style Cookies, Oatmeal");
        set_food_label("Archway_home_style_cookies_oatmeal");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(421.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(68.17000);
        ...
        set_niacin_in_milligrams(1.88000);
