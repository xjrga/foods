 ...
 */
public class Mori_nu_tofu_silken_firm extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mori_nu_tofu_silken_firm() {
		set_food_id("16162");
		set_food_name("MORI-NU, Tofu, silken, firm");
		set_food_label("Mori_nu_tofu_silken_firm");
		...
		set_niacin_in_milligrams(0.24700);
