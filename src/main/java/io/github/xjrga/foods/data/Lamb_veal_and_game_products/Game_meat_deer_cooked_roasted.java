 ...
 */
public class Game_meat_deer_cooked_roasted extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_deer_cooked_roasted() {
		set_food_id("17165");
		set_food_name("Game meat, deer, cooked, roasted");
		set_food_label("Game_meat_deer_cooked_roasted");
		...
		set_niacin_in_milligrams(6.71000);
