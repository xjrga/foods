 ...
 */
public class Toaster_pastries_kellogg_kelloggs_pop_tarts_frosted_blueberry extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Toaster_pastries_kellogg_kelloggs_pop_tarts_frosted_blueberry() {
		set_food_id("18477");
		set_food_name("Toaster Pastries, KELLOGG, KELLOGG'S POP TARTS, Frosted blueberry");
		set_food_label("Toaster_pastries_kellogg_kelloggs_pop_tarts_frosted_blueberry");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(391.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(71.77000);
		set_fat_in_grams(10.00000);
		set_fiber_in_grams(1.10000);
		set_protein_in_grams(4.60000);
		set_cholesterol_in_milligrams(0.00000);
		set_monounsaturated_fat_in_grams(6.83000);
