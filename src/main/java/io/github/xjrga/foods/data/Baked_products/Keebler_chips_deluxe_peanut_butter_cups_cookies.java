 ...
 */
public class Keebler_chips_deluxe_peanut_butter_cups_cookies extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_chips_deluxe_peanut_butter_cups_cookies() {
        set_food_id("28059");
        set_food_name("KEEBLER, CHIPS DELUXE, Peanut Butter Cups Cookies");
        set_food_label("Keebler_chips_deluxe_peanut_butter_cups_cookies");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(519.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(60.80000);
        set_fat_in_grams(28.90000);
