 ...
 */
public class Morningstar_farms_chik_patties_frozen_unprepared extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Morningstar_farms_chik_patties_frozen_unprepared() {
		set_food_id("16557");
		set_food_name("MORNINGSTAR FARMS Chik Patties, frozen, unprepared");
		set_food_label("Morningstar_farms_chik_patties_frozen_unprepared");
