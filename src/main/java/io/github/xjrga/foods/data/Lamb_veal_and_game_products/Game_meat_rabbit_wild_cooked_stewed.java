 ...
 */
public class Game_meat_rabbit_wild_cooked_stewed extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Game_meat_rabbit_wild_cooked_stewed() {
        set_food_id("17181");
        set_food_name("Game meat, rabbit, wild, cooked, stewed");
        set_food_label("Game_meat_rabbit_wild_cooked_stewed");
        ...
        set_iron_in_milligrams(4.85000);
