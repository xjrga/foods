 ...
 */
public class Campbells_low_sodium_soups_chicken_with_noodles_soup extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Campbells_low_sodium_soups_chicken_with_noodles_soup() {
		set_food_id("06482");
		set_food_name("CAMPBELL'S Low Sodium Soups, Chicken with Noodles Soup");
		set_food_label("Campbells_low_sodium_soups_chicken_with_noodles_soup");
