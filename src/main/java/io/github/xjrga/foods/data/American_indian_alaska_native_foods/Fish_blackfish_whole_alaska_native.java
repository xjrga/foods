 ...
 */
public class Fish_blackfish_whole_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fish_blackfish_whole_alaska_native() {
        set_food_id("35016");
        set_food_name("Fish, blackfish, whole (Alaska Native)");
        set_food_label("Fish_blackfish_whole_alaska_native");
