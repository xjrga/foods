 ...
 */
public class Keebler_sandies_pecan_shortbread_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_sandies_pecan_shortbread_cookies() {
		set_food_id("28127");
		set_food_name("KEEBLER, SANDIES, Pecan Shortbread Cookies");
		set_food_label("Keebler_sandies_pecan_shortbread_cookies");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(541.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(59.00000);
