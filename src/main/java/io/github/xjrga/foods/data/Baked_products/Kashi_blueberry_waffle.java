 ...
 */
public class Kashi_blueberry_waffle extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_blueberry_waffle() {
		set_food_id("18978");
		set_food_name("KASHI, Blueberry Waffle");
		set_food_label("Kashi_blueberry_waffle");
