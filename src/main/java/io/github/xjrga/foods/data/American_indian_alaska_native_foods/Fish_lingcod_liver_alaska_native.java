 ...
 */
public class Fish_lingcod_liver_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fish_lingcod_liver_alaska_native() {
        set_food_id("35047");
        set_food_name("Fish, lingcod, liver (Alaska Native)");
        set_food_label("Fish_lingcod_liver_alaska_native");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(424.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(6.00000);
        set_fat_in_grams(42.00000);
