 ...
 */
public class Seal_bearded_oogruk_meat_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Seal_bearded_oogruk_meat_raw_alaska_native() {
		set_food_id("35056");
		set_food_name("Seal, bearded (Oogruk), meat, raw (Alaska Native)");
		set_food_label("Seal_bearded_oogruk_meat_raw_alaska_native");
		...
		set_iron_in_milligrams(12.90000);
