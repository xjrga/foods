 ...
 */
public class Murray_southern_kitchen_chocolate_chip_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_southern_kitchen_chocolate_chip_cookies() {
		set_food_id("28217");
		set_food_name("MURRAY, SOUTHERN KITCHEN, Chocolate Chip Cookies");
		set_food_label("Murray_southern_kitchen_chocolate_chip_cookies");
