 ...
 */
public class Milk_reduced_fat_fluid_2_milkfat_with_added_nonfat_milk_solids_without_added_vitamin_a extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Milk_reduced_fat_fluid_2_milkfat_with_added_nonfat_milk_solids_without_added_vitamin_a() {
        set_food_id("01152");
        set_food_name("Milk, reduced fat, fluid, 2% milkfat, with added nonfat milk solids, without added vitamin A");
        set_food_label("Milk_reduced_fat_fluid_2_milkfat_with_added_nonfat_milk_solids_without_added_vitamin_a");
