 ...
 */
public class Murray_chocolate_creme_sandwich_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_chocolate_creme_sandwich_cookies() {
		set_food_id("28272");
		set_food_name("MURRAY, Chocolate Creme Sandwich Cookies");
		set_food_label("Murray_chocolate_creme_sandwich_cookies");
