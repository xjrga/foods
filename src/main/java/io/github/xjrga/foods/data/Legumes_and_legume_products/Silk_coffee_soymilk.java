 ...
 */
public class Silk_coffee_soymilk extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Silk_coffee_soymilk() {
        set_food_id("16249");
        set_food_name("SILK Coffee, soymilk");
        set_food_label("Silk_coffee_soymilk");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(62.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(10.29000);
