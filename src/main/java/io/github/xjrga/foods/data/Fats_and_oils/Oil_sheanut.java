 ...
 */
public class Oil_sheanut extends Abstract_food {
	...
	public Oil_sheanut() {
		set_food_id("04536");
		set_food_name("Oil, sheanut");
		set_food_label("Oil_sheanut");
		...
		set_monounsaturated_fat_in_grams(44.00000);
		set_polyunsaturated_fat_in_grams(5.20000);
		set_saturated_fat_in_grams(46.60000);
