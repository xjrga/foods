 ...
 */
public class Beverages_coffee_brewed_breakfast_blend extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Beverages_coffee_brewed_breakfast_blend() {
		set_food_id("14180");
		set_food_name("Beverages, coffee, brewed, breakfast blend");
		set_food_label("Beverages_coffee_brewed_breakfast_blend");
