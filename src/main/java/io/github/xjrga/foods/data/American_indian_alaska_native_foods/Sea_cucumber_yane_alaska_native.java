 ...
 */
public class Sea_cucumber_yane_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Sea_cucumber_yane_alaska_native() {
		set_food_id("35070");
		set_food_name("Sea cucumber, yane (Alaska Native)");
		set_food_label("Sea_cucumber_yane_alaska_native");
