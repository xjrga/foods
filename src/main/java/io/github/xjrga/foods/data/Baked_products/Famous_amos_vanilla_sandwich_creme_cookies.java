 ...
 */
public class Famous_amos_vanilla_sandwich_creme_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Famous_amos_vanilla_sandwich_creme_cookies() {
		set_food_id("28262");
		set_food_name("FAMOUS AMOS, Vanilla Sandwich Creme Cookies");
		set_food_label("Famous_amos_vanilla_sandwich_creme_cookies");
