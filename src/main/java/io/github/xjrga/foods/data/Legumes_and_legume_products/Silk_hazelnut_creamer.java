 ...
 */
public class Silk_hazelnut_creamer extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Silk_hazelnut_creamer() {
		set_food_id("16262");
		set_food_name("SILK Hazelnut Creamer");
		set_food_label("Silk_hazelnut_creamer");
