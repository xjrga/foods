 ...
 */
public class Nabisco_nabisco_grahams_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Nabisco_nabisco_grahams_crackers() {
		set_food_id("18617");
		set_food_name("NABISCO, NABISCO GRAHAMS Crackers");
		set_food_label("Nabisco_nabisco_grahams_crackers");
		...
		set_iron_in_milligrams(4.13000);
