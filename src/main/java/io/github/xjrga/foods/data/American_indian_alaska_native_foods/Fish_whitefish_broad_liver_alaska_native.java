 ...
 */
public class Fish_whitefish_broad_liver_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fish_whitefish_broad_liver_alaska_native() {
        set_food_id("35088");
        set_food_name("Fish, whitefish, broad, liver (Alaska Native)");
        set_food_label("Fish_whitefish_broad_liver_alaska_native");
