 ...
 */
public class Fish_herring_eggs_pacific_dry_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Fish_herring_eggs_pacific_dry_alaska_native() {
		set_food_id("35040");
		set_food_name("Fish, herring eggs, Pacific, dry (Alaska Native)");
		set_food_label("Fish_herring_eggs_pacific_dry_alaska_native");
		...
		set_phosphorus_in_milligrams(808.00000);
