 ...
 */
public class Murray_sugar_free_fudge_dipped_grahams extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_sugar_free_fudge_dipped_grahams() {
		set_food_id("28222");
		set_food_name("MURRAY, SUGAR FREE, Fudge Dipped Grahams");
		set_food_label("Murray_sugar_free_fudge_dipped_grahams");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(483.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(63.30000);
		...
		set_saturated_fat_in_grams(19.10000);
