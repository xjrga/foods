 ...
 */
public class Silk_original_creamer extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Silk_original_creamer() {
		set_food_id("16260");
		set_food_name("SILK Original Creamer");
		set_food_label("Silk_original_creamer");
