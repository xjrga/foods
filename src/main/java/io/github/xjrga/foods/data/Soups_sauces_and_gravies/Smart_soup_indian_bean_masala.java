 ...
 */
public class Smart_soup_indian_bean_masala extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Smart_soup_indian_bean_masala() {
		set_food_id("06622");
		set_food_name("SMART SOUP, Indian Bean Masala");
		set_food_label("Smart_soup_indian_bean_masala");
