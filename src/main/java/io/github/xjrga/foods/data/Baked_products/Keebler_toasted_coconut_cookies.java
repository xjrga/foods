 ...
 */
public class Keebler_toasted_coconut_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_toasted_coconut_cookies() {
		set_food_id("28132");
		set_food_name("KEEBLER, Toasted Coconut Cookies");
		set_food_label("Keebler_toasted_coconut_cookies");
