 ...
 */
public class Murray_vanilla_creme_sandwich_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_vanilla_creme_sandwich_cookies() {
		set_food_id("28273");
		set_food_name("MURRAY, Vanilla Creme Sandwich Cookies");
		set_food_label("Murray_vanilla_creme_sandwich_cookies");
