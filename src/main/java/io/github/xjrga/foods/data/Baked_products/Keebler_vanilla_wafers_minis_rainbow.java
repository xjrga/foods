 ...
 */
public class Keebler_vanilla_wafers_minis_rainbow extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_vanilla_wafers_minis_rainbow() {
		set_food_id("28152");
		set_food_name("KEEBLER, Vanilla Wafers Minis, Rainbow");
		set_food_label("Keebler_vanilla_wafers_minis_rainbow");
		...
		set_saturated_fat_in_grams(6.00000);
