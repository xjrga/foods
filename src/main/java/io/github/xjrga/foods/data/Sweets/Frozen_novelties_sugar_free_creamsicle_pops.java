 ...
 */
public class Frozen_novelties_sugar_free_creamsicle_pops extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Frozen_novelties_sugar_free_creamsicle_pops() {
		set_food_id("19892");
		set_food_name("Frozen novelties, Sugar Free, CREAMSICLE Pops");
		set_food_label("Frozen_novelties_sugar_free_creamsicle_pops");
