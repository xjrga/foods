 ...
 */
public class Spaghettios_spaghetti_in_tomato_cheese_sauce extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Spaghettios_spaghetti_in_tomato_cheese_sauce() {
		set_food_id("22930");
		set_food_name("SPAGHETTIOS, Spaghetti in Tomato & Cheese Sauce");
		set_food_label("Spaghettios_spaghetti_in_tomato_cheese_sauce");
