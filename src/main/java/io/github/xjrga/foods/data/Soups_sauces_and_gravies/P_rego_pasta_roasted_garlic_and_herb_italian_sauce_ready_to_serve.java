 ...
 */
public class P_rego_pasta_roasted_garlic_and_herb_italian_sauce_ready_to_serve extends Abstract_food {

    /**
     * Constructs a food item
     */
    public P_rego_pasta_roasted_garlic_and_herb_italian_sauce_ready_to_serve() {
        set_food_id("06235");
        set_food_name("P REGO Pasta, Roasted Garlic and Herb Italian Sauce, ready-to-serve");
        set_food_label("P_rego_pasta_roasted_garlic_and_herb_italian_sauce_ready_to_serve");
