 ...
 */
public class Mouse_nuts_roots_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Mouse_nuts_roots_alaska_native() {
        set_food_id("35052");
        set_food_name("Mouse nuts, roots (Alaska Native)");
        set_food_label("Mouse_nuts_roots_alaska_native");
