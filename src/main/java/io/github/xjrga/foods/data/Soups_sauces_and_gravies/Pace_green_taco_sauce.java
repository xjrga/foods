 ...
 */
public class Pace_green_taco_sauce extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Pace_green_taco_sauce() {
		set_food_id("06600");
		set_food_name("PACE, Green Taco Sauce");
		set_food_label("Pace_green_taco_sauce");
