 ...
 */
public class Mountain_yam_hawaii_cooked_steamed_without_salt extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Mountain_yam_hawaii_cooked_steamed_without_salt() {
        set_food_id("11259");
        set_food_name("Mountain yam, hawaii, cooked, steamed, without salt");
        set_food_label("Mountain_yam_hawaii_cooked_steamed_without_salt");
