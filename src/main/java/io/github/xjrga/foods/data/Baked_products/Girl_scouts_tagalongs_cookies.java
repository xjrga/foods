 ...
 */
public class Girl_scouts_tagalongs_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Girl_scouts_tagalongs_cookies() {
		set_food_id("28033");
		set_food_name("GIRL SCOUTS, Tagalongs Cookies");
		set_food_label("Girl_scouts_tagalongs_cookies");
