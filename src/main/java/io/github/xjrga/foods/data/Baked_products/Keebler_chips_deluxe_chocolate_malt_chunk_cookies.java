 ...
 */
public class Keebler_chips_deluxe_chocolate_malt_chunk_cookies extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_chips_deluxe_chocolate_malt_chunk_cookies() {
        set_food_id("28053");
        set_food_name("KEEBLER, CHIPS DELUXE, Chocolate Malt Chunk Cookies");
        set_food_label("Keebler_chips_deluxe_chocolate_malt_chunk_cookies");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(537.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(61.80000);
