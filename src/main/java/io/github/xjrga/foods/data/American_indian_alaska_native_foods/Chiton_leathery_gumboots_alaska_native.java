 ...
 */
public class Chiton_leathery_gumboots_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Chiton_leathery_gumboots_alaska_native() {
		set_food_id("35026");
		set_food_name("Chiton, leathery, gumboots (Alaska Native)");
		set_food_label("Chiton_leathery_gumboots_alaska_native");
		...
		set_iron_in_milligrams(16.00000);
