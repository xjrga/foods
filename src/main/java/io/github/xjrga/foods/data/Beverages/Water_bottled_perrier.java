 ...
 */
public class Water_bottled_perrier extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Water_bottled_perrier() {
		set_food_id("14384");
		set_food_name("Water, bottled, PERRIER");
		set_food_label("Water_bottled_perrier");
