 ...
 */
public class Peppers_hot_chili_green_canned_pods_excluding_seeds_solids_and_liquids extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Peppers_hot_chili_green_canned_pods_excluding_seeds_solids_and_liquids() {
		set_food_id("11329");
		set_food_name("Peppers, hot chili, green, canned, pods, excluding seeds, solids and liquids");
		set_food_label("Peppers_hot_chili_green_canned_pods_excluding_seeds_solids_and_liquids");
