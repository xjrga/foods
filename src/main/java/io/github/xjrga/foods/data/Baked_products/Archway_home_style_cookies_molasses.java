 ...
 */
public class Archway_home_style_cookies_molasses extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Archway_home_style_cookies_molasses() {
        set_food_id("18535");
        set_food_name("ARCHWAY Home Style Cookies, Molasses");
        set_food_label("Archway_home_style_cookies_molasses");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(403.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(69.41000);
        ...
        set_niacin_in_milligrams(2.71000);
