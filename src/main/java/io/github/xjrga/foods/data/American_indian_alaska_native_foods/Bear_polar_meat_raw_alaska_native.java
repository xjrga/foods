 ...
 */
public class Bear_polar_meat_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Bear_polar_meat_raw_alaska_native() {
		set_food_id("35008");
		set_food_name("Bear, polar, meat, raw (Alaska Native)");
		set_food_label("Bear_polar_meat_raw_alaska_native");
		...
		set_iron_in_milligrams(6.10000);
		...
		set_riboflavin_in_milligrams(0.57300);
