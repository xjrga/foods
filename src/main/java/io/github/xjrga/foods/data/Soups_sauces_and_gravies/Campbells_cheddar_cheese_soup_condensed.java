 ...
 */
public class Campbells_cheddar_cheese_soup_condensed extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Campbells_cheddar_cheese_soup_condensed() {
		set_food_id("06038");
		set_food_name("CAMPBELL'S, Cheddar Cheese Soup, condensed");
		set_food_label("Campbells_cheddar_cheese_soup_condensed");
