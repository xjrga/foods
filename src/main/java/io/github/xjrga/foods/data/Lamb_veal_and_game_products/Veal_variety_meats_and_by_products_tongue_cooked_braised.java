 ...
 */
public class Veal_variety_meats_and_by_products_tongue_cooked_braised extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Veal_variety_meats_and_by_products_tongue_cooked_braised() {
        set_food_id("17223");
        set_food_name("Veal, variety meats and by-products, tongue, cooked, braised");
        set_food_label("Veal_variety_meats_and_by_products_tongue_cooked_braised");
        ...
        set_cholesterol_in_milligrams(238.00000);
        set_monounsaturated_fat_in_grams(4.61000);
        set_polyunsaturated_fat_in_grams(0.38000);
        set_saturated_fat_in_grams(4.35000);
        ...
        set_vitamin_b12_in_micrograms(5.30000);
