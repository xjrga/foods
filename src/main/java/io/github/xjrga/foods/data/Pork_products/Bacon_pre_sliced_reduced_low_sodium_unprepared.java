 ...
 */
public class Bacon_pre_sliced_reduced_low_sodium_unprepared extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Bacon_pre_sliced_reduced_low_sodium_unprepared() {
        set_food_id("10994");
        set_food_name("Bacon, pre-sliced, reduced/low sodium, unprepared");
        set_food_label("Bacon_pre_sliced_reduced_low_sodium_unprepared");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(407.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(0.83000);
        set_fat_in_grams(39.27000);
