 ...
 */
public class Game_meat_elk_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_elk_raw() {
		set_food_id("17166");
		set_food_name("Game meat, elk, raw");
		set_food_label("Game_meat_elk_raw");
