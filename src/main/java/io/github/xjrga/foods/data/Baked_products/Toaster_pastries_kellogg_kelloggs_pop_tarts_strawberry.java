 ...
 */
public class Toaster_pastries_kellogg_kelloggs_pop_tarts_strawberry extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Toaster_pastries_kellogg_kelloggs_pop_tarts_strawberry() {
		set_food_id("18488");
		set_food_name("Toaster Pastries, KELLOGG, KELLOGG'S POP TARTS, Strawberry");
		set_food_label("Toaster_pastries_kellogg_kelloggs_pop_tarts_strawberry");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(398.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(71.10000);
