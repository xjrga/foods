 ...
 */
public class Mori_nu_tofu_silken_soft extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Mori_nu_tofu_silken_soft() {
        set_food_id("16161");
        set_food_name("MORI-NU, Tofu, silken, soft");
        set_food_label("Mori_nu_tofu_silken_soft");
        ...
        set_monounsaturated_fat_in_grams(0.52200);
        set_polyunsaturated_fat_in_grams(1.55000);
        set_saturated_fat_in_grams(0.35700);
