 ...
 */
public class Mothers_chocolate_chip_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mothers_chocolate_chip_cookies() {
		set_food_id("28195");
		set_food_name("MOTHER'S, Chocolate Chip Cookies");
		set_food_label("Mothers_chocolate_chip_cookies");
