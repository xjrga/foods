 ...
 */
public class Keebler_chips_deluxe_rainbow_chocolate_chip_cookies_bite_size extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_chips_deluxe_rainbow_chocolate_chip_cookies_bite_size() {
        set_food_id("28061");
        set_food_name("KEEBLER, CHIPS DELUXE, Rainbow Chocolate Chip Cookies, bite size");
        set_food_label("Keebler_chips_deluxe_rainbow_chocolate_chip_cookies_bite_size");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(505.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(68.55000);
        set_fat_in_grams(23.90000);
        set_fiber_in_grams(1.70000);
        set_protein_in_grams(4.75000);
        set_cholesterol_in_milligrams(3.00000);
        set_monounsaturated_fat_in_grams(4.95000);
        set_polyunsaturated_fat_in_grams(7.65000);
        set_saturated_fat_in_grams(9.65000);
