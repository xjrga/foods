 ...
 */
public class Puddings_tapioca_ready_to_eat_fat_free extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Puddings_tapioca_ready_to_eat_fat_free() {
		set_food_id("19234");
		set_food_name("Puddings, tapioca, ready-to-eat, fat free");
		set_food_label("Puddings_tapioca_ready_to_eat_fat_free");
