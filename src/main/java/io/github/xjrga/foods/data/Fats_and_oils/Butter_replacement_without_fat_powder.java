 ...
 */
public class Butter_replacement_without_fat_powder extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Butter_replacement_without_fat_powder() {
		set_food_id("43214");
		set_food_name("Butter replacement, without fat, powder");
		set_food_label("Butter_replacement_without_fat_powder");
		...
		set_saturated_fat_in_grams(0.58900);
