 ...
 */
public class Keebler_ready_crust_shortbread_pie_crust extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_ready_crust_shortbread_pie_crust() {
		set_food_id("28112");
		set_food_name("KEEBLER, READY CRUST, Shortbread Pie Crust");
		set_food_label("Keebler_ready_crust_shortbread_pie_crust");
