 ...
 */
public class Duck_young_duckling_domesticated_white_pekin_breast_meat_and_skin_boneless_cooked_roasted
		extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Duck_young_duckling_domesticated_white_pekin_breast_meat_and_skin_boneless_cooked_roasted() {
		set_food_id("05315");
		set_food_name(
				"Duck, young duckling, domesticated, White Pekin, breast, meat and skin, boneless, cooked, roasted");
		set_food_label("Duck_young_duckling_domesticated_white_pekin_breast_meat_and_skin_boneless_cooked_roasted");
		...
		set_monounsaturated_fat_in_grams(5.42800);
		set_polyunsaturated_fat_in_grams(1.63200);
		set_saturated_fat_in_grams(2.92200);
