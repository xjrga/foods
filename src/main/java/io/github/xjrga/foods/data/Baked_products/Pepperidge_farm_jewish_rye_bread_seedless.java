 ...
 */
public class Pepperidge_farm_jewish_rye_bread_seedless extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Pepperidge_farm_jewish_rye_bread_seedless() {
		set_food_id("28385");
		set_food_name("PEPPERIDGE FARM, Jewish Rye Bread (Seedless)");
		set_food_label("Pepperidge_farm_jewish_rye_bread_seedless");
