 ...
 */
public class Water_bottled_generic extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Water_bottled_generic() {
		set_food_id("14555");
		set_food_name("Water, bottled, generic");
		set_food_label("Water_bottled_generic");
