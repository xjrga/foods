 ...
 */
public class Murray_southern_kitchen_iced_oatmeal_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_southern_kitchen_iced_oatmeal_cookies() {
		set_food_id("28219");
		set_food_name("MURRAY, SOUTHERN KITCHEN, Iced Oatmeal Cookies");
		set_food_label("Murray_southern_kitchen_iced_oatmeal_cookies");
