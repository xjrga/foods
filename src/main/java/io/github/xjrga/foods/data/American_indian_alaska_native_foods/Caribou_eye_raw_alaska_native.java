 ...
 */
public class Caribou_eye_raw_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Caribou_eye_raw_alaska_native() {
        set_food_id("35022");
        set_food_name("Caribou, eye, raw (Alaska Native)");
        set_food_label("Caribou_eye_raw_alaska_native");
