 ...
 */
public class Roast_beef_spread extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Roast_beef_spread() {
		set_food_id("07912");
		set_food_name("Roast beef spread");
		set_food_label("Roast_beef_spread");
		...
		set_monounsaturated_fat_in_grams(5.58700);
