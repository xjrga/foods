 ...
 */
public class Caribou_liver_raw_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Caribou_liver_raw_alaska_native() {
        set_food_id("35023");
        set_food_name("Caribou, liver, raw (Alaska Native)");
        set_food_label("Caribou_liver_raw_alaska_native");
