 ...
 */
public class Potatoes_french_fried_cross_cut_frozen_unprepared extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Potatoes_french_fried_cross_cut_frozen_unprepared() {
        set_food_id("31031");
        set_food_name("Potatoes, french fried, cross cut, frozen, unprepared");
        set_food_label("Potatoes_french_fried_cross_cut_frozen_unprepared");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(193.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(22.95000);
