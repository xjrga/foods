 ...
 */
public class Campbells_chicken_with_rice_soup_condensed extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Campbells_chicken_with_rice_soup_condensed() {
		set_food_id("06309");
		set_food_name("CAMPBELL'S, Chicken with Rice Soup, condensed");
		set_food_label("Campbells_chicken_with_rice_soup_condensed");
