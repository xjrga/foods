 ...
 */
public class Keebler_fudge_shoppe_deluxe_grahams_cookies extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_fudge_shoppe_deluxe_grahams_cookies() {
        set_food_id("28080");
        set_food_name("KEEBLER, FUDGE SHOPPE, Deluxe Grahams Cookies");
        set_food_label("Keebler_fudge_shoppe_deluxe_grahams_cookies");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(511.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(66.60000);
