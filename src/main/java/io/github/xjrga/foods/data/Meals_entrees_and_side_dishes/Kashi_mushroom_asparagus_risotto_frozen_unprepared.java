 ...
 */
public class Kashi_mushroom_asparagus_risotto_frozen_unprepared extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_mushroom_asparagus_risotto_frozen_unprepared() {
		set_food_id("32023");
		set_food_name("KASHI Mushroom & Asparagus Risotto, frozen, unprepared");
		set_food_label("Kashi_mushroom_asparagus_risotto_frozen_unprepared");
