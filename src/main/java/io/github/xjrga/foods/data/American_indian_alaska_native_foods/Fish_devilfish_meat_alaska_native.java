 ...
 */
public class Fish_devilfish_meat_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fish_devilfish_meat_alaska_native() {
        set_food_id("35034");
        set_food_name("Fish, devilfish, meat (Alaska Native)");
        set_food_label("Fish_devilfish_meat_alaska_native");
