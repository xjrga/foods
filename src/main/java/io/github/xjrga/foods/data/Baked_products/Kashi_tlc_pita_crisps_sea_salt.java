 ...
 */
public class Kashi_tlc_pita_crisps_sea_salt extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_tlc_pita_crisps_sea_salt() {
		set_food_id("28017");
		set_food_name("KASHI, TLC, Pita Crisps, Sea Salt");
		set_food_label("Kashi_tlc_pita_crisps_sea_salt");
