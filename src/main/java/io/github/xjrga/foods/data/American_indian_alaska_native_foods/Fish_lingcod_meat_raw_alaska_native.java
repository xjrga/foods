 ...
 */
public class Fish_lingcod_meat_raw_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fish_lingcod_meat_raw_alaska_native() {
        set_food_id("35046");
        set_food_name("Fish, lingcod, meat, raw (Alaska Native)");
        set_food_label("Fish_lingcod_meat_raw_alaska_native");
