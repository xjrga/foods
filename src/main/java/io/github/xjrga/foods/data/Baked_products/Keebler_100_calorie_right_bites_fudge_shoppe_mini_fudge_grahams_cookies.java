 ...
 */
public class Keebler_100_calorie_right_bites_fudge_shoppe_mini_fudge_grahams_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_100_calorie_right_bites_fudge_shoppe_mini_fudge_grahams_cookies() {
		set_food_id("28118");
		set_food_name("KEEBLER, 100 Calorie RIGHT BITES, FUDGE SHOPPE, Mini Fudge Grahams Cookies");
		set_food_label("Keebler_100_calorie_right_bites_fudge_shoppe_mini_fudge_grahams_cookies");
