 ...
 */
public class Cereals_ready_to_eat_quaker_mothers_peanut_butter_bumpers_cereal extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Cereals_ready_to_eat_quaker_mothers_peanut_butter_bumpers_cereal() {
        set_food_id("08351");
        set_food_name("Cereals ready-to-eat, QUAKER, MOTHER'S PEANUT BUTTER BUMPERS Cereal");
        set_food_label("Cereals_ready_to_eat_quaker_mothers_peanut_butter_bumpers_cereal");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(407.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(79.68000);
        ...
        set_polyunsaturated_fat_in_grams(2.25000);
        ...
        set_sodium_in_milligrams(774.00000);
        ...
        set_vitamin_e_in_milligrams(3.71000);
