 ...
 */
public class Fish_salmon_tipnuk_fermented_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Fish_salmon_tipnuk_fermented_alaska_native() {
		set_food_id("35064");
		set_food_name("Fish, salmon, tipnuk, fermented (Alaska Native)");
		set_food_label("Fish_salmon_tipnuk_fermented_alaska_native");
