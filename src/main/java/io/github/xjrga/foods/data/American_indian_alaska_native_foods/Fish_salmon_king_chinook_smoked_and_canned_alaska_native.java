 ...
 */
public class Fish_salmon_king_chinook_smoked_and_canned_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Fish_salmon_king_chinook_smoked_and_canned_alaska_native() {
		set_food_id("35066");
		set_food_name("Fish, salmon, king, chinook, smoked and canned (Alaska Native)");
		set_food_label("Fish_salmon_king_chinook_smoked_and_canned_alaska_native");
