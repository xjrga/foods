 ...
 */
public class Kashi_steam_meal_chicken_fettuccine_frozen_entree extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Kashi_steam_meal_chicken_fettuccine_frozen_entree() {
		set_food_id("22982");
		set_food_name("KASHI, STEAM MEAL, Chicken Fettuccine, Frozen Entree");
		set_food_label("Kashi_steam_meal_chicken_fettuccine_frozen_entree");
