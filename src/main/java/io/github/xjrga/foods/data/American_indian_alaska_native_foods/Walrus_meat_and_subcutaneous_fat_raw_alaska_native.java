 ...
 */
public class Walrus_meat_and_subcutaneous_fat_raw_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Walrus_meat_and_subcutaneous_fat_raw_alaska_native() {
        set_food_id("35082");
        set_food_name("Walrus, meat and subcutaneous fat raw (Alaska Native)");
        set_food_label("Walrus_meat_and_subcutaneous_fat_raw_alaska_native");
