 ...
 */
public class Beverages_zevia_cola extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Beverages_zevia_cola() {
		set_food_id("14073");
		set_food_name("Beverages, ZEVIA, cola");
		set_food_label("Beverages_zevia_cola");
