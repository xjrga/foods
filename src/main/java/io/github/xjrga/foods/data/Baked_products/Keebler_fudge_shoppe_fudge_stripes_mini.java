 ...
 */
public class Keebler_fudge_shoppe_fudge_stripes_mini extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Keebler_fudge_shoppe_fudge_stripes_mini() {
		set_food_id("28089");
		set_food_name("KEEBLER, FUDGE SHOPPE, Fudge Stripes, Mini");
		set_food_label("Keebler_fudge_shoppe_fudge_stripes_mini");
