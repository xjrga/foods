 ...
 */
public class Morningstar_farms_corn_dog_frozen_unprepared extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Morningstar_farms_corn_dog_frozen_unprepared() {
        set_food_id("16560");
        set_food_name("MORNINGSTAR FARMS Corn Dog, frozen, unprepared");
        set_food_label("Morningstar_farms_corn_dog_frozen_unprepared");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(208.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(36.00000);
