 ...
 */
public class Keebler_fudge_shoppe_cheesecake_middles_original_graham_cookies extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Keebler_fudge_shoppe_cheesecake_middles_original_graham_cookies() {
        set_food_id("28077");
        set_food_name("KEEBLER, FUDGE SHOPPE, Cheesecake Middles, Original Graham Cookies");
        set_food_label("Keebler_fudge_shoppe_cheesecake_middles_original_graham_cookies");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(507.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(65.50000);
        set_fat_in_grams(26.20000);
