 ...
 */
public class Sunshine_cheez_it_big_crackers extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Sunshine_cheez_it_big_crackers() {
		set_food_id("28236");
		set_food_name("SUNSHINE, CHEEZ-IT, BIG Crackers");
		set_food_label("Sunshine_cheez_it_big_crackers");
