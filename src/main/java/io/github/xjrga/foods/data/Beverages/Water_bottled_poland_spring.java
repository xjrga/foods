 ...
 */
public class Water_bottled_poland_spring extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Water_bottled_poland_spring() {
		set_food_id("14385");
		set_food_name("Water, bottled, POLAND SPRING");
		set_food_label("Water_bottled_poland_spring");
