 ...
 */
public class Deer_venison_sitka_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Deer_venison_sitka_raw_alaska_native() {
		set_food_id("35080");
		set_food_name("Deer (venison), sitka, raw (Alaska Native)");
		set_food_label("Deer_venison_sitka_raw_alaska_native");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(116.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(0.00000);
		set_fat_in_grams(2.66000);
