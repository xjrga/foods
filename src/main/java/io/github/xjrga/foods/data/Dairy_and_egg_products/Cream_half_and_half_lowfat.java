 ...
 */
public class Cream_half_and_half_lowfat extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Cream_half_and_half_lowfat() {
		set_food_id("01303");
		set_food_name("Cream, half and half, lowfat");
		set_food_label("Cream_half_and_half_lowfat");
		...
		set_monounsaturated_fat_in_grams(1.52600);
		set_polyunsaturated_fat_in_grams(0.25700);
		set_saturated_fat_in_grams(3.27600);
