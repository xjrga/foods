 ...
 */
public class Cereals_quaker_whole_wheat_natural_cereal_dry extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Cereals_quaker_whole_wheat_natural_cereal_dry() {
		set_food_id("08452");
		set_food_name("Cereals, QUAKER, Whole Wheat Natural Cereal, dry");
		set_food_label("Cereals_quaker_whole_wheat_natural_cereal_dry");
		...
		set_monounsaturated_fat_in_grams(0.30900);
