 ...
 */
public class Game_meat_bison_separable_lean_only_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Game_meat_bison_separable_lean_only_raw() {
		set_food_id("17156");
		set_food_name("Game meat, bison, separable lean only, raw");
		set_food_label("Game_meat_bison_separable_lean_only_raw");
		...
		set_niacin_in_milligrams(1.91000);
