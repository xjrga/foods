 ...
 */
public class Mcdonalds_side_salad extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Mcdonalds_side_salad() {
		set_food_id("21379");
		set_food_name("McDONALD'S, Side Salad");
		set_food_label("Mcdonalds_side_salad");
