 ...
 */
public class Campbells_homestyle_chicken_noodle_soup_condensed extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Campbells_homestyle_chicken_noodle_soup_condensed() {
		set_food_id("06363");
		set_food_name("CAMPBELL'S, Homestyle Chicken Noodle Soup, condensed");
		set_food_label("Campbells_homestyle_chicken_noodle_soup_condensed");
