 ...
 */
public class Vital_wheat_gluten extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Vital_wheat_gluten() {
		set_food_id("48052");
		set_food_name("Vital wheat gluten");
		set_food_label("Vital_wheat_gluten");
