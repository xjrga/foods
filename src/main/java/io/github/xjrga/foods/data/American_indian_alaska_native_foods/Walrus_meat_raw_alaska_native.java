 ...
 */
public class Walrus_meat_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Walrus_meat_raw_alaska_native() {
		set_food_id("35081");
		set_food_name("Walrus, meat, raw (Alaska Native)");
		set_food_label("Walrus_meat_raw_alaska_native");
