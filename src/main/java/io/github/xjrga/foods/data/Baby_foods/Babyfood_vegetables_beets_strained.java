 ...
 */
public class Babyfood_vegetables_beets_strained extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Babyfood_vegetables_beets_strained() {
		set_food_id("03098");
		set_food_name("Babyfood, vegetables, beets, strained");
		set_food_label("Babyfood_vegetables_beets_strained");
