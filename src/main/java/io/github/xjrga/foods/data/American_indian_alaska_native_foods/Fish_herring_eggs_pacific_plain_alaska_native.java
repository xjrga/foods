 ...
 */
public class Fish_herring_eggs_pacific_plain_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Fish_herring_eggs_pacific_plain_alaska_native() {
        set_food_id("35041");
        set_food_name("Fish, herring eggs, Pacific, plain (Alaska Native)");
        set_food_label("Fish_herring_eggs_pacific_plain_alaska_native");
