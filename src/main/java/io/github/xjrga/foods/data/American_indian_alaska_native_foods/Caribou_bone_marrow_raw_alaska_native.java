 ...
 */
public class Caribou_bone_marrow_raw_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Caribou_bone_marrow_raw_alaska_native() {
        set_food_id("35021");
        set_food_name("Caribou, bone marrow, raw (Alaska Native)");
        set_food_label("Caribou_bone_marrow_raw_alaska_native");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(786.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(0.00000);
        set_fat_in_grams(84.40000);
