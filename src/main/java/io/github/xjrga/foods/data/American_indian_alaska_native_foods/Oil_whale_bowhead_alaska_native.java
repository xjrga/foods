 ...
 */
public class Oil_whale_bowhead_alaska_native extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Oil_whale_bowhead_alaska_native() {
        set_food_id("35087");
        set_food_name("Oil, whale, bowhead (Alaska Native)");
        set_food_label("Oil_whale_bowhead_alaska_native");
