 ...
 */
public class Murray_sugar_free_oatmeal_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Murray_sugar_free_oatmeal_cookies() {
		set_food_id("28278");
		set_food_name("MURRAY, SUGAR FREE, Oatmeal Cookies");
		set_food_label("Murray_sugar_free_oatmeal_cookies");
		...
		set_saturated_fat_in_grams(7.20000);
