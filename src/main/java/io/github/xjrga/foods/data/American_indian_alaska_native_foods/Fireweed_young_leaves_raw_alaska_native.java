 ...
 */
public class Fireweed_young_leaves_raw_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Fireweed_young_leaves_raw_alaska_native() {
		set_food_id("35038");
		set_food_name("Fireweed, young leaves, raw (Alaska Native)");
		set_food_label("Fireweed_young_leaves_raw_alaska_native");
		...
		set_vitamin_c_in_milligrams(99.00000);
