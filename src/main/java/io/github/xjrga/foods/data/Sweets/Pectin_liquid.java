 ...
 */
public class Pectin_liquid extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Pectin_liquid() {
		set_food_id("42063");
		set_food_name("Pectin, liquid");
		set_food_label("Pectin_liquid");
