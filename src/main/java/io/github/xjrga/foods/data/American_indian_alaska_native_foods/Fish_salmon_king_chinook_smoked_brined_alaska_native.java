 ...
 */
public class Fish_salmon_king_chinook_smoked_brined_alaska_native extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Fish_salmon_king_chinook_smoked_brined_alaska_native() {
		set_food_id("35067");
		set_food_name("Fish, salmon, king, chinook, smoked, brined (Alaska Native)");
		set_food_label("Fish_salmon_king_chinook_smoked_brined_alaska_native");
		...
		set_protein_in_grams(39.90000);
		set_cholesterol_in_milligrams(107.00000);
		set_monounsaturated_fat_in_grams(16.90000);
		...
		set_potassium_in_milligrams(700.00000);
		...
		set_niacin_in_milligrams(11.80000);
