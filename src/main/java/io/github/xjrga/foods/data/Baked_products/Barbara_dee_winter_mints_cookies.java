 ...
 */
public class Barbara_dee_winter_mints_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Barbara_dee_winter_mints_cookies() {
		set_food_id("18991");
		set_food_name("BARBARA DEE, Winter Mints Cookies");
		set_food_label("Barbara_dee_winter_mints_cookies");
