 ...
 */
public class Veal_rib_separable_lean_only_raw extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Veal_rib_separable_lean_only_raw() {
		set_food_id("17113");
		set_food_name("Veal, rib, separable lean only, raw");
		set_food_label("Veal_rib_separable_lean_only_raw");
