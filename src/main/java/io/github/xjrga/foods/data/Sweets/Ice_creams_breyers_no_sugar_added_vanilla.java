 ...
 */
public class Ice_creams_breyers_no_sugar_added_vanilla extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Ice_creams_breyers_no_sugar_added_vanilla() {
		set_food_id("19882");
		set_food_name("Ice creams, BREYERS, No Sugar Added, Vanilla");
		set_food_label("Ice_creams_breyers_no_sugar_added_vanilla");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(143.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(21.92000);
