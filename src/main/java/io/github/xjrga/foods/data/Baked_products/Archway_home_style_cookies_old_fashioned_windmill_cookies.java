 ...
 */
public class Archway_home_style_cookies_old_fashioned_windmill_cookies extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Archway_home_style_cookies_old_fashioned_windmill_cookies() {
		set_food_id("18540");
		set_food_name("ARCHWAY Home Style Cookies, Old Fashioned Windmill Cookies");
		set_food_label("Archway_home_style_cookies_old_fashioned_windmill_cookies");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(468.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(72.23000);
		set_fat_in_grams(17.55000);
