 ...
 */
public class Cheese_muenster_low_fat extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Cheese_muenster_low_fat() {
		set_food_id("42303");
		set_food_name("Cheese, muenster, low fat");
		set_food_label("Cheese_muenster_low_fat");
		...
		set_monounsaturated_fat_in_grams(5.09000);
		set_polyunsaturated_fat_in_grams(0.65000);
		set_saturated_fat_in_grams(10.95000);
