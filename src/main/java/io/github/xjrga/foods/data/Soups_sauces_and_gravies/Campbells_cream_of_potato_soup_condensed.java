 ...
 */
public class Campbells_cream_of_potato_soup_condensed extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Campbells_cream_of_potato_soup_condensed() {
        set_food_id("06341");
        set_food_name("CAMPBELL'S, Cream of Potato Soup, condensed");
        set_food_label("Campbells_cream_of_potato_soup_condensed");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(71.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(13.25000);
