 ...
 */
public class Campbells_98_fat_free_cream_of_mushroom_soup_condensed extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Campbells_98_fat_free_cream_of_mushroom_soup_condensed() {
        set_food_id("27034");
        set_food_name("CAMPBELL'S, 98% Fat Free Cream of Mushroom Soup, condensed");
        set_food_label("Campbells_98_fat_free_cream_of_mushroom_soup_condensed");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(53.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(7.63000);
