 ...
 */
public class Vinegar_cider extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Vinegar_cider() {
        set_food_id("02048");
        set_food_name("Vinegar, cider");
        set_food_label("Vinegar_cider");
