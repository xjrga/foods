 ...
 */
public class Babyfood_dessert_banana_yogurt_strained extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Babyfood_dessert_banana_yogurt_strained() {
        set_food_id("43539");
        set_food_name("Babyfood, dessert, banana yogurt, strained");
        set_food_label("Babyfood_dessert_banana_yogurt_strained");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(78.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(17.35000);
