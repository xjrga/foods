 ...
 */
public class Taro_shoots_cooked_without_salt extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Taro_shoots_cooked_without_salt() {
		set_food_id("11523");
		set_food_name("Taro shoots, cooked, without salt");
		set_food_label("Taro_shoots_cooked_without_salt");
