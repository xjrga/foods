 ...
 */
public class Cereals_ready_to_eat_kashi_organic_promise_raisin_vineyard extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Cereals_ready_to_eat_kashi_organic_promise_raisin_vineyard() {
        set_food_id("08697");
        set_food_name("Cereals ready-to-eat, KASHI ORGANIC PROMISE, RAISIN VINEYARD");
        set_food_label("Cereals_ready_to_eat_kashi_organic_promise_raisin_vineyard");
