 ...
 */
public class Martha_white_foods_martha_whites_chewy_fudge_brownie_mix_dry extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Martha_white_foods_martha_whites_chewy_fudge_brownie_mix_dry() {
        set_food_id("18614");
        set_food_name("MARTHA WHITE FOODS, Martha White's Chewy Fudge Brownie Mix, dry");
        set_food_label("Martha_white_foods_martha_whites_chewy_fudge_brownie_mix_dry");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(407.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(83.58000);
