 ...
 */
public class Sweeteners_for_baking_contains_sugar_and_sucralose extends Abstract_food {

    /**
     * Constructs a food item
     */
    public Sweeteners_for_baking_contains_sugar_and_sucralose() {
        set_food_id("19907");
        set_food_name("Sweeteners, for baking, contains sugar and sucralose");
        set_food_label("Sweeteners_for_baking_contains_sugar_and_sucralose");
        set_weight_in_grams(100.00000);
        set_energy_gross_in_kilocalories(398.00000);
        set_alcohol_in_grams(0.00000);
        set_carbohydrate_by_difference_in_grams(99.53000);
