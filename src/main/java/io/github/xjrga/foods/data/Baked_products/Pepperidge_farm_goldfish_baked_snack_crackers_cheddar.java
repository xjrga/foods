 ...
 */
public class Pepperidge_farm_goldfish_baked_snack_crackers_cheddar extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Pepperidge_farm_goldfish_baked_snack_crackers_cheddar() {
		set_food_id("28361");
		set_food_name("PEPPERIDGE FARM, Goldfish, Baked Snack Crackers, Cheddar");
		set_food_label("Pepperidge_farm_goldfish_baked_snack_crackers_cheddar");
		...
		set_iron_in_milligrams(4.26000);
		set_magnesium_in_milligrams(26.00000);
		set_manganese_in_milligrams(0.59800);
