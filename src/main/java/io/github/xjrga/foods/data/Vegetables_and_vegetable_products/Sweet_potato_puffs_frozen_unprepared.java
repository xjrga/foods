 ...
 */
public class Sweet_potato_puffs_frozen_unprepared extends Abstract_food {

	/**
	 * Constructs a food item
	 */
	public Sweet_potato_puffs_frozen_unprepared() {
		set_food_id("31025");
		set_food_name("Sweet Potato puffs, frozen, unprepared");
		set_food_label("Sweet_potato_puffs_frozen_unprepared");
		set_weight_in_grams(100.00000);
		set_energy_gross_in_kilocalories(161.00000);
		set_alcohol_in_grams(0.00000);
		set_carbohydrate_by_difference_in_grams(30.72000);
