 ...
 */
public class Cucumber_peeled_raw implements Food {

    private final Cucumber_peeled_raw_mutable food;

    public Cucumber_peeled_raw() {
        food = new Cucumber_peeled_raw_mutable();
    }
    ...
    private class Cucumber_peeled_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cucumber_peeled_raw_mutable() {
            set_food_name("Cucumber, peeled, raw");
            set_food_label("cucumber_peeled_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(14.00000);
            set_carbohydrate_by_difference(2.16000);
            ...
            set_fat(0.16000);
            set_fiber(0.70000);
            set_fluoride(1.30000);
            set_folate(14.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(12.00000);
            set_iron(0.22000);
            ...
            set_phosphorus(21.00000);
            set_polyunsaturated_fat(0.00300);
            set_potassium(136.00000);
            set_protein(0.59000);
