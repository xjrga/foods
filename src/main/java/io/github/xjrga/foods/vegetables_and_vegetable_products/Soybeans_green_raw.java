 ...
 */
public class Soybeans_green_raw implements Food {

    private final Soybeans_green_raw_mutable food;

    public Soybeans_green_raw() {
        food = new Soybeans_green_raw_mutable();
    }
    ...
    private class Soybeans_green_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Soybeans_green_raw_mutable() {
            set_food_name("Soybeans, green, raw");
            set_food_label("soybeans_green_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(197.00000);
            ...
            set_manganese(0.54000);
            set_monounsaturated_fat(1.28000);
            set_niacin(1.65000);
            set_pantothenic_acid(0.14000);
            set_phosphorus(194.00000);
            set_polyunsaturated_fat(3.20000);
            set_potassium(620.00000);
            set_protein(12.95000);
            set_riboflavin(0.17000);
            set_saturated_fat(0.78000);
