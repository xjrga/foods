 ...
 */
public class Broccoli_cooked_boiled_drained_without_salt implements Food {

    private final Broccoli_cooked_boiled_drained_without_salt_mutable food;

    public Broccoli_cooked_boiled_drained_without_salt() {
        food = new Broccoli_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Broccoli_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Broccoli_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(40.00000);
            set_carbohydrate_by_difference(7.18000);
            set_cholesterol(0.00000);
            set_choline(40.10000);
