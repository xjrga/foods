 ...
 */
public class Mushrooms_portabella_grilled implements Food {

    private final Mushrooms_portabella_grilled_mutable food;

    public Mushrooms_portabella_grilled() {
        food = new Mushrooms_portabella_grilled_mutable();
    }
    ...
    private class Mushrooms_portabella_grilled_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Mushrooms_portabella_grilled_mutable() {
            set_food_name("Mushrooms, portabella, grilled");
            set_food_label("mushrooms_portabella_grilled");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(3.00000);
            set_carbohydrate_by_difference(4.44000);
