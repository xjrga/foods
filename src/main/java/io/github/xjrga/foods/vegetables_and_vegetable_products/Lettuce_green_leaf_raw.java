 ...
 */
public class Lettuce_green_leaf_raw implements Food {

    private final Lettuce_green_leaf_raw_mutable food;

    public Lettuce_green_leaf_raw() {
        food = new Lettuce_green_leaf_raw_mutable();
    }
    ...
    private class Lettuce_green_leaf_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Lettuce_green_leaf_raw_mutable() {
            ...
            set_carbohydrate_by_difference(2.87000);
            set_cholesterol(0.00000);
            set_choline(13.60000);
