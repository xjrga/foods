 ...
 */
public class Kale_raw implements Food {

    private final Kale_raw_mutable food;

    public Kale_raw() {
        food = new Kale_raw_mutable();
    }
    ...
    private class Kale_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Kale_raw_mutable() {
            set_food_name("Kale, raw");
            set_food_label("kale_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(150.00000);
            set_carbohydrate_by_difference(8.75000);
            ...
            set_sodium(38.00000);
            set_thiamin(0.11000);
            set_vitamin_a(500.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.27000);
            set_vitamin_c(120.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.54000);
            set_vitamin_k(704.80000);
            set_water(84.04000);
