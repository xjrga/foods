 ...
 */
public class Catsup_low_sodium implements Food {

    private final Catsup_low_sodium_mutable food;

    public Catsup_low_sodium() {
        food = new Catsup_low_sodium_mutable();
    }
    ...
    private class Catsup_low_sodium_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Catsup_low_sodium_mutable() {
