 ...
 */
public class Nopales_raw implements Food {

    private final Nopales_raw_mutable food;

    public Nopales_raw() {
        food = new Nopales_raw_mutable();
    }
    ...
    private class Nopales_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nopales_raw_mutable() {
            set_food_name("Nopales, raw");
            set_food_label("nopales_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(164.00000);
            set_carbohydrate_by_difference(3.33000);
            ...
            set_vitamin_c(9.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.00000);
            set_vitamin_k(5.30000);
            set_water(94.12000);
