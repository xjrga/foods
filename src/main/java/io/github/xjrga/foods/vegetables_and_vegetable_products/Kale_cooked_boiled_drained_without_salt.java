 ...
 */
public class Kale_cooked_boiled_drained_without_salt implements Food {

    private final Kale_cooked_boiled_drained_without_salt_mutable food;

    public Kale_cooked_boiled_drained_without_salt() {
        food = new Kale_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Kale_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Kale_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(5.63000);
            ...
            set_phosphorus(28.00000);
            set_polyunsaturated_fat(0.19000);
            set_potassium(228.00000);
            set_protein(1.90000);
