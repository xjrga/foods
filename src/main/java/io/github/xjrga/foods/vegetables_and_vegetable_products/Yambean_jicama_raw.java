 ...
 */
public class Yambean_jicama_raw implements Food {

    private final Yambean_jicama_raw_mutable food;

    public Yambean_jicama_raw() {
        food = new Yambean_jicama_raw_mutable();
    }
    ...
    private class Yambean_jicama_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Yambean_jicama_raw_mutable() {
            set_food_name("Yambean (jicama), raw");
            set_food_label("yambean_jicama_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(12.00000);
            set_carbohydrate_by_difference(8.82000);
