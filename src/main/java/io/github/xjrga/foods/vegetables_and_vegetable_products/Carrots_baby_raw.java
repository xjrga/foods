 ...
 */
public class Carrots_baby_raw implements Food {

    private final Carrots_baby_raw_mutable food;

    public Carrots_baby_raw() {
        food = new Carrots_baby_raw_mutable();
    }
    ...
    private class Carrots_baby_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Carrots_baby_raw_mutable() {
            set_food_name("Carrots, baby, raw");
            set_food_label("carrots_baby_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(32.00000);
            set_carbohydrate_by_difference(8.24000);
