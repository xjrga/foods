 ...
 */
public class Tomatoes_red_ripe_raw_year_round_average implements Food {

    private final Tomatoes_red_ripe_raw_year_round_average_mutable food;

    public Tomatoes_red_ripe_raw_year_round_average() {
        food = new Tomatoes_red_ripe_raw_year_round_average_mutable();
    }
    ...
    private class Tomatoes_red_ripe_raw_year_round_average_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Tomatoes_red_ripe_raw_year_round_average_mutable() {
            ...
            set_carbohydrate_by_difference(3.89000);
            ...
            set_vitamin_c(13.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.54000);
            set_vitamin_k(7.90000);
            set_water(94.52000);
