 ...
 */
public class Potatoes_white_flesh_and_skin_raw implements Food {

    private final Potatoes_white_flesh_and_skin_raw_mutable food;

    public Potatoes_white_flesh_and_skin_raw() {
        food = new Potatoes_white_flesh_and_skin_raw_mutable();
    }
    ...
    private class Potatoes_white_flesh_and_skin_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Potatoes_white_flesh_and_skin_raw_mutable() {
            ...
            set_calcium(9.00000);
            set_carbohydrate_by_difference(15.71000);
            set_cholesterol(0.00000);
            set_choline(11.00000);
