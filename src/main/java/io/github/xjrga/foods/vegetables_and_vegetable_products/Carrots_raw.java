 ...
 */
public class Carrots_raw implements Food {

    private final Carrots_raw_mutable food;

    public Carrots_raw() {
        food = new Carrots_raw_mutable();
    }
    ...
    private class Carrots_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Carrots_raw_mutable() {
            set_food_name("Carrots, raw");
            set_food_label("carrots_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(33.00000);
            set_carbohydrate_by_difference(9.58000);
