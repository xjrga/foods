 ...
 */
public class Sweet_potato_canned_syrup_pack_drained_solids implements Food {

    private final Sweet_potato_canned_syrup_pack_drained_solids_mutable food;

    public Sweet_potato_canned_syrup_pack_drained_solids() {
        food = new Sweet_potato_canned_syrup_pack_drained_solids_mutable();
    }
    ...
    private class Sweet_potato_canned_syrup_pack_drained_solids_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Sweet_potato_canned_syrup_pack_drained_solids_mutable() {
            ...
            set_carbohydrate_by_difference(25.36000);
            ...
            set_gross_energy(108.00000);
            set_iron(0.95000);
            set_linoleic_acid(0.00000);
            set_magnesium(12.00000);
            set_manganese(0.61000);
            set_monounsaturated_fat(0.01000);
            set_niacin(0.34000);
            set_pantothenic_acid(0.40000);
            set_phosphorus(25.00000);
            set_polyunsaturated_fat(0.14000);
            set_potassium(193.00000);
            set_protein(1.28000);
            ...
            set_sodium(39.00000);
            set_thiamin(0.02000);
            set_vitamin_a(458.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.06000);
            set_vitamin_c(10.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.15000);
