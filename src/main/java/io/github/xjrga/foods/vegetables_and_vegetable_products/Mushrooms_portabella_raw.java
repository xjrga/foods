 ...
 */
public class Mushrooms_portabella_raw implements Food {

    private final Mushrooms_portabella_raw_mutable food;

    public Mushrooms_portabella_raw() {
        food = new Mushrooms_portabella_raw_mutable();
    }
    ...
    private class Mushrooms_portabella_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Mushrooms_portabella_raw_mutable() {
            set_food_name("Mushrooms, portabella, raw");
            set_food_label("mushrooms_portabella_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(3.00000);
            set_carbohydrate_by_difference(3.87000);
            set_cholesterol(0.00000);
            set_choline(21.20000);
            ...
            set_gross_energy(22.00000);
            set_iron(0.31000);
            set_linoleic_acid(0.11000);
            ...
            set_polyunsaturated_fat(0.11000);
            set_potassium(364.00000);
            set_protein(2.11000);
            set_riboflavin(0.13000);
            set_saturated_fat(0.06000);
            set_selenium(18.60000);
            set_sodium(9.00000);
            set_thiamin(0.05000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.05000);
