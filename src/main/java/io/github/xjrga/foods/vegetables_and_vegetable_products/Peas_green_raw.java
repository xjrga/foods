 ...
 */
public class Peas_green_raw implements Food {

    private final Peas_green_raw_mutable food;

    public Peas_green_raw() {
        food = new Peas_green_raw_mutable();
    }
    ...
    private class Peas_green_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Peas_green_raw_mutable() {
            set_food_name("Peas, green, raw");
            set_food_label("peas_green_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(25.00000);
            set_carbohydrate_by_difference(14.45000);
            set_cholesterol(0.00000);
            set_choline(28.40000);
