 ...
 */
public class Edamame_frozen_prepared implements Food {

    private final Edamame_frozen_prepared_mutable food;

    public Edamame_frozen_prepared() {
        food = new Edamame_frozen_prepared_mutable();
    }
    ...
    private class Edamame_frozen_prepared_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Edamame_frozen_prepared_mutable() {
            set_food_name("Edamame, frozen, prepared");
            set_food_label("edamame_frozen_prepared");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.35000);
            set_calcium(63.00000);
            set_carbohydrate_by_difference(8.91000);
            set_cholesterol(0.00000);
            set_choline(56.30000);
