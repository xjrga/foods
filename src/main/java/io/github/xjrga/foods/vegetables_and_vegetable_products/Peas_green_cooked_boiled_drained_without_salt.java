 ...
 */
public class Peas_green_cooked_boiled_drained_without_salt implements Food {

    private final Peas_green_cooked_boiled_drained_without_salt_mutable food;

    public Peas_green_cooked_boiled_drained_without_salt() {
        food = new Peas_green_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Peas_green_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peas_green_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(15.63000);
            set_cholesterol(0.00000);
            set_choline(29.70000);
