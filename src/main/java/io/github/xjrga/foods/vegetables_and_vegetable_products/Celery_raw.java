 ...
 */
public class Celery_raw implements Food {

    private final Celery_raw_mutable food;

    public Celery_raw() {
        food = new Celery_raw_mutable();
    }
    ...
    private class Celery_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Celery_raw_mutable() {
