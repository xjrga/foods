 ...
 */
public class Asparagus_cooked_boiled_drained implements Food {

    private final Asparagus_cooked_boiled_drained_mutable food;

    public Asparagus_cooked_boiled_drained() {
        food = new Asparagus_cooked_boiled_drained_mutable();
    }
    ...
    private class Asparagus_cooked_boiled_drained_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Asparagus_cooked_boiled_drained_mutable() {
            ...
            set_carbohydrate_by_difference(4.11000);
            set_cholesterol(0.00000);
            set_choline(26.10000);
            ...
            set_sodium(14.00000);
            set_thiamin(0.16000);
            set_vitamin_a(50.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.07000);
            set_vitamin_c(7.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.50000);
            set_vitamin_k(50.60000);
            set_water(92.63000);
