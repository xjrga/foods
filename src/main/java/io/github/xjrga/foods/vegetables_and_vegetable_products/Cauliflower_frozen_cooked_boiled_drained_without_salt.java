 ...
 */
public class Cauliflower_frozen_cooked_boiled_drained_without_salt implements Food {

    private final Cauliflower_frozen_cooked_boiled_drained_without_salt_mutable food;

    public Cauliflower_frozen_cooked_boiled_drained_without_salt() {
        food = new Cauliflower_frozen_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Cauliflower_frozen_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cauliflower_frozen_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(3.75000);
            set_cholesterol(0.00000);
            set_choline(33.50000);
