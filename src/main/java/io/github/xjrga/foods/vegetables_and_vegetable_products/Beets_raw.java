 ...
 */
public class Beets_raw implements Food {

    private final Beets_raw_mutable food;

    public Beets_raw() {
        food = new Beets_raw_mutable();
    }
    ...
    private class Beets_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beets_raw_mutable() {
            set_food_name("Beets, raw");
            set_food_label("beets_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(16.00000);
            set_carbohydrate_by_difference(9.56000);
