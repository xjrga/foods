 ...
 */
public class Cauliflower_frozen_unprepared implements Food {

    private final Cauliflower_frozen_unprepared_mutable food;

    public Cauliflower_frozen_unprepared() {
        food = new Cauliflower_frozen_unprepared_mutable();
    }
    ...
    private class Cauliflower_frozen_unprepared_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cauliflower_frozen_unprepared_mutable() {
            ...
            set_carbohydrate_by_difference(4.68000);
            set_cholesterol(0.00000);
            set_choline(41.90000);
            ...
            set_vitamin_c(48.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.07000);
            set_vitamin_k(14.80000);
            set_water(92.51000);
