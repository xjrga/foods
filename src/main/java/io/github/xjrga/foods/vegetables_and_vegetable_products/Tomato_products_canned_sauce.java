 ...
 */
public class Tomato_products_canned_sauce implements Food {

    private final Tomato_products_canned_sauce_mutable food;

    public Tomato_products_canned_sauce() {
        food = new Tomato_products_canned_sauce_mutable();
    }
    ...
    private class Tomato_products_canned_sauce_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Tomato_products_canned_sauce_mutable() {
            ...
            set_carbohydrate_by_difference(5.31000);
