 ...
 */
public class Coriander_cilantro_leaves_raw implements Food {

    private final Coriander_cilantro_leaves_raw_mutable food;

    public Coriander_cilantro_leaves_raw() {
        food = new Coriander_cilantro_leaves_raw_mutable();
    }
    ...
    private class Coriander_cilantro_leaves_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Coriander_cilantro_leaves_raw_mutable() {
            set_food_name("Coriander (cilantro) leaves, raw");
            set_food_label("coriander_cilantro_leaves_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(67.00000);
            set_carbohydrate_by_difference(3.67000);
            set_cholesterol(0.00000);
            set_choline(12.80000);
            ...
            set_manganese(0.42000);
            set_monounsaturated_fat(0.27000);
            set_niacin(1.11000);
            set_pantothenic_acid(0.57000);
            set_phosphorus(48.00000);
            set_polyunsaturated_fat(0.04000);
            set_potassium(521.00000);
            set_protein(2.13000);
            ...
            set_sodium(46.00000);
            set_thiamin(0.06000);
            set_vitamin_a(337.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.14000);
            set_vitamin_c(27.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.50000);
            set_vitamin_k(310.00000);
            set_water(92.21000);
