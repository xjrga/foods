 ...
 */
public class Spinach_cooked_boiled_drained_without_salt implements Food {

    private final Spinach_cooked_boiled_drained_without_salt_mutable food;

    public Spinach_cooked_boiled_drained_without_salt() {
        food = new Spinach_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Spinach_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Spinach_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_fat(0.26000);
            set_fiber(2.40000);
            set_fluoride(37.80000);
            set_folate(146.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(23.00000);
            set_iron(3.57000);
            set_linoleic_acid(0.00000);
            set_magnesium(87.00000);
            set_manganese(0.93000);
            set_monounsaturated_fat(0.00600);
            set_niacin(0.49000);
            set_pantothenic_acid(0.14000);
            set_phosphorus(56.00000);
            set_polyunsaturated_fat(0.10000);
            set_potassium(466.00000);
            set_protein(2.97000);
            set_riboflavin(0.23000);
            set_saturated_fat(0.04000);
            set_selenium(1.50000);
            set_sodium(70.00000);
            set_thiamin(0.09000);
            set_vitamin_a(524.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.24000);
            set_vitamin_c(9.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.08000);
            set_vitamin_k(493.60000);
            set_water(91.21000);
