 ...
 */
public class Beets_cooked_boiled_drained implements Food {

    private final Beets_cooked_boiled_drained_mutable food;

    public Beets_cooked_boiled_drained() {
        food = new Beets_cooked_boiled_drained_mutable();
    }
    ...
    private class Beets_cooked_boiled_drained_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beets_cooked_boiled_drained_mutable() {
            ...
            set_carbohydrate_by_difference(9.96000);
