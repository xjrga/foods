 ...
 */
public class Garlic_raw implements Food {

    private final Garlic_raw_mutable food;

    public Garlic_raw() {
        food = new Garlic_raw_mutable();
    }
    ...
    private class Garlic_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Garlic_raw_mutable() {
            set_food_name("Garlic, raw");
            set_food_label("garlic_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(181.00000);
            set_carbohydrate_by_difference(33.06000);
            set_cholesterol(0.00000);
            set_choline(23.20000);
