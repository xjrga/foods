 ...
 */
public class Mushrooms_white_stir_fried implements Food {

    private final Mushrooms_white_stir_fried_mutable food;

    public Mushrooms_white_stir_fried() {
        food = new Mushrooms_white_stir_fried_mutable();
    }
    ...
    private class Mushrooms_white_stir_fried_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Mushrooms_white_stir_fried_mutable() {
            set_food_name("Mushrooms, white, stir-fried");
            set_food_label("mushrooms_white_stir_fried");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(4.00000);
            set_carbohydrate_by_difference(4.04000);
            set_cholesterol(0.00000);
            set_choline(21.90000);
