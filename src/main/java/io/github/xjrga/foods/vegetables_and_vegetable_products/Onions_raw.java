 ...
 */
public class Onions_raw implements Food {

    private final Onions_raw_mutable food;

    public Onions_raw() {
        food = new Onions_raw_mutable();
    }
    ...
    private class Onions_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Onions_raw_mutable() {
            set_food_name("Onions, raw");
            set_food_label("onions_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(23.00000);
            set_carbohydrate_by_difference(9.34000);
