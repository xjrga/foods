 ...
 */
public class Potatoes_russet_flesh_and_skin_raw implements Food {

    private final Potatoes_russet_flesh_and_skin_raw_mutable food;

    public Potatoes_russet_flesh_and_skin_raw() {
        food = new Potatoes_russet_flesh_and_skin_raw_mutable();
    }
    ...
    private class Potatoes_russet_flesh_and_skin_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Potatoes_russet_flesh_and_skin_raw_mutable() {
            ...
            set_carbohydrate_by_difference(18.07000);
            set_cholesterol(0.00000);
            set_choline(12.60000);
            ...
            set_vitamin_c(5.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.01000);
            set_vitamin_k(1.80000);
            set_water(78.58000);
