 ...
 */
public class Cabbage_cooked_boiled_drained_without_salt implements Food {

    private final Cabbage_cooked_boiled_drained_without_salt_mutable food;

    public Cabbage_cooked_boiled_drained_without_salt() {
        food = new Cabbage_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Cabbage_cooked_boiled_drained_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Cabbage_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(48.00000);
            set_carbohydrate_by_difference(5.51000);
            set_cholesterol(0.00000);
            set_choline(20.30000);
