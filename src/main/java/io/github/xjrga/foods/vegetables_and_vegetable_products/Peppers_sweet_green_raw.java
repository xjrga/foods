 ...
 */
public class Peppers_sweet_green_raw implements Food {

    private final Peppers_sweet_green_raw_mutable food;

    public Peppers_sweet_green_raw() {
        food = new Peppers_sweet_green_raw_mutable();
    }
    ...
    private class Peppers_sweet_green_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Peppers_sweet_green_raw_mutable() {
            ...
            set_carbohydrate_by_difference(4.64000);
            ...
            set_monounsaturated_fat(0.00800);
            set_niacin(0.48000);
            ...
            set_sodium(3.00000);
            set_thiamin(0.05000);
            set_vitamin_a(18.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.22000);
            set_vitamin_c(80.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.37000);
            set_vitamin_k(7.40000);
            set_water(93.89000);
