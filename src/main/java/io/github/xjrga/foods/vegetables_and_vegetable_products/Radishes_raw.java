 ...
 */
public class Radishes_raw implements Food {

    private final Radishes_raw_mutable food;

    public Radishes_raw() {
        food = new Radishes_raw_mutable();
    }
    ...
    private class Radishes_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Radishes_raw_mutable() {
