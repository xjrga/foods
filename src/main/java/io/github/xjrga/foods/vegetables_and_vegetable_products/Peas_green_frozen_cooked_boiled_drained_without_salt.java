 ...
 */
public class Peas_green_frozen_cooked_boiled_drained_without_salt implements Food {

    private final Peas_green_frozen_cooked_boiled_drained_without_salt_mutable food;

    public Peas_green_frozen_cooked_boiled_drained_without_salt() {
        food = new Peas_green_frozen_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Peas_green_frozen_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peas_green_frozen_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(24.00000);
            set_carbohydrate_by_difference(14.26000);
            set_cholesterol(0.00000);
            set_choline(27.50000);
