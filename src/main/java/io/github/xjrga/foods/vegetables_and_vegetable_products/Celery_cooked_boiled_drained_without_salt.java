 ...
 */
public class Celery_cooked_boiled_drained_without_salt implements Food {

    private final Celery_cooked_boiled_drained_without_salt_mutable food;

    public Celery_cooked_boiled_drained_without_salt() {
        food = new Celery_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Celery_cooked_boiled_drained_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Celery_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(4.00000);
