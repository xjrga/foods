 ...
 */
public class Squash_winter_all_varieties_raw implements Food {

    private final Squash_winter_all_varieties_raw_mutable food;

    public Squash_winter_all_varieties_raw() {
        food = new Squash_winter_all_varieties_raw_mutable();
    }
    ...
    private class Squash_winter_all_varieties_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Squash_winter_all_varieties_raw_mutable() {
            ...
            set_carbohydrate_by_difference(8.59000);
            set_cholesterol(0.00000);
            set_choline(10.00000);
