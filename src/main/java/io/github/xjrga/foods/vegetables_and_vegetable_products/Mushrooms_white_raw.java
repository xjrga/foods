 ...
 */
public class Mushrooms_white_raw implements Food {

    private final Mushrooms_white_raw_mutable food;

    public Mushrooms_white_raw() {
        food = new Mushrooms_white_raw_mutable();
    }
    ...
    private class Mushrooms_white_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Mushrooms_white_raw_mutable() {
            set_food_name("Mushrooms, white, raw");
            set_food_label("mushrooms_white_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(3.00000);
            set_carbohydrate_by_difference(3.26000);
            set_cholesterol(0.00000);
            set_choline(17.30000);
