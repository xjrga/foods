 ...
 */
public class Potatoes_red_flesh_and_skin_raw implements Food {

    private final Potatoes_red_flesh_and_skin_raw_mutable food;

    public Potatoes_red_flesh_and_skin_raw() {
        food = new Potatoes_red_flesh_and_skin_raw_mutable();
    }
    ...
    private class Potatoes_red_flesh_and_skin_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Potatoes_red_flesh_and_skin_raw_mutable() {
            ...
            set_carbohydrate_by_difference(15.90000);
            ...
            set_vitamin_c(8.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.01000);
            set_vitamin_k(2.90000);
            set_water(80.96000);
