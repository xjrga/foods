 ...
 */
public class Sweet_potato_raw_unprepared implements Food {

    private final Sweet_potato_raw_unprepared_mutable food;

    public Sweet_potato_raw_unprepared() {
        food = new Sweet_potato_raw_unprepared_mutable();
    }
    ...
    private class Sweet_potato_raw_unprepared_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Sweet_potato_raw_unprepared_mutable() {
            ...
            set_carbohydrate_by_difference(20.12000);
            set_cholesterol(0.00000);
            set_choline(12.30000);
            ...
            set_monounsaturated_fat(0.00100);
            set_niacin(0.55000);
            set_pantothenic_acid(0.80000);
            set_phosphorus(47.00000);
            set_polyunsaturated_fat(0.01000);
            set_potassium(337.00000);
            set_protein(1.57000);
            ...
            set_vitamin_c(2.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.26000);
