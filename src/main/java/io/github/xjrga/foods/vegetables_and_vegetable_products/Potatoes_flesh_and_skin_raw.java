 ...
 */
public class Potatoes_flesh_and_skin_raw implements Food {

    private final Potatoes_flesh_and_skin_raw_mutable food;

    public Potatoes_flesh_and_skin_raw() {
        food = new Potatoes_flesh_and_skin_raw_mutable();
    }
    ...
    private class Potatoes_flesh_and_skin_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Potatoes_flesh_and_skin_raw_mutable() {
            ...
            set_carbohydrate_by_difference(17.49000);
            set_cholesterol(0.00000);
            set_choline(12.10000);
            ...
            set_phosphorus(57.00000);
            set_polyunsaturated_fat(0.04000);
            set_potassium(425.00000);
            set_protein(2.05000);
