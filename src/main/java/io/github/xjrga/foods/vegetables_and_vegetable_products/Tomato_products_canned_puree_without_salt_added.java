 ...
 */
public class Tomato_products_canned_puree_without_salt_added implements Food {

    private final Tomato_products_canned_puree_without_salt_added_mutable food;

    public Tomato_products_canned_puree_without_salt_added() {
        food = new Tomato_products_canned_puree_without_salt_added_mutable();
    }
    ...
    private class Tomato_products_canned_puree_without_salt_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Tomato_products_canned_puree_without_salt_added_mutable() {
            ...
            set_carbohydrate_by_difference(8.98000);
            set_cholesterol(0.00000);
            set_choline(17.60000);
            ...
            set_gross_energy(38.00000);
            set_iron(1.78000);
            set_linoleic_acid(0.00000);
            set_magnesium(23.00000);
            set_manganese(0.16000);
            set_monounsaturated_fat(0.03000);
            set_niacin(1.46000);
            set_pantothenic_acid(0.44000);
            set_phosphorus(40.00000);
            set_polyunsaturated_fat(0.08000);
            set_potassium(439.00000);
            set_protein(1.65000);
            set_riboflavin(0.08000);
            set_saturated_fat(0.02000);
            set_selenium(0.70000);
            set_sodium(28.00000);
            set_thiamin(0.02000);
            set_vitamin_a(26.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.12000);
            set_vitamin_c(10.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.97000);
            set_vitamin_k(3.40000);
            set_water(87.88000);
