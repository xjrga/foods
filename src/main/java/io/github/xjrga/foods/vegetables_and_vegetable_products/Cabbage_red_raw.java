 ...
 */
public class Cabbage_red_raw implements Food {

    private final Cabbage_red_raw_mutable food;

    public Cabbage_red_raw() {
        food = new Cabbage_red_raw_mutable();
    }
    ...
    private class Cabbage_red_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cabbage_red_raw_mutable() {
            set_food_name("Cabbage, red, raw");
            set_food_label("cabbage_red_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(45.00000);
            set_carbohydrate_by_difference(7.37000);
            set_cholesterol(0.00000);
            set_choline(17.10000);
