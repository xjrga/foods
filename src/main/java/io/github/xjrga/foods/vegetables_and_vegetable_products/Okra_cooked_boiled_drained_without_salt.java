 ...
 */
public class Okra_cooked_boiled_drained_without_salt implements Food {

    private final Okra_cooked_boiled_drained_without_salt_mutable food;

    public Okra_cooked_boiled_drained_without_salt() {
        food = new Okra_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Okra_cooked_boiled_drained_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Okra_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(77.00000);
            set_carbohydrate_by_difference(4.51000);
            ...
            set_vitamin_c(16.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.27000);
            set_vitamin_k(40.00000);
            set_water(92.57000);
