 ...
 */
public class Cauliflower_raw implements Food {

    private final Cauliflower_raw_mutable food;

    public Cauliflower_raw() {
        food = new Cauliflower_raw_mutable();
    }
    ...
    private class Cauliflower_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cauliflower_raw_mutable() {
            set_food_name("Cauliflower, raw");
            set_food_label("cauliflower_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.01000);
            set_calcium(22.00000);
            set_carbohydrate_by_difference(4.97000);
            set_cholesterol(0.00000);
            set_choline(44.30000);
            ...
            set_vitamin_c(48.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.08000);
            set_vitamin_k(15.50000);
            set_water(92.07000);
