 ...
 */
public class Broccoli_raw implements Food {

    private final Broccoli_raw_mutable food;

    public Broccoli_raw() {
        food = new Broccoli_raw_mutable();
    }
    ...
    private class Broccoli_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Broccoli_raw_mutable() {
            set_food_name("Broccoli, raw");
            set_food_label("broccoli_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(47.00000);
            set_carbohydrate_by_difference(6.64000);
            set_cholesterol(0.00000);
            set_choline(18.70000);
            ...
            set_sodium(33.00000);
            set_thiamin(0.07000);
            set_vitamin_a(31.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.17000);
            set_vitamin_c(89.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.78000);
            set_vitamin_k(101.60000);
            set_water(89.30000);
