 ...
 */
public class Cucumber_with_peel_raw implements Food {

    private final Cucumber_with_peel_raw_mutable food;

    public Cucumber_with_peel_raw() {
        food = new Cucumber_with_peel_raw_mutable();
    }
    ...
    private class Cucumber_with_peel_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cucumber_with_peel_raw_mutable() {
            ...
            set_carbohydrate_by_difference(3.63000);
