 ...
 */
public class Cauliflower_cooked_boiled_drained_without_salt implements Food {

    private final Cauliflower_cooked_boiled_drained_without_salt_mutable food;

    public Cauliflower_cooked_boiled_drained_without_salt() {
        food = new Cauliflower_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Cauliflower_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cauliflower_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_phosphorus(32.00000);
            set_polyunsaturated_fat(0.21000);
            set_potassium(142.00000);
            set_protein(1.84000);
            ...
            set_vitamin_c(44.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.07000);
            set_vitamin_k(13.80000);
            set_water(93.00000);
