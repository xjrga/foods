 ...
 */
public class Lettuce_iceberg_includes_crisphead_types_raw implements Food {

    private final Lettuce_iceberg_includes_crisphead_types_raw_mutable food;

    public Lettuce_iceberg_includes_crisphead_types_raw() {
        food = new Lettuce_iceberg_includes_crisphead_types_raw_mutable();
    }
    ...
    private class Lettuce_iceberg_includes_crisphead_types_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Lettuce_iceberg_includes_crisphead_types_raw_mutable() {
            ...
            set_carbohydrate_by_difference(2.97000);
            ...
            set_gross_energy(14.00000);
            set_iron(0.41000);
            set_linoleic_acid(0.00000);
            set_magnesium(7.00000);
            set_manganese(0.12000);
            ...
            set_vitamin_c(2.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.18000);
            set_vitamin_k(24.10000);
            set_water(95.64000);
