 ...
 */
public class Campbells_tomato_juice_low_sodium implements Food {

    private final Campbell_s_tomato_juice_low_sodium_mutable food;

    public Campbells_tomato_juice_low_sodium() {
        food = new Campbell_s_tomato_juice_low_sodium_mutable();
    }
    ...
    private class Campbell_s_tomato_juice_low_sodium_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Campbell_s_tomato_juice_low_sodium_mutable() {
