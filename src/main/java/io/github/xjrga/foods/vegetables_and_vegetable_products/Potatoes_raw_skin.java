 ...
 */
public class Potatoes_raw_skin implements Food {

    private final Potatoes_raw_skin_mutable food;

    public Potatoes_raw_skin() {
        food = new Potatoes_raw_skin_mutable();
    }
    ...
    private class Potatoes_raw_skin_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Potatoes_raw_skin_mutable() {
            set_food_name("Potatoes, raw, skin");
            set_food_label("potatoes_raw_skin");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(30.00000);
            set_carbohydrate_by_difference(12.44000);
