 ...
 */
public class Peppers_jalapeno_raw implements Food {

    private final Peppers_jalapeno_raw_mutable food;

    public Peppers_jalapeno_raw() {
        food = new Peppers_jalapeno_raw_mutable();
    }
    ...
    private class Peppers_jalapeno_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peppers_jalapeno_raw_mutable() {
            ...
            set_carbohydrate_by_difference(6.50000);
            ...
            set_vitamin_c(118.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(3.58000);
            set_vitamin_k(18.50000);
            set_water(91.69000);
