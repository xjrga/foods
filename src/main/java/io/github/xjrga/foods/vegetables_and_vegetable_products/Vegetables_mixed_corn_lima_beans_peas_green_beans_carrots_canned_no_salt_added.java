 ...
 */
public class Vegetables_mixed_corn_lima_beans_peas_green_beans_carrots_canned_no_salt_added implements Food {

    private final Vegetables_mixed_corn_lima_beans_peas_green_beans_carrots_canned_no_salt_added_mutable food;

    public Vegetables_mixed_corn_lima_beans_peas_green_beans_carrots_canned_no_salt_added() {
        food = new Vegetables_mixed_corn_lima_beans_peas_green_beans_carrots_canned_no_salt_added_mutable();
    }
    ...
    private class Vegetables_mixed_corn_lima_beans_peas_green_beans_carrots_canned_no_salt_added_mutable extends Food_abstract {
         ...
         */
        public Vegetables_mixed_corn_lima_beans_peas_green_beans_carrots_canned_no_salt_added_mutable() {
            ...
            set_carbohydrate_by_difference(7.31000);
            set_cholesterol(0.00000);
            set_choline(18.60000);
            ...
            set_fat(0.20000);
            set_fiber(3.10000);
            set_fluoride(37.00000);
            set_folate(18.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(37.00000);
            set_iron(0.65000);
