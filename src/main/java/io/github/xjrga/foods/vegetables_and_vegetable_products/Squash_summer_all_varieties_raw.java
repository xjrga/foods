 ...
 */
public class Squash_summer_all_varieties_raw implements Food {

    private final Squash_summer_all_varieties_raw_mutable food;

    public Squash_summer_all_varieties_raw() {
        food = new Squash_summer_all_varieties_raw_mutable();
    }
    ...
    private class Squash_summer_all_varieties_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Squash_summer_all_varieties_raw_mutable() {
            ...
            set_carbohydrate_by_difference(3.35000);
