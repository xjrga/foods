 ...
 */
public class Mushrooms_shiitake_raw implements Food {

    private final Mushrooms_shiitake_raw_mutable food;

    public Mushrooms_shiitake_raw() {
        food = new Mushrooms_shiitake_raw_mutable();
    }
    ...
    private class Mushrooms_shiitake_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Mushrooms_shiitake_raw_mutable() {
            set_food_name("Mushrooms, shiitake, raw");
            set_food_label("mushrooms_shiitake_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(2.00000);
            set_carbohydrate_by_difference(6.79000);
