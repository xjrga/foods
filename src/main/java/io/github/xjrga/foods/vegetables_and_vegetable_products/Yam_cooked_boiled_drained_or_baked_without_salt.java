 ...
 */
public class Yam_cooked_boiled_drained_or_baked_without_salt implements Food {

    private final Yam_cooked_boiled_drained_or_baked_without_salt_mutable food;

    public Yam_cooked_boiled_drained_or_baked_without_salt() {
        food = new Yam_cooked_boiled_drained_or_baked_without_salt_mutable();
    }
    ...
    private class Yam_cooked_boiled_drained_or_baked_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Yam_cooked_boiled_drained_or_baked_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(27.48000);
            set_cholesterol(0.00000);
            set_choline(16.20000);
            ...
            set_monounsaturated_fat(0.00500);
            set_niacin(0.55000);
            set_pantothenic_acid(0.31000);
            set_phosphorus(49.00000);
            set_polyunsaturated_fat(0.06000);
            set_potassium(670.00000);
            set_protein(1.49000);
            ...
            set_vitamin_c(12.10000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.34000);
            set_vitamin_k(2.30000);
            set_water(70.13000);
