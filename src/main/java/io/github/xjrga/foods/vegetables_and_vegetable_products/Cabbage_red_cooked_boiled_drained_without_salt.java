 ...
 */
public class Cabbage_red_cooked_boiled_drained_without_salt implements Food {

    private final Cabbage_red_cooked_boiled_drained_without_salt_mutable food;

    public Cabbage_red_cooked_boiled_drained_without_salt() {
        food = new Cabbage_red_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Cabbage_red_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cabbage_red_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(42.00000);
            set_carbohydrate_by_difference(6.94000);
            set_cholesterol(0.00000);
            set_choline(21.40000);
            ...
            set_gross_energy(29.00000);
            set_iron(0.66000);
            set_linoleic_acid(0.00000);
            set_magnesium(17.00000);
            set_manganese(0.22000);
            set_monounsaturated_fat(0.00700);
            set_niacin(0.38000);
            set_pantothenic_acid(0.15000);
            set_phosphorus(33.00000);
            set_polyunsaturated_fat(0.04000);
            set_potassium(262.00000);
            set_protein(1.51000);
            ...
            set_vitamin_c(34.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.12000);
            set_vitamin_k(47.60000);
            set_water(90.84000);
