 ...
 */
public class Vegetables_mixed_frozen_unprepared implements Food {

    private final Vegetables_mixed_frozen_unprepared_mutable food;

    public Vegetables_mixed_frozen_unprepared() {
        food = new Vegetables_mixed_frozen_unprepared_mutable();
    }
    ...
    private class Vegetables_mixed_frozen_unprepared_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Vegetables_mixed_frozen_unprepared_mutable() {
            ...
            set_carbohydrate_by_difference(13.47000);
            ...
            set_sodium(47.00000);
            set_thiamin(0.12000);
            set_vitamin_a(254.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.09000);
            set_vitamin_c(10.40000);
