 ...
 */
public class Catsup implements Food {

    private final Catsup_mutable food;

    public Catsup() {
        food = new Catsup_mutable();
    }
    ...
    private class Catsup_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Catsup_mutable() {
            set_food_name("Catsup");
            set_food_label("catsup");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(15.00000);
            set_carbohydrate_by_difference(27.40000);
            set_cholesterol(0.00000);
            set_choline(12.50000);
