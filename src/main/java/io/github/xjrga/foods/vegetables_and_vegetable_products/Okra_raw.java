 ...
 */
public class Okra_raw implements Food {

    private final Okra_raw_mutable food;

    public Okra_raw() {
        food = new Okra_raw_mutable();
    }
    ...
    private class Okra_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Okra_raw_mutable() {
            set_food_name("Okra, raw");
            set_food_label("okra_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(82.00000);
            set_carbohydrate_by_difference(7.45000);
            ...
            set_gross_energy(33.00000);
            set_iron(0.62000);
            set_linoleic_acid(0.00000);
            set_magnesium(57.00000);
