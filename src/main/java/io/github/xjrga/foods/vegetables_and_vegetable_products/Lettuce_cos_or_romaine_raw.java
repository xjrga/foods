 ...
 */
public class Lettuce_cos_or_romaine_raw implements Food {

    private final Lettuce_cos_or_romaine_raw_mutable food;

    public Lettuce_cos_or_romaine_raw() {
        food = new Lettuce_cos_or_romaine_raw_mutable();
    }
    ...
    private class Lettuce_cos_or_romaine_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Lettuce_cos_or_romaine_raw_mutable() {
            ...
            set_carbohydrate_by_difference(3.29000);
