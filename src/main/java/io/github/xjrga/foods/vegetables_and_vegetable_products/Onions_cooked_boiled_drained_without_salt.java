 ...
 */
public class Onions_cooked_boiled_drained_without_salt implements Food {

    private final Onions_cooked_boiled_drained_without_salt_mutable food;

    public Onions_cooked_boiled_drained_without_salt() {
        food = new Onions_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Onions_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Onions_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(22.00000);
            set_carbohydrate_by_difference(10.15000);
            ...
            set_niacin(0.16000);
            set_pantothenic_acid(0.11000);
            set_phosphorus(35.00000);
            set_polyunsaturated_fat(0.07000);
            set_potassium(166.00000);
            set_protein(1.36000);
            ...
            set_vitamin_c(5.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.02000);
