 ...
 */
public class Sweet_potato_cooked_baked_in_skin_flesh_without_salt implements Food {

    private final Sweet_potato_cooked_baked_in_skin_flesh_without_salt_mutable food;

    public Sweet_potato_cooked_baked_in_skin_flesh_without_salt() {
        food = new Sweet_potato_cooked_baked_in_skin_flesh_without_salt_mutable();
    }
    ...
    private class Sweet_potato_cooked_baked_in_skin_flesh_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Sweet_potato_cooked_baked_in_skin_flesh_without_salt_mutable() {
            ...
            set_calcium(38.00000);
            set_carbohydrate_by_difference(20.71000);
            set_cholesterol(0.00000);
            set_choline(13.10000);
            ...
            set_niacin(1.48000);
            set_pantothenic_acid(0.88000);
            set_phosphorus(54.00000);
            set_polyunsaturated_fat(0.09000);
            set_potassium(475.00000);
            set_protein(2.01000);
            ...
            set_sodium(36.00000);
            set_thiamin(0.10000);
            set_vitamin_a(961.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.28000);
            set_vitamin_c(19.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.71000);
