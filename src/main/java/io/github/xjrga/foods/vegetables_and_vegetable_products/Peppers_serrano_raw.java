 ...
 */
public class Peppers_serrano_raw implements Food {

    private final Peppers_serrano_raw_mutable food;

    public Peppers_serrano_raw() {
        food = new Peppers_serrano_raw_mutable();
    }
    ...
    private class Peppers_serrano_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peppers_serrano_raw_mutable() {
            set_food_name("Peppers, serrano, raw");
            set_food_label("peppers_serrano_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(11.00000);
            set_carbohydrate_by_difference(6.70000);
            ...
            set_sodium(10.00000);
            set_thiamin(0.05000);
            set_vitamin_a(47.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.50000);
            set_vitamin_c(44.90000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.69000);
            set_vitamin_k(11.80000);
            set_water(90.25000);
