 ...
 */
public class Cabbage_raw implements Food {

    private final Cabbage_raw_mutable food;

    public Cabbage_raw() {
        food = new Cabbage_raw_mutable();
    }
    ...
    private class Cabbage_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cabbage_raw_mutable() {
            set_food_name("Cabbage, raw");
            set_food_label("cabbage_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(40.00000);
            set_carbohydrate_by_difference(5.80000);
            ...
            set_vitamin_c(36.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.15000);
            set_vitamin_k(76.00000);
            set_water(92.18000);
