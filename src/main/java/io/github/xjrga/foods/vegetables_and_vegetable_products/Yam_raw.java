 ...
 */
public class Yam_raw implements Food {

    private final Yam_raw_mutable food;

    public Yam_raw() {
        food = new Yam_raw_mutable();
    }
    ...
    private class Yam_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Yam_raw_mutable() {
            set_food_name("Yam, raw");
            set_food_label("yam_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(17.00000);
            set_carbohydrate_by_difference(27.88000);
            set_cholesterol(0.00000);
            set_choline(16.50000);
