 ...
 */
public class Potatoes_white_flesh_and_skin_baked implements Food {

    private final Potatoes_white_flesh_and_skin_baked_mutable food;

    public Potatoes_white_flesh_and_skin_baked() {
        food = new Potatoes_white_flesh_and_skin_baked_mutable();
    }
    ...
    private class Potatoes_white_flesh_and_skin_baked_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Potatoes_white_flesh_and_skin_baked_mutable() {
            ...
            set_carbohydrate_by_difference(21.08000);
            set_cholesterol(0.00000);
            set_choline(14.40000);
