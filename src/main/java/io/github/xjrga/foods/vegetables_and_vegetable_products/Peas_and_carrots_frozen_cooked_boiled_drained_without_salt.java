 ...
 */
public class Peas_and_carrots_frozen_cooked_boiled_drained_without_salt implements Food {

    private final Peas_and_carrots_frozen_cooked_boiled_drained_without_salt_mutable food;

    public Peas_and_carrots_frozen_cooked_boiled_drained_without_salt() {
        food = new Peas_and_carrots_frozen_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Peas_and_carrots_frozen_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peas_and_carrots_frozen_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(23.00000);
            set_carbohydrate_by_difference(10.12000);
            set_cholesterol(0.00000);
            set_choline(18.10000);
            ...
            set_niacin(1.15000);
            set_pantothenic_acid(0.16000);
            set_phosphorus(49.00000);
            set_polyunsaturated_fat(0.20000);
            set_potassium(158.00000);
            set_protein(3.09000);
            ...
            set_sodium(68.00000);
            set_thiamin(0.22000);
            set_vitamin_a(476.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.08000);
            set_vitamin_c(8.10000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.52000);
            set_vitamin_k(18.80000);
            set_water(85.80000);
