 ...
 */
public class Spinach_canned_regular_pack_drained_solids implements Food {

    private final Spinach_canned_regular_pack_drained_solids_mutable food;

    public Spinach_canned_regular_pack_drained_solids() {
        food = new Spinach_canned_regular_pack_drained_solids_mutable();
    }
    ...
    private class Spinach_canned_regular_pack_drained_solids_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Spinach_canned_regular_pack_drained_solids_mutable() {
