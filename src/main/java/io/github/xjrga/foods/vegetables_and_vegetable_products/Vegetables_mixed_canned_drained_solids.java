 ...
 */
public class Vegetables_mixed_canned_drained_solids implements Food {

    private final Vegetables_mixed_canned_drained_solids_mutable food;

    public Vegetables_mixed_canned_drained_solids() {
        food = new Vegetables_mixed_canned_drained_solids_mutable();
    }
    ...
    private class Vegetables_mixed_canned_drained_solids_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Vegetables_mixed_canned_drained_solids_mutable() {
            ...
            set_carbohydrate_by_difference(9.26000);
