 ...
 */
public class Corn_sweet_yellow_raw implements Food {

    private final Corn_sweet_yellow_raw_mutable food;

    public Corn_sweet_yellow_raw() {
        food = new Corn_sweet_yellow_raw_mutable();
    }
    ...
    private class Corn_sweet_yellow_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Corn_sweet_yellow_raw_mutable() {
            set_food_name("Corn, sweet, yellow, raw");
            set_food_label("corn_sweet_yellow_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.01000);
            set_calcium(2.00000);
            set_carbohydrate_by_difference(18.70000);
            set_cholesterol(0.00000);
            set_choline(23.00000);
            ...
            set_iron(0.52000);
            set_linoleic_acid(0.46000);
            set_magnesium(37.00000);
            set_manganese(0.16000);
            set_monounsaturated_fat(0.43000);
            set_niacin(1.77000);
            set_pantothenic_acid(0.71000);
            set_phosphorus(89.00000);
            set_polyunsaturated_fat(0.48000);
            set_potassium(270.00000);
            set_protein(3.27000);
