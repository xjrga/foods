 ...
 */
public class Potatoes_boiled_cooked_in_skin_flesh_without_salt implements Food {

    private final Potatoes_boiled_cooked_in_skin_flesh_without_salt_mutable food;

    public Potatoes_boiled_cooked_in_skin_flesh_without_salt() {
        food = new Potatoes_boiled_cooked_in_skin_flesh_without_salt_mutable();
    }
    ...
    private class Potatoes_boiled_cooked_in_skin_flesh_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Potatoes_boiled_cooked_in_skin_flesh_without_salt_mutable() {
            ...
            set_vitamin_b6(0.29000);
            set_vitamin_c(13.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.01000);
            set_vitamin_k(2.20000);
            set_water(76.98000);
