 ...
 */
public class Squash_summer_all_varieties_cooked_boiled_drained_without_salt implements Food {

    private final Squash_summer_all_varieties_cooked_boiled_drained_without_salt_mutable food;

    public Squash_summer_all_varieties_cooked_boiled_drained_without_salt() {
        food = new Squash_summer_all_varieties_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Squash_summer_all_varieties_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Squash_summer_all_varieties_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(4.31000);
            ...
            set_niacin(0.51000);
            set_pantothenic_acid(0.13000);
            set_phosphorus(39.00000);
            set_polyunsaturated_fat(0.13000);
            set_potassium(192.00000);
            set_protein(0.91000);
