 ...
 */
public class Corn_sweet_white_raw implements Food {

    private final Corn_sweet_white_raw_mutable food;

    public Corn_sweet_white_raw() {
        food = new Corn_sweet_white_raw_mutable();
    }
    ...
    private class Corn_sweet_white_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Corn_sweet_white_raw_mutable() {
            set_food_name("Corn, sweet, white, raw");
            set_food_label("corn_sweet_white_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(2.00000);
            set_carbohydrate_by_difference(19.02000);
            ...
            set_niacin(1.70000);
            set_pantothenic_acid(0.76000);
            set_phosphorus(89.00000);
            set_polyunsaturated_fat(0.55000);
