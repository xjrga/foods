 ...
 */
public class Asparagus_raw implements Food {

    private final Asparagus_raw_mutable food;

    public Asparagus_raw() {
        food = new Asparagus_raw_mutable();
    }
    ...
    private class Asparagus_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Asparagus_raw_mutable() {
            set_food_name("Asparagus, raw");
            set_food_label("asparagus_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(24.00000);
            set_carbohydrate_by_difference(3.88000);
            ...
            set_vitamin_e(1.13000);
            set_vitamin_k(41.60000);
            set_water(93.22000);
