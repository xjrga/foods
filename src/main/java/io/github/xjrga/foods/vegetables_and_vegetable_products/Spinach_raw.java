 ...
 */
public class Spinach_raw implements Food {

    private final Spinach_raw_mutable food;

    public Spinach_raw() {
        food = new Spinach_raw_mutable();
    }
    ...
    private class Spinach_raw_mutable extends Food_abstract {
        ...
        public Spinach_raw_mutable() {
            ...
            set_sodium(79.00000);
            set_thiamin(0.07000);
            set_vitamin_a(469.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.19000);
            set_vitamin_c(28.10000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.03000);
            set_vitamin_k(482.90000);
            set_water(91.40000);
