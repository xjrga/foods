 ...
 */
public class Lettuce_red_leaf_raw implements Food {

    private final Lettuce_red_leaf_raw_mutable food;

    public Lettuce_red_leaf_raw() {
        food = new Lettuce_red_leaf_raw_mutable();
    }
    ...
    private class Lettuce_red_leaf_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Lettuce_red_leaf_raw_mutable() {
            ...
            set_carbohydrate_by_difference(2.26000);
            set_cholesterol(0.00000);
            set_choline(11.80000);
