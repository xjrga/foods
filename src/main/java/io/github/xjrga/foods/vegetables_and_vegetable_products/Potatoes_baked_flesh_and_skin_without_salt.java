 ...
 */
public class Potatoes_baked_flesh_and_skin_without_salt implements Food {

    private final Potatoes_baked_flesh_and_skin_without_salt_mutable food;

    public Potatoes_baked_flesh_and_skin_without_salt() {
        food = new Potatoes_baked_flesh_and_skin_without_salt_mutable();
    }
    ...
    private class Potatoes_baked_flesh_and_skin_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Potatoes_baked_flesh_and_skin_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(21.15000);
            set_cholesterol(0.00000);
            set_choline(14.80000);
