 ...
 */
public class Nopales_cooked_without_salt implements Food {

    private final Nopales_cooked_without_salt_mutable food;

    public Nopales_cooked_without_salt() {
        food = new Nopales_cooked_without_salt_mutable();
    }
    ...
    private class Nopales_cooked_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nopales_cooked_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(3.28000);
            ...
            set_vitamin_c(5.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.00000);
            set_vitamin_k(5.10000);
            set_water(94.31000);
