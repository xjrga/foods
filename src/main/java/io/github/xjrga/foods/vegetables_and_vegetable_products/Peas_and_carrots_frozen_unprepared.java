 ...
 */
public class Peas_and_carrots_frozen_unprepared implements Food {

    private final Peas_and_carrots_frozen_unprepared_mutable food;

    public Peas_and_carrots_frozen_unprepared() {
        food = new Peas_and_carrots_frozen_unprepared_mutable();
    }
    ...
    private class Peas_and_carrots_frozen_unprepared_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peas_and_carrots_frozen_unprepared_mutable() {
            ...
            set_carbohydrate_by_difference(11.15000);
            ...
            set_sodium(79.00000);
            set_thiamin(0.19000);
            set_vitamin_a(475.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.10000);
            set_vitamin_c(11.20000);
