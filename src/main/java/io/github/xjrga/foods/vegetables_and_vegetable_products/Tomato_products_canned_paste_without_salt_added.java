 ...
 */
public class Tomato_products_canned_paste_without_salt_added implements Food {

    private final Tomato_products_canned_paste_without_salt_added_mutable food;

    public Tomato_products_canned_paste_without_salt_added() {
        food = new Tomato_products_canned_paste_without_salt_added_mutable();
    }
    ...
    private class Tomato_products_canned_paste_without_salt_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Tomato_products_canned_paste_without_salt_added_mutable() {
            ...
            set_calcium(36.00000);
            set_carbohydrate_by_difference(18.91000);
            set_cholesterol(0.00000);
            set_choline(38.50000);
            ...
            set_gross_energy(82.00000);
            set_iron(2.98000);
            set_linoleic_acid(0.00000);
            set_magnesium(42.00000);
            set_manganese(0.30000);
            set_monounsaturated_fat(0.06000);
            set_niacin(3.07000);
            set_pantothenic_acid(0.14000);
            set_phosphorus(83.00000);
            set_polyunsaturated_fat(0.16000);
            set_potassium(1014.00000);
            set_protein(4.32000);
            set_riboflavin(0.15000);
            set_saturated_fat(0.10000);
            set_selenium(5.30000);
            set_sodium(59.00000);
            set_thiamin(0.06000);
            set_vitamin_a(76.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.21000);
            set_vitamin_c(21.90000);
            set_vitamin_d(0.00000);
            set_vitamin_e(4.30000);
            set_vitamin_k(11.40000);
            set_water(73.50000);
