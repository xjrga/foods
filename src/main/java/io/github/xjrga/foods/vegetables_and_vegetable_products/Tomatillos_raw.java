 ...
 */
public class Tomatillos_raw implements Food {

    private final Tomatillos_raw_mutable food;

    public Tomatillos_raw() {
        food = new Tomatillos_raw_mutable();
    }
    ...
    private class Tomatillos_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Tomatillos_raw_mutable() {
            set_food_name("Tomatillos, raw");
            set_food_label("tomatillos_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(7.00000);
            set_carbohydrate_by_difference(5.84000);
            ...
            set_polyunsaturated_fat(0.41000);
            ...
            set_vitamin_c(11.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.38000);
            set_vitamin_k(10.10000);
            set_water(91.63000);
