 ...
 */
public class Ginger_root_raw implements Food {

    private final Ginger_root_raw_mutable food;

    public Ginger_root_raw() {
        food = new Ginger_root_raw_mutable();
    }
    ...
    private class Ginger_root_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Ginger_root_raw_mutable() {
            set_food_name("Ginger root, raw");
            set_food_label("ginger_root_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(16.00000);
            set_carbohydrate_by_difference(17.77000);
            set_cholesterol(0.00000);
            set_choline(28.80000);
