 ...
 */
public class Peas_green_frozen_unprepared implements Food {

    private final Peas_green_frozen_unprepared_mutable food;

    public Peas_green_frozen_unprepared() {
        food = new Peas_green_frozen_unprepared_mutable();
    }
    ...
    private class Peas_green_frozen_unprepared_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Peas_green_frozen_unprepared_mutable() {
            ...
            set_carbohydrate_by_difference(13.62000);
            set_cholesterol(0.00000);
            set_choline(27.00000);
