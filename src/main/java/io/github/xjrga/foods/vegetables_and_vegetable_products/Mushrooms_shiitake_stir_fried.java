 ...
 */
public class Mushrooms_shiitake_stir_fried implements Food {

    private final Mushrooms_shiitake_stir_fried_mutable food;

    public Mushrooms_shiitake_stir_fried() {
        food = new Mushrooms_shiitake_stir_fried_mutable();
    }
    ...
    private class Mushrooms_shiitake_stir_fried_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Mushrooms_shiitake_stir_fried_mutable() {
