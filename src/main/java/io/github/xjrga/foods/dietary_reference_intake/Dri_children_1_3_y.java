 ...
 */
public class Dri_children_1_3_y implements Dri {

    private final Dri_children_1_3_y_mutable dri;

    /**
     * Constructs a dri item
     */
    public Dri_children_1_3_y() {
        dri = new Dri_children_1_3_y_mutable();
    }
    ...
    private class Dri_children_1_3_y_mutable extends Abstract_dri {

        /**
         * Constructs a dri item
         */
        public Dri_children_1_3_y_mutable() {
            set_calcium_lower(700.00000);
            set_calcium_upper(2500.00000);
            set_choline_lower(200.00000);
            set_choline_upper(1000.00000);
            set_copper_lower(0.34000);
            set_copper_upper(1.00000);
            set_fluoride_lower(700.00000);
            set_fluoride_upper(1300.00000);
            set_folate_lower(150.00000);
            set_folate_upper(300.00000);
            set_iron_lower(7.00000);
            set_iron_upper(40.00000);
            set_magnesium_lower(80.00000);
            set_magnesium_upper(65.00000);
            set_manganese_lower(1.20000);
            set_manganese_upper(2.00000);
            set_niacin_lower(6.00000);
            set_niacin_upper(10.00000);
            set_pantothenic_acid_lower(2.00000);
            set_pantothenic_acid_upper(0.00000);
            set_phosphorus_lower(460.00000);
            set_phosphorus_upper(3000.00000);
            set_potassium_lower(2000.00000);
            set_potassium_upper(0.00000);
            set_riboflavin_lower(0.50000);
            set_riboflavin_upper(0.00000);
            set_selenium_lower(20.00000);
            set_selenium_upper(90.00000);
            set_sodium_lower(800.00000);
            set_sodium_upper(0.00000);
            set_thiamin_lower(0.50000);
            set_thiamin_upper(0.00000);
            set_vitamin_a_lower(300.00000);
            set_vitamin_a_upper(600.00000);
            set_vitamin_b12_lower(0.90000);
            set_vitamin_b12_upper(0.00000);
            set_vitamin_b6_lower(0.50000);
            set_vitamin_b6_upper(30.00000);
            set_vitamin_c_lower(15.00000);
            set_vitamin_c_upper(400.00000);
            set_vitamin_d_lower(15.00000);
            set_vitamin_d_upper(63.00000);
            set_vitamin_e_lower(6.00000);
            set_vitamin_e_upper(200.00000);
            set_vitamin_k_lower(30.00000);
            set_vitamin_k_upper(0.00000);
            set_zinc_lower(3.00000);
            set_zinc_upper(7.00000);
