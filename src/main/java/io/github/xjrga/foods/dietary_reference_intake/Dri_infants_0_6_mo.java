 ...
 */
public class Dri_infants_0_6_mo implements Dri {

    private final Dri_infants_0_6_mo_mutable dri;

    /**
     * Constructs a dri item
     */
    public Dri_infants_0_6_mo() {
        dri = new Dri_infants_0_6_mo_mutable();
    }
    ...
    private class Dri_infants_0_6_mo_mutable extends Abstract_dri {
         ...
         * Constructs a dri item
         */
        public Dri_infants_0_6_mo_mutable() {
            set_calcium_lower(200.00000);
            set_calcium_upper(1000.00000);
            set_choline_lower(125.00000);
            set_choline_upper(0.00000);
            set_copper_lower(0.20000);
            set_copper_upper(0.00000);
            set_fluoride_lower(10.00000);
            set_fluoride_upper(700.00000);
            set_folate_lower(65.00000);
            set_folate_upper(0.00000);
            set_iron_lower(0.27000);
            set_iron_upper(40.00000);
            set_magnesium_lower(30.00000);
            set_magnesium_upper(0.00000);
            set_manganese_lower(0.00300);
            set_manganese_upper(0.00000);
            set_niacin_lower(2.00000);
            set_niacin_upper(0.00000);
            set_pantothenic_acid_lower(1.70000);
            set_pantothenic_acid_upper(0.00000);
            set_phosphorus_lower(100.00000);
            set_phosphorus_upper(0.00000);
            set_potassium_lower(400.00000);
            set_potassium_upper(0.00000);
            set_riboflavin_lower(0.30000);
            set_riboflavin_upper(0.00000);
            set_selenium_lower(15.00000);
            set_selenium_upper(45.00000);
            set_sodium_lower(110.00000);
            set_sodium_upper(0.00000);
            set_thiamin_lower(0.20000);
            set_thiamin_upper(0.00000);
            set_vitamin_a_lower(400.00000);
            set_vitamin_a_upper(600.00000);
            set_vitamin_b12_lower(0.40000);
            set_vitamin_b12_upper(0.00000);
            set_vitamin_b6_lower(0.10000);
            set_vitamin_b6_upper(0.00000);
            set_vitamin_c_lower(40.00000);
            set_vitamin_c_upper(0.00000);
            set_vitamin_d_lower(10.00000);
            set_vitamin_d_upper(25.00000);
            set_vitamin_e_lower(4.00000);
            set_vitamin_e_upper(0.00000);
            set_vitamin_k_lower(2.00000);
            set_vitamin_k_upper(0.00000);
            set_zinc_lower(2.00000);
            set_zinc_upper(4.00000);
