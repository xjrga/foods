 ...
 */
public class Dri_children_4_8_y implements Dri {

    private final Dri_children_4_8_y_mutable dri;

    /**
     * Constructs a dri item
     */
    public Dri_children_4_8_y() {
        dri = new Dri_children_4_8_y_mutable();
    }
    ...
    private class Dri_children_4_8_y_mutable extends Dri_abstract {

        /**
         * Constructs a dri item
         */
        public Dri_children_4_8_y_mutable() {
            set_calcium_lower(1000.00000);
            set_calcium_upper(2500.00000);
            set_choline_lower(250.00000);
            set_choline_upper(1000.00000);
            set_copper_lower(0.44000);
            set_copper_upper(3.00000);
            set_fluoride_lower(1000.00000);
            set_fluoride_upper(2200.00000);
            set_folate_lower(200.00000);
            set_folate_upper(400.00000);
            set_iron_lower(10.00000);
            set_iron_upper(40.00000);
            set_magnesium_lower(130.00000);
            set_magnesium_upper(110.00000);
            set_manganese_lower(1.50000);
            set_manganese_upper(3.00000);
            set_niacin_lower(8.00000);
            set_niacin_upper(15.00000);
            set_pantothenic_acid_lower(3.00000);
            set_pantothenic_acid_upper(0.00000);
            set_phosphorus_lower(500.00000);
            set_phosphorus_upper(3000.00000);
            set_potassium_lower(2300.00000);
            set_potassium_upper(0.00000);
            set_riboflavin_lower(0.60000);
            set_riboflavin_upper(0.00000);
            set_selenium_lower(30.00000);
            set_selenium_upper(150.00000);
            set_sodium_lower(1000.00000);
            set_sodium_upper(0.00000);
            set_thiamin_lower(0.60000);
            set_thiamin_upper(0.00000);
            set_vitamin_a_lower(400.00000);
            set_vitamin_a_upper(900.00000);
            set_vitamin_b12_lower(1.20000);
            set_vitamin_b12_upper(0.00000);
            set_vitamin_b6_lower(0.60000);
            set_vitamin_b6_upper(40.00000);
            set_vitamin_c_lower(25.00000);
            set_vitamin_c_upper(650.00000);
            set_vitamin_d_lower(15.00000);
            set_vitamin_d_upper(75.00000);
            set_vitamin_e_lower(7.00000);
            set_vitamin_e_upper(300.00000);
            set_vitamin_k_lower(55.00000);
            set_vitamin_k_upper(0.00000);
            set_zinc_lower(5.00000);
            set_zinc_upper(12.00000);
