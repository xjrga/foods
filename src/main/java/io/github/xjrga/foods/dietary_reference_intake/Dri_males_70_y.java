 ...
 */
public class Dri_males_70_y implements Dri {

    private final Dri_males_70_y_mutable dri;

    /**
     * Constructs a dri item
     */
    public Dri_males_70_y() {
        dri = new Dri_males_70_y_mutable();
    }
    ...
    private class Dri_males_70_y_mutable extends Abstract_dri {

        /**
         * Constructs a dri item
         */
        public Dri_males_70_y_mutable() {
            ...
            set_potassium_lower(3400.00000);
