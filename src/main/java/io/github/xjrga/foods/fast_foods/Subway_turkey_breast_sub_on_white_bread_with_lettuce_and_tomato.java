 ...
 */
public class Subway_turkey_breast_sub_on_white_bread_with_lettuce_and_tomato implements Food {

    private final Subway_turkey_breast_sub_on_white_bread_with_lettuce_and_tomato_mutable food;

    public Subway_turkey_breast_sub_on_white_bread_with_lettuce_and_tomato() {
        food = new Subway_turkey_breast_sub_on_white_bread_with_lettuce_and_tomato_mutable();
    }
    ...
    private class Subway_turkey_breast_sub_on_white_bread_with_lettuce_and_tomato_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Subway_turkey_breast_sub_on_white_bread_with_lettuce_and_tomato_mutable() {
            ...
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.08000);
            set_calcium(169.00000);
            set_carbohydrate_by_difference(22.42000);
            set_cholesterol(10.00000);
            set_choline(0.00000);
            ...
            set_gross_energy(147.00000);
            set_iron(1.84000);
            set_linoleic_acid(0.90000);
            set_magnesium(23.00000);
            set_manganese(0.29000);
            set_monounsaturated_fat(0.52000);
            set_niacin(4.61000);
            set_pantothenic_acid(0.42000);
            set_phosphorus(122.00000);
            set_polyunsaturated_fat(1.03000);
            set_potassium(253.00000);
            set_protein(9.12000);
            set_riboflavin(0.22000);
            set_saturated_fat(0.47000);
            set_selenium(17.00000);
            set_sodium(317.00000);
            set_thiamin(0.27000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(0.12000);
            set_vitamin_b6(0.17000);
            set_vitamin_c(1.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.28000);
