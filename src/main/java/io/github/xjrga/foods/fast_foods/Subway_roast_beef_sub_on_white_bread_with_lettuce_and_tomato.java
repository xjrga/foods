 ...
 */
public class Subway_roast_beef_sub_on_white_bread_with_lettuce_and_tomato implements Food {

    private final Subway_roast_beef_sub_on_white_bread_with_lettuce_and_tomato_mutable food;

    public Subway_roast_beef_sub_on_white_bread_with_lettuce_and_tomato() {
        food = new Subway_roast_beef_sub_on_white_bread_with_lettuce_and_tomato_mutable();
    }
    ...
    private class Subway_roast_beef_sub_on_white_bread_with_lettuce_and_tomato_mutable extends Food_abstract {
         ...
         */
        public Subway_roast_beef_sub_on_white_bread_with_lettuce_and_tomato_mutable() {
            ...
            set_calcium(164.00000);
            set_carbohydrate_by_difference(20.34000);
            ...
            set_iron(2.09000);
            set_linoleic_acid(0.60000);
            set_magnesium(20.00000);
            set_manganese(0.26000);
            set_monounsaturated_fat(0.78000);
            set_niacin(4.18000);
            set_pantothenic_acid(0.41000);
            set_phosphorus(118.00000);
            set_polyunsaturated_fat(0.71000);
            set_potassium(188.00000);
            set_protein(12.17000);
            set_riboflavin(0.25000);
            set_saturated_fat(0.97000);
            set_selenium(17.00000);
            set_sodium(329.00000);
            set_thiamin(0.23000);
