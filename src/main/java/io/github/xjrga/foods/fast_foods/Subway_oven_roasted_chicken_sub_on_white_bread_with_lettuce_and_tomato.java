 ...
 */
public class Subway_oven_roasted_chicken_sub_on_white_bread_with_lettuce_and_tomato implements Food {

    private final Subway_oven_roasted_chicken_sub_on_white_bread_with_lettuce_and_tomato_mutable food;

    public Subway_oven_roasted_chicken_sub_on_white_bread_with_lettuce_and_tomato() {
        food = new Subway_oven_roasted_chicken_sub_on_white_bread_with_lettuce_and_tomato_mutable();
    }
    ...
    private class Subway_oven_roasted_chicken_sub_on_white_bread_with_lettuce_and_tomato_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Subway_oven_roasted_chicken_sub_on_white_bread_with_lettuce_and_tomato_mutable() {
            ...
            set_calcium(154.00000);
            set_carbohydrate_by_difference(21.35000);
            set_cholesterol(23.00000);
            set_choline(0.00000);
            ...
            set_gross_energy(157.00000);
            set_iron(1.72000);
            set_linoleic_acid(0.83000);
            set_magnesium(22.00000);
            set_manganese(0.28000);
            set_monounsaturated_fat(0.93000);
            set_niacin(5.21000);
            set_pantothenic_acid(0.65000);
            set_phosphorus(145.00000);
            set_polyunsaturated_fat(0.95000);
            set_potassium(198.00000);
            set_protein(10.84000);
            set_riboflavin(0.23000);
            set_saturated_fat(0.72000);
            set_selenium(16.80000);
            set_sodium(268.00000);
            set_thiamin(1.15000);
            set_vitamin_a(5.00000);
            set_vitamin_b12(0.08000);
            set_vitamin_b6(0.25000);
            set_vitamin_c(1.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.42000);
