 ...
 */
package io.github.xjrga.foods.baby_foods;
 ...
 */
public class Babyfood_dessert_custard_pudding_vanilla_junior implements Food {

    private final Babyfood_dessert_custard_pudding_vanilla_junior_mutable food;

    public Babyfood_dessert_custard_pudding_vanilla_junior() {
        food = new Babyfood_dessert_custard_pudding_vanilla_junior_mutable();
    }
    ...
    private class Babyfood_dessert_custard_pudding_vanilla_junior_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Babyfood_dessert_custard_pudding_vanilla_junior_mutable() {
            ...
            set_calcium(54.00000);
            set_carbohydrate_by_difference(17.58000);
            set_cholesterol(38.00000);
            set_choline(29.90000);
            ...
            set_monounsaturated_fat(0.36000);
            set_niacin(0.07000);
            set_pantothenic_acid(0.23000);
            set_phosphorus(55.00000);
            set_polyunsaturated_fat(0.12000);
            set_potassium(68.00000);
            set_protein(1.76000);
            set_riboflavin(0.05000);
            set_saturated_fat(0.32000);
            set_selenium(2.40000);
            set_sodium(26.00000);
            set_thiamin(0.01000);
