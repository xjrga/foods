 ...
 */
package io.github.xjrga.foods.breakfast_cereals;
 ...
 */
public class Cereals_ready_to_eat_kellogg_kelloggs_all_bran_original implements Food {

    private final Cereals_ready_to_eat_kellogg_kellogg_s_all_bran_original_mutable food;

    public Cereals_ready_to_eat_kellogg_kelloggs_all_bran_original() {
        food = new Cereals_ready_to_eat_kellogg_kellogg_s_all_bran_original_mutable();
    }
    ...
    private class Cereals_ready_to_eat_kellogg_kellogg_s_all_bran_original_mutable extends Abstract_food {
         ...
         */
        public Cereals_ready_to_eat_kellogg_kellogg_s_all_bran_original_mutable() {
            ...
            set_calcium(389.00000);
            set_carbohydrate_by_difference(74.24000);
            set_cholesterol(0.00000);
            set_choline(49.40000);
            ...
            set_folate(2198.00000);
            set_glycemic_index(34.00000);
            set_gross_energy(259.00000);
            set_iron(17.60000);
            set_linoleic_acid(0.00000);
            set_magnesium(362.00000);
            set_manganese(7.41000);
            set_monounsaturated_fat(0.89000);
            set_niacin(14.80000);
            set_pantothenic_acid(1.06000);
            set_phosphorus(1150.00000);
            set_polyunsaturated_fat(2.00000);
            set_potassium(1020.00000);
            set_protein(13.14000);
            set_riboflavin(2.71000);
            set_saturated_fat(1.10000);
            set_selenium(9.40000);
            set_sodium(258.00000);
            set_thiamin(2.27000);
            set_vitamin_a(522.00000);
            set_vitamin_b12(18.80000);
            set_vitamin_b6(12.00000);
            set_vitamin_c(20.00000);
            set_vitamin_d(4.30000);
            set_vitamin_e(1.19000);
            set_vitamin_k(5.20000);
            set_water(2.12000);
