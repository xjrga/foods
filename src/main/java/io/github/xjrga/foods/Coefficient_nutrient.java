...
public class Coefficient_nutrient {
	...
	private void populate_coefficient_arrays() {
		for (int i = 0; i < size; i++) {
			...
			gross_energy[i] = food.get_energy_gross_in_kilocalories_coefficient();
	...
	public final String toString() {
		...
		sb.append("\n");
		sb.append(print_coefficients("Energy_digestible_carbohydrate",
				get_energy_digestible_carbohydrate_coefficients()));
		sb.append("\n");
