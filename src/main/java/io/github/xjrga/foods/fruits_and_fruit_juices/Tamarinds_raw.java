 ...
 */
public class Tamarinds_raw implements Food {

    private final Tamarinds_raw_mutable food;

    public Tamarinds_raw() {
        food = new Tamarinds_raw_mutable();
    }
    ...
    private class Tamarinds_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Tamarinds_raw_mutable() {
            set_food_name("Tamarinds, raw");
            set_food_label("tamarinds_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(74.00000);
            set_carbohydrate_by_difference(62.50000);
