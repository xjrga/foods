 ...
 */
public class Applesauce_canned_unsweetened_with_added_ascorbic_acid implements Food {

    private final Applesauce_canned_unsweetened_with_added_ascorbic_acid_mutable food;

    public Applesauce_canned_unsweetened_with_added_ascorbic_acid() {
        food = new Applesauce_canned_unsweetened_with_added_ascorbic_acid_mutable();
    }
    ...
    private class Applesauce_canned_unsweetened_with_added_ascorbic_acid_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Applesauce_canned_unsweetened_with_added_ascorbic_acid_mutable() {
            ...
            set_calcium(4.00000);
            set_carbohydrate_by_difference(11.27000);
