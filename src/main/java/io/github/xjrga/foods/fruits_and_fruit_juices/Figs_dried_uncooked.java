 ...
 */
public class Figs_dried_uncooked implements Food {

    private final Figs_dried_uncooked_mutable food;

    public Figs_dried_uncooked() {
        food = new Figs_dried_uncooked_mutable();
    }
    ...
    private class Figs_dried_uncooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Figs_dried_uncooked_mutable() {
            set_food_name("Figs, dried, uncooked");
            set_food_label("figs_dried_uncooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(162.00000);
            set_carbohydrate_by_difference(63.87000);
            set_cholesterol(0.00000);
            set_choline(15.80000);
