 ...
 */
public class Lemons_raw_without_peel implements Food {

    private final Lemons_raw_without_peel_mutable food;

    public Lemons_raw_without_peel() {
        food = new Lemons_raw_without_peel_mutable();
    }
    ...
    private class Lemons_raw_without_peel_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Lemons_raw_without_peel_mutable() {
            set_food_name("Lemons, raw, without peel");
            set_food_label("lemons_raw_without_peel");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(26.00000);
            set_carbohydrate_by_difference(9.32000);
