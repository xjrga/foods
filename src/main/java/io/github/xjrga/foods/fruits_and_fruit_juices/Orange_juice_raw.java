 ...
 */
public class Orange_juice_raw implements Food {

    private final Orange_juice_raw_mutable food;

    public Orange_juice_raw() {
        food = new Orange_juice_raw_mutable();
    }
    ...
    private class Orange_juice_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Orange_juice_raw_mutable() {
