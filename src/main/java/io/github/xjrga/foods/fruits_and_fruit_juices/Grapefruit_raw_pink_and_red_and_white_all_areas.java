 ...
 */
public class Grapefruit_raw_pink_and_red_and_white_all_areas implements Food {

    private final Grapefruit_raw_pink_and_red_and_white_all_areas_mutable food;

    public Grapefruit_raw_pink_and_red_and_white_all_areas() {
        food = new Grapefruit_raw_pink_and_red_and_white_all_areas_mutable();
    }
    ...
    private class Grapefruit_raw_pink_and_red_and_white_all_areas_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Grapefruit_raw_pink_and_red_and_white_all_areas_mutable() {
            ...
            set_carbohydrate_by_difference(8.08000);
