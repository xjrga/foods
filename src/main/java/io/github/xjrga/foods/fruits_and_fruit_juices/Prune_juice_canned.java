 ...
 */
public class Prune_juice_canned implements Food {

    private final Prune_juice_canned_mutable food;

    public Prune_juice_canned() {
        food = new Prune_juice_canned_mutable();
    }
    ...
    private class Prune_juice_canned_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Prune_juice_canned_mutable() {
            set_food_name("Prune juice, canned");
            set_food_label("prune_juice_canned");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(12.00000);
            set_carbohydrate_by_difference(17.45000);
            ...
            set_fat(0.03000);
            set_fiber(1.00000);
            set_fluoride(60.20000);
            set_folate(0.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(71.00000);
            set_iron(1.18000);
            ...
            set_polyunsaturated_fat(0.00700);
            set_potassium(276.00000);
            set_protein(0.61000);
            set_riboflavin(0.07000);
            set_saturated_fat(0.00300);
