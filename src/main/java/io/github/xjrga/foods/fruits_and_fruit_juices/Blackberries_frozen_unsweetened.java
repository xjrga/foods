 ...
 */
public class Blackberries_frozen_unsweetened implements Food {

    private final Blackberries_frozen_unsweetened_mutable food;

    public Blackberries_frozen_unsweetened() {
        food = new Blackberries_frozen_unsweetened_mutable();
    }
    ...
    private class Blackberries_frozen_unsweetened_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Blackberries_frozen_unsweetened_mutable() {
            ...
            set_carbohydrate_by_difference(15.67000);
            ...
            set_vitamin_c(3.10000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.17000);
            set_vitamin_k(19.80000);
            set_water(82.21000);
