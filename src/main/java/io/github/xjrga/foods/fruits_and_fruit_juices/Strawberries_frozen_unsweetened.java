 ...
 */
public class Strawberries_frozen_unsweetened implements Food {

    private final Strawberries_frozen_unsweetened_mutable food;

    public Strawberries_frozen_unsweetened() {
        food = new Strawberries_frozen_unsweetened_mutable();
    }
    ...
    private class Strawberries_frozen_unsweetened_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Strawberries_frozen_unsweetened_mutable() {
            ...
            set_carbohydrate_by_difference(9.13000);
            ...
            set_niacin(0.46000);
            set_pantothenic_acid(0.10000);
            set_phosphorus(13.00000);
            set_polyunsaturated_fat(0.05000);
            set_potassium(148.00000);
            set_protein(0.43000);
            set_riboflavin(0.03000);
            set_saturated_fat(0.00600);
