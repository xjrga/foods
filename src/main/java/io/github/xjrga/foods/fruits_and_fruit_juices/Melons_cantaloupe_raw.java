 ...
 */
public class Melons_cantaloupe_raw implements Food {

    private final Melons_cantaloupe_raw_mutable food;

    public Melons_cantaloupe_raw() {
        food = new Melons_cantaloupe_raw_mutable();
    }
    ...
    private class Melons_cantaloupe_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Melons_cantaloupe_raw_mutable() {
            set_food_name("Melons, cantaloupe, raw");
            set_food_label("melons_cantaloupe_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(8.16000);
            ...
            set_sodium(16.00000);
            set_thiamin(0.04000);
            set_vitamin_a(169.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.07000);
            set_vitamin_c(36.70000);
