 ...
 */
public class Prune_puree implements Food {

    private final Prune_puree_mutable food;

    public Prune_puree() {
        food = new Prune_puree_mutable();
    }
    ...
    private class Prune_puree_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Prune_puree_mutable() {
            set_food_name("Prune puree");
            set_food_label("prune_puree");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(31.00000);
            set_carbohydrate_by_difference(65.10000);
