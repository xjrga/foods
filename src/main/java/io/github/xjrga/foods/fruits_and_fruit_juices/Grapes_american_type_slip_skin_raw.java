 ...
 */
public class Grapes_american_type_slip_skin_raw implements Food {

    private final Grapes_american_type_slip_skin_raw_mutable food;

    public Grapes_american_type_slip_skin_raw() {
        food = new Grapes_american_type_slip_skin_raw_mutable();
    }
    ...
    private class Grapes_american_type_slip_skin_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Grapes_american_type_slip_skin_raw_mutable() {
            ...
            set_carbohydrate_by_difference(17.15000);
