 ...
 */
public class Pears_raw implements Food {

    private final Pears_raw_mutable food;

    public Pears_raw() {
        food = new Pears_raw_mutable();
    }
    ...
    private class Pears_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Pears_raw_mutable() {
            set_food_name("Pears, raw");
            set_food_label("pears_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(15.23000);
            ...
            set_vitamin_c(4.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.12000);
            set_vitamin_k(4.40000);
            set_water(83.96000);
