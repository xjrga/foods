 ...
 */
public class Watermelon_raw implements Food {

    private final Watermelon_raw_mutable food;

    public Watermelon_raw() {
        food = new Watermelon_raw_mutable();
    }
    ...
    private class Watermelon_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Watermelon_raw_mutable() {
            set_food_name("Watermelon, raw");
            set_food_label("watermelon_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(7.00000);
            set_carbohydrate_by_difference(7.55000);
            ...
            set_fat(0.15000);
            set_fiber(0.40000);
            set_fluoride(1.50000);
            set_folate(3.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(30.00000);
            set_iron(0.24000);
