 ...
 */
public class Bananas_raw implements Food {

    private final Bananas_raw_mutable food;

    public Bananas_raw() {
        food = new Bananas_raw_mutable();
    }
    ...
    private class Bananas_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bananas_raw_mutable() {
            set_food_name("Bananas, raw");
            set_food_label("bananas_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(5.00000);
            set_carbohydrate_by_difference(22.84000);
            ...
            set_phosphorus(22.00000);
            set_polyunsaturated_fat(0.07000);
            set_potassium(358.00000);
            set_protein(1.09000);
