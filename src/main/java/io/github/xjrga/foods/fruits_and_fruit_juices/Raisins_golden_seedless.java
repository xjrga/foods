 ...
 */
public class Raisins_golden_seedless implements Food {

    private final Raisins_golden_seedless_mutable food;

    public Raisins_golden_seedless() {
        food = new Raisins_golden_seedless_mutable();
    }
    ...
    private class Raisins_golden_seedless_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Raisins_golden_seedless_mutable() {
            set_food_name("Raisins, golden seedless");
            set_food_label("raisins_golden_seedless");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(53.00000);
            set_carbohydrate_by_difference(79.52000);
            set_cholesterol(0.00000);
            set_choline(11.10000);
