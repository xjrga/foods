 ...
 */
public class Papayas_raw implements Food {

    private final Papayas_raw_mutable food;

    public Papayas_raw() {
        food = new Papayas_raw_mutable();
    }
    ...
    private class Papayas_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Papayas_raw_mutable() {
            set_food_name("Papayas, raw");
            set_food_label("papayas_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(20.00000);
            set_carbohydrate_by_difference(10.82000);
