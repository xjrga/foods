 ...
 */
public class Olives_ripe_canned_small_extra_large implements Food {

    private final Olives_ripe_canned_small_extra_large_mutable food;

    public Olives_ripe_canned_small_extra_large() {
        food = new Olives_ripe_canned_small_extra_large_mutable();
    }
    ...
    private class Olives_ripe_canned_small_extra_large_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Olives_ripe_canned_small_extra_large_mutable() {
            ...
            set_calcium(88.00000);
            set_carbohydrate_by_difference(6.26000);
            set_cholesterol(0.00000);
            set_choline(10.30000);
            ...
            set_gross_energy(115.00000);
            set_iron(3.30000);
            set_linoleic_acid(0.00000);
            set_magnesium(4.00000);
            set_manganese(0.02000);
            set_monounsaturated_fat(7.88000);
            set_niacin(0.03000);
            set_pantothenic_acid(0.01000);
            set_phosphorus(3.00000);
            set_polyunsaturated_fat(0.91000);
            set_potassium(8.00000);
            set_protein(0.84000);
            set_riboflavin(0.00000);
            set_saturated_fat(1.41000);
            set_selenium(0.90000);
            set_sodium(735.00000);
            set_thiamin(0.00300);
            set_vitamin_a(20.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.00900);
            set_vitamin_c(0.90000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.65000);
