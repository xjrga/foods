 ...
 */
public class Figs_dried_stewed implements Food {

    private final Figs_dried_stewed_mutable food;

    public Figs_dried_stewed() {
        food = new Figs_dried_stewed_mutable();
    }
    ...
    private class Figs_dried_stewed_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Figs_dried_stewed_mutable() {
            ...
            set_vitamin_c(4.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.15000);
            set_vitamin_k(6.70000);
            set_water(69.80000);
