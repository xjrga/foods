 ...
 */
public class Olives_ripe_canned_jumbo_super_colossal implements Food {

    private final Olives_ripe_canned_jumbo_super_colossal_mutable food;

    public Olives_ripe_canned_jumbo_super_colossal() {
        food = new Olives_ripe_canned_jumbo_super_colossal_mutable();
    }
    ...
    private class Olives_ripe_canned_jumbo_super_colossal_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Olives_ripe_canned_jumbo_super_colossal_mutable() {
            ...
            set_calcium(94.00000);
            set_carbohydrate_by_difference(5.61000);
            ...
            set_monounsaturated_fat(5.07000);
            set_niacin(0.02000);
