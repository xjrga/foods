 ...
 */
public class Avocados_raw_all_commercial_varieties implements Food {

    private final Avocados_raw_all_commercial_varieties_mutable food;

    public Avocados_raw_all_commercial_varieties() {
        food = new Avocados_raw_all_commercial_varieties_mutable();
    }
    ...
    private class Avocados_raw_all_commercial_varieties_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Avocados_raw_all_commercial_varieties_mutable() {
            set_food_name("Avocados, raw, all commercial varieties");
            set_food_label("avocados_raw_all_commercial_varieties");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.11000);
            set_calcium(12.00000);
            set_carbohydrate_by_difference(8.53000);
            set_cholesterol(0.00000);
            set_choline(14.20000);
            ...
            set_fat(14.66000);
            set_fiber(6.70000);
            set_fluoride(7.00000);
            set_folate(81.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(160.00000);
            set_iron(0.55000);
            set_linoleic_acid(0.00000);
            set_magnesium(29.00000);
            set_manganese(0.14000);
            set_monounsaturated_fat(9.79000);
            set_niacin(1.73000);
            set_pantothenic_acid(1.38000);
            set_phosphorus(52.00000);
            set_polyunsaturated_fat(1.81000);
            set_potassium(485.00000);
            set_protein(2.00000);
            set_riboflavin(0.13000);
            set_saturated_fat(2.12000);
            ...
            set_vitamin_c(10.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.07000);
            set_vitamin_k(21.00000);
            set_water(73.23000);
