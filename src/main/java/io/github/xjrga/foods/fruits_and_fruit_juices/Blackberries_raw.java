 ...
 */
public class Blackberries_raw implements Food {

    private final Blackberries_raw_mutable food;

    public Blackberries_raw() {
        food = new Blackberries_raw_mutable();
    }
    ...
    private class Blackberries_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Blackberries_raw_mutable() {
            set_food_name("Blackberries, raw");
            set_food_label("blackberries_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(29.00000);
            set_carbohydrate_by_difference(9.61000);
