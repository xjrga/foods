 ...
 */
public class Blueberries_frozen_unsweetened implements Food {

    private final Blueberries_frozen_unsweetened_mutable food;

    public Blueberries_frozen_unsweetened() {
        food = new Blueberries_frozen_unsweetened_mutable();
    }
    ...
    private class Blueberries_frozen_unsweetened_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Blueberries_frozen_unsweetened_mutable() {
            ...
            set_calcium(8.00000);
            set_carbohydrate_by_difference(12.17000);
