 ...
 */
public class Fruit_cocktail_canned_heavy_syrup_drained implements Food {

    private final Fruit_cocktail_canned_heavy_syrup_drained_mutable food;

    public Fruit_cocktail_canned_heavy_syrup_drained() {
        food = new Fruit_cocktail_canned_heavy_syrup_drained_mutable();
    }
    ...
    private class Fruit_cocktail_canned_heavy_syrup_drained_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fruit_cocktail_canned_heavy_syrup_drained_mutable() {
            ...
            set_calcium(7.00000);
            set_carbohydrate_by_difference(18.80000);
