 ...
 */
public class Pomegranate_juice_bottled implements Food {

    private final Pomegranate_juice_bottled_mutable food;

    public Pomegranate_juice_bottled() {
        food = new Pomegranate_juice_bottled_mutable();
    }
    ...
    private class Pomegranate_juice_bottled_mutable extends Abstract_food {
         ...
         */
        public Pomegranate_juice_bottled_mutable() {
            ...
            set_carbohydrate_by_difference(13.13000);
