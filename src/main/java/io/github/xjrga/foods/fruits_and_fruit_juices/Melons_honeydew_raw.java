 ...
 */
public class Melons_honeydew_raw implements Food {

    private final Melons_honeydew_raw_mutable food;

    public Melons_honeydew_raw() {
        food = new Melons_honeydew_raw_mutable();
    }
    ...
    private class Melons_honeydew_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Melons_honeydew_raw_mutable() {
            set_food_name("Melons, honeydew, raw");
            set_food_label("melons_honeydew_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(9.09000);
