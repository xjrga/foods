 ...
 */
public class Lemon_juice_raw implements Food {

    private final Lemon_juice_raw_mutable food;

    public Lemon_juice_raw() {
        food = new Lemon_juice_raw_mutable();
    }
    ...
    private class Lemon_juice_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Lemon_juice_raw_mutable() {
            set_food_name("Lemon juice, raw");
            set_food_label("lemon_juice_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00900);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(6.90000);
