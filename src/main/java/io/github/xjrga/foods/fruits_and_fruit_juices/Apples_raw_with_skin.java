 ...
 */
public class Apples_raw_with_skin implements Food {

    private final Apples_raw_with_skin_mutable food;

    public Apples_raw_with_skin() {
        food = new Apples_raw_with_skin_mutable();
    }
