 ...
 */
public class Raspberries_raw implements Food {

    private final Raspberries_raw_mutable food;

    public Raspberries_raw() {
        food = new Raspberries_raw_mutable();
    }
    ...
    private class Raspberries_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Raspberries_raw_mutable() {
            set_food_name("Raspberries, raw");
            set_food_label("raspberries_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(25.00000);
            set_carbohydrate_by_difference(11.94000);
            ...
            set_vitamin_c(26.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.87000);
            set_vitamin_k(7.80000);
            set_water(85.75000);
