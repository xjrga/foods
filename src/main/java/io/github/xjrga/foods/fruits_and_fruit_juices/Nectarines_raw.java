 ...
 */
public class Nectarines_raw implements Food {

    private final Nectarines_raw_mutable food;

    public Nectarines_raw() {
        food = new Nectarines_raw_mutable();
    }
    ...
    private class Nectarines_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Nectarines_raw_mutable() {
            set_food_name("Nectarines, raw");
            set_food_label("nectarines_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(10.55000);
            ...
            set_vitamin_c(5.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.77000);
