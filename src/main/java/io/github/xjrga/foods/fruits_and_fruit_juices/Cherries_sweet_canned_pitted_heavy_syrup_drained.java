 ...
 */
public class Cherries_sweet_canned_pitted_heavy_syrup_drained implements Food {

    private final Cherries_sweet_canned_pitted_heavy_syrup_drained_mutable food;

    public Cherries_sweet_canned_pitted_heavy_syrup_drained() {
        food = new Cherries_sweet_canned_pitted_heavy_syrup_drained_mutable();
    }
    ...
    private class Cherries_sweet_canned_pitted_heavy_syrup_drained_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Cherries_sweet_canned_pitted_heavy_syrup_drained_mutable() {
            ...
            set_carbohydrate_by_difference(21.07000);
