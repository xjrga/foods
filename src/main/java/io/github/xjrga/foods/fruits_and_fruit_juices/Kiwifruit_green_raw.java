 ...
 */
public class Kiwifruit_green_raw implements Food {

    private final Kiwifruit_green_raw_mutable food;

    public Kiwifruit_green_raw() {
        food = new Kiwifruit_green_raw_mutable();
    }
    ...
    private class Kiwifruit_green_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Kiwifruit_green_raw_mutable() {
            set_food_name("Kiwifruit, green, raw");
            set_food_label("kiwifruit_green_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(34.00000);
            set_carbohydrate_by_difference(14.66000);
            ...
            set_phosphorus(34.00000);
            set_polyunsaturated_fat(0.28000);
            set_potassium(312.00000);
            set_protein(1.14000);
            ...
            set_vitamin_c(92.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.46000);
            set_vitamin_k(40.30000);
            set_water(83.07000);
