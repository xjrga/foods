 ...
 */
public class Tangerines_mandarin_oranges_raw implements Food {

    private final Tangerines_mandarin_oranges_raw_mutable food;

    public Tangerines_mandarin_oranges_raw() {
        food = new Tangerines_mandarin_oranges_raw_mutable();
    }
    ...
    private class Tangerines_mandarin_oranges_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Tangerines_mandarin_oranges_raw_mutable() {
            ...
            set_carbohydrate_by_difference(13.34000);
            set_cholesterol(0.00000);
            set_choline(10.20000);
            ...
            set_vitamin_c(26.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.20000);
