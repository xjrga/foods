 ...
 */
public class Pears_asian_raw implements Food {

    private final Pears_asian_raw_mutable food;

    public Pears_asian_raw() {
        food = new Pears_asian_raw_mutable();
    }
    ...
    private class Pears_asian_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Pears_asian_raw_mutable() {
            set_food_name("Pears, asian, raw");
            set_food_label("pears_asian_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(4.00000);
            set_carbohydrate_by_difference(10.65000);
