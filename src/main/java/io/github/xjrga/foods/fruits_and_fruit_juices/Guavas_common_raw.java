 ...
 */
public class Guavas_common_raw implements Food {

    private final Guavas_common_raw_mutable food;

    public Guavas_common_raw() {
        food = new Guavas_common_raw_mutable();
    }
    ...
    private class Guavas_common_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Guavas_common_raw_mutable() {
            set_food_name("Guavas, common, raw");
            set_food_label("guavas_common_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(18.00000);
            set_carbohydrate_by_difference(14.32000);
