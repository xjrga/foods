 ...
 */
public class Limes_raw implements Food {

    private final Limes_raw_mutable food;

    public Limes_raw() {
        food = new Limes_raw_mutable();
    }
    ...
    private class Limes_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Limes_raw_mutable() {
            set_food_name("Limes, raw");
            set_food_label("limes_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(33.00000);
            set_carbohydrate_by_difference(10.54000);
