 ...
 */
public class Blueberries_raw implements Food {

    private final Blueberries_raw_mutable food;

    public Blueberries_raw() {
        food = new Blueberries_raw_mutable();
    }
    ...
    private class Blueberries_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Blueberries_raw_mutable() {
            set_food_name("Blueberries, raw");
            set_food_label("blueberries_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(14.49000);
            ...
            set_vitamin_c(9.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.57000);
            set_vitamin_k(19.30000);
            set_water(84.21000);
