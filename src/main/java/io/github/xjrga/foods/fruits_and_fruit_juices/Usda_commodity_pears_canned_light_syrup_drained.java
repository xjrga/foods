 ...
 */
public class Usda_commodity_pears_canned_light_syrup_drained implements Food {

    private final Usda_commodity_pears_canned_light_syrup_drained_mutable food;

    public Usda_commodity_pears_canned_light_syrup_drained() {
        food = new Usda_commodity_pears_canned_light_syrup_drained_mutable();
    }
    ...
    private class Usda_commodity_pears_canned_light_syrup_drained_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Usda_commodity_pears_canned_light_syrup_drained_mutable() {
            ...
            set_calcium(5.00000);
            set_carbohydrate_by_difference(16.21000);
            ...
            set_phosphorus(7.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(61.00000);
            set_protein(0.28000);
