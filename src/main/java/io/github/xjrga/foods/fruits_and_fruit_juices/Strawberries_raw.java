 ...
 */
public class Strawberries_raw implements Food {

    private final Strawberries_raw_mutable food;

    public Strawberries_raw() {
        food = new Strawberries_raw_mutable();
    }
    ...
    private class Strawberries_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Strawberries_raw_mutable() {
