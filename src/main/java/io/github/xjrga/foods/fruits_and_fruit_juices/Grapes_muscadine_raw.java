 ...
 */
public class Grapes_muscadine_raw implements Food {

    private final Grapes_muscadine_raw_mutable food;

    public Grapes_muscadine_raw() {
        food = new Grapes_muscadine_raw_mutable();
    }
    ...
    private class Grapes_muscadine_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Grapes_muscadine_raw_mutable() {
            ...
            set_carbohydrate_by_difference(13.93000);
