 ...
 */
public class Lime_juice_raw implements Food {

    private final Lime_juice_raw_mutable food;

    public Lime_juice_raw() {
        food = new Lime_juice_raw_mutable();
    }
    ...
    private class Lime_juice_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Lime_juice_raw_mutable() {
            set_food_name("Lime juice, raw");
            set_food_label("lime_juice_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(14.00000);
            set_carbohydrate_by_difference(8.42000);
