 ...
 */
public class Grapefruit_juice_pink_raw implements Food {

    private final Grapefruit_juice_pink_raw_mutable food;

    public Grapefruit_juice_pink_raw() {
        food = new Grapefruit_juice_pink_raw_mutable();
    }
    ...
    private class Grapefruit_juice_pink_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Grapefruit_juice_pink_raw_mutable() {
            set_food_name("Grapefruit juice, pink, raw");
            set_food_label("grapefruit_juice_pink_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(9.20000);
