 ...
 */
public class Pomegranates_raw implements Food {

    private final Pomegranates_raw_mutable food;

    public Pomegranates_raw() {
        food = new Pomegranates_raw_mutable();
    }
    ...
    private class Pomegranates_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Pomegranates_raw_mutable() {
            ...
            set_phosphorus(36.00000);
            set_polyunsaturated_fat(0.07000);
            set_potassium(236.00000);
            set_protein(1.67000);
            ...
            set_vitamin_c(10.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.60000);
