 ...
 */
public class Guavas_strawberry_raw implements Food {

    private final Guavas_strawberry_raw_mutable food;

    public Guavas_strawberry_raw() {
        food = new Guavas_strawberry_raw_mutable();
    }
    ...
    private class Guavas_strawberry_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Guavas_strawberry_raw_mutable() {
            ...
            set_carbohydrate_by_difference(17.36000);
