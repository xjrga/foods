 ...
 */
public class Pineapple_raw_all_varieties implements Food {

    private final Pineapple_raw_all_varieties_mutable food;

    public Pineapple_raw_all_varieties() {
        food = new Pineapple_raw_all_varieties_mutable();
    }
    ...
    private class Pineapple_raw_all_varieties_mutable extends Food_abstract {
         ...
         */
        public Pineapple_raw_all_varieties_mutable() {
            ...
            set_carbohydrate_by_difference(13.12000);
