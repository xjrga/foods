 ...
 */
public class Cherries_sweet_raw implements Food {

    private final Cherries_sweet_raw_mutable food;

    public Cherries_sweet_raw() {
        food = new Cherries_sweet_raw_mutable();
    }
    ...
    private class Cherries_sweet_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cherries_sweet_raw_mutable() {
            set_food_name("Cherries, sweet, raw");
            set_food_label("cherries_sweet_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(13.00000);
            set_carbohydrate_by_difference(16.01000);
