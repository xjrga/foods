 ...
 */
public class Usda_commodity_peaches_canned_light_syrup_drained implements Food {

    private final Usda_commodity_peaches_canned_light_syrup_drained_mutable food;

    public Usda_commodity_peaches_canned_light_syrup_drained() {
        food = new Usda_commodity_peaches_canned_light_syrup_drained_mutable();
    }
    ...
    private class Usda_commodity_peaches_canned_light_syrup_drained_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Usda_commodity_peaches_canned_light_syrup_drained_mutable() {
            ...
            set_calcium(3.00000);
            set_carbohydrate_by_difference(15.65000);
            ...
            set_phosphorus(10.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(87.00000);
            set_protein(0.56000);
