 ...
 */
public class Apricots_canned_heavy_syrup_drained implements Food {

    private final Apricots_canned_heavy_syrup_drained_mutable food;

    public Apricots_canned_heavy_syrup_drained() {
        food = new Apricots_canned_heavy_syrup_drained_mutable();
    }
    ...
    private class Apricots_canned_heavy_syrup_drained_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Apricots_canned_heavy_syrup_drained_mutable() {
            ...
            set_carbohydrate_by_difference(21.31000);
            ...
            set_potassium(143.00000);
            set_protein(0.64000);
            set_riboflavin(0.02000);
            set_saturated_fat(0.00700);
            set_selenium(0.10000);
            set_sodium(4.00000);
            set_thiamin(0.02000);
            set_vitamin_a(146.00000);
