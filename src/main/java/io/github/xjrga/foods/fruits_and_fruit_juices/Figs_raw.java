 ...
 */
public class Figs_raw implements Food {

    private final Figs_raw_mutable food;

    public Figs_raw() {
        food = new Figs_raw_mutable();
    }
    ...
    private class Figs_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Figs_raw_mutable() {
            set_food_name("Figs, raw");
            set_food_label("figs_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(35.00000);
            set_carbohydrate_by_difference(19.18000);
            ...
            set_vitamin_c(2.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.11000);
            set_vitamin_k(4.70000);
            set_water(79.11000);
