 ...
 */
public class Apricots_raw implements Food {

    private final Apricots_raw_mutable food;

    public Apricots_raw() {
        food = new Apricots_raw_mutable();
    }
    ...
    private class Apricots_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Apricots_raw_mutable() {
            set_food_name("Apricots, raw");
            set_food_label("apricots_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(13.00000);
            set_carbohydrate_by_difference(11.12000);
