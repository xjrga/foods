 ...
 */
public class Fish_salmon_atlantic_farmed_cooked_dry_heat implements Food {

    private final Fish_salmon_atlantic_farmed_cooked_dry_heat_mutable food;

    public Fish_salmon_atlantic_farmed_cooked_dry_heat() {
        food = new Fish_salmon_atlantic_farmed_cooked_dry_heat_mutable();
    }
    ...
    private class Fish_salmon_atlantic_farmed_cooked_dry_heat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_salmon_atlantic_farmed_cooked_dry_heat_mutable() {
            ...
            set_calcium(15.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(63.00000);
            set_choline(90.50000);
            set_complete_protein(22.10000);
            set_copper(0.04000);
            set_cost(0.00000);
            set_dha(1.45000);
            set_epa(0.69000);
            ...
            set_gross_energy(206.00000);
            set_iron(0.34000);
            set_linoleic_acid(0.00000);
            set_magnesium(30.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(4.18000);
            set_niacin(8.04000);
            set_pantothenic_acid(1.47000);
            set_phosphorus(252.00000);
            set_polyunsaturated_fat(4.55000);
            set_potassium(384.00000);
            set_protein(22.10000);
            set_riboflavin(0.13000);
            set_saturated_fat(2.39000);
            set_selenium(41.40000);
            set_sodium(61.00000);
            set_thiamin(0.34000);
            set_vitamin_a(69.00000);
            set_vitamin_b12(2.80000);
            set_vitamin_b6(0.64000);
            set_vitamin_c(3.70000);
            set_vitamin_d(13.10000);
            set_vitamin_e(1.14000);
