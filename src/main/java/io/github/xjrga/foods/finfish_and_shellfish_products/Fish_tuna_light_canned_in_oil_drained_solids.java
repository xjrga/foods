 ...
 */
public class Fish_tuna_light_canned_in_oil_drained_solids implements Food {

    private final Fish_tuna_light_canned_in_oil_drained_solids_mutable food;

    public Fish_tuna_light_canned_in_oil_drained_solids() {
        food = new Fish_tuna_light_canned_in_oil_drained_solids_mutable();
    }
    ...
    private class Fish_tuna_light_canned_in_oil_drained_solids_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_tuna_light_canned_in_oil_drained_solids_mutable() {
            ...
            set_fat(8.21000);
            set_fiber(0.00000);
            set_fluoride(31.00000);
            set_folate(5.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(198.00000);
            set_iron(1.39000);
            set_linoleic_acid(0.00000);
            set_magnesium(31.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(2.94000);
            set_niacin(12.40000);
            set_pantothenic_acid(0.37000);
            set_phosphorus(311.00000);
            set_polyunsaturated_fat(2.88000);
            set_potassium(207.00000);
            set_protein(29.13000);
            set_riboflavin(0.12000);
            set_saturated_fat(1.53000);
            set_selenium(76.00000);
            set_sodium(416.00000);
            set_thiamin(0.03000);
            set_vitamin_a(23.00000);
            set_vitamin_b12(2.20000);
            set_vitamin_b6(0.11000);
            set_vitamin_c(0.00000);
            set_vitamin_d(6.70000);
            set_vitamin_e(0.87000);
            set_vitamin_k(44.00000);
            set_water(59.83000);
