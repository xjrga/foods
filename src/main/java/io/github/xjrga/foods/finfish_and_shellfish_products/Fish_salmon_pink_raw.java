 ...
 */
public class Fish_salmon_pink_raw implements Food {

    private final Fish_salmon_pink_raw_mutable food;

    public Fish_salmon_pink_raw() {
        food = new Fish_salmon_pink_raw_mutable();
    }
    ...
    private class Fish_salmon_pink_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_salmon_pink_raw_mutable() {
            ...
            set_cholesterol(46.00000);
            set_choline(94.60000);
            set_complete_protein(20.50000);
            set_copper(0.06000);
            set_cost(0.00000);
            set_dha(0.33000);
            set_epa(0.18000);
            ...
            set_monounsaturated_fat(1.34000);
            set_niacin(7.99000);
            set_pantothenic_acid(1.03000);
            set_phosphorus(261.00000);
            set_polyunsaturated_fat(0.81000);
            set_potassium(366.00000);
            set_protein(20.50000);
            set_riboflavin(0.10000);
            set_saturated_fat(0.81000);
            set_selenium(31.40000);
            set_sodium(75.00000);
            set_thiamin(0.08000);
            set_vitamin_a(35.00000);
            set_vitamin_b12(4.15000);
            set_vitamin_b6(0.61000);
            set_vitamin_c(0.00000);
            set_vitamin_d(10.90000);
