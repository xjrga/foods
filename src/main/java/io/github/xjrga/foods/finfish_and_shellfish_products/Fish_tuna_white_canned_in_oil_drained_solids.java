 ...
 */
public class Fish_tuna_white_canned_in_oil_drained_solids implements Food {

    private final Fish_tuna_white_canned_in_oil_drained_solids_mutable food;

    public Fish_tuna_white_canned_in_oil_drained_solids() {
        food = new Fish_tuna_white_canned_in_oil_drained_solids_mutable();
    }
    ...
    private class Fish_tuna_white_canned_in_oil_drained_solids_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_tuna_white_canned_in_oil_drained_solids_mutable() {
            ...
            set_cholesterol(31.00000);
            set_choline(0.00000);
            set_complete_protein(26.53000);
            set_copper(0.13000);
            set_cost(0.00000);
            set_dha(0.17000);
            set_epa(0.06000);
