 ...
 */
public class Crustaceans_shrimp_raw_not_previously_frozen implements Food {

    private final Crustaceans_shrimp_raw_not_previously_frozen_mutable food;

    public Crustaceans_shrimp_raw_not_previously_frozen() {
        food = new Crustaceans_shrimp_raw_not_previously_frozen_mutable();
    }
    ...
    private class Crustaceans_shrimp_raw_not_previously_frozen_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Crustaceans_shrimp_raw_not_previously_frozen_mutable() {
            ...
            set_calcium(64.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(161.00000);
            set_choline(0.00000);
            set_complete_protein(20.10000);
            set_copper(0.39000);
            set_cost(0.00000);
            set_dha(0.03000);
            set_epa(0.03000);
