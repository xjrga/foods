 ...
 */
public class Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone implements Food {

    private final Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone_mutable food;

    public Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone() {
        food = new Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone_mutable();
    }
    ...
    private class Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_sardine_atlantic_canned_in_oil_drained_solids_with_bone_mutable() {
            ...
            set_calcium(382.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(142.00000);
            set_choline(75.00000);
            set_complete_protein(24.62000);
            set_copper(0.18000);
            set_cost(0.00000);
            set_dha(0.50000);
            set_epa(0.47000);
            ...
            set_gross_energy(208.00000);
            set_iron(2.92000);
            set_linoleic_acid(0.00000);
            set_magnesium(39.00000);
            set_manganese(0.10000);
            set_monounsaturated_fat(3.86000);
            set_niacin(5.24000);
            set_pantothenic_acid(0.64000);
            set_phosphorus(490.00000);
            set_polyunsaturated_fat(5.14000);
            set_potassium(397.00000);
            set_protein(24.62000);
            set_riboflavin(0.22000);
            set_saturated_fat(1.52000);
            set_selenium(52.70000);
            set_sodium(307.00000);
            set_thiamin(0.08000);
            set_vitamin_a(32.00000);
            set_vitamin_b12(8.94000);
            set_vitamin_b6(0.16000);
            set_vitamin_c(0.00000);
            set_vitamin_d(4.80000);
            set_vitamin_e(2.04000);
            set_vitamin_k(2.60000);
            set_water(59.61000);
