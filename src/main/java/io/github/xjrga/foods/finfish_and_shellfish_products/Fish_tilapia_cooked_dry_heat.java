 ...
 */
public class Fish_tilapia_cooked_dry_heat implements Food {

    private final Fish_tilapia_cooked_dry_heat_mutable food;

    public Fish_tilapia_cooked_dry_heat() {
        food = new Fish_tilapia_cooked_dry_heat_mutable();
    }
    ...
    private class Fish_tilapia_cooked_dry_heat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_tilapia_cooked_dry_heat_mutable() {
            set_food_name("Fish, tilapia, cooked, dry heat");
            set_food_label("fish_tilapia_cooked_dry_heat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.04000);
            set_calcium(14.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(57.00000);
            set_choline(51.30000);
            set_complete_protein(26.15000);
            set_copper(0.07000);
            set_cost(0.00000);
            set_dha(0.13000);
            set_epa(0.00500);
            ...
            set_monounsaturated_fat(0.95000);
            set_niacin(4.74000);
            set_pantothenic_acid(0.66000);
            set_phosphorus(204.00000);
            set_polyunsaturated_fat(0.60000);
            set_potassium(380.00000);
            set_protein(26.15000);
            set_riboflavin(0.07000);
            set_saturated_fat(0.94000);
            set_selenium(54.40000);
            set_sodium(56.00000);
            set_thiamin(0.09000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(1.86000);
            set_vitamin_b6(0.12000);
            set_vitamin_c(0.00000);
            set_vitamin_d(3.70000);
            set_vitamin_e(0.79000);
            set_vitamin_k(0.90000);
            set_water(71.59000);
