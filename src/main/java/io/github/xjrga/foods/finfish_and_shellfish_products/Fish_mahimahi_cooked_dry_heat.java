 ...
 */
public class Fish_mahimahi_cooked_dry_heat implements Food {

    private final Fish_mahimahi_cooked_dry_heat_mutable food;

    public Fish_mahimahi_cooked_dry_heat() {
        food = new Fish_mahimahi_cooked_dry_heat_mutable();
    }
    ...
    private class Fish_mahimahi_cooked_dry_heat_mutable extends Abstract_food {
         ...
         */
        public Fish_mahimahi_cooked_dry_heat_mutable() {
            ...
            set_cholesterol(94.00000);
            set_choline(0.00000);
            set_complete_protein(23.72000);
            set_copper(0.05000);
            set_cost(0.00000);
            set_dha(0.11000);
            set_epa(0.02000);
            ...
            set_magnesium(38.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.15000);
            set_niacin(7.42000);
            set_pantothenic_acid(0.86000);
            set_phosphorus(183.00000);
            set_polyunsaturated_fat(0.21000);
            set_potassium(533.00000);
            set_protein(23.72000);
            set_riboflavin(0.08000);
            set_saturated_fat(0.24000);
            set_selenium(46.80000);
            set_sodium(113.00000);
            set_thiamin(0.02000);
            set_vitamin_a(62.00000);
            set_vitamin_b12(0.69000);
