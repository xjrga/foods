 ...
 */
public class Fish_mahimahi_raw implements Food {

    private final Fish_mahimahi_raw_mutable food;

    public Fish_mahimahi_raw() {
        food = new Fish_mahimahi_raw_mutable();
    }
    ...
    private class Fish_mahimahi_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_mahimahi_raw_mutable() {
            ...
            set_phosphorus(143.00000);
            set_polyunsaturated_fat(0.16000);
            set_potassium(416.00000);
            set_protein(18.50000);
            set_riboflavin(0.07000);
            set_saturated_fat(0.18000);
            set_selenium(36.50000);
            set_sodium(88.00000);
            set_thiamin(0.02000);
            set_vitamin_a(54.00000);
            set_vitamin_b12(0.60000);
