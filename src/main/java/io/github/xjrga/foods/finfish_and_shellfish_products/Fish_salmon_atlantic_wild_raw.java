 ...
 */
public class Fish_salmon_atlantic_wild_raw implements Food {

    private final Fish_salmon_atlantic_wild_raw_mutable food;

    public Fish_salmon_atlantic_wild_raw() {
        food = new Fish_salmon_atlantic_wild_raw_mutable();
    }
    ...
    private class Fish_salmon_atlantic_wild_raw_mutable extends Food_abstract {
        ...
        public Fish_salmon_atlantic_wild_raw_mutable() {
            ...
            set_gross_energy(142.00000);
            set_iron(0.80000);
            set_linoleic_acid(0.00000);
            set_magnesium(29.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(2.10000);
            set_niacin(7.86000);
            set_pantothenic_acid(1.66000);
            set_phosphorus(200.00000);
            set_polyunsaturated_fat(2.53000);
            set_potassium(490.00000);
            set_protein(19.84000);
            set_riboflavin(0.38000);
            set_saturated_fat(0.98000);
            set_selenium(36.50000);
            set_sodium(44.00000);
            set_thiamin(0.22000);
            set_vitamin_a(12.00000);
            set_vitamin_b12(3.18000);
