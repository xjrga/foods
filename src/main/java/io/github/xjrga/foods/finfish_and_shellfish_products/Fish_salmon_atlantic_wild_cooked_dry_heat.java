 ...
 */
public class Fish_salmon_atlantic_wild_cooked_dry_heat implements Food {

    private final Fish_salmon_atlantic_wild_cooked_dry_heat_mutable food;

    public Fish_salmon_atlantic_wild_cooked_dry_heat() {
        food = new Fish_salmon_atlantic_wild_cooked_dry_heat_mutable();
    }
    ...
    private class Fish_salmon_atlantic_wild_cooked_dry_heat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_salmon_atlantic_wild_cooked_dry_heat_mutable() {
            ...
            set_cholesterol(71.00000);
            set_choline(0.00000);
            set_complete_protein(25.44000);
            set_copper(0.32000);
            set_cost(0.00000);
            set_dha(1.42000);
            set_epa(0.41000);
            ...
            set_gross_energy(182.00000);
            set_iron(1.03000);
            set_linoleic_acid(0.00000);
            set_magnesium(37.00000);
            set_manganese(0.02000);
            set_monounsaturated_fat(2.69000);
            set_niacin(10.07000);
            set_pantothenic_acid(1.92000);
            set_phosphorus(256.00000);
            set_polyunsaturated_fat(3.25000);
            set_potassium(628.00000);
            set_protein(25.44000);
            set_riboflavin(0.48000);
            set_saturated_fat(1.25000);
            set_selenium(46.80000);
            set_sodium(56.00000);
            set_thiamin(0.27000);
            set_vitamin_a(13.00000);
            set_vitamin_b12(3.05000);
            set_vitamin_b6(0.94000);
