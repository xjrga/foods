 ...
 */
public class Fish_salmon_atlantic_farmed_raw implements Food {

    private final Fish_salmon_atlantic_farmed_raw_mutable food;

    public Fish_salmon_atlantic_farmed_raw() {
        food = new Fish_salmon_atlantic_farmed_raw_mutable();
    }
    ...
    private class Fish_salmon_atlantic_farmed_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_salmon_atlantic_farmed_raw_mutable() {
            set_food_name("Fish, salmon, Atlantic, farmed, raw");
            set_food_label("fish_salmon_atlantic_farmed_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.14000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(55.00000);
            set_choline(78.50000);
            set_complete_protein(20.42000);
            set_copper(0.04000);
            set_cost(0.00000);
            set_dha(1.10000);
            set_epa(0.86000);
            ...
            set_monounsaturated_fat(3.77000);
            set_niacin(8.67000);
            set_pantothenic_acid(1.54000);
            set_phosphorus(240.00000);
            set_polyunsaturated_fat(3.88000);
            set_potassium(363.00000);
            set_protein(20.42000);
            set_riboflavin(0.15000);
            set_saturated_fat(3.05000);
            set_selenium(24.00000);
            set_sodium(59.00000);
            set_thiamin(0.20000);
            set_vitamin_a(58.00000);
            set_vitamin_b12(3.23000);
            set_vitamin_b6(0.63000);
            set_vitamin_c(3.90000);
            set_vitamin_d(11.00000);
            set_vitamin_e(3.55000);
