 ...
 */
public class Fish_tuna_white_canned_in_water_drained_solids implements Food {

    private final Fish_tuna_white_canned_in_water_drained_solids_mutable food;

    public Fish_tuna_white_canned_in_water_drained_solids() {
        food = new Fish_tuna_white_canned_in_water_drained_solids_mutable();
    }
    ...
    private class Fish_tuna_white_canned_in_water_drained_solids_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_tuna_white_canned_in_water_drained_solids_mutable() {
            ...
            set_cholesterol(42.00000);
            set_choline(29.30000);
            set_complete_protein(23.62000);
            set_copper(0.03000);
            set_cost(0.00000);
            set_dha(0.62000);
            set_epa(0.23000);
            ...
            set_magnesium(33.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.78000);
            set_niacin(5.79000);
            set_pantothenic_acid(0.12000);
            set_phosphorus(217.00000);
            set_polyunsaturated_fat(1.10000);
            set_potassium(237.00000);
            set_protein(23.62000);
            set_riboflavin(0.04000);
            set_saturated_fat(0.79000);
            set_selenium(65.70000);
            set_sodium(377.00000);
            set_thiamin(0.00800);
            set_vitamin_a(6.00000);
            set_vitamin_b12(1.17000);
            set_vitamin_b6(0.21000);
            set_vitamin_c(0.00000);
            set_vitamin_d(2.00000);
            set_vitamin_e(0.85000);
            set_vitamin_k(2.50000);
            set_water(73.19000);
