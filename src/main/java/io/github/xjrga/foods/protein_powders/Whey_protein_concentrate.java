 ...
 */
public class Whey_protein_concentrate implements Food {

    private final Whey_protein_concentrate_mutable food;

    public Whey_protein_concentrate() {
        food = new Whey_protein_concentrate_mutable();
    }
    ...
    private class Whey_protein_concentrate_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Whey_protein_concentrate_mutable() {
            set_food_name("Whey Protein Concentrate");
            set_food_label("whey_protein_concentrate");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(550.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(215.00000);
            set_choline(0.00000);
            set_complete_protein(80.00000);
            set_copper(0.00000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_phosphorus(350.00000);
            set_polyunsaturated_fat(0.70000);
            set_potassium(530.00000);
            set_protein(80.00000);
            set_riboflavin(0.00000);
            set_saturated_fat(2.10000);
            set_selenium(0.00000);
            set_sodium(175.00000);
            set_thiamin(0.00000);
