 ...
 */
public class Oil_wheat_germ implements Food {

    private final Oil_wheat_germ_mutable food;

    public Oil_wheat_germ() {
        food = new Oil_wheat_germ_mutable();
    }
    ...
    private class Oil_wheat_germ_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_wheat_germ_mutable() {
