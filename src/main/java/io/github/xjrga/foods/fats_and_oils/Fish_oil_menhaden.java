 ...
 */
public class Fish_oil_menhaden implements Food {

    private final Fish_oil_menhaden_mutable food;

    public Fish_oil_menhaden() {
        food = new Fish_oil_menhaden_mutable();
    }
    ...
    private class Fish_oil_menhaden_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_oil_menhaden_mutable() {
