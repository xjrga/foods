 ...
 */
public class Oil_soybean_lecithin implements Food {

    private final Oil_soybean_lecithin_mutable food;

    public Oil_soybean_lecithin() {
        food = new Oil_soybean_lecithin_mutable();
    }
    ...
    private class Oil_soybean_lecithin_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_soybean_lecithin_mutable() {
