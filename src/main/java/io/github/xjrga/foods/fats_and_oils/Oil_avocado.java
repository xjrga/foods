 ...
 */
public class Oil_avocado implements Food {

    private final Oil_avocado_mutable food;

    public Oil_avocado() {
        food = new Oil_avocado_mutable();
    }
    ...
    private class Oil_avocado_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_avocado_mutable() {
