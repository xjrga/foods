 ...
 */
public class Oil_corn_and_canola implements Food {

    private final Oil_corn_and_canola_mutable food;

    public Oil_corn_and_canola() {
        food = new Oil_corn_and_canola_mutable();
    }
    ...
    private class Oil_corn_and_canola_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_corn_and_canola_mutable() {
            set_food_name("Oil, corn and canola");
            set_food_label("oil_corn_and_canola");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(5.79000);
            set_calcium(0.00000);
            ...
            set_vitamin_e(14.84000);
            set_vitamin_k(42.20000);
            set_water(0.00000);
