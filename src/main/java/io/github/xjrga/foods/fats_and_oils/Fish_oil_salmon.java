 ...
 */
public class Fish_oil_salmon implements Food {

    private final Fish_oil_salmon_mutable food;

    public Fish_oil_salmon() {
        food = new Fish_oil_salmon_mutable();
    }
    ...
    private class Fish_oil_salmon_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_oil_salmon_mutable() {
