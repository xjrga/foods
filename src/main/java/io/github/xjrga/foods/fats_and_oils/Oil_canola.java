 ...
 */
public class Oil_canola implements Food {

    private final Oil_canola_mutable food;

    public Oil_canola() {
        food = new Oil_canola_mutable();
    }
    ...
    private class Oil_canola_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_canola_mutable() {
            set_food_name("Oil, canola");
            set_food_label("oil_canola");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(9.13000);
            set_calcium(0.00000);
            ...
            set_vitamin_e(17.46000);
            set_vitamin_k(71.30000);
            set_water(0.00000);
