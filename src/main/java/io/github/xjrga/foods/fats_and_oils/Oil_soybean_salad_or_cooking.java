 ...
 */
public class Oil_soybean_salad_or_cooking implements Food {

    private final Oil_soybean_salad_or_cooking_mutable food;

    public Oil_soybean_salad_or_cooking() {
        food = new Oil_soybean_salad_or_cooking_mutable();
    }
    ...
    private class Oil_soybean_salad_or_cooking_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_soybean_salad_or_cooking_mutable() {
            set_food_name("Oil, soybean, salad or cooking");
            set_food_label("oil_soybean_salad_or_cooking");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(6.78000);
            set_calcium(0.00000);
            ...
            set_gross_energy(884.00000);
            set_iron(0.05000);
            set_linoleic_acid(50.41000);
            set_magnesium(0.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(22.78000);
            set_niacin(0.00000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(0.00000);
            set_polyunsaturated_fat(57.74000);
            set_potassium(0.00000);
            set_protein(0.00000);
            set_riboflavin(0.00000);
            set_saturated_fat(15.65000);
            ...
            set_vitamin_e(8.18000);
            set_vitamin_k(183.90000);
            set_water(0.00000);
