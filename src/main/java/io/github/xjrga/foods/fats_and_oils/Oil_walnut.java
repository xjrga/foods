 ...
 */
public class Oil_walnut implements Food {

    private final Oil_walnut_mutable food;

    public Oil_walnut() {
        food = new Oil_walnut_mutable();
    }
    ...
    private class Oil_walnut_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_walnut_mutable() {
