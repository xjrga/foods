 ...
 */
public class Oil_peanut_salad_or_cooking implements Food {

    private final Oil_peanut_salad_or_cooking_mutable food;

    public Oil_peanut_salad_or_cooking() {
        food = new Oil_peanut_salad_or_cooking_mutable();
    }
    ...
    private class Oil_peanut_salad_or_cooking_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_peanut_salad_or_cooking_mutable() {
