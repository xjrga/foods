 ...
 */
public class Oil_almond implements Food {

    private final Oil_almond_mutable food;

    public Oil_almond() {
        food = new Oil_almond_mutable();
    }
    ...
    private class Oil_almond_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_almond_mutable() {
            ...
            set_vitamin_e(39.20000);
            set_vitamin_k(7.00000);
            set_water(0.00000);
