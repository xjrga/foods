 ...
 */
public class Mayonnaise_reduced_fat_with_olive_oil implements Food {

    private final Mayonnaise_reduced_fat_with_olive_oil_mutable food;

    public Mayonnaise_reduced_fat_with_olive_oil() {
        food = new Mayonnaise_reduced_fat_with_olive_oil_mutable();
    }
    ...
    private class Mayonnaise_reduced_fat_with_olive_oil_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Mayonnaise_reduced_fat_with_olive_oil_mutable() {
            ...
            set_gross_energy(361.00000);
            set_iron(0.00000);
            set_linoleic_acid(0.00000);
            set_magnesium(2.00000);
            set_manganese(0.00700);
            set_monounsaturated_fat(29.54000);
            set_niacin(0.01000);
            set_pantothenic_acid(0.05000);
            set_phosphorus(15.00000);
            set_polyunsaturated_fat(4.00000);
            set_potassium(31.00000);
            set_protein(0.37000);
            set_riboflavin(0.00000);
            set_saturated_fat(5.37000);
            set_selenium(2.30000);
            set_sodium(800.00000);
            set_thiamin(0.00800);
            set_vitamin_a(8.00000);
            set_vitamin_b12(0.12000);
            set_vitamin_b6(0.00200);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.19000);
            set_vitamin_k(53.70000);
            set_water(57.58000);
