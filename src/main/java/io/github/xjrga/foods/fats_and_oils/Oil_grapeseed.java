 ...
 */
public class Oil_grapeseed implements Food {

    private final Oil_grapeseed_mutable food;

    public Oil_grapeseed() {
        food = new Oil_grapeseed_mutable();
    }
    ...
    private class Oil_grapeseed_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_grapeseed_mutable() {
