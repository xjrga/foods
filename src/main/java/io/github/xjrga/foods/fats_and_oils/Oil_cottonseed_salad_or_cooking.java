 ...
 */
public class Oil_cottonseed_salad_or_cooking implements Food {

    private final Oil_cottonseed_salad_or_cooking_mutable food;

    public Oil_cottonseed_salad_or_cooking() {
        food = new Oil_cottonseed_salad_or_cooking_mutable();
    }
    ...
    private class Oil_cottonseed_salad_or_cooking_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_cottonseed_salad_or_cooking_mutable() {
            ...
            set_vitamin_e(35.30000);
            set_vitamin_k(24.70000);
            set_water(0.00000);
