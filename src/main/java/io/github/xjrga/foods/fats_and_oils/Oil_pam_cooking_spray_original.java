 ...
 */
public class Oil_pam_cooking_spray_original implements Food {

    private final Oil_pam_cooking_spray_original_mutable food;

    public Oil_pam_cooking_spray_original() {
        food = new Oil_pam_cooking_spray_original_mutable();
    }
    ...
    private class Oil_pam_cooking_spray_original_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_pam_cooking_spray_original_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(20.69000);
