 ...
 */
public class Oil_sesame_salad_or_cooking implements Food {

    private final Oil_sesame_salad_or_cooking_mutable food;

    public Oil_sesame_salad_or_cooking() {
        food = new Oil_sesame_salad_or_cooking_mutable();
    }
    ...
    private class Oil_sesame_salad_or_cooking_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oil_sesame_salad_or_cooking_mutable() {
