 ...
 */
public class Fish_oil_cod_liver implements Food {

    private final Fish_oil_cod_liver_mutable food;

    public Fish_oil_cod_liver() {
        food = new Fish_oil_cod_liver_mutable();
    }
    ...
    private class Fish_oil_cod_liver_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Fish_oil_cod_liver_mutable() {
