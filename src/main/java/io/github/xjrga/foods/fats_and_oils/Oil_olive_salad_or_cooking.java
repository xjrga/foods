 ...
 */
public class Oil_olive_salad_or_cooking implements Food {

    private final Oil_olive_salad_or_cooking_mutable food;

    public Oil_olive_salad_or_cooking() {
        food = new Oil_olive_salad_or_cooking_mutable();
    }
    ...
    private class Oil_olive_salad_or_cooking_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oil_olive_salad_or_cooking_mutable() {
            ...
            set_vitamin_e(14.35000);
            set_vitamin_k(60.20000);
            set_water(0.00000);
