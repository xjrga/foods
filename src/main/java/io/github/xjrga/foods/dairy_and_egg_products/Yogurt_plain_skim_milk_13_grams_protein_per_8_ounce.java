 ...
 */
public class Yogurt_plain_skim_milk_13_grams_protein_per_8_ounce implements Food {

    private final Yogurt_plain_skim_milk_13_grams_protein_per_8_ounce_mutable food;

    public Yogurt_plain_skim_milk_13_grams_protein_per_8_ounce() {
        food = new Yogurt_plain_skim_milk_13_grams_protein_per_8_ounce_mutable();
    }
    ...
    private class Yogurt_plain_skim_milk_13_grams_protein_per_8_ounce_mutable extends Abstract_food {
         ...
         */
        public Yogurt_plain_skim_milk_13_grams_protein_per_8_ounce_mutable() {
            ...
            set_calcium(199.00000);
            set_carbohydrate_by_difference(7.68000);
            set_cholesterol(2.00000);
            set_choline(15.20000);
            set_complete_protein(5.73000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_manganese(0.00500);
            set_monounsaturated_fat(0.04000);
            set_niacin(0.12000);
            set_pantothenic_acid(0.64000);
            set_phosphorus(157.00000);
            set_polyunsaturated_fat(0.00500);
            set_potassium(255.00000);
            set_protein(5.73000);
            set_riboflavin(0.23000);
            set_saturated_fat(0.11000);
            set_selenium(3.60000);
            set_sodium(77.00000);
            set_thiamin(0.04000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(0.61000);
            set_vitamin_b6(0.05000);
            set_vitamin_c(0.90000);
