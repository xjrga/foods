 ...
 */
public class Cheese_mozzarella_nonfat implements Food {

    private final Cheese_mozzarella_nonfat_mutable food;

    public Cheese_mozzarella_nonfat() {
        food = new Cheese_mozzarella_nonfat_mutable();
    }
    ...
    private class Cheese_mozzarella_nonfat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cheese_mozzarella_nonfat_mutable() {
            ...
            set_phosphorus(656.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(106.00000);
            set_protein(31.70000);
            set_riboflavin(0.30000);
            set_saturated_fat(0.00000);
            set_selenium(18.90000);
            set_sodium(743.00000);
            set_thiamin(0.02000);
            set_vitamin_a(127.00000);
            set_vitamin_b12(0.92000);
