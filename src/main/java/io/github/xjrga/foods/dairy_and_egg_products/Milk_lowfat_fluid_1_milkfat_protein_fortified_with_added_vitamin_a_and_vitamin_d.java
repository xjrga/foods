 ...
 */
public class Milk_lowfat_fluid_1_milkfat_protein_fortified_with_added_vitamin_a_and_vitamin_d implements Food {

    private final Milk_lowfat_fluid_1_milkfat_protein_fortified_with_added_vitamin_a_and_vitamin_d_mutable food;

    public Milk_lowfat_fluid_1_milkfat_protein_fortified_with_added_vitamin_a_and_vitamin_d() {
        food = new Milk_lowfat_fluid_1_milkfat_protein_fortified_with_added_vitamin_a_and_vitamin_d_mutable();
    }
    ...
    private class Milk_lowfat_fluid_1_milkfat_protein_fortified_with_added_vitamin_a_and_vitamin_d_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Milk_lowfat_fluid_1_milkfat_protein_fortified_with_added_vitamin_a_and_vitamin_d_mutable() {
            ...
            set_calcium(142.00000);
            set_carbohydrate_by_difference(5.52000);
            set_cholesterol(4.00000);
            set_choline(0.00000);
            set_complete_protein(3.93000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(48.00000);
            set_iron(0.06000);
            set_linoleic_acid(0.00000);
            set_magnesium(16.00000);
            set_manganese(0.00200);
            set_monounsaturated_fat(0.33000);
            set_niacin(0.10000);
            set_pantothenic_acid(0.37000);
            set_phosphorus(111.00000);
            set_polyunsaturated_fat(0.04000);
            set_potassium(180.00000);
            set_protein(3.93000);
            set_riboflavin(0.19000);
            set_saturated_fat(0.72000);
            set_selenium(2.50000);
            set_sodium(58.00000);
            set_thiamin(0.04000);
            set_vitamin_a(61.00000);
            set_vitamin_b12(0.43000);
            set_vitamin_b6(0.05000);
            set_vitamin_c(1.20000);
            set_vitamin_d(1.00000);
