 ...
 */
public class Milk_buttermilk_fluid_cultured_lowfat implements Food {

    private final Milk_buttermilk_fluid_cultured_lowfat_mutable food;

    public Milk_buttermilk_fluid_cultured_lowfat() {
        food = new Milk_buttermilk_fluid_cultured_lowfat_mutable();
    }
    ...
    private class Milk_buttermilk_fluid_cultured_lowfat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_buttermilk_fluid_cultured_lowfat_mutable() {
            ...
            set_calcium(116.00000);
            set_carbohydrate_by_difference(4.79000);
            set_cholesterol(4.00000);
            set_choline(17.70000);
            set_complete_protein(3.31000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(40.00000);
            set_iron(0.05000);
            set_linoleic_acid(0.00000);
            set_magnesium(11.00000);
            set_manganese(0.00200);
            set_monounsaturated_fat(0.25000);
            set_niacin(0.05000);
            set_pantothenic_acid(0.27000);
            set_phosphorus(89.00000);
            set_polyunsaturated_fat(0.03000);
            set_potassium(151.00000);
            set_protein(3.31000);
            set_riboflavin(0.15000);
            set_saturated_fat(0.54000);
            set_selenium(2.00000);
            set_sodium(190.00000);
            set_thiamin(0.03000);
            set_vitamin_a(14.00000);
            set_vitamin_b12(0.22000);
            set_vitamin_b6(0.03000);
            set_vitamin_c(1.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.05000);
