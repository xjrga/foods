 ...
 */
public class Cheese_cottage_lowfat_1_milkfat implements Food {

    private final Cheese_cottage_lowfat_1_milkfat_mutable food;

    public Cheese_cottage_lowfat_1_milkfat() {
        food = new Cheese_cottage_lowfat_1_milkfat_mutable();
    }
    ...
    private class Cheese_cottage_lowfat_1_milkfat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cheese_cottage_lowfat_1_milkfat_mutable() {
            ...
            set_calcium(61.00000);
            set_carbohydrate_by_difference(2.72000);
            set_cholesterol(4.00000);
            set_choline(17.50000);
            set_complete_protein(12.39000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            set_fat(1.02000);
            set_fiber(0.00000);
            set_fluoride(31.60000);
            set_folate(12.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(72.00000);
            set_iron(0.14000);
            set_linoleic_acid(0.00000);
            set_magnesium(5.00000);
            set_manganese(0.00300);
            set_monounsaturated_fat(0.29000);
            set_niacin(0.12000);
            set_pantothenic_acid(0.21000);
            set_phosphorus(134.00000);
            set_polyunsaturated_fat(0.03000);
            set_potassium(86.00000);
            set_protein(12.39000);
            set_riboflavin(0.16000);
            set_saturated_fat(0.64000);
            set_selenium(9.00000);
            set_sodium(406.00000);
            set_thiamin(0.02000);
            set_vitamin_a(11.00000);
