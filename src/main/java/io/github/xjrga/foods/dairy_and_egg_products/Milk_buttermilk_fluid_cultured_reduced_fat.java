 ...
 */
public class Milk_buttermilk_fluid_cultured_reduced_fat implements Food {

    private final Milk_buttermilk_fluid_cultured_reduced_fat_mutable food;

    public Milk_buttermilk_fluid_cultured_reduced_fat() {
        food = new Milk_buttermilk_fluid_cultured_reduced_fat_mutable();
    }
    ...
    private class Milk_buttermilk_fluid_cultured_reduced_fat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_buttermilk_fluid_cultured_reduced_fat_mutable() {
            set_food_name("Milk, buttermilk, fluid, cultured, reduced fat");
            set_food_label("milk_buttermilk_fluid_cultured_reduced_fat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(143.00000);
            set_carbohydrate_by_difference(5.30000);
            set_cholesterol(8.00000);
            set_choline(16.00000);
            set_complete_protein(4.10000);
            set_copper(0.00800);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
