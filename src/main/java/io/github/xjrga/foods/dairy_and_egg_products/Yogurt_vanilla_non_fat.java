 ...
 */
public class Yogurt_vanilla_non_fat implements Food {

    private final Yogurt_vanilla_non_fat_mutable food;

    public Yogurt_vanilla_non_fat() {
        food = new Yogurt_vanilla_non_fat_mutable();
    }
    ...
    private class Yogurt_vanilla_non_fat_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Yogurt_vanilla_non_fat_mutable() {
            set_food_name("Yogurt, vanilla, non-fat");
            set_food_label("yogurt_vanilla_non_fat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(118.00000);
            set_carbohydrate_by_difference(17.04000);
            set_cholesterol(3.00000);
            set_choline(15.60000);
            set_complete_protein(2.94000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_niacin(0.10000);
            set_pantothenic_acid(0.55000);
            set_phosphorus(88.00000);
