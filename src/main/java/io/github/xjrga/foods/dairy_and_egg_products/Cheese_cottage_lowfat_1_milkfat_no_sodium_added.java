 ...
 */
public class Cheese_cottage_lowfat_1_milkfat_no_sodium_added implements Food {

    private final Cheese_cottage_lowfat_1_milkfat_no_sodium_added_mutable food;

    public Cheese_cottage_lowfat_1_milkfat_no_sodium_added() {
        food = new Cheese_cottage_lowfat_1_milkfat_no_sodium_added_mutable();
    }
    ...
    private class Cheese_cottage_lowfat_1_milkfat_no_sodium_added_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Cheese_cottage_lowfat_1_milkfat_no_sodium_added_mutable() {
            ...
            set_carbohydrate_by_difference(2.70000);
            set_cholesterol(4.00000);
            set_choline(17.50000);
            set_complete_protein(12.40000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
