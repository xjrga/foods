 ...
 */
public class Milk_nonfat_fluid_protein_fortified_with_added_vitamin_a_and_vitamin_d_fat_free_and_skim implements Food {

    private final Milk_nonfat_fluid_protein_fortified_with_added_vitamin_a_and_vitamin_d_fat_free_and_skim_mutable food;

    public Milk_nonfat_fluid_protein_fortified_with_added_vitamin_a_and_vitamin_d_fat_free_and_skim() {
        food = new Milk_nonfat_fluid_protein_fortified_with_added_vitamin_a_and_vitamin_d_fat_free_and_skim_mutable();
    }
    ...
    private class Milk_nonfat_fluid_protein_fortified_with_added_vitamin_a_and_vitamin_d_fat_free_and_skim_mutable extends Food_abstract {
         ...
         */
        public Milk_nonfat_fluid_protein_fortified_with_added_vitamin_a_and_vitamin_d_fat_free_and_skim_mutable() {
            ...
            set_carbohydrate_by_difference(5.56000);
            set_cholesterol(2.00000);
            set_choline(0.00000);
            set_complete_protein(3.96000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_phosphorus(112.00000);
            set_polyunsaturated_fat(0.00900);
