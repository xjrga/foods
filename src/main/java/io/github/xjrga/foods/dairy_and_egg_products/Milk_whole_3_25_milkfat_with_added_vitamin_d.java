 ...
 */
public class Milk_whole_3_25_milkfat_with_added_vitamin_d implements Food {

    private final Milk_whole_3_25_milkfat_with_added_vitamin_d_mutable food;

    public Milk_whole_3_25_milkfat_with_added_vitamin_d() {
        food = new Milk_whole_3_25_milkfat_with_added_vitamin_d_mutable();
    }
    ...
    private class Milk_whole_3_25_milkfat_with_added_vitamin_d_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_whole_3_25_milkfat_with_added_vitamin_d_mutable() {
            ...
            set_calcium(113.00000);
            set_carbohydrate_by_difference(4.80000);
            set_cholesterol(10.00000);
            set_choline(14.30000);
            set_complete_protein(3.15000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(61.00000);
            set_iron(0.03000);
            set_linoleic_acid(0.00000);
            set_magnesium(10.00000);
            set_manganese(0.00400);
            set_monounsaturated_fat(0.81000);
            set_niacin(0.08000);
            set_pantothenic_acid(0.37000);
            set_phosphorus(84.00000);
            set_polyunsaturated_fat(0.19000);
            set_potassium(132.00000);
            set_protein(3.15000);
            ...
            set_sodium(43.00000);
            set_thiamin(0.04000);
            set_vitamin_a(46.00000);
            set_vitamin_b12(0.45000);
            set_vitamin_b6(0.03000);
            set_vitamin_c(0.00000);
            set_vitamin_d(1.30000);
            set_vitamin_e(0.07000);
