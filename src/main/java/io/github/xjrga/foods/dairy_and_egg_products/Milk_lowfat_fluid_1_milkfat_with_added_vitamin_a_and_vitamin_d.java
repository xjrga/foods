 ...
 */
public class Milk_lowfat_fluid_1_milkfat_with_added_vitamin_a_and_vitamin_d implements Food {

    private final Milk_lowfat_fluid_1_milkfat_with_added_vitamin_a_and_vitamin_d_mutable food;

    public Milk_lowfat_fluid_1_milkfat_with_added_vitamin_a_and_vitamin_d() {
        food = new Milk_lowfat_fluid_1_milkfat_with_added_vitamin_a_and_vitamin_d_mutable();
    }
    ...
    private class Milk_lowfat_fluid_1_milkfat_with_added_vitamin_a_and_vitamin_d_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Milk_lowfat_fluid_1_milkfat_with_added_vitamin_a_and_vitamin_d_mutable() {
            ...
            set_calcium(125.00000);
            set_carbohydrate_by_difference(4.99000);
            set_cholesterol(5.00000);
            set_choline(17.70000);
            ...
            set_fat(0.97000);
            set_fiber(0.00000);
            set_fluoride(2.60000);
            set_folate(5.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(42.00000);
            set_iron(0.03000);
            set_linoleic_acid(0.02000);
            set_magnesium(11.00000);
            set_manganese(0.00300);
            set_monounsaturated_fat(0.27000);
            set_niacin(0.09000);
            set_pantothenic_acid(0.36000);
            set_phosphorus(95.00000);
            set_polyunsaturated_fat(0.03000);
            set_potassium(150.00000);
            set_protein(3.37000);
            set_riboflavin(0.18000);
            set_saturated_fat(0.63000);
            set_selenium(3.30000);
            set_sodium(44.00000);
            set_thiamin(0.02000);
            set_vitamin_a(58.00000);
            set_vitamin_b12(0.47000);
            set_vitamin_b6(0.03000);
            set_vitamin_c(0.00000);
            set_vitamin_d(1.20000);
            set_vitamin_e(0.01000);
            set_vitamin_k(0.10000);
            set_water(89.92000);
