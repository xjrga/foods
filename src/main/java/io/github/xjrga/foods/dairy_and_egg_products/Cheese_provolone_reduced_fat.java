 ...
 */
public class Cheese_provolone_reduced_fat implements Food {

    private final Cheese_provolone_reduced_fat_mutable food;

    public Cheese_provolone_reduced_fat() {
        food = new Cheese_provolone_reduced_fat_mutable();
    }
    ...
    private class Cheese_provolone_reduced_fat_mutable extends Abstract_food {
         ...
         */
        public Cheese_provolone_reduced_fat_mutable() {
            set_food_name("Cheese, provolone, reduced fat");
            set_food_label("cheese_provolone_reduced_fat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(756.00000);
            set_carbohydrate_by_difference(3.50000);
            set_cholesterol(55.00000);
            set_choline(12.90000);
            set_complete_protein(24.70000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(274.00000);
            set_iron(0.52000);
            set_linoleic_acid(0.00000);
            set_magnesium(28.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(4.89000);
            set_niacin(0.15000);
            set_pantothenic_acid(0.47000);
            set_phosphorus(496.00000);
            set_polyunsaturated_fat(0.51000);
            set_potassium(138.00000);
            set_protein(24.70000);
            set_riboflavin(0.32000);
            set_saturated_fat(11.30000);
            set_selenium(14.50000);
            set_sodium(615.00000);
            set_thiamin(0.01000);
            set_vitamin_a(141.00000);
            set_vitamin_b12(1.46000);
            set_vitamin_b6(0.07000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.30000);
            set_vitamin_e(0.15000);
