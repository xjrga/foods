 ...
 */
public class Milk_canned_evaporated_with_added_vitamin_d_and_without_added_vitamin_a implements Food {

    private final Milk_canned_evaporated_with_added_vitamin_d_and_without_added_vitamin_a_mutable food;

    public Milk_canned_evaporated_with_added_vitamin_d_and_without_added_vitamin_a() {
        food = new Milk_canned_evaporated_with_added_vitamin_d_and_without_added_vitamin_a_mutable();
    }
    ...
    private class Milk_canned_evaporated_with_added_vitamin_d_and_without_added_vitamin_a_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_canned_evaporated_with_added_vitamin_d_and_without_added_vitamin_a_mutable() {
            ...
            set_calcium(261.00000);
            set_carbohydrate_by_difference(10.04000);
            set_cholesterol(29.00000);
            set_choline(31.80000);
            set_complete_protein(6.81000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(134.00000);
            set_iron(0.19000);
            set_linoleic_acid(0.00000);
            set_magnesium(24.00000);
            set_manganese(0.00600);
            set_monounsaturated_fat(2.33000);
            set_niacin(0.19000);
            set_pantothenic_acid(0.63000);
            set_phosphorus(203.00000);
            set_polyunsaturated_fat(0.24000);
            set_potassium(303.00000);
            set_protein(6.81000);
            set_riboflavin(0.31000);
            set_saturated_fat(4.59000);
            set_selenium(2.30000);
            set_sodium(106.00000);
            set_thiamin(0.04000);
            set_vitamin_a(65.00000);
            set_vitamin_b12(0.16000);
            set_vitamin_b6(0.05000);
            set_vitamin_c(1.90000);
            set_vitamin_d(2.00000);
            set_vitamin_e(0.14000);
            set_vitamin_k(0.50000);
            set_water(74.04000);
