 ...
 */
public class Cheese_cottage_lowfat_2_milkfat implements Food {

    private final Cheese_cottage_lowfat_2_milkfat_mutable food;

    public Cheese_cottage_lowfat_2_milkfat() {
        food = new Cheese_cottage_lowfat_2_milkfat_mutable();
    }
    ...
    private class Cheese_cottage_lowfat_2_milkfat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cheese_cottage_lowfat_2_milkfat_mutable() {
            set_food_name("Cheese, cottage, lowfat, 2% milkfat");
            set_food_label("cheese_cottage_lowfat_2_milkfat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00700);
            set_calcium(111.00000);
            set_carbohydrate_by_difference(4.76000);
            set_cholesterol(12.00000);
            set_choline(16.30000);
            set_complete_protein(10.45000);
            set_copper(0.03000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00100);
            ...
            set_iron(0.13000);
            set_linoleic_acid(0.04000);
            set_magnesium(9.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.51000);
            set_niacin(0.10000);
            set_pantothenic_acid(0.52000);
            set_phosphorus(150.00000);
            set_polyunsaturated_fat(0.08000);
            set_potassium(125.00000);
            set_protein(10.45000);
            set_riboflavin(0.25000);
            set_saturated_fat(1.23000);
            set_selenium(11.90000);
            set_sodium(308.00000);
            set_thiamin(0.02000);
            set_vitamin_a(68.00000);
