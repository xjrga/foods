 ...
 */
public class Parmesan_cheese_topping_fat_free implements Food {

    private final Parmesan_cheese_topping_fat_free_mutable food;

    public Parmesan_cheese_topping_fat_free() {
        food = new Parmesan_cheese_topping_fat_free_mutable();
    }
    ...
    private class Parmesan_cheese_topping_fat_free_mutable extends Food_abstract {
         ...
         */
        public Parmesan_cheese_topping_fat_free_mutable() {
            ...
            set_calcium(800.00000);
            set_carbohydrate_by_difference(40.00000);
            set_cholesterol(20.00000);
            set_choline(15.40000);
            set_complete_protein(40.00000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(370.00000);
            set_iron(5.00000);
            set_linoleic_acid(0.00000);
            set_magnesium(40.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(1.44000);
            set_niacin(0.20000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(700.00000);
            set_polyunsaturated_fat(0.18000);
            set_potassium(600.00000);
            set_protein(40.00000);
            set_riboflavin(0.05000);
            set_saturated_fat(3.11000);
            set_selenium(43.30000);
            set_sodium(1150.00000);
            set_thiamin(0.05000);
            set_vitamin_a(40.00000);
            set_vitamin_b12(1.10000);
