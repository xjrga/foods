 ...
 */
public class Cheese_swiss_low_fat implements Food {

    private final Cheese_swiss_low_fat_mutable food;

    public Cheese_swiss_low_fat() {
        food = new Cheese_swiss_low_fat_mutable();
    }
    ...
    private class Cheese_swiss_low_fat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cheese_swiss_low_fat_mutable() {
            set_food_name("Cheese, swiss, low fat");
            set_food_label("cheese_swiss_low_fat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(961.00000);
            set_carbohydrate_by_difference(3.40000);
            set_cholesterol(35.00000);
            set_choline(15.40000);
            set_complete_protein(28.40000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(179.00000);
            set_iron(0.17000);
            set_linoleic_acid(0.00000);
            set_magnesium(36.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(1.35000);
            set_niacin(0.09000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(605.00000);
            set_polyunsaturated_fat(0.18000);
            set_potassium(111.00000);
            set_protein(28.40000);
            set_riboflavin(0.36000);
            set_saturated_fat(3.30000);
            set_selenium(12.70000);
            set_sodium(199.00000);
            set_thiamin(0.02000);
            set_vitamin_a(40.00000);
            set_vitamin_b12(1.68000);
