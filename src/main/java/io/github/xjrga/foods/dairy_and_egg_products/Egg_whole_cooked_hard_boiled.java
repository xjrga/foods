 ...
 */
public class Egg_whole_cooked_hard_boiled implements Food {

    private final Egg_whole_cooked_hard_boiled_mutable food;

    public Egg_whole_cooked_hard_boiled() {
        food = new Egg_whole_cooked_hard_boiled_mutable();
    }
    ...
    private class Egg_whole_cooked_hard_boiled_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Egg_whole_cooked_hard_boiled_mutable() {
            set_food_name("Egg, whole, cooked, hard-boiled");
            set_food_label("egg_whole_cooked_hard_boiled");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(50.00000);
            set_carbohydrate_by_difference(1.12000);
            set_cholesterol(373.00000);
            set_choline(293.80000);
            set_complete_protein(12.58000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.03000);
            set_epa(0.00500);
            set_fat(10.61000);
            set_fiber(0.00000);
            set_fluoride(4.80000);
            set_folate(44.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(155.00000);
            set_iron(1.19000);
            set_linoleic_acid(0.00000);
            set_magnesium(10.00000);
            set_manganese(0.02000);
            set_monounsaturated_fat(4.07000);
            set_niacin(0.06000);
            set_pantothenic_acid(1.39000);
            set_phosphorus(172.00000);
            set_polyunsaturated_fat(1.41000);
            set_potassium(126.00000);
            set_protein(12.58000);
            set_riboflavin(0.51000);
            set_saturated_fat(3.26000);
            set_selenium(30.80000);
            set_sodium(124.00000);
            set_thiamin(0.06000);
            set_vitamin_a(149.00000);
            set_vitamin_b12(1.11000);
            set_vitamin_b6(0.12000);
            set_vitamin_c(0.00000);
            set_vitamin_d(2.20000);
            set_vitamin_e(1.03000);
