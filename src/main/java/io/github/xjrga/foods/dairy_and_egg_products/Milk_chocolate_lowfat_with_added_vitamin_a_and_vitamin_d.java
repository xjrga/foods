 ...
 */
public class Milk_chocolate_lowfat_with_added_vitamin_a_and_vitamin_d implements Food {

    private final Milk_chocolate_lowfat_with_added_vitamin_a_and_vitamin_d_mutable food;

    public Milk_chocolate_lowfat_with_added_vitamin_a_and_vitamin_d() {
        food = new Milk_chocolate_lowfat_with_added_vitamin_a_and_vitamin_d_mutable();
    }
    ...
    private class Milk_chocolate_lowfat_with_added_vitamin_a_and_vitamin_d_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_chocolate_lowfat_with_added_vitamin_a_and_vitamin_d_mutable() {
            ...
            set_calcium(129.00000);
            set_carbohydrate_by_difference(9.86000);
            set_cholesterol(5.00000);
            set_choline(17.00000);
            set_complete_protein(3.46000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00100);
            ...
            set_gross_energy(62.00000);
            set_iron(0.23000);
            set_linoleic_acid(0.02000);
            set_magnesium(13.00000);
            set_manganese(0.03000);
            set_monounsaturated_fat(0.54000);
            set_niacin(0.12000);
            set_pantothenic_acid(0.43000);
            set_phosphorus(96.00000);
            set_polyunsaturated_fat(0.09000);
            set_potassium(172.00000);
            set_protein(3.46000);
            set_riboflavin(0.24000);
            set_saturated_fat(0.58000);
            set_selenium(1.90000);
            set_sodium(65.00000);
            set_thiamin(0.03000);
            set_vitamin_a(52.00000);
            set_vitamin_b12(0.23000);
            set_vitamin_b6(0.04000);
            set_vitamin_c(0.40000);
