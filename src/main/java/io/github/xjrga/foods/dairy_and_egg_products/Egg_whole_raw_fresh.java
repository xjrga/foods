 ...
 */
public class Egg_whole_raw_fresh implements Food {

    private final Egg_whole_raw_fresh_mutable food;

    public Egg_whole_raw_fresh() {
        food = new Egg_whole_raw_fresh_mutable();
    }
    ...
    private class Egg_whole_raw_fresh_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Egg_whole_raw_fresh_mutable() {
            set_food_name("Egg, whole, raw, fresh");
            set_food_label("egg_whole_raw_fresh");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.03000);
            set_calcium(56.00000);
            set_carbohydrate_by_difference(0.72000);
            set_cholesterol(372.00000);
            set_choline(293.80000);
            set_complete_protein(12.56000);
            set_copper(0.07000);
            set_cost(0.00000);
            set_dha(0.05000);
            set_epa(0.00000);
            set_fat(9.51000);
            set_fiber(0.00000);
            set_fluoride(1.10000);
            set_folate(47.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(143.00000);
            set_iron(1.75000);
            set_linoleic_acid(1.53000);
            set_magnesium(12.00000);
            set_manganese(0.02000);
            set_monounsaturated_fat(3.65000);
            set_niacin(0.07000);
            set_pantothenic_acid(1.53000);
            set_phosphorus(198.00000);
            set_polyunsaturated_fat(1.91000);
            set_potassium(138.00000);
            set_protein(12.56000);
            set_riboflavin(0.45000);
            set_saturated_fat(3.12000);
            set_selenium(30.70000);
            set_sodium(142.00000);
            set_thiamin(0.04000);
            set_vitamin_a(160.00000);
            set_vitamin_b12(0.89000);
            set_vitamin_b6(0.17000);
            set_vitamin_c(0.00000);
            set_vitamin_d(2.00000);
            set_vitamin_e(1.05000);
