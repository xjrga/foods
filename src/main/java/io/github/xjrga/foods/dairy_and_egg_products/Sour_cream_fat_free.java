 ...
 */
public class Sour_cream_fat_free implements Food {

    private final Sour_cream_fat_free_mutable food;

    public Sour_cream_fat_free() {
        food = new Sour_cream_fat_free_mutable();
    }
    ...
    private class Sour_cream_fat_free_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Sour_cream_fat_free_mutable() {
            set_food_name("Sour cream, fat free");
            set_food_label("sour_cream_fat_free");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(125.00000);
            set_carbohydrate_by_difference(15.60000);
            set_cholesterol(9.00000);
            set_choline(19.20000);
            set_complete_protein(3.10000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_sodium(141.00000);
            set_thiamin(0.04000);
            set_vitamin_a(73.00000);
            set_vitamin_b12(0.30000);
