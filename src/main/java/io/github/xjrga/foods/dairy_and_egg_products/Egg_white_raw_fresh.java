 ...
 */
public class Egg_white_raw_fresh implements Food {

    private final Egg_white_raw_fresh_mutable food;

    public Egg_white_raw_fresh() {
        food = new Egg_white_raw_fresh_mutable();
    }
    ...
    private class Egg_white_raw_fresh_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Egg_white_raw_fresh_mutable() {
            set_food_name("Egg, white, raw, fresh");
            set_food_label("egg_white_raw_fresh");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(7.00000);
            set_carbohydrate_by_difference(0.73000);
            set_cholesterol(0.00000);
            set_choline(1.10000);
            set_complete_protein(10.90000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
