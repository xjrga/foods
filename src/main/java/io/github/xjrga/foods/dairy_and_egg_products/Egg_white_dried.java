 ...
 */
public class Egg_white_dried implements Food {

    private final Egg_white_dried_mutable food;

    public Egg_white_dried() {
        food = new Egg_white_dried_mutable();
    }
    ...
    private class Egg_white_dried_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Egg_white_dried_mutable() {
            set_food_name("Egg, white, dried");
            set_food_label("egg_white_dried");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(62.00000);
            set_carbohydrate_by_difference(7.80000);
            set_cholesterol(0.00000);
            set_choline(8.40000);
            set_complete_protein(81.10000);
            set_copper(0.11000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_potassium(1125.00000);
            set_protein(81.10000);
            set_riboflavin(2.53000);
            set_saturated_fat(0.00000);
            set_selenium(125.10000);
            set_sodium(1280.00000);
            set_thiamin(0.00500);
