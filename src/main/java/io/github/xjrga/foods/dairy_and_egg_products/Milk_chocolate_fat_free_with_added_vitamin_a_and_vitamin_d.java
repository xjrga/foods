 ...
 */
public class Milk_chocolate_fat_free_with_added_vitamin_a_and_vitamin_d implements Food {

    private final Milk_chocolate_fat_free_with_added_vitamin_a_and_vitamin_d_mutable food;

    public Milk_chocolate_fat_free_with_added_vitamin_a_and_vitamin_d() {
        food = new Milk_chocolate_fat_free_with_added_vitamin_a_and_vitamin_d_mutable();
    }
    ...
    private class Milk_chocolate_fat_free_with_added_vitamin_a_and_vitamin_d_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_chocolate_fat_free_with_added_vitamin_a_and_vitamin_d_mutable() {
            ...
            set_calcium(127.00000);
            set_carbohydrate_by_difference(13.46000);
            set_cholesterol(2.00000);
            set_choline(15.60000);
            set_complete_protein(3.39000);
            set_copper(0.07000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(67.00000);
            set_iron(0.27000);
            set_linoleic_acid(0.00000);
            set_magnesium(13.00000);
            set_manganese(0.06000);
            set_monounsaturated_fat(0.00000);
            set_niacin(0.16000);
            set_pantothenic_acid(0.30000);
            set_phosphorus(101.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(182.00000);
            set_protein(3.39000);
            set_riboflavin(0.16000);
            set_saturated_fat(0.00000);
            set_selenium(1.90000);
            set_sodium(110.00000);
            set_thiamin(0.04000);
            set_vitamin_a(64.00000);
            set_vitamin_b12(0.32000);
            set_vitamin_b6(0.02000);
            set_vitamin_c(1.00000);
            set_vitamin_d(1.10000);
            set_vitamin_e(0.04000);
            set_vitamin_k(0.20000);
            set_water(82.34000);
