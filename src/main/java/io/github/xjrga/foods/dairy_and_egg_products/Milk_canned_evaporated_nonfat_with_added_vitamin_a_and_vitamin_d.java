 ...
 */
public class Milk_canned_evaporated_nonfat_with_added_vitamin_a_and_vitamin_d implements Food {

    private final Milk_canned_evaporated_nonfat_with_added_vitamin_a_and_vitamin_d_mutable food;

    public Milk_canned_evaporated_nonfat_with_added_vitamin_a_and_vitamin_d() {
        food = new Milk_canned_evaporated_nonfat_with_added_vitamin_a_and_vitamin_d_mutable();
    }
    ...
    private class Milk_canned_evaporated_nonfat_with_added_vitamin_a_and_vitamin_d_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Milk_canned_evaporated_nonfat_with_added_vitamin_a_and_vitamin_d_mutable() {
            ...
            set_calcium(290.00000);
            set_carbohydrate_by_difference(11.35000);
            set_cholesterol(4.00000);
            set_choline(25.20000);
            set_complete_protein(7.55000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            set_fat(0.20000);
            set_fiber(0.00000);
            set_fluoride(8.50000);
            set_folate(9.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(78.00000);
            set_iron(0.29000);
            set_linoleic_acid(0.00000);
            set_magnesium(27.00000);
            set_manganese(0.00600);
            set_monounsaturated_fat(0.06000);
            set_niacin(0.17000);
            set_pantothenic_acid(0.73000);
            set_phosphorus(195.00000);
            set_polyunsaturated_fat(0.00600);
            set_potassium(332.00000);
            set_protein(7.55000);
            set_riboflavin(0.30000);
            set_saturated_fat(0.12000);
            set_selenium(2.50000);
            set_sodium(115.00000);
            set_thiamin(0.04000);
            set_vitamin_a(118.00000);
            set_vitamin_b12(0.24000);
            set_vitamin_b6(0.05000);
            set_vitamin_c(1.20000);
            set_vitamin_d(2.00000);
