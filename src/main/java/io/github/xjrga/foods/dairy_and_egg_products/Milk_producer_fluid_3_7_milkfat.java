 ...
 */
public class Milk_producer_fluid_3_7_milkfat implements Food {

    private final Milk_producer_fluid_3_7_milkfat_mutable food;

    public Milk_producer_fluid_3_7_milkfat() {
        food = new Milk_producer_fluid_3_7_milkfat_mutable();
    }
    ...
    private class Milk_producer_fluid_3_7_milkfat_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Milk_producer_fluid_3_7_milkfat_mutable() {
            ...
            set_calcium(119.00000);
            set_carbohydrate_by_difference(4.65000);
            set_cholesterol(14.00000);
            set_choline(0.00000);
            set_complete_protein(3.28000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
