 ...
 */
public class Beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw implements Food {

    private final Beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable food;

    public Beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw() {
        food = new Beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable() {
            set_food_name("Beef, loin, top sirloin petite roast/filet, boneless, separable lean only, trimmed to 0' fat, all grades, raw");
            set_food_label("beef_loin_top_sirloin_petite_roast_filet_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(5.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(69.00000);
            set_choline(0.00000);
            set_complete_protein(23.04000);
            set_copper(0.09000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00100);
            ...
            set_gross_energy(128.00000);
            set_iron(2.24000);
            set_linoleic_acid(0.08000);
            set_magnesium(25.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(1.70000);
            set_niacin(5.86000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(222.00000);
            set_polyunsaturated_fat(0.12000);
            set_potassium(395.00000);
            set_protein(23.04000);
            set_riboflavin(0.18000);
            set_saturated_fat(1.28000);
            set_selenium(26.30000);
            set_sodium(65.00000);
            set_thiamin(0.06000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(2.90000);
            set_vitamin_b6(0.65000);
