 ...
 */
public class Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw implements Food {

    private final Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable food;

    public Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw() {
        food = new Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable() {
            set_food_name("Beef, round, tip round, roast, separable lean only, trimmed to 0' fat, all grades, raw");
            set_food_label("beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_all_grades_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(18.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(57.00000);
            set_choline(88.00000);
            set_complete_protein(21.07000);
            set_copper(0.09000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(126.00000);
            set_iron(1.77000);
            set_linoleic_acid(0.00000);
            set_magnesium(22.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.64000);
            set_niacin(6.21000);
            set_pantothenic_acid(0.62000);
            set_phosphorus(198.00000);
            set_polyunsaturated_fat(0.20000);
            set_potassium(323.00000);
            set_protein(21.07000);
            set_riboflavin(0.13000);
            set_saturated_fat(1.37000);
            set_selenium(26.00000);
            set_sodium(54.00000);
            set_thiamin(0.08000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(1.47000);
            set_vitamin_b6(0.61000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.27000);
            set_vitamin_k(1.10000);
            set_water(74.48000);
