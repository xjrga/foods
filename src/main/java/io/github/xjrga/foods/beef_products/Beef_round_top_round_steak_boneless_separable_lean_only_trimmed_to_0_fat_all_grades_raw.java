 ...
 */
public class Beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw implements Food {

    private final Beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable food;

    public Beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw() {
        food = new Beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable() {
            set_food_name("Beef, round, top round steak, boneless, separable lean only, trimmed to 0' fat, all grades, raw");
            set_food_label("beef_round_top_round_steak_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw");
            set_alcohol(0.00000);
