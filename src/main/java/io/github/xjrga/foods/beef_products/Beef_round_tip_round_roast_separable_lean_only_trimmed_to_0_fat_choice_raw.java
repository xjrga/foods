 ...
 */
public class Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_choice_raw implements Food {

    private final Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_choice_raw_mutable food;

    public Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_choice_raw() {
        food = new Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_choice_raw_mutable();
    }
    ...
    private class Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_choice_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beef_round_tip_round_roast_separable_lean_only_trimmed_to_0_fat_choice_raw_mutable() {
            ...
            set_cholesterol(58.00000);
            set_choline(86.70000);
            set_complete_protein(20.76000);
            set_copper(0.09000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(130.00000);
            set_iron(1.92000);
            set_linoleic_acid(0.00000);
            set_magnesium(23.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.85000);
            set_niacin(6.31000);
            set_pantothenic_acid(0.61000);
            set_phosphorus(200.00000);
            set_polyunsaturated_fat(0.22000);
            set_potassium(318.00000);
            set_protein(20.76000);
            set_riboflavin(0.14000);
            set_saturated_fat(1.55000);
            set_selenium(25.80000);
            set_sodium(52.00000);
            set_thiamin(0.08000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(1.73000);
