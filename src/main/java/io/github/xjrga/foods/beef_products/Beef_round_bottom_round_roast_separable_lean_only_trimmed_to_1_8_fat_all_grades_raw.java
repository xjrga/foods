 ...
 */
public class Beef_round_bottom_round_roast_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw implements Food {

    private final Beef_round_bottom_round_roast_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable food;

    public Beef_round_bottom_round_roast_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw() {
        food = new Beef_round_bottom_round_roast_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_round_bottom_round_roast_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beef_round_bottom_round_roast_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable() {
            ...
            set_calcium(20.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(61.00000);
            set_choline(92.70000);
            set_complete_protein(22.19000);
            set_copper(0.09000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_monounsaturated_fat(1.81000);
            set_niacin(6.66000);
            set_pantothenic_acid(0.65000);
            set_phosphorus(214.00000);
            set_polyunsaturated_fat(0.18000);
            set_potassium(350.00000);
            set_protein(22.19000);
            set_riboflavin(0.14000);
            set_saturated_fat(1.47000);
            set_selenium(28.20000);
            set_sodium(59.00000);
            set_thiamin(0.09000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(1.57000);
            set_vitamin_b6(0.65000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.29000);
            set_vitamin_k(1.20000);
            set_water(72.58000);
