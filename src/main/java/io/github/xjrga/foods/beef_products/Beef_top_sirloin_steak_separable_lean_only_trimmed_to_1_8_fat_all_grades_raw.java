 ...
 */
public class Beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw implements Food {

    private final Beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable food;

    public Beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw() {
        food = new Beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw_mutable() {
            set_food_name("Beef, top sirloin, steak, separable lean only, trimmed to 1/8' fat, all grades, raw");
            set_food_label("beef_top_sirloin_steak_separable_lean_only_trimmed_to_1_8_fat_all_grades_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(25.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(60.00000);
            set_choline(92.30000);
            set_complete_protein(22.09000);
            set_copper(0.07000);
            set_cost(0.00000);
            set_dha(0.00100);
            set_epa(0.00200);
            ...
            set_gross_energy(131.00000);
            set_iron(1.61000);
            set_linoleic_acid(0.00000);
            set_magnesium(23.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.64000);
            set_niacin(6.84000);
            set_pantothenic_acid(0.65000);
            set_phosphorus(207.00000);
            set_polyunsaturated_fat(0.19000);
            set_potassium(349.00000);
            set_protein(22.09000);
            set_riboflavin(0.11000);
            set_saturated_fat(1.50000);
            set_selenium(27.10000);
            set_sodium(56.00000);
            set_thiamin(0.06000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(1.09000);
            set_vitamin_b6(0.61000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.10000);
            set_vitamin_e(0.32000);
            set_vitamin_k(1.30000);
            set_water(72.91000);
