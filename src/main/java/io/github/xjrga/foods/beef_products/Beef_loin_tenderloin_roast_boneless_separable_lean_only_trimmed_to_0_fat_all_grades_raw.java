 ...
 */
public class Beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw implements Food {

    private final Beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable food;

    public Beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw() {
        food = new Beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable() {
            set_food_name("Beef, loin, tenderloin roast, boneless, separable lean only, trimmed to 0' fat, all grades, raw");
            set_food_label("beef_loin_tenderloin_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.01000);
            set_calcium(13.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(61.00000);
            set_choline(55.40000);
            set_complete_protein(21.94000);
            set_copper(0.06000);
            set_cost(0.00000);
            set_dha(0.00100);
            set_epa(0.00300);
            ...
            set_gross_energy(139.00000);
            set_iron(2.50000);
            set_linoleic_acid(0.26000);
            set_magnesium(12.00000);
            set_manganese(0.00700);
            set_monounsaturated_fat(2.12000);
            set_niacin(4.75000);
            set_pantothenic_acid(0.35000);
            set_phosphorus(215.00000);
            set_polyunsaturated_fat(0.42000);
            set_potassium(289.00000);
            set_protein(21.94000);
            set_riboflavin(0.31000);
            set_saturated_fat(1.95000);
            set_selenium(20.40000);
            set_sodium(44.00000);
            set_thiamin(0.05000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(3.53000);
            set_vitamin_b6(0.61000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.10000);
