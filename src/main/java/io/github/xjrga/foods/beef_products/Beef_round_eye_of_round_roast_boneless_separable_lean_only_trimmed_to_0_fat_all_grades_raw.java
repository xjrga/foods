 ...
 */
package io.github.xjrga.foods.beef_products;
 ...
 */
public class Beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw implements Food {

    private final Beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable food;

    public Beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw() {
        food = new Beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable() {
            set_food_name("Beef, round, eye of round roast, boneless, separable lean only, trimmed to 0' fat, all grades, raw");
            set_food_label("beef_round_eye_of_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00600);
            set_calcium(13.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(60.00000);
            set_choline(64.20000);
            set_complete_protein(23.37000);
            set_copper(0.04000);
            set_cost(0.00000);
            set_dha(0.00200);
            set_epa(0.00400);
            ...
            set_gross_energy(121.00000);
            set_iron(1.45000);
            set_linoleic_acid(0.13000);
            set_magnesium(12.00000);
            set_manganese(0.00100);
            set_monounsaturated_fat(1.26000);
            set_niacin(6.72000);
            set_pantothenic_acid(0.35000);
            set_phosphorus(222.00000);
            set_polyunsaturated_fat(0.23000);
            set_potassium(319.00000);
            set_protein(23.37000);
            set_riboflavin(0.18000);
            set_saturated_fat(1.08000);
            set_selenium(22.60000);
            set_sodium(53.00000);
            set_thiamin(0.06000);
            set_vitamin_a(1.00000);
            set_vitamin_b12(1.84000);
            set_vitamin_b6(0.64000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.24000);
            set_vitamin_k(1.50000);
            set_water(73.43000);
