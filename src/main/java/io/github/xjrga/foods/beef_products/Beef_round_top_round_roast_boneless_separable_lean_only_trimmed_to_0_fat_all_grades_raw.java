 ...
 */
public class Beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw implements Food {

    private final Beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable food;

    public Beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw() {
        food = new Beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable();
    }
    ...
    private class Beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw_mutable() {
            set_food_name("Beef, round, top round roast, boneless, separable lean only, trimmed to 0' fat, all grades, raw");
            set_food_label("beef_round_top_round_roast_boneless_separable_lean_only_trimmed_to_0_fat_all_grades_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00400);
            set_calcium(13.00000);
            set_carbohydrate_by_difference(0.00000);
            set_cholesterol(62.00000);
            set_choline(64.80000);
            set_complete_protein(23.59000);
            set_copper(0.04000);
            set_cost(0.00000);
            set_dha(0.00100);
            set_epa(0.00200);
            ...
            set_manganese(0.00400);
            set_monounsaturated_fat(1.29000);
            set_niacin(6.46000);
            set_pantothenic_acid(0.35000);
            set_phosphorus(220.00000);
            set_polyunsaturated_fat(0.22000);
            set_potassium(313.00000);
            set_protein(23.59000);
            set_riboflavin(0.23000);
            set_saturated_fat(1.12000);
            set_selenium(22.20000);
            set_sodium(54.00000);
            set_thiamin(0.06000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(1.64000);
            set_vitamin_b6(0.63000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.23000);
