 ...
 */
public class Nuts_almonds_dry_roasted_without_salt_added implements Food {

    private final Nuts_almonds_dry_roasted_without_salt_added_mutable food;

    public Nuts_almonds_dry_roasted_without_salt_added() {
        food = new Nuts_almonds_dry_roasted_without_salt_added_mutable();
    }
    ...
    private class Nuts_almonds_dry_roasted_without_salt_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_almonds_dry_roasted_without_salt_added_mutable() {
            ...
            set_calcium(268.00000);
            set_carbohydrate_by_difference(21.01000);
            set_cholesterol(0.00000);
            set_choline(52.10000);
            ...
            set_gross_energy(598.00000);
            set_iron(3.73000);
            set_linoleic_acid(12.94000);
            set_magnesium(279.00000);
            set_manganese(2.23000);
            set_monounsaturated_fat(33.07000);
            set_niacin(3.63000);
            set_pantothenic_acid(0.32000);
            set_phosphorus(471.00000);
            set_polyunsaturated_fat(12.95000);
            set_potassium(713.00000);
            set_protein(20.96000);
            set_riboflavin(1.19000);
            set_saturated_fat(4.09000);
            set_selenium(2.00000);
            set_sodium(3.00000);
            set_thiamin(0.07000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.13000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(23.90000);
