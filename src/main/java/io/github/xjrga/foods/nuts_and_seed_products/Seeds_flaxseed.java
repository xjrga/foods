 ...
 */
public class Seeds_flaxseed implements Food {

    private final Seeds_flaxseed_mutable food;

    public Seeds_flaxseed() {
        food = new Seeds_flaxseed_mutable();
    }
    ...
    private class Seeds_flaxseed_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Seeds_flaxseed_mutable() {
