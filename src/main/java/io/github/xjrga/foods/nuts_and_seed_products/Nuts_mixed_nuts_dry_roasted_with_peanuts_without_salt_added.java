 ...
 */
public class Nuts_mixed_nuts_dry_roasted_with_peanuts_without_salt_added implements Food {

    private final Nuts_mixed_nuts_dry_roasted_with_peanuts_without_salt_added_mutable food;

    public Nuts_mixed_nuts_dry_roasted_with_peanuts_without_salt_added() {
        food = new Nuts_mixed_nuts_dry_roasted_with_peanuts_without_salt_added_mutable();
    }
    ...
    private class Nuts_mixed_nuts_dry_roasted_with_peanuts_without_salt_added_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Nuts_mixed_nuts_dry_roasted_with_peanuts_without_salt_added_mutable() {
            ...
            set_gross_energy(607.00000);
            set_iron(3.73000);
            set_linoleic_acid(9.74000);
            set_magnesium(227.00000);
            set_manganese(2.61000);
            set_monounsaturated_fat(34.53000);
            set_niacin(6.22000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(438.00000);
            set_polyunsaturated_fat(9.85000);
            set_potassium(643.00000);
            set_protein(19.50000);
            set_riboflavin(0.40000);
            set_saturated_fat(8.01000);
            set_selenium(9.30000);
            set_sodium(4.00000);
            set_thiamin(0.30000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.36000);
            set_vitamin_c(0.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(6.13000);
            set_vitamin_k(12.00000);
            set_water(2.13000);
