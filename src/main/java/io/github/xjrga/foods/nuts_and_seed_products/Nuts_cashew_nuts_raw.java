 ...
 */
public class Nuts_cashew_nuts_raw implements Food {

    private final Nuts_cashew_nuts_raw_mutable food;

    public Nuts_cashew_nuts_raw() {
        food = new Nuts_cashew_nuts_raw_mutable();
    }
    ...
    private class Nuts_cashew_nuts_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_cashew_nuts_raw_mutable() {
            ...
            set_carbohydrate_by_difference(30.19000);
            ...
            set_gross_energy(553.00000);
            set_iron(6.68000);
            set_linoleic_acid(0.00000);
            set_magnesium(292.00000);
            set_manganese(1.65000);
            set_monounsaturated_fat(23.79000);
            set_niacin(1.06000);
            set_pantothenic_acid(0.86000);
            set_phosphorus(593.00000);
            set_polyunsaturated_fat(7.84000);
            set_potassium(660.00000);
            set_protein(18.22000);
            set_riboflavin(0.05000);
            set_saturated_fat(7.78000);
            set_selenium(19.90000);
            set_sodium(12.00000);
            set_thiamin(0.42000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.41000);
            set_vitamin_c(0.50000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.90000);
            set_vitamin_k(34.10000);
            set_water(5.20000);
