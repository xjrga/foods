 ...
 */
public class Seeds_flaxseed_efas implements Food {

    private final Seeds_flaxseed_efas_mutable food;

    public Seeds_flaxseed_efas() {
        food = new Seeds_flaxseed_efas_mutable();
    }
    ...
    private class Seeds_flaxseed_efas_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Seeds_flaxseed_efas_mutable() {
            set_food_name("Seeds, flaxseed (EFAs)");
            set_food_label("seeds_flaxseed_efas");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(24.45280);
            set_calcium(255.00000);
            set_carbohydrate_by_difference(28.88000);
            set_cholesterol(0.00000);
            set_choline(78.70000);
            ...
            set_gross_energy(534.00000);
            set_iron(5.73000);
            set_linoleic_acid(6.02888);
            set_magnesium(392.00000);
            set_manganese(2.48000);
            set_monounsaturated_fat(7.52000);
            set_niacin(3.08000);
            set_pantothenic_acid(0.98000);
            set_phosphorus(642.00000);
            set_polyunsaturated_fat(28.73000);
            set_potassium(813.00000);
            set_protein(18.29000);
            set_riboflavin(0.16000);
            set_saturated_fat(3.66000);
            set_selenium(25.40000);
            set_sodium(30.00000);
            set_thiamin(1.64000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.47000);
            set_vitamin_c(0.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.31000);
