 ...
 */
public class Nuts_pistachio_nuts_raw implements Food {

    private final Nuts_pistachio_nuts_raw_mutable food;

    public Nuts_pistachio_nuts_raw() {
        food = new Nuts_pistachio_nuts_raw_mutable();
    }
    ...
    private class Nuts_pistachio_nuts_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_pistachio_nuts_raw_mutable() {
            set_food_name("Nuts, pistachio nuts, raw");
            set_food_label("nuts_pistachio_nuts_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(105.00000);
            set_carbohydrate_by_difference(27.17000);
            ...
            set_gross_energy(560.00000);
            set_iron(3.92000);
            set_linoleic_acid(14.09000);
            set_magnesium(121.00000);
            set_manganese(1.20000);
            set_monounsaturated_fat(23.25000);
            set_niacin(1.30000);
            set_pantothenic_acid(0.52000);
            set_phosphorus(490.00000);
            set_polyunsaturated_fat(14.38000);
            set_potassium(1025.00000);
            set_protein(20.16000);
            set_riboflavin(0.16000);
            set_saturated_fat(5.90000);
            set_selenium(7.00000);
            set_sodium(1.00000);
            set_thiamin(0.87000);
            set_vitamin_a(26.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(1.70000);
            set_vitamin_c(5.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.86000);
