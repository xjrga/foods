 ...
 */
public class Nuts_walnuts_dry_roasted_with_salt_added implements Food {

    private final Nuts_walnuts_dry_roasted_with_salt_added_mutable food;

    public Nuts_walnuts_dry_roasted_with_salt_added() {
        food = new Nuts_walnuts_dry_roasted_with_salt_added_mutable();
    }
    ...
    private class Nuts_walnuts_dry_roasted_with_salt_added_mutable extends Abstract_food {
         ...
         */
        public Nuts_walnuts_dry_roasted_with_salt_added_mutable() {
            ...
            set_calcium(71.00000);
            set_carbohydrate_by_difference(17.86000);
            set_cholesterol(0.00000);
            set_choline(38.00000);
            ...
            set_gross_energy(643.00000);
            set_iron(2.57000);
            set_linoleic_acid(0.00000);
            set_magnesium(151.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(8.37000);
            set_niacin(2.21000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(329.00000);
            set_polyunsaturated_fat(44.18000);
            set_potassium(459.00000);
            set_protein(14.29000);
            set_riboflavin(0.29000);
            set_saturated_fat(5.35000);
            set_selenium(5.00000);
            set_sodium(643.00000);
            set_thiamin(0.52000);
            set_vitamin_a(1.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.52000);
            set_vitamin_c(1.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.90000);
