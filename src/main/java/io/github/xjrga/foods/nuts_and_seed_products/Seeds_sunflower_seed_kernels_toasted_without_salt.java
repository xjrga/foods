 ...
 */
public class Seeds_sunflower_seed_kernels_toasted_without_salt implements Food {

    private final Seeds_sunflower_seed_kernels_toasted_without_salt_mutable food;

    public Seeds_sunflower_seed_kernels_toasted_without_salt() {
        food = new Seeds_sunflower_seed_kernels_toasted_without_salt_mutable();
    }
    ...
    private class Seeds_sunflower_seed_kernels_toasted_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Seeds_sunflower_seed_kernels_toasted_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(20.59000);
            ...
            set_folate(238.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(619.00000);
            set_iron(6.81000);
            ...
            set_niacin(4.19000);
            set_pantothenic_acid(7.05000);
            set_phosphorus(1158.00000);
            set_polyunsaturated_fat(37.50000);
            set_potassium(491.00000);
            set_protein(17.21000);
            set_riboflavin(0.28000);
            set_saturated_fat(5.95000);
