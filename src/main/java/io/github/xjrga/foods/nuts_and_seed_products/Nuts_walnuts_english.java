 ...
 */
public class Nuts_walnuts_english implements Food {

    private final Nuts_walnuts_english_mutable food;

    public Nuts_walnuts_english() {
        food = new Nuts_walnuts_english_mutable();
    }
    ...
    private class Nuts_walnuts_english_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Nuts_walnuts_english_mutable() {
            set_food_name("Nuts, walnuts, english");
            set_food_label("nuts_walnuts_english");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(98.00000);
            set_carbohydrate_by_difference(13.71000);
            set_cholesterol(0.00000);
            set_choline(39.20000);
            ...
            set_gross_energy(654.00000);
            set_iron(2.91000);
            set_linoleic_acid(0.00000);
            set_magnesium(158.00000);
            set_manganese(3.41000);
            set_monounsaturated_fat(8.93000);
            set_niacin(1.12000);
            set_pantothenic_acid(0.57000);
            set_phosphorus(346.00000);
            set_polyunsaturated_fat(47.17000);
            set_potassium(441.00000);
            set_protein(15.23000);
            set_riboflavin(0.15000);
            set_saturated_fat(6.12000);
