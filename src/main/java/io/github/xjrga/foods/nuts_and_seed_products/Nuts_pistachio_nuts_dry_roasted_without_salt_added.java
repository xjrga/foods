 ...
 */
public class Nuts_pistachio_nuts_dry_roasted_without_salt_added implements Food {

    private final Nuts_pistachio_nuts_dry_roasted_without_salt_added_mutable food;

    public Nuts_pistachio_nuts_dry_roasted_without_salt_added() {
        food = new Nuts_pistachio_nuts_dry_roasted_without_salt_added_mutable();
    }
    ...
    private class Nuts_pistachio_nuts_dry_roasted_without_salt_added_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Nuts_pistachio_nuts_dry_roasted_without_salt_added_mutable() {
            ...
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.21000);
            set_calcium(107.00000);
            set_carbohydrate_by_difference(28.28000);
            set_cholesterol(0.00000);
            set_choline(71.40000);
            ...
            set_gross_energy(572.00000);
            set_iron(4.03000);
            set_linoleic_acid(13.12000);
            set_magnesium(109.00000);
            set_manganese(1.24000);
            set_monounsaturated_fat(24.53000);
            set_niacin(1.37000);
            set_pantothenic_acid(0.51000);
            set_phosphorus(469.00000);
            set_polyunsaturated_fat(13.34000);
            set_potassium(1007.00000);
            set_protein(21.05000);
            set_riboflavin(0.23000);
            set_saturated_fat(5.64000);
            set_selenium(10.00000);
            set_sodium(6.00000);
            set_thiamin(0.69000);
            set_vitamin_a(13.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(1.12000);
            set_vitamin_c(3.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.17000);
            set_vitamin_k(13.20000);
            set_water(1.85000);
