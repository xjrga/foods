 ...
 */
public class Nuts_hazelnuts_or_filberts_dry_roasted_without_salt_added implements Food {

    private final Nuts_hazelnuts_or_filberts_dry_roasted_without_salt_added_mutable food;

    public Nuts_hazelnuts_or_filberts_dry_roasted_without_salt_added() {
        food = new Nuts_hazelnuts_or_filberts_dry_roasted_without_salt_added_mutable();
    }
    ...
    private class Nuts_hazelnuts_or_filberts_dry_roasted_without_salt_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_hazelnuts_or_filberts_dry_roasted_without_salt_added_mutable() {
            ...
            set_calcium(123.00000);
            set_carbohydrate_by_difference(17.60000);
            ...
            set_gross_energy(646.00000);
            set_iron(4.38000);
            set_linoleic_acid(0.00000);
            set_magnesium(173.00000);
            set_manganese(5.55000);
            set_monounsaturated_fat(46.60000);
            set_niacin(2.05000);
            set_pantothenic_acid(0.92000);
            set_phosphorus(310.00000);
            set_polyunsaturated_fat(8.46000);
            set_potassium(755.00000);
            set_protein(15.03000);
            set_riboflavin(0.12000);
            set_saturated_fat(4.51000);
            set_selenium(4.10000);
            set_sodium(0.00000);
            set_thiamin(0.33000);
            set_vitamin_a(3.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.62000);
            set_vitamin_c(3.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(15.28000);
