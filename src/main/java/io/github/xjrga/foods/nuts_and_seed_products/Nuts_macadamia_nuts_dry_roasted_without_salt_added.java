 ...
 */
public class Nuts_macadamia_nuts_dry_roasted_without_salt_added implements Food {

    private final Nuts_macadamia_nuts_dry_roasted_without_salt_added_mutable food;

    public Nuts_macadamia_nuts_dry_roasted_without_salt_added() {
        food = new Nuts_macadamia_nuts_dry_roasted_without_salt_added_mutable();
    }
    ...
    private class Nuts_macadamia_nuts_dry_roasted_without_salt_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_macadamia_nuts_dry_roasted_without_salt_added_mutable() {
            ...
            set_carbohydrate_by_difference(13.38000);
            set_cholesterol(0.00000);
            set_choline(44.60000);
            ...
            set_gross_energy(718.00000);
            set_iron(2.65000);
            set_linoleic_acid(0.00000);
            set_magnesium(118.00000);
            set_manganese(3.03000);
            set_monounsaturated_fat(59.27000);
            set_niacin(2.27000);
            set_pantothenic_acid(0.60000);
            set_phosphorus(198.00000);
            set_polyunsaturated_fat(1.49000);
            set_potassium(363.00000);
            set_protein(7.79000);
            set_riboflavin(0.08000);
            set_saturated_fat(11.94000);
            set_selenium(11.70000);
            set_sodium(4.00000);
            set_thiamin(0.71000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.35000);
            set_vitamin_c(0.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.57000);
