 ...
 */
public class Nuts_cashew_butter_plain_without_salt_added implements Food {

    private final Nuts_cashew_butter_plain_without_salt_added_mutable food;

    public Nuts_cashew_butter_plain_without_salt_added() {
        food = new Nuts_cashew_butter_plain_without_salt_added_mutable();
    }
    ...
    private class Nuts_cashew_butter_plain_without_salt_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_cashew_butter_plain_without_salt_added_mutable() {
            ...
            set_calcium(43.00000);
            set_carbohydrate_by_difference(27.57000);
            ...
            set_magnesium(258.00000);
            set_manganese(0.81000);
            set_monounsaturated_fat(29.12000);
            set_niacin(1.59000);
            set_pantothenic_acid(1.20000);
            set_phosphorus(457.00000);
            set_polyunsaturated_fat(8.35000);
            set_potassium(546.00000);
            set_protein(17.56000);
            set_riboflavin(0.18000);
            set_saturated_fat(9.76000);
            set_selenium(11.50000);
            set_sodium(15.00000);
            set_thiamin(0.31000);
