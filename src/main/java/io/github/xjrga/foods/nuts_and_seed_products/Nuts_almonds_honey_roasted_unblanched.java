 ...
 */
public class Nuts_almonds_honey_roasted_unblanched implements Food {

    private final Nuts_almonds_honey_roasted_unblanched_mutable food;

    public Nuts_almonds_honey_roasted_unblanched() {
        food = new Nuts_almonds_honey_roasted_unblanched_mutable();
    }
    ...
    private class Nuts_almonds_honey_roasted_unblanched_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_almonds_honey_roasted_unblanched_mutable() {
            ...
            set_calcium(263.00000);
            set_carbohydrate_by_difference(27.90000);
            ...
            set_gross_energy(594.00000);
            set_iron(2.83000);
            set_linoleic_acid(0.00000);
            set_magnesium(240.00000);
            set_manganese(2.00000);
            set_monounsaturated_fat(32.40000);
            set_niacin(2.81000);
            set_pantothenic_acid(0.25000);
            set_phosphorus(400.00000);
            set_polyunsaturated_fat(10.47000);
            set_potassium(560.00000);
            set_protein(18.17000);
            set_riboflavin(0.95000);
            set_saturated_fat(4.73000);
            set_selenium(0.00000);
            set_sodium(130.00000);
            set_thiamin(0.11000);
