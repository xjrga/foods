 ...
 */
public class Nuts_macadamia_nuts_raw implements Food {

    private final Nuts_macadamia_nuts_raw_mutable food;

    public Nuts_macadamia_nuts_raw() {
        food = new Nuts_macadamia_nuts_raw_mutable();
    }
    ...
    private class Nuts_macadamia_nuts_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Nuts_macadamia_nuts_raw_mutable() {
            set_food_name("Nuts, macadamia nuts, raw");
            set_food_label("nuts_macadamia_nuts_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(85.00000);
            set_carbohydrate_by_difference(13.82000);
            ...
            set_manganese(4.13000);
            set_monounsaturated_fat(58.87000);
            set_niacin(2.47000);
            set_pantothenic_acid(0.75000);
            set_phosphorus(188.00000);
            set_polyunsaturated_fat(1.50000);
            set_potassium(368.00000);
            set_protein(7.91000);
            set_riboflavin(0.16000);
            set_saturated_fat(12.06000);
