 ...
 */
public class Nuts_pecans implements Food {

    private final Nuts_pecans_mutable food;

    public Nuts_pecans() {
        food = new Nuts_pecans_mutable();
    }
    ...
    private class Nuts_pecans_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_pecans_mutable() {
            set_food_name("Nuts, pecans");
            set_food_label("nuts_pecans");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(70.00000);
            set_carbohydrate_by_difference(13.86000);
            set_cholesterol(0.00000);
            set_choline(40.50000);
            ...
            set_fat(71.97000);
            set_fiber(9.60000);
            set_fluoride(10.00000);
            set_folate(22.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(691.00000);
            set_iron(2.53000);
            set_linoleic_acid(0.00000);
            set_magnesium(121.00000);
            set_manganese(4.50000);
            set_monounsaturated_fat(40.80000);
            set_niacin(1.16000);
            set_pantothenic_acid(0.86000);
            set_phosphorus(277.00000);
            set_polyunsaturated_fat(21.61000);
            set_potassium(410.00000);
            set_protein(9.17000);
            set_riboflavin(0.13000);
            set_saturated_fat(6.18000);
            set_selenium(3.80000);
            set_sodium(0.00000);
            set_thiamin(0.66000);
