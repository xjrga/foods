 ...
 */
public class Nuts_almonds implements Food {

    private final Nuts_almonds_mutable food;

    public Nuts_almonds() {
        food = new Nuts_almonds_mutable();
    }
    ...
    private class Nuts_almonds_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Nuts_almonds_mutable() {
            set_food_name("Nuts, almonds");
            set_food_label("nuts_almonds");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00300);
            set_calcium(269.00000);
            set_carbohydrate_by_difference(21.55000);
            ...
            set_iron(3.71000);
            set_linoleic_acid(12.32000);
            set_magnesium(270.00000);
            set_manganese(2.17000);
            set_monounsaturated_fat(31.55000);
            set_niacin(3.61000);
            set_pantothenic_acid(0.47000);
            set_phosphorus(481.00000);
            set_polyunsaturated_fat(12.32000);
            set_potassium(733.00000);
            set_protein(21.15000);
            set_riboflavin(1.13000);
            set_saturated_fat(3.80000);
