 ...
 */
public class Seeds_sunflower_seed_kernels_dry_roasted_without_salt implements Food {

    private final Seeds_sunflower_seed_kernels_dry_roasted_without_salt_mutable food;

    public Seeds_sunflower_seed_kernels_dry_roasted_without_salt() {
        food = new Seeds_sunflower_seed_kernels_dry_roasted_without_salt_mutable();
    }
    ...
    private class Seeds_sunflower_seed_kernels_dry_roasted_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Seeds_sunflower_seed_kernels_dry_roasted_without_salt_mutable() {
            ...
            set_calcium(70.00000);
            set_carbohydrate_by_difference(24.07000);
            set_cholesterol(0.00000);
            set_choline(55.10000);
            ...
            set_folate(237.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(582.00000);
            set_iron(3.80000);
            set_linoleic_acid(0.00000);
            set_magnesium(129.00000);
            set_manganese(2.11000);
            set_monounsaturated_fat(9.50000);
            set_niacin(7.04000);
            set_pantothenic_acid(7.04000);
            set_phosphorus(1155.00000);
            set_polyunsaturated_fat(32.88000);
            set_potassium(850.00000);
            set_protein(19.33000);
            set_riboflavin(0.24000);
            set_saturated_fat(5.21000);
            set_selenium(79.30000);
            set_sodium(3.00000);
            set_thiamin(0.10000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.80000);
            set_vitamin_c(1.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(26.10000);
            set_vitamin_k(2.70000);
            set_water(1.20000);
