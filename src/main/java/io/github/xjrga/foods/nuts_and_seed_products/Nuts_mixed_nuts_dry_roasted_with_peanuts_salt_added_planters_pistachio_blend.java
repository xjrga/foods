 ...
 */
public class Nuts_mixed_nuts_dry_roasted_with_peanuts_salt_added_planters_pistachio_blend implements Food {

    private final Nuts_mixed_nuts_dry_roasted_with_peanuts_salt_added_planters_pistachio_blend_mutable food;

    public Nuts_mixed_nuts_dry_roasted_with_peanuts_salt_added_planters_pistachio_blend() {
        food = new Nuts_mixed_nuts_dry_roasted_with_peanuts_salt_added_planters_pistachio_blend_mutable();
    }
    ...
    private class Nuts_mixed_nuts_dry_roasted_with_peanuts_salt_added_planters_pistachio_blend_mutable extends Food_abstract {
         ...
         */
        public Nuts_mixed_nuts_dry_roasted_with_peanuts_salt_added_planters_pistachio_blend_mutable() {
            ...
            set_carbohydrate_by_difference(22.51000);
            ...
            set_gross_energy(580.00000);
            set_iron(3.43000);
            set_linoleic_acid(11.53000);
            set_magnesium(209.00000);
            set_manganese(1.77000);
            set_monounsaturated_fat(27.61000);
            set_niacin(4.51000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(493.00000);
            set_polyunsaturated_fat(11.65000);
            set_potassium(758.00000);
            set_protein(21.95000);
            set_riboflavin(0.57000);
            set_saturated_fat(6.71000);
            set_selenium(11.00000);
            set_sodium(232.00000);
            set_thiamin(0.35000);
            set_vitamin_a(4.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.49000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(5.65000);
