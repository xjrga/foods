 ...
 */
public class Nuts_cashew_nuts_dry_roasted_without_salt_added implements Food {

    private final Nuts_cashew_nuts_dry_roasted_without_salt_added_mutable food;

    public Nuts_cashew_nuts_dry_roasted_without_salt_added() {
        food = new Nuts_cashew_nuts_dry_roasted_without_salt_added_mutable();
    }
    ...
    private class Nuts_cashew_nuts_dry_roasted_without_salt_added_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Nuts_cashew_nuts_dry_roasted_without_salt_added_mutable() {
            ...
            set_calcium(45.00000);
            set_carbohydrate_by_difference(32.69000);
            set_cholesterol(0.00000);
            set_choline(61.00000);
            ...
            set_gross_energy(574.00000);
            set_iron(6.00000);
            set_linoleic_acid(0.00000);
            set_magnesium(260.00000);
            set_manganese(0.82000);
            set_monounsaturated_fat(27.31000);
            set_niacin(1.40000);
            set_pantothenic_acid(1.21000);
            set_phosphorus(490.00000);
            set_polyunsaturated_fat(7.83000);
            set_potassium(565.00000);
            set_protein(15.31000);
            set_riboflavin(0.20000);
            set_saturated_fat(9.15000);
            set_selenium(11.70000);
            set_sodium(16.00000);
            set_thiamin(0.20000);
            ...
            set_vitamin_e(0.92000);
            set_vitamin_k(34.70000);
            set_water(1.70000);
