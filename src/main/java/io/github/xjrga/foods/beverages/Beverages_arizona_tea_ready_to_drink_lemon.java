 ...
 */
public class Beverages_arizona_tea_ready_to_drink_lemon implements Food {

    private final Beverages_arizona_tea_ready_to_drink_lemon_mutable food;

    public Beverages_arizona_tea_ready_to_drink_lemon() {
        food = new Beverages_arizona_tea_ready_to_drink_lemon_mutable();
    }
    ...
    private class Beverages_arizona_tea_ready_to_drink_lemon_mutable extends Food_abstract {
         ...
         */
        public Beverages_arizona_tea_ready_to_drink_lemon_mutable() {
            ...
            set_calcium(3.00000);
            set_carbohydrate_by_difference(9.77000);
