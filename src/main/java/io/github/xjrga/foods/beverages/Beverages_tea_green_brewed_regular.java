 ...
 */
public class Beverages_tea_green_brewed_regular implements Food {

    private final Beverages_tea_green_brewed_regular_mutable food;

    public Beverages_tea_green_brewed_regular() {
        food = new Beverages_tea_green_brewed_regular_mutable();
    }
    ...
    private class Beverages_tea_green_brewed_regular_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beverages_tea_green_brewed_regular_mutable() {
