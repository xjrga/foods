 ...
 */
public class Beverages_carbonated_beverage_sprite_lemon_lime_without_caffeine implements Food {

    private final Beverages_carbonated_beverage_sprite_lemon_lime_without_caffeine_mutable food;

    public Beverages_carbonated_beverage_sprite_lemon_lime_without_caffeine() {
        food = new Beverages_carbonated_beverage_sprite_lemon_lime_without_caffeine_mutable();
    }
    ...
    private class Beverages_carbonated_beverage_sprite_lemon_lime_without_caffeine_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beverages_carbonated_beverage_sprite_lemon_lime_without_caffeine_mutable() {
            ...
            set_calcium(2.00000);
            set_carbohydrate_by_difference(10.14000);
