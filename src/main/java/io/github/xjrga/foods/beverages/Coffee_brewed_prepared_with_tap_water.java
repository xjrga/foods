 ...
 */
public class Coffee_brewed_prepared_with_tap_water implements Food {

    private final Coffee_brewed_prepared_with_tap_water_mutable food;

    public Coffee_brewed_prepared_with_tap_water() {
        food = new Coffee_brewed_prepared_with_tap_water_mutable();
    }
    ...
    private class Coffee_brewed_prepared_with_tap_water_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Coffee_brewed_prepared_with_tap_water_mutable() {
            ...
            set_polyunsaturated_fat(0.00100);
            set_potassium(49.00000);
            set_protein(0.12000);
