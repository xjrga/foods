 ...
 */
public class Beverages_tea_oolong_brewed implements Food {

    private final Beverages_tea_oolong_brewed_mutable food;

    public Beverages_tea_oolong_brewed() {
        food = new Beverages_tea_oolong_brewed_mutable();
    }
    ...
    private class Beverages_tea_oolong_brewed_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beverages_tea_oolong_brewed_mutable() {
            set_food_name("Beverages, tea, Oolong, brewed");
            set_food_label("beverages_tea_oolong_brewed");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(1.00000);
            set_carbohydrate_by_difference(0.15000);
