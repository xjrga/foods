 ...
 */
public class Beverages_tea_black_brewed_prepared_with_tap_water implements Food {

    private final Beverages_tea_black_brewed_prepared_with_tap_water_mutable food;

    public Beverages_tea_black_brewed_prepared_with_tap_water() {
        food = new Beverages_tea_black_brewed_prepared_with_tap_water_mutable();
    }
    ...
    private class Beverages_tea_black_brewed_prepared_with_tap_water_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beverages_tea_black_brewed_prepared_with_tap_water_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(0.30000);
            ...
            set_fat(0.00000);
            set_fiber(0.00000);
            set_fluoride(372.90000);
            set_folate(5.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(1.00000);
            set_iron(0.02000);
            ...
            set_niacin(0.00000);
            set_pantothenic_acid(0.01000);
            set_phosphorus(1.00000);
            set_polyunsaturated_fat(0.00400);
            set_potassium(37.00000);
            set_protein(0.00000);
            set_riboflavin(0.01000);
            set_saturated_fat(0.00200);
