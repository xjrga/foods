 ...
 */
public class Alcoholic_beverage_wine_table_red implements Food {

    private final Alcoholic_beverage_wine_table_red_mutable food;

    public Alcoholic_beverage_wine_table_red() {
        food = new Alcoholic_beverage_wine_table_red_mutable();
    }
    ...
    private class Alcoholic_beverage_wine_table_red_mutable extends Food_abstract {
        ...
        public Alcoholic_beverage_wine_table_red_mutable() {
            ...
            set_niacin(0.22000);
            set_pantothenic_acid(0.03000);
            set_phosphorus(23.00000);
