 ...
 */
public class Alcoholic_beverage_beer_regular_all implements Food {

    private final Alcoholic_beverage_beer_regular_all_mutable food;

    public Alcoholic_beverage_beer_regular_all() {
        food = new Alcoholic_beverage_beer_regular_all_mutable();
    }
    ...
    private class Alcoholic_beverage_beer_regular_all_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Alcoholic_beverage_beer_regular_all_mutable() {
            ...
            set_calcium(4.00000);
            set_carbohydrate_by_difference(3.55000);
            set_cholesterol(0.00000);
            set_choline(10.10000);
            ...
            set_fat(0.00000);
            set_fiber(0.00000);
            set_fluoride(44.20000);
            set_folate(6.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(43.00000);
            set_iron(0.02000);
            set_linoleic_acid(0.00000);
            set_magnesium(6.00000);
            set_manganese(0.00800);
            set_monounsaturated_fat(0.00000);
            set_niacin(0.51000);
            set_pantothenic_acid(0.04000);
            set_phosphorus(14.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(27.00000);
            set_protein(0.46000);
