 ...
 */
public class Alcoholic_beverage_wine_table_white implements Food {

    private final Alcoholic_beverage_wine_table_white_mutable food;

    public Alcoholic_beverage_wine_table_white() {
        food = new Alcoholic_beverage_wine_table_white_mutable();
    }
    ...
    private class Alcoholic_beverage_wine_table_white_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Alcoholic_beverage_wine_table_white_mutable() {
            set_food_name("Alcoholic beverage, wine, table, white");
            set_food_label("alcoholic_beverage_wine_table_white");
            set_alcohol(10.30000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(2.60000);
            ...
            set_phosphorus(18.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(71.00000);
            set_protein(0.07000);
