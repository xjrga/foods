 ...
 */
public class Alcoholic_beverage_liqueur_coffee_53_proof implements Food {

    private final Alcoholic_beverage_liqueur_coffee_53_proof_mutable food;

    public Alcoholic_beverage_liqueur_coffee_53_proof() {
        food = new Alcoholic_beverage_liqueur_coffee_53_proof_mutable();
    }
    ...
    private class Alcoholic_beverage_liqueur_coffee_53_proof_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Alcoholic_beverage_liqueur_coffee_53_proof_mutable() {
            set_food_name("Alcoholic beverage, liqueur, coffee, 53 proof");
            set_food_label("alcoholic_beverage_liqueur_coffee_53_proof");
            set_alcohol(21.70000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(1.00000);
            set_carbohydrate_by_difference(46.80000);
            ...
            set_phosphorus(6.00000);
            set_polyunsaturated_fat(0.10000);
            set_potassium(30.00000);
            set_protein(0.10000);
