 ...
 */
public class Alcoholic_beverage_beer_light implements Food {

    private final Alcoholic_beverage_beer_light_mutable food;

    public Alcoholic_beverage_beer_light() {
        food = new Alcoholic_beverage_beer_light_mutable();
    }
    ...
    private class Alcoholic_beverage_beer_light_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Alcoholic_beverage_beer_light_mutable() {
            set_food_name("Alcoholic beverage, beer, light");
            set_food_label("alcoholic_beverage_beer_light");
            set_alcohol(3.10000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(4.00000);
            set_carbohydrate_by_difference(1.64000);
