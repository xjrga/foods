 ...
 */
public class Generic_multivitamin implements Food {

    private final Generic_multivitamin_mutable food;

    public Generic_multivitamin() {
        food = new Generic_multivitamin_mutable();
    }
    ...
    private class Generic_multivitamin_mutable extends Food_abstract {
        ...
        public Generic_multivitamin_mutable() {
            ...
            set_folate(680.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(0.00000);
            set_iron(0.00000);
            set_linoleic_acid(0.00000);
            set_magnesium(50.00000);
            set_manganese(2.30000);
            set_monounsaturated_fat(0.00000);
            set_niacin(20.00000);
            set_pantothenic_acid(10.00000);
            set_phosphorus(20.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(80.00000);
            set_protein(0.00000);
            set_riboflavin(1.70000);
            set_saturated_fat(0.00000);
            set_selenium(19.00000);
            set_sodium(0.00000);
            set_thiamin(1.50000);
            set_vitamin_a(750.00000);
            set_vitamin_b12(25.00000);
            set_vitamin_b6(3.00000);
            set_vitamin_c(60.00000);
            set_vitamin_d(25.00000);
            set_vitamin_e(50.00000);
            set_vitamin_k(30.00000);
            set_water(0.00000);
            set_weight(1.40000);
            set_zinc(11.00000);
