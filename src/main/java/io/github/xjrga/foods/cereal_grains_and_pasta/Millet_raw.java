 ...
 */
public class Millet_raw implements Food {

    private final Millet_raw_mutable food;

    public Millet_raw() {
        food = new Millet_raw_mutable();
    }
    ...
    private class Millet_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Millet_raw_mutable() {
            set_food_name("Millet, raw");
            set_food_label("millet_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(8.00000);
            set_carbohydrate_by_difference(72.85000);
            ...
            set_magnesium(114.00000);
            set_manganese(1.63000);
            set_monounsaturated_fat(0.77000);
            set_niacin(4.72000);
            set_pantothenic_acid(0.84000);
            set_phosphorus(285.00000);
            set_polyunsaturated_fat(2.13000);
            set_potassium(195.00000);
            set_protein(11.02000);
            set_riboflavin(0.29000);
            set_saturated_fat(0.72000);
            set_selenium(2.70000);
            set_sodium(5.00000);
            set_thiamin(0.42000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.38000);
