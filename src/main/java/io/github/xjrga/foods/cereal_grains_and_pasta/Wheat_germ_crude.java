 ...
 */
public class Wheat_germ_crude implements Food {

    private final Wheat_germ_crude_mutable food;

    public Wheat_germ_crude() {
        food = new Wheat_germ_crude_mutable();
    }
    ...
    private class Wheat_germ_crude_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Wheat_germ_crude_mutable() {
            set_food_name("Wheat germ, crude");
            set_food_label("wheat_germ_crude");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(39.00000);
            set_carbohydrate_by_difference(51.80000);
            ...
            set_folate(281.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(360.00000);
            set_iron(6.26000);
            set_linoleic_acid(0.00000);
            set_magnesium(239.00000);
            set_manganese(13.30000);
            set_monounsaturated_fat(1.36000);
            set_niacin(6.81000);
            set_pantothenic_acid(2.25000);
            set_phosphorus(842.00000);
            set_polyunsaturated_fat(6.01000);
            set_potassium(892.00000);
            set_protein(23.15000);
            set_riboflavin(0.49000);
            set_saturated_fat(1.66000);
            set_selenium(79.20000);
            set_sodium(12.00000);
            set_thiamin(1.88000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(1.30000);
