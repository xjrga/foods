 ...
 */
public class Oat_bran_raw implements Food {

    private final Oat_bran_raw_mutable food;

    public Oat_bran_raw() {
        food = new Oat_bran_raw_mutable();
    }
    ...
    private class Oat_bran_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oat_bran_raw_mutable() {
            set_food_name("Oat bran, raw");
            set_food_label("oat_bran_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(58.00000);
            set_carbohydrate_by_difference(66.22000);
            ...
            set_gross_energy(246.00000);
            set_iron(5.41000);
            set_linoleic_acid(0.00000);
            set_magnesium(235.00000);
            set_manganese(5.63000);
            set_monounsaturated_fat(2.37000);
            set_niacin(0.93000);
            set_pantothenic_acid(1.49000);
            set_phosphorus(734.00000);
            set_polyunsaturated_fat(2.76000);
            set_potassium(566.00000);
            set_protein(17.30000);
            set_riboflavin(0.22000);
            set_saturated_fat(1.32000);
            set_selenium(45.20000);
            set_sodium(4.00000);
            set_thiamin(1.17000);
            ...
            set_vitamin_e(1.01000);
            set_vitamin_k(3.20000);
            set_water(6.55000);
