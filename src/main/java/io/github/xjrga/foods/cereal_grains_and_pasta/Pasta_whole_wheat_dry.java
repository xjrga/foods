 ...
 */
public class Pasta_whole_wheat_dry implements Food {

    private final Pasta_whole_wheat_dry_mutable food;

    public Pasta_whole_wheat_dry() {
        food = new Pasta_whole_wheat_dry_mutable();
    }
    ...
    private class Pasta_whole_wheat_dry_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Pasta_whole_wheat_dry_mutable() {
            set_food_name("Pasta, whole-wheat, dry");
            set_food_label("pasta_whole_wheat_dry");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.07000);
            set_calcium(29.00000);
            set_carbohydrate_by_difference(73.37000);
            ...
            set_iron(3.62000);
            set_linoleic_acid(1.06000);
            set_magnesium(128.00000);
            set_manganese(2.98000);
            set_monounsaturated_fat(0.36000);
            set_niacin(8.69000);
            set_pantothenic_acid(0.87000);
            set_phosphorus(343.00000);
            set_polyunsaturated_fat(1.13000);
            set_potassium(434.00000);
            set_protein(13.87000);
            set_riboflavin(0.21000);
            set_saturated_fat(0.42000);
            set_selenium(77.60000);
            set_sodium(6.00000);
            set_thiamin(0.40000);
