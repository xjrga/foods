 ...
 */
public class Couscous_dry implements Food {

    private final Couscous_dry_mutable food;

    public Couscous_dry() {
        food = new Couscous_dry_mutable();
    }
    ...
    private class Couscous_dry_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Couscous_dry_mutable() {
            set_food_name("Couscous, dry");
            set_food_label("couscous_dry");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(24.00000);
            set_carbohydrate_by_difference(77.43000);
