 ...
 */
public class Pasta_dry_enriched implements Food {

    private final Pasta_dry_enriched_mutable food;

    public Pasta_dry_enriched() {
        food = new Pasta_dry_enriched_mutable();
    }
    ...
    private class Pasta_dry_enriched_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pasta_dry_enriched_mutable() {
            set_food_name("Pasta, dry, enriched");
            set_food_label("pasta_dry_enriched");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.02000);
            set_calcium(21.00000);
            set_carbohydrate_by_difference(74.67000);
            ...
            set_fat(1.51000);
            set_fiber(3.20000);
            set_fluoride(18.00000);
            set_folate(391.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(371.00000);
            set_iron(3.30000);
            set_linoleic_acid(0.00000);
            set_magnesium(53.00000);
            set_manganese(0.91000);
            set_monounsaturated_fat(0.17000);
            set_niacin(7.17000);
            set_pantothenic_acid(0.43000);
            set_phosphorus(189.00000);
            set_polyunsaturated_fat(0.56000);
            set_potassium(223.00000);
            set_protein(13.04000);
            set_riboflavin(0.40000);
            set_saturated_fat(0.27000);
            set_selenium(63.20000);
            set_sodium(6.00000);
            set_thiamin(0.89000);
