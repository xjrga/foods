 ...
 */
public class Rice_white_long_grain_regular_raw_enriched implements Food {

    private final Rice_white_long_grain_regular_raw_enriched_mutable food;

    public Rice_white_long_grain_regular_raw_enriched() {
        food = new Rice_white_long_grain_regular_raw_enriched_mutable();
    }
    ...
    private class Rice_white_long_grain_regular_raw_enriched_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Rice_white_long_grain_regular_raw_enriched_mutable() {
            ...
            set_carbohydrate_by_difference(79.95000);
            ...
            set_folate(387.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(365.00000);
            set_iron(4.31000);
            set_linoleic_acid(0.00000);
            set_magnesium(25.00000);
            set_manganese(1.08000);
            set_monounsaturated_fat(0.20000);
            set_niacin(4.19000);
            set_pantothenic_acid(1.01000);
            set_phosphorus(115.00000);
            set_polyunsaturated_fat(0.17000);
            set_potassium(115.00000);
            set_protein(7.13000);
            set_riboflavin(0.04000);
            set_saturated_fat(0.18000);
            set_selenium(15.10000);
            set_sodium(5.00000);
            set_thiamin(0.57000);
