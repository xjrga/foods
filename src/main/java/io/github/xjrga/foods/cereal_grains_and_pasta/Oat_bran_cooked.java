 ...
 */
public class Oat_bran_cooked implements Food {

    private final Oat_bran_cooked_mutable food;

    public Oat_bran_cooked() {
        food = new Oat_bran_cooked_mutable();
    }
    ...
    private class Oat_bran_cooked_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oat_bran_cooked_mutable() {
            set_food_name("Oat bran, cooked");
            set_food_label("oat_bran_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(10.00000);
            set_carbohydrate_by_difference(11.44000);
