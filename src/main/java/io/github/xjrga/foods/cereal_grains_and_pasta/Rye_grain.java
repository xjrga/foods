 ...
 */
public class Rye_grain implements Food {

    private final Rye_grain_mutable food;

    public Rye_grain() {
        food = new Rye_grain_mutable();
    }
    ...
    private class Rye_grain_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Rye_grain_mutable() {
            set_food_name("Rye grain");
            set_food_label("rye_grain");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(24.00000);
            set_carbohydrate_by_difference(75.86000);
            set_cholesterol(0.00000);
            set_choline(30.40000);
            ...
            set_gross_energy(338.00000);
            set_iron(2.63000);
            set_linoleic_acid(0.00000);
            set_magnesium(110.00000);
            set_manganese(2.57000);
            set_monounsaturated_fat(0.20000);
            set_niacin(4.27000);
            set_pantothenic_acid(1.45000);
            set_phosphorus(332.00000);
            set_polyunsaturated_fat(0.76000);
            set_potassium(510.00000);
