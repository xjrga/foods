 ...
 */
public class Rice_brown_medium_grain_raw implements Food {

    private final Rice_brown_medium_grain_raw_mutable food;

    public Rice_brown_medium_grain_raw() {
        food = new Rice_brown_medium_grain_raw_mutable();
    }
    ...
    private class Rice_brown_medium_grain_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_brown_medium_grain_raw_mutable() {
            set_food_name("Rice, brown, medium-grain, raw");
            set_food_label("rice_brown_medium_grain_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(33.00000);
            set_carbohydrate_by_difference(76.17000);
            ...
            set_gross_energy(362.00000);
            set_iron(1.80000);
            set_linoleic_acid(0.00000);
            set_magnesium(143.00000);
            set_manganese(3.74000);
            set_monounsaturated_fat(0.97000);
            set_niacin(4.30000);
            set_pantothenic_acid(1.49000);
            set_phosphorus(264.00000);
            set_polyunsaturated_fat(0.95000);
            set_potassium(268.00000);
            set_protein(7.50000);
            set_riboflavin(0.04000);
            set_saturated_fat(0.53000);
            set_selenium(0.00000);
            set_sodium(4.00000);
            set_thiamin(0.41000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.50000);
