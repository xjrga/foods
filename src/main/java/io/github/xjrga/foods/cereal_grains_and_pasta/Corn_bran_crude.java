 ...
 */
public class Corn_bran_crude implements Food {

    private final Corn_bran_crude_mutable food;

    public Corn_bran_crude() {
        food = new Corn_bran_crude_mutable();
    }
    ...
    private class Corn_bran_crude_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Corn_bran_crude_mutable() {
            set_food_name("Corn bran, crude");
            set_food_label("corn_bran_crude");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(42.00000);
            set_carbohydrate_by_difference(85.64000);
