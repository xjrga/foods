 ...
 */
public class Rice_bran_crude implements Food {

    private final Rice_bran_crude_mutable food;

    public Rice_bran_crude() {
        food = new Rice_bran_crude_mutable();
    }
    ...
    private class Rice_bran_crude_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Rice_bran_crude_mutable() {
            set_food_name("Rice bran, crude");
            set_food_label("rice_bran_crude");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(57.00000);
            set_carbohydrate_by_difference(49.69000);
            set_cholesterol(0.00000);
            set_choline(32.20000);
            ...
            set_gross_energy(316.00000);
            set_iron(18.54000);
            set_linoleic_acid(0.00000);
            set_magnesium(781.00000);
            set_manganese(14.21000);
            set_monounsaturated_fat(7.54000);
            set_niacin(33.99000);
            set_pantothenic_acid(7.39000);
            set_phosphorus(1677.00000);
            set_polyunsaturated_fat(7.45000);
            set_potassium(1485.00000);
            set_protein(13.35000);
            set_riboflavin(0.28000);
            set_saturated_fat(4.17000);
            set_selenium(15.60000);
            set_sodium(5.00000);
            set_thiamin(2.75000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(4.07000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(4.92000);
