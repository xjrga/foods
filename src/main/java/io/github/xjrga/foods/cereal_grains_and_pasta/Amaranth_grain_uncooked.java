 ...
 */
public class Amaranth_grain_uncooked implements Food {

    private final Amaranth_grain_uncooked_mutable food;

    public Amaranth_grain_uncooked() {
        food = new Amaranth_grain_uncooked_mutable();
    }
    ...
    private class Amaranth_grain_uncooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Amaranth_grain_uncooked_mutable() {
            set_food_name("Amaranth grain, uncooked");
            set_food_label("amaranth_grain_uncooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.04000);
            set_calcium(159.00000);
            set_carbohydrate_by_difference(65.25000);
            set_cholesterol(0.00000);
            set_choline(69.80000);
            ...
            set_gross_energy(371.00000);
            set_iron(7.61000);
            set_linoleic_acid(0.00000);
            set_magnesium(248.00000);
            set_manganese(3.33000);
            set_monounsaturated_fat(1.68000);
            set_niacin(0.92000);
            set_pantothenic_acid(1.45000);
            set_phosphorus(557.00000);
            set_polyunsaturated_fat(2.77000);
            set_potassium(508.00000);
            set_protein(13.56000);
            set_riboflavin(0.20000);
            set_saturated_fat(1.45000);
            set_selenium(18.70000);
            set_sodium(4.00000);
            set_thiamin(0.11000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.59000);
            set_vitamin_c(4.20000);
