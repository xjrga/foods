 ...
 */
public class Sorghum_grain implements Food {

    private final Sorghum_grain_mutable food;

    public Sorghum_grain() {
        food = new Sorghum_grain_mutable();
    }
