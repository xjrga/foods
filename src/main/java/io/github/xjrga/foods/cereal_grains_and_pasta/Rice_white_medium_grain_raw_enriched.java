 ...
 */
public class Rice_white_medium_grain_raw_enriched implements Food {

    private final Rice_white_medium_grain_raw_enriched_mutable food;

    public Rice_white_medium_grain_raw_enriched() {
        food = new Rice_white_medium_grain_raw_enriched_mutable();
    }
    ...
    private class Rice_white_medium_grain_raw_enriched_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Rice_white_medium_grain_raw_enriched_mutable() {
            ...
            set_calcium(9.00000);
            set_carbohydrate_by_difference(79.34000);
            ...
            set_folate(386.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(360.00000);
            set_iron(4.36000);
            set_linoleic_acid(0.00000);
            set_magnesium(35.00000);
            set_manganese(1.10000);
            set_monounsaturated_fat(0.18000);
            set_niacin(5.09000);
            set_pantothenic_acid(1.34000);
            set_phosphorus(108.00000);
            set_polyunsaturated_fat(0.15000);
            set_potassium(86.00000);
            set_protein(6.61000);
            set_riboflavin(0.04000);
            set_saturated_fat(0.15000);
            set_selenium(15.10000);
            set_sodium(1.00000);
            set_thiamin(0.57000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.14000);
