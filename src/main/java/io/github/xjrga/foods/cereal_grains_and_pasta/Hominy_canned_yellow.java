 ...
 */
public class Hominy_canned_yellow implements Food {

    private final Hominy_canned_yellow_mutable food;

    public Hominy_canned_yellow() {
        food = new Hominy_canned_yellow_mutable();
    }
    ...
    private class Hominy_canned_yellow_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Hominy_canned_yellow_mutable() {
