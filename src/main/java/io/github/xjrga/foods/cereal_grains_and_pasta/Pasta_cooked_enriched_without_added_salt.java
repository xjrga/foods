 ...
 */
public class Pasta_cooked_enriched_without_added_salt implements Food {

    private final Pasta_cooked_enriched_without_added_salt_mutable food;

    public Pasta_cooked_enriched_without_added_salt() {
        food = new Pasta_cooked_enriched_without_added_salt_mutable();
    }
    ...
    private class Pasta_cooked_enriched_without_added_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Pasta_cooked_enriched_without_added_salt_mutable() {
            ...
            set_calcium(7.00000);
            set_carbohydrate_by_difference(30.86000);
            ...
            set_folate(119.00000);
            set_glycemic_index(42.00000);
            set_gross_energy(158.00000);
            set_iron(1.28000);
            set_linoleic_acid(0.00000);
            set_magnesium(18.00000);
            set_manganese(0.32000);
            set_monounsaturated_fat(0.13000);
            set_niacin(1.68000);
            set_pantothenic_acid(0.11000);
            set_phosphorus(58.00000);
            set_polyunsaturated_fat(0.32000);
            set_potassium(44.00000);
            set_protein(5.80000);
            set_riboflavin(0.13000);
            set_saturated_fat(0.17000);
            set_selenium(26.40000);
            set_sodium(1.00000);
            set_thiamin(0.27000);
