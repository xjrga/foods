 ...
 */
public class Rice_white_glutinous_unenriched_uncooked implements Food {

    private final Rice_white_glutinous_unenriched_uncooked_mutable food;

    public Rice_white_glutinous_unenriched_uncooked() {
        food = new Rice_white_glutinous_unenriched_uncooked_mutable();
    }
    ...
    private class Rice_white_glutinous_unenriched_uncooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_white_glutinous_unenriched_uncooked_mutable() {
            ...
            set_carbohydrate_by_difference(81.68000);
            ...
            set_niacin(2.14000);
            set_pantothenic_acid(0.82000);
            set_phosphorus(71.00000);
            set_polyunsaturated_fat(0.19000);
            set_potassium(77.00000);
            set_protein(6.81000);
