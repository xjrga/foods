 ...
 */
public class Amaranth_grain_cooked implements Food {

    private final Amaranth_grain_cooked_mutable food;

    public Amaranth_grain_cooked() {
        food = new Amaranth_grain_cooked_mutable();
    }
    ...
    private class Amaranth_grain_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Amaranth_grain_cooked_mutable() {
            ...
            set_carbohydrate_by_difference(18.69000);
