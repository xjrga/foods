 ...
 */
public class Rice_white_short_grain_enriched_uncooked implements Food {

    private final Rice_white_short_grain_enriched_uncooked_mutable food;

    public Rice_white_short_grain_enriched_uncooked() {
        food = new Rice_white_short_grain_enriched_uncooked_mutable();
    }
    ...
    private class Rice_white_short_grain_enriched_uncooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_white_short_grain_enriched_uncooked_mutable() {
            ...
            set_calcium(3.00000);
            set_carbohydrate_by_difference(79.15000);
            ...
            set_monounsaturated_fat(0.16000);
            set_niacin(4.11000);
            set_pantothenic_acid(1.28000);
            set_phosphorus(95.00000);
            set_polyunsaturated_fat(0.13000);
            set_potassium(76.00000);
            set_protein(6.50000);
            set_riboflavin(0.04000);
            set_saturated_fat(0.14000);
