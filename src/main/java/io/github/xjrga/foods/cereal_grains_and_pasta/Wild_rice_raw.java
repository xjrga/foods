 ...
 */
public class Wild_rice_raw implements Food {

    private final Wild_rice_raw_mutable food;

    public Wild_rice_raw() {
        food = new Wild_rice_raw_mutable();
    }
    ...
    private class Wild_rice_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Wild_rice_raw_mutable() {
            set_food_name("Wild rice, raw");
            set_food_label("wild_rice_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(21.00000);
            set_carbohydrate_by_difference(74.90000);
            set_cholesterol(0.00000);
            set_choline(35.00000);
            ...
            set_gross_energy(357.00000);
            set_iron(1.96000);
            set_linoleic_acid(0.00000);
            set_magnesium(177.00000);
            set_manganese(1.32000);
            set_monounsaturated_fat(0.15000);
            set_niacin(6.73000);
            set_pantothenic_acid(1.07000);
            set_phosphorus(433.00000);
            set_polyunsaturated_fat(0.67000);
            set_potassium(427.00000);
            set_protein(14.73000);
