 ...
 */
public class Wheat_bran_crude implements Food {

    private final Wheat_bran_crude_mutable food;

    public Wheat_bran_crude() {
        food = new Wheat_bran_crude_mutable();
    }
    ...
    private class Wheat_bran_crude_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Wheat_bran_crude_mutable() {
            set_food_name("Wheat bran, crude");
            set_food_label("wheat_bran_crude");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(73.00000);
            set_carbohydrate_by_difference(64.51000);
            set_cholesterol(0.00000);
            set_choline(74.40000);
            ...
            set_gross_energy(216.00000);
            set_iron(10.57000);
            set_linoleic_acid(0.00000);
            set_magnesium(611.00000);
            set_manganese(11.50000);
            set_monounsaturated_fat(0.63000);
            set_niacin(13.57000);
            set_pantothenic_acid(2.18000);
            set_phosphorus(1013.00000);
            set_polyunsaturated_fat(2.21000);
            set_potassium(1182.00000);
            set_protein(15.55000);
