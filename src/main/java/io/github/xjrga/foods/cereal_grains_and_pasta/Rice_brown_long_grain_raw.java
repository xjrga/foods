 ...
 */
public class Rice_brown_long_grain_raw implements Food {

    private final Rice_brown_long_grain_raw_mutable food;

    public Rice_brown_long_grain_raw() {
        food = new Rice_brown_long_grain_raw_mutable();
    }
    ...
    private class Rice_brown_long_grain_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_brown_long_grain_raw_mutable() {
            set_food_name("Rice, brown, long-grain, raw");
            set_food_label("rice_brown_long_grain_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.03000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(76.25000);
            set_cholesterol(0.00000);
            set_choline(21.50000);
            ...
            set_gross_energy(367.00000);
            set_iron(1.29000);
            set_linoleic_acid(0.96000);
            set_magnesium(116.00000);
            set_manganese(2.85000);
            set_monounsaturated_fat(1.05000);
            set_niacin(6.49000);
            set_pantothenic_acid(1.06000);
            set_phosphorus(311.00000);
            set_polyunsaturated_fat(1.00000);
            set_potassium(250.00000);
            set_protein(7.54000);
            set_riboflavin(0.09000);
            set_saturated_fat(0.59000);
            set_selenium(17.10000);
            set_sodium(5.00000);
            set_thiamin(0.54000);
