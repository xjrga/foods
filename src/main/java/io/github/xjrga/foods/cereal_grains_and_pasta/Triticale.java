 ...
 */
public class Triticale implements Food {

    private final Triticale_mutable food;

    public Triticale() {
        food = new Triticale_mutable();
    }
    ...
    private class Triticale_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Triticale_mutable() {
            set_food_name("Triticale");
            set_food_label("triticale");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(37.00000);
            set_carbohydrate_by_difference(72.13000);
            ...
            set_manganese(3.21000);
            set_monounsaturated_fat(0.21000);
            set_niacin(1.43000);
            set_pantothenic_acid(1.32000);
            set_phosphorus(358.00000);
            set_polyunsaturated_fat(0.91000);
            set_potassium(332.00000);
            set_protein(13.05000);
