 ...
 */
public class Quinoa_cooked implements Food {

    private final Quinoa_cooked_mutable food;

    public Quinoa_cooked() {
        food = new Quinoa_cooked_mutable();
    }
    ...
    private class Quinoa_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Quinoa_cooked_mutable() {
            set_food_name("Quinoa, cooked");
            set_food_label("quinoa_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(17.00000);
            set_carbohydrate_by_difference(21.30000);
            ...
            set_phosphorus(152.00000);
            set_polyunsaturated_fat(1.07000);
