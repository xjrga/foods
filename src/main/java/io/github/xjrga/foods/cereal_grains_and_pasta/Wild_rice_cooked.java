 ...
 */
public class Wild_rice_cooked implements Food {

    private final Wild_rice_cooked_mutable food;

    public Wild_rice_cooked() {
        food = new Wild_rice_cooked_mutable();
    }
    ...
    private class Wild_rice_cooked_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Wild_rice_cooked_mutable() {
            set_food_name("Wild rice, cooked");
            set_food_label("wild_rice_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(3.00000);
            set_carbohydrate_by_difference(21.34000);
