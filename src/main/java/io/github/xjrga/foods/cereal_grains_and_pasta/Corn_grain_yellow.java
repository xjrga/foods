 ...
 */
public class Corn_grain_yellow implements Food {

    private final Corn_grain_yellow_mutable food;

    public Corn_grain_yellow() {
        food = new Corn_grain_yellow_mutable();
    }
    ...
    private class Corn_grain_yellow_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Corn_grain_yellow_mutable() {
