 ...
 */
public class Millet_cooked implements Food {

    private final Millet_cooked_mutable food;

    public Millet_cooked() {
        food = new Millet_cooked_mutable();
    }
    ...
    private class Millet_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Millet_cooked_mutable() {
            set_food_name("Millet, cooked");
            set_food_label("millet_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(3.00000);
            set_carbohydrate_by_difference(23.67000);
            set_cholesterol(0.00000);
            set_choline(11.20000);
