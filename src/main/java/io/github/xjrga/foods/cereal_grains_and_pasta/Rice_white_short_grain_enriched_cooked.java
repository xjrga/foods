 ...
 */
public class Rice_white_short_grain_enriched_cooked implements Food {

    private final Rice_white_short_grain_enriched_cooked_mutable food;

    public Rice_white_short_grain_enriched_cooked() {
        food = new Rice_white_short_grain_enriched_cooked_mutable();
    }
    ...
    private class Rice_white_short_grain_enriched_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_white_short_grain_enriched_cooked_mutable() {
            ...
            set_calcium(1.00000);
            set_carbohydrate_by_difference(28.73000);
            ...
            set_magnesium(8.00000);
            set_manganese(0.35000);
            set_monounsaturated_fat(0.05000);
            set_niacin(1.49000);
            set_pantothenic_acid(0.39000);
            set_phosphorus(33.00000);
            set_polyunsaturated_fat(0.05000);
            set_potassium(26.00000);
            set_protein(2.36000);
