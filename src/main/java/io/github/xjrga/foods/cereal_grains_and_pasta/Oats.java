...
public class Oats implements Food {
    ...
    private final Oats_mutable food;

    public Oats() {
        food = new Oats_mutable();
    }
    ...
    private class Oats_mutable extends Abstract_food {
        ...
        public Oats_mutable() {
            ...
            set_carbohydrate_by_difference(66.27000);
            ...
            set_gross_energy(389.00000);
            set_iron(4.72000);
            set_linoleic_acid(0.00000);
            set_magnesium(177.00000);
            set_manganese(4.91000);
            set_monounsaturated_fat(2.17000);
            set_niacin(0.96000);
            set_pantothenic_acid(1.34000);
            set_phosphorus(523.00000);
            set_polyunsaturated_fat(2.53000);
            set_potassium(429.00000);
            set_protein(16.89000);
            set_riboflavin(0.13000);
            set_saturated_fat(1.21000);
