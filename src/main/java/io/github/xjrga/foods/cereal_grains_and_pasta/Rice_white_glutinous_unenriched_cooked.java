 ...
 */
public class Rice_white_glutinous_unenriched_cooked implements Food {

    private final Rice_white_glutinous_unenriched_cooked_mutable food;

    public Rice_white_glutinous_unenriched_cooked() {
        food = new Rice_white_glutinous_unenriched_cooked_mutable();
    }
    ...
    private class Rice_white_glutinous_unenriched_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_white_glutinous_unenriched_cooked_mutable() {
            ...
            set_calcium(2.00000);
            set_carbohydrate_by_difference(21.09000);
