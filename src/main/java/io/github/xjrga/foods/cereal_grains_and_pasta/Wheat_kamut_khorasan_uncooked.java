 ...
 */
public class Wheat_kamut_khorasan_uncooked implements Food {

    private final Wheat_kamut_khorasan_uncooked_mutable food;

    public Wheat_kamut_khorasan_uncooked() {
        food = new Wheat_kamut_khorasan_uncooked_mutable();
    }
    ...
    private class Wheat_kamut_khorasan_uncooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Wheat_kamut_khorasan_uncooked_mutable() {
            ...
            set_carbohydrate_by_difference(70.58000);
            set_cholesterol(0.00000);
            set_choline(25.80000);
            ...
            set_magnesium(130.00000);
            set_manganese(2.73000);
            set_monounsaturated_fat(0.21000);
            set_niacin(6.37000);
            set_pantothenic_acid(0.94000);
            set_phosphorus(364.00000);
            set_polyunsaturated_fat(0.62000);
            set_potassium(403.00000);
            set_protein(14.54000);
            set_riboflavin(0.18000);
            set_saturated_fat(0.19000);
            set_selenium(81.50000);
            set_sodium(5.00000);
            set_thiamin(0.56000);
