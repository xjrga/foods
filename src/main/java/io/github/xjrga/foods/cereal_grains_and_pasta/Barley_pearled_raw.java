 ...
 */
public class Barley_pearled_raw implements Food {

    private final Barley_pearled_raw_mutable food;

    public Barley_pearled_raw() {
        food = new Barley_pearled_raw_mutable();
    }
    ...
    private class Barley_pearled_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Barley_pearled_raw_mutable() {
            set_food_name("Barley, pearled, raw");
            set_food_label("barley_pearled_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(29.00000);
            set_carbohydrate_by_difference(77.72000);
            set_cholesterol(0.00000);
            set_choline(37.80000);
