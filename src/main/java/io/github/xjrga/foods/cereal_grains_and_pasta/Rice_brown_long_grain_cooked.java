 ...
 */
public class Rice_brown_long_grain_cooked implements Food {

    private final Rice_brown_long_grain_cooked_mutable food;

    public Rice_brown_long_grain_cooked() {
        food = new Rice_brown_long_grain_cooked_mutable();
    }
    ...
    private class Rice_brown_long_grain_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_brown_long_grain_cooked_mutable() {
            set_food_name("Rice, brown, long-grain, cooked");
            set_food_label("rice_brown_long_grain_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.01000);
            set_calcium(3.00000);
            set_carbohydrate_by_difference(25.58000);
