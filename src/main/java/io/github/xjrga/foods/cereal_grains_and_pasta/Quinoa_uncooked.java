 ...
 */
public class Quinoa_uncooked implements Food {

    private final Quinoa_uncooked_mutable food;

    public Quinoa_uncooked() {
        food = new Quinoa_uncooked_mutable();
    }
    ...
    private class Quinoa_uncooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Quinoa_uncooked_mutable() {
            set_food_name("Quinoa, uncooked");
            set_food_label("quinoa_uncooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(47.00000);
            set_carbohydrate_by_difference(64.16000);
            set_cholesterol(0.00000);
            set_choline(70.20000);
            ...
            set_folate(184.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(368.00000);
            set_iron(4.57000);
            set_linoleic_acid(0.00000);
            set_magnesium(197.00000);
            set_manganese(2.03000);
            set_monounsaturated_fat(1.61000);
            set_niacin(1.52000);
            set_pantothenic_acid(0.77000);
            set_phosphorus(457.00000);
            set_polyunsaturated_fat(3.29000);
            set_potassium(563.00000);
            set_protein(14.12000);
            set_riboflavin(0.31000);
            set_saturated_fat(0.70000);
            set_selenium(8.50000);
            set_sodium(5.00000);
            set_thiamin(0.36000);
            set_vitamin_a(1.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.48000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(2.44000);
