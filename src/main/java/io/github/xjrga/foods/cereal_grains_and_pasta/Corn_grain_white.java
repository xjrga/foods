 ...
 */
public class Corn_grain_white implements Food {

    private final Corn_grain_white_mutable food;

    public Corn_grain_white() {
        food = new Corn_grain_white_mutable();
    }
    ...
    private class Corn_grain_white_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Corn_grain_white_mutable() {
            set_food_name("Corn grain, white");
            set_food_label("corn_grain_white");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(7.00000);
            set_carbohydrate_by_difference(74.26000);
            ...
            set_magnesium(127.00000);
            set_manganese(0.48000);
            set_monounsaturated_fat(1.25000);
            set_niacin(3.62000);
            set_pantothenic_acid(0.42000);
            set_phosphorus(210.00000);
            set_polyunsaturated_fat(2.16000);
            set_potassium(287.00000);
            set_protein(9.42000);
            set_riboflavin(0.20000);
            set_saturated_fat(0.66000);
            set_selenium(15.50000);
            set_sodium(35.00000);
            set_thiamin(0.38000);
