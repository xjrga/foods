 ...
 */
public class Wheat_kamut_khorasan_cooked implements Food {

    private final Wheat_kamut_khorasan_cooked_mutable food;

    public Wheat_kamut_khorasan_cooked() {
        food = new Wheat_kamut_khorasan_cooked_mutable();
    }
    ...
    private class Wheat_kamut_khorasan_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Wheat_kamut_khorasan_cooked_mutable() {
            set_food_name("Wheat, KAMUT khorasan, cooked");
            set_food_label("wheat_kamut_khorasan_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(27.60000);
