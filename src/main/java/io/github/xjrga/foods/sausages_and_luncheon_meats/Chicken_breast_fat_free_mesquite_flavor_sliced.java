 ...
 */
public class Chicken_breast_fat_free_mesquite_flavor_sliced implements Food {

    private final Chicken_breast_fat_free_mesquite_flavor_sliced_mutable food;

    public Chicken_breast_fat_free_mesquite_flavor_sliced() {
        food = new Chicken_breast_fat_free_mesquite_flavor_sliced_mutable();
    }
    ...
    private class Chicken_breast_fat_free_mesquite_flavor_sliced_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Chicken_breast_fat_free_mesquite_flavor_sliced_mutable() {
            ...
            set_calcium(4.00000);
            set_carbohydrate_by_difference(2.25000);
            set_cholesterol(36.00000);
            set_choline(0.00000);
            set_complete_protein(16.80000);
            set_copper(0.23000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_niacin(2.74000);
            set_pantothenic_acid(0.19000);
            set_phosphorus(256.00000);
            set_polyunsaturated_fat(0.06000);
            set_potassium(316.00000);
            set_protein(16.80000);
            set_riboflavin(0.02000);
            set_saturated_fat(0.13000);
            set_selenium(6.10000);
            set_sodium(1040.00000);
            set_thiamin(0.01000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.07000);
