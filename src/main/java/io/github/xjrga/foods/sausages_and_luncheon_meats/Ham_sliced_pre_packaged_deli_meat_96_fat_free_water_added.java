 ...
 */
public class Ham_sliced_pre_packaged_deli_meat_96_fat_free_water_added implements Food {

    private final Ham_sliced_pre_packaged_deli_meat_96_fat_free_water_added_mutable food;

    public Ham_sliced_pre_packaged_deli_meat_96_fat_free_water_added() {
        food = new Ham_sliced_pre_packaged_deli_meat_96_fat_free_water_added_mutable();
    }
    ...
    private class Ham_sliced_pre_packaged_deli_meat_96_fat_free_water_added_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Ham_sliced_pre_packaged_deli_meat_96_fat_free_water_added_mutable() {
            ...
            set_calcium(5.00000);
            set_carbohydrate_by_difference(0.70000);
            set_cholesterol(41.00000);
            set_choline(62.40000);
            set_complete_protein(16.85000);
            set_copper(0.05000);
            set_cost(0.00000);
            set_dha(0.00200);
            set_epa(0.00100);
            ...
            set_gross_energy(107.00000);
            set_iron(0.59000);
            set_linoleic_acid(0.50000);
            set_magnesium(19.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.61000);
            set_niacin(5.69000);
            set_pantothenic_acid(0.69000);
            set_phosphorus(252.00000);
            set_polyunsaturated_fat(0.62000);
            set_potassium(463.00000);
            set_protein(16.85000);
            set_riboflavin(0.26000);
            set_saturated_fat(1.22000);
            set_selenium(31.60000);
            set_sodium(945.00000);
            set_thiamin(0.33000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.36000);
            set_vitamin_b6(0.39000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.60000);
