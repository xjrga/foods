 ...
 */
public class Oscar_mayer_chicken_breast_honey_glazed implements Food {

    private final Oscar_mayer_chicken_breast_honey_glazed_mutable food;

    public Oscar_mayer_chicken_breast_honey_glazed() {
        food = new Oscar_mayer_chicken_breast_honey_glazed_mutable();
    }
    ...
    private class Oscar_mayer_chicken_breast_honey_glazed_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Oscar_mayer_chicken_breast_honey_glazed_mutable() {
            ...
            set_carbohydrate_by_difference(4.30000);
            set_cholesterol(53.00000);
            set_choline(0.00000);
            set_complete_protein(19.85000);
            set_copper(0.17000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
