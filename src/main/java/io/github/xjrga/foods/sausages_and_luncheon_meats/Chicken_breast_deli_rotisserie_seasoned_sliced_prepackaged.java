 ...
 */
public class Chicken_breast_deli_rotisserie_seasoned_sliced_prepackaged implements Food {

    private final Chicken_breast_deli_rotisserie_seasoned_sliced_prepackaged_mutable food;

    public Chicken_breast_deli_rotisserie_seasoned_sliced_prepackaged() {
        food = new Chicken_breast_deli_rotisserie_seasoned_sliced_prepackaged_mutable();
    }
    ...
    private class Chicken_breast_deli_rotisserie_seasoned_sliced_prepackaged_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Chicken_breast_deli_rotisserie_seasoned_sliced_prepackaged_mutable() {
            ...
            set_carbohydrate_by_difference(2.92000);
            set_cholesterol(51.00000);
            set_choline(44.20000);
            set_complete_protein(17.40000);
            set_copper(0.02000);
            set_cost(0.00000);
            set_dha(0.00300);
            set_epa(0.00100);
            ...
            set_gross_energy(98.00000);
            set_iron(0.39000);
            set_linoleic_acid(0.35000);
            set_magnesium(26.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.74000);
            set_niacin(9.05000);
            set_pantothenic_acid(0.97000);
            set_phosphorus(257.00000);
            set_polyunsaturated_fat(0.45000);
            set_potassium(360.00000);
            set_protein(17.40000);
            set_riboflavin(0.07000);
            set_saturated_fat(0.56000);
            set_selenium(13.20000);
            set_sodium(1032.00000);
            set_thiamin(0.04000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(0.14000);
            set_vitamin_b6(0.44000);
