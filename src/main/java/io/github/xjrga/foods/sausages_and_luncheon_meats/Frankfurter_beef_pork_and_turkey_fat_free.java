 ...
 */
public class Frankfurter_beef_pork_and_turkey_fat_free implements Food {

    private final Frankfurter_beef_pork_and_turkey_fat_free_mutable food;

    public Frankfurter_beef_pork_and_turkey_fat_free() {
        food = new Frankfurter_beef_pork_and_turkey_fat_free_mutable();
    }
    ...
    private class Frankfurter_beef_pork_and_turkey_fat_free_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Frankfurter_beef_pork_and_turkey_fat_free_mutable() {
            ...
            set_carbohydrate_by_difference(11.21000);
            set_cholesterol(41.00000);
            set_choline(74.90000);
            set_complete_protein(12.50000);
            set_copper(0.11000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
