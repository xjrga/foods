 ...
 */
public class Pastrami_beef_98_fat_free implements Food {

    private final Pastrami_beef_98_fat_free_mutable food;

    public Pastrami_beef_98_fat_free() {
        food = new Pastrami_beef_98_fat_free_mutable();
    }
    ...
    private class Pastrami_beef_98_fat_free_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pastrami_beef_98_fat_free_mutable() {
            set_food_name("Pastrami, beef, 98% fat-free");
            set_food_label("pastrami_beef_98_fat_free");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(9.00000);
            set_carbohydrate_by_difference(1.54000);
            set_cholesterol(47.00000);
            set_choline(0.00000);
            set_complete_protein(19.60000);
            set_copper(0.07000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_selenium(10.40000);
            set_sodium(1010.00000);
            set_thiamin(0.09000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(1.76000);
            set_vitamin_b6(0.18000);
            set_vitamin_c(34.60000);
