 ...
 */
public class Chicken_breast_oven_roasted_fat_free_sliced implements Food {

    private final Chicken_breast_oven_roasted_fat_free_sliced_mutable food;

    public Chicken_breast_oven_roasted_fat_free_sliced() {
        food = new Chicken_breast_oven_roasted_fat_free_sliced_mutable();
    }
    ...
    private class Chicken_breast_oven_roasted_fat_free_sliced_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Chicken_breast_oven_roasted_fat_free_sliced_mutable() {
            ...
            set_calcium(6.00000);
            set_carbohydrate_by_difference(2.17000);
            set_cholesterol(36.00000);
            set_choline(0.00000);
            set_complete_protein(16.79000);
            set_copper(0.03000);
            set_cost(0.00000);
            set_dha(0.00200);
            set_epa(0.00100);
            ...
            set_gross_energy(79.00000);
            set_iron(0.32000);
            set_linoleic_acid(0.00000);
            set_magnesium(9.00000);
            set_manganese(0.04000);
            set_monounsaturated_fat(0.12000);
            set_niacin(3.42000);
            set_pantothenic_acid(0.24000);
            set_phosphorus(60.00000);
            set_polyunsaturated_fat(0.07000);
            set_potassium(67.00000);
            set_protein(16.79000);
            set_riboflavin(0.02000);
            set_saturated_fat(0.13000);
            set_selenium(7.60000);
            set_sodium(1087.00000);
            set_thiamin(0.01000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.09000);
            set_vitamin_b6(0.15000);
