 ...
 */
public class Pork_fresh_loin_tenderloin_separable_lean_only_cooked_roasted implements Food {

    private final Pork_fresh_loin_tenderloin_separable_lean_only_cooked_roasted_mutable food;

    public Pork_fresh_loin_tenderloin_separable_lean_only_cooked_roasted() {
        food = new Pork_fresh_loin_tenderloin_separable_lean_only_cooked_roasted_mutable();
    }
    ...
    private class Pork_fresh_loin_tenderloin_separable_lean_only_cooked_roasted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pork_fresh_loin_tenderloin_separable_lean_only_cooked_roasted_mutable() {
            ...
            set_cholesterol(73.00000);
            set_choline(88.90000);
            set_complete_protein(26.17000);
            set_copper(0.11000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(143.00000);
            set_iron(1.15000);
            set_linoleic_acid(0.41000);
            set_magnesium(29.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.33000);
            set_niacin(7.43000);
            set_pantothenic_acid(1.01000);
            set_phosphorus(267.00000);
            set_polyunsaturated_fat(0.50000);
            set_potassium(421.00000);
            set_protein(26.17000);
            set_riboflavin(0.38000);
            set_saturated_fat(1.19000);
            set_selenium(38.20000);
            set_sodium(57.00000);
            set_thiamin(0.95000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.57000);
            set_vitamin_b6(0.73000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.20000);
            set_vitamin_e(0.08000);
