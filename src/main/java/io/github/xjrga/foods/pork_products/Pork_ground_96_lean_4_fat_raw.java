 ...
 */
public class Pork_ground_96_lean_4_fat_raw implements Food {

    private final Pork_ground_96_lean_4_fat_raw_mutable food;

    public Pork_ground_96_lean_4_fat_raw() {
        food = new Pork_ground_96_lean_4_fat_raw_mutable();
    }
    ...
    private class Pork_ground_96_lean_4_fat_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pork_ground_96_lean_4_fat_raw_mutable() {
            set_food_name("Pork, ground, 96% lean / 4% fat, raw");
            set_food_label("pork_ground_96_lean_4_fat_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.02000);
            set_calcium(15.00000);
            set_carbohydrate_by_difference(0.21000);
            set_cholesterol(59.00000);
            set_choline(71.70000);
            set_complete_protein(21.10000);
            set_copper(0.03000);
            set_cost(0.00000);
            set_dha(0.00700);
            set_epa(0.00300);
            ...
            set_iron(0.86000);
            set_linoleic_acid(0.53000);
            set_magnesium(19.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.89000);
            set_niacin(7.91000);
            set_pantothenic_acid(0.64000);
            set_phosphorus(190.00000);
            set_polyunsaturated_fat(0.66000);
            set_potassium(310.00000);
            set_protein(21.10000);
            set_riboflavin(0.36000);
            set_saturated_fat(1.42000);
            set_selenium(34.80000);
            set_sodium(67.00000);
            set_thiamin(0.41000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.64000);
            set_vitamin_b6(0.66000);
