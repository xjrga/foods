 ...
 */
public class Pork_ground_96_lean_4_fat_cooked_pan_broiled implements Food {

    private final Pork_ground_96_lean_4_fat_cooked_pan_broiled_mutable food;

    public Pork_ground_96_lean_4_fat_cooked_pan_broiled() {
        food = new Pork_ground_96_lean_4_fat_cooked_pan_broiled_mutable();
    }
    ...
    private class Pork_ground_96_lean_4_fat_cooked_pan_broiled_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pork_ground_96_lean_4_fat_cooked_pan_broiled_mutable() {
            ...
            set_carbohydrate_by_difference(0.57000);
            set_cholesterol(85.00000);
            set_choline(95.20000);
            set_complete_protein(31.69000);
            set_copper(0.03000);
            set_cost(0.00000);
            set_dha(0.00300);
            set_epa(0.00200);
            ...
            set_iron(1.11000);
            set_linoleic_acid(0.66000);
            set_magnesium(25.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(2.36000);
            set_niacin(10.29000);
            set_pantothenic_acid(0.84000);
            set_phosphorus(261.00000);
            set_polyunsaturated_fat(0.81000);
            set_potassium(415.00000);
            set_protein(31.69000);
            set_riboflavin(0.43000);
            set_saturated_fat(1.86000);
            set_selenium(49.10000);
            set_sodium(88.00000);
            set_thiamin(0.43000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.83000);
            set_vitamin_b6(0.62000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.20000);
            set_vitamin_e(0.40000);
