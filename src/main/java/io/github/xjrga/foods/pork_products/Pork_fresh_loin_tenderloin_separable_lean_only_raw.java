 ...
 */
public class Pork_fresh_loin_tenderloin_separable_lean_only_raw implements Food {

    private final Pork_fresh_loin_tenderloin_separable_lean_only_raw_mutable food;

    public Pork_fresh_loin_tenderloin_separable_lean_only_raw() {
        food = new Pork_fresh_loin_tenderloin_separable_lean_only_raw_mutable();
    }
    ...
    private class Pork_fresh_loin_tenderloin_separable_lean_only_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pork_fresh_loin_tenderloin_separable_lean_only_raw_mutable() {
            ...
            set_cholesterol(65.00000);
            set_choline(80.80000);
            set_complete_protein(20.95000);
            set_copper(0.09000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(109.00000);
            set_iron(0.98000);
            set_linoleic_acid(0.29000);
            set_magnesium(27.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.79000);
            set_niacin(6.68000);
            set_pantothenic_acid(0.84000);
            set_phosphorus(247.00000);
            set_polyunsaturated_fat(0.36000);
            set_potassium(399.00000);
            set_protein(20.95000);
            set_riboflavin(0.34000);
            set_saturated_fat(0.69000);
            set_selenium(30.80000);
            set_sodium(53.00000);
            set_thiamin(0.99000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.51000);
            set_vitamin_b6(0.77000);
