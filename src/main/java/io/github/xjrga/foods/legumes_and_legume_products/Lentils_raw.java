 ...
 */
public class Lentils_raw implements Food {

    private final Lentils_raw_mutable food;

    public Lentils_raw() {
        food = new Lentils_raw_mutable();
    }
    ...
    private class Lentils_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Lentils_raw_mutable() {
            set_food_name("Lentils, raw");
            set_food_label("lentils_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(35.00000);
            set_carbohydrate_by_difference(63.35000);
            set_cholesterol(0.00000);
            set_choline(96.40000);
            ...
            set_folate(479.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(352.00000);
            set_iron(6.51000);
            set_linoleic_acid(0.00000);
            set_magnesium(47.00000);
            set_manganese(1.39000);
            set_monounsaturated_fat(0.19000);
            set_niacin(2.60000);
            set_pantothenic_acid(2.14000);
            set_phosphorus(281.00000);
            set_polyunsaturated_fat(0.52000);
            set_potassium(677.00000);
            set_protein(24.63000);
