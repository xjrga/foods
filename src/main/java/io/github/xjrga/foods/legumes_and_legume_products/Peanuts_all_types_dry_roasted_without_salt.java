 ...
 */
public class Peanuts_all_types_dry_roasted_without_salt implements Food {

    private final Peanuts_all_types_dry_roasted_without_salt_mutable food;

    public Peanuts_all_types_dry_roasted_without_salt() {
        food = new Peanuts_all_types_dry_roasted_without_salt_mutable();
    }
    ...
    private class Peanuts_all_types_dry_roasted_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Peanuts_all_types_dry_roasted_without_salt_mutable() {
            ...
            set_calcium(58.00000);
            set_carbohydrate_by_difference(21.26000);
            set_cholesterol(0.00000);
            set_choline(64.60000);
            ...
            set_gross_energy(587.00000);
            set_iron(1.58000);
            set_linoleic_acid(9.69000);
            set_magnesium(178.00000);
            set_manganese(1.78000);
            set_monounsaturated_fat(26.18000);
            set_niacin(14.35000);
            set_pantothenic_acid(1.01000);
            set_phosphorus(363.00000);
            set_polyunsaturated_fat(9.77000);
            set_potassium(634.00000);
            set_protein(24.35000);
            set_riboflavin(0.19000);
            set_saturated_fat(7.72000);
            set_selenium(9.30000);
            set_sodium(6.00000);
            set_thiamin(0.15000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.46000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(4.93000);
