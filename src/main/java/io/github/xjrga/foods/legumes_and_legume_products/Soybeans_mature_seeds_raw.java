 ...
 */
public class Soybeans_mature_seeds_raw implements Food {

    private final Soybeans_mature_seeds_raw_mutable food;

    public Soybeans_mature_seeds_raw() {
        food = new Soybeans_mature_seeds_raw_mutable();
    }
    ...
    private class Soybeans_mature_seeds_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Soybeans_mature_seeds_raw_mutable() {
            set_food_name("Soybeans, mature seeds, raw");
            set_food_label("soybeans_mature_seeds_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(277.00000);
            set_carbohydrate_by_difference(30.16000);
            set_cholesterol(0.00000);
            set_choline(115.90000);
            ...
            set_folate(375.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(446.00000);
            set_iron(15.70000);
            set_linoleic_acid(0.00000);
            set_magnesium(280.00000);
            set_manganese(2.51000);
            set_monounsaturated_fat(4.40000);
            set_niacin(1.62000);
            set_pantothenic_acid(0.79000);
            set_phosphorus(704.00000);
            set_polyunsaturated_fat(11.25000);
            set_potassium(1797.00000);
            set_protein(36.49000);
            set_riboflavin(0.87000);
            set_saturated_fat(2.88000);
            set_selenium(17.80000);
            set_sodium(2.00000);
            set_thiamin(0.87000);
            set_vitamin_a(1.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.37000);
            set_vitamin_c(6.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.85000);
            set_vitamin_k(47.00000);
            set_water(8.54000);
