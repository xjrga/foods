 ...
 */
public class Beans_black_mature_seeds_raw implements Food {

    private final Beans_black_mature_seeds_raw_mutable food;

    public Beans_black_mature_seeds_raw() {
        food = new Beans_black_mature_seeds_raw_mutable();
    }
    ...
    private class Beans_black_mature_seeds_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beans_black_mature_seeds_raw_mutable() {
            ...
            set_carbohydrate_by_difference(62.36000);
            set_cholesterol(0.00000);
            set_choline(66.40000);
            ...
            set_folate(444.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(341.00000);
            set_iron(5.02000);
            set_linoleic_acid(0.00000);
            set_magnesium(171.00000);
            set_manganese(1.06000);
            set_monounsaturated_fat(0.12000);
            set_niacin(1.95000);
            set_pantothenic_acid(0.89000);
            set_phosphorus(352.00000);
            set_polyunsaturated_fat(0.61000);
            set_potassium(1483.00000);
            set_protein(21.60000);
            set_riboflavin(0.19000);
            set_saturated_fat(0.36000);
