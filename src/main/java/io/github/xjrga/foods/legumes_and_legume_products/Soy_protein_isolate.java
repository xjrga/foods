 ...
 */
public class Soy_protein_isolate implements Food {

    private final Soy_protein_isolate_mutable food;

    public Soy_protein_isolate() {
        food = new Soy_protein_isolate_mutable();
    }
    ...
    private class Soy_protein_isolate_mutable extends Food_abstract {
        ...
        public Soy_protein_isolate_mutable() {
            ...
            set_folate(176.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(335.00000);
            set_iron(14.50000);
            set_linoleic_acid(0.00000);
            set_magnesium(39.00000);
            set_manganese(1.49000);
            set_monounsaturated_fat(0.64000);
            set_niacin(1.43000);
            set_pantothenic_acid(0.06000);
            set_phosphorus(776.00000);
            set_polyunsaturated_fat(1.64000);
            set_potassium(81.00000);
            set_protein(88.32000);
            set_riboflavin(0.10000);
            set_saturated_fat(0.42000);
            set_selenium(0.80000);
            set_sodium(1005.00000);
            set_thiamin(0.17000);
