 ...
 */
public class Soy_meal_defatted_raw implements Food {

    private final Soy_meal_defatted_raw_mutable food;

    public Soy_meal_defatted_raw() {
        food = new Soy_meal_defatted_raw_mutable();
    }
    ...
    private class Soy_meal_defatted_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Soy_meal_defatted_raw_mutable() {
            set_food_name("Soy meal, defatted, raw");
            set_food_label("soy_meal_defatted_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(244.00000);
            set_carbohydrate_by_difference(35.89000);
            ...
            set_folate(303.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(337.00000);
            set_iron(13.70000);
            set_linoleic_acid(0.00000);
            set_magnesium(306.00000);
            set_manganese(3.80000);
            set_monounsaturated_fat(0.40000);
            set_niacin(2.58000);
            set_pantothenic_acid(1.97000);
            set_phosphorus(701.00000);
            set_polyunsaturated_fat(1.04000);
            set_potassium(2490.00000);
            set_protein(49.20000);
