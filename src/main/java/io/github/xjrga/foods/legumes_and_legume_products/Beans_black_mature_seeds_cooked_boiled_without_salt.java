 ...
 */
public class Beans_black_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Beans_black_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Beans_black_mature_seeds_cooked_boiled_without_salt() {
        food = new Beans_black_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Beans_black_mature_seeds_cooked_boiled_without_salt_mutable extends Abstract_food {
         ...
         */
        public Beans_black_mature_seeds_cooked_boiled_without_salt_mutable() {
            ...
            set_calcium(27.00000);
            set_carbohydrate_by_difference(23.71000);
            set_cholesterol(0.00000);
            set_choline(32.60000);
            ...
            set_folate(149.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(132.00000);
            set_iron(2.10000);
            set_linoleic_acid(0.00000);
            set_magnesium(70.00000);
            set_manganese(0.44000);
            set_monounsaturated_fat(0.04000);
            set_niacin(0.50000);
            set_pantothenic_acid(0.24000);
            set_phosphorus(140.00000);
