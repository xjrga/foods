 ...
 */
public class Beans_kidney_all_types_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Beans_kidney_all_types_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Beans_kidney_all_types_mature_seeds_cooked_boiled_without_salt() {
        food = new Beans_kidney_all_types_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Beans_kidney_all_types_mature_seeds_cooked_boiled_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beans_kidney_all_types_mature_seeds_cooked_boiled_without_salt_mutable() {
