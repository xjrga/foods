 ...
 */
public class Peanut_butter_chunk_style_without_salt implements Food {

    private final Peanut_butter_chunk_style_without_salt_mutable food;

    public Peanut_butter_chunk_style_without_salt() {
        food = new Peanut_butter_chunk_style_without_salt_mutable();
    }
    ...
    private class Peanut_butter_chunk_style_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peanut_butter_chunk_style_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(21.57000);
            ...
            set_gross_energy(589.00000);
            set_iron(1.90000);
            set_linoleic_acid(0.00000);
            set_magnesium(160.00000);
            set_manganese(1.80000);
            set_monounsaturated_fat(23.12000);
            set_niacin(13.69000);
            set_pantothenic_acid(1.11000);
            set_phosphorus(319.00000);
            set_polyunsaturated_fat(13.93000);
            set_potassium(745.00000);
            set_protein(24.06000);
            set_riboflavin(0.11000);
            set_saturated_fat(7.60000);
            set_selenium(8.20000);
            set_sodium(17.00000);
            set_thiamin(0.10000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.41000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(6.30000);
