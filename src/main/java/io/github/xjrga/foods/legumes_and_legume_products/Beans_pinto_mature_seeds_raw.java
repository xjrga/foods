 ...
 */
public class Beans_pinto_mature_seeds_raw implements Food {

    private final Beans_pinto_mature_seeds_raw_mutable food;

    public Beans_pinto_mature_seeds_raw() {
        food = new Beans_pinto_mature_seeds_raw_mutable();
    }
    ...
    private class Beans_pinto_mature_seeds_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beans_pinto_mature_seeds_raw_mutable() {
            ...
            set_carbohydrate_by_difference(62.55000);
            set_cholesterol(0.00000);
            set_choline(66.20000);
            ...
            set_folate(525.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(347.00000);
            set_iron(5.07000);
            set_linoleic_acid(0.00000);
            set_magnesium(176.00000);
            set_manganese(1.14000);
            set_monounsaturated_fat(0.22000);
            set_niacin(1.17000);
            set_pantothenic_acid(0.78000);
            set_phosphorus(411.00000);
            set_polyunsaturated_fat(0.40000);
            set_potassium(1393.00000);
            set_protein(21.42000);
            set_riboflavin(0.21000);
            set_saturated_fat(0.23000);
            set_selenium(27.90000);
            set_sodium(12.00000);
            set_thiamin(0.71000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.47000);
            set_vitamin_c(6.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.21000);
            set_vitamin_k(5.60000);
            set_water(11.33000);
