 ...
 */
public class Peas_split_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Peas_split_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Peas_split_mature_seeds_cooked_boiled_without_salt() {
        food = new Peas_split_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Peas_split_mature_seeds_cooked_boiled_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peas_split_mature_seeds_cooked_boiled_without_salt_mutable() {
            ...
            set_carbohydrate_by_difference(21.10000);
            set_cholesterol(0.00000);
            set_choline(32.80000);
            ...
            set_gross_energy(118.00000);
            set_iron(1.29000);
            set_linoleic_acid(0.00000);
            set_magnesium(36.00000);
            set_manganese(0.39000);
            set_monounsaturated_fat(0.08000);
            set_niacin(0.89000);
            set_pantothenic_acid(0.59000);
            set_phosphorus(99.00000);
