 ...
 */
public class Beans_kidney_california_red_mature_seeds_raw implements Food {

    private final Beans_kidney_california_red_mature_seeds_raw_mutable food;

    public Beans_kidney_california_red_mature_seeds_raw() {
        food = new Beans_kidney_california_red_mature_seeds_raw_mutable();
    }
    ...
    private class Beans_kidney_california_red_mature_seeds_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beans_kidney_california_red_mature_seeds_raw_mutable() {
            ...
            set_calcium(195.00000);
            set_carbohydrate_by_difference(59.80000);
            ...
            set_gross_energy(330.00000);
            set_iron(9.35000);
            set_linoleic_acid(0.00000);
            set_magnesium(160.00000);
            set_manganese(1.00000);
            set_monounsaturated_fat(0.01000);
            set_niacin(2.06000);
            set_pantothenic_acid(0.78000);
            set_phosphorus(405.00000);
            set_polyunsaturated_fat(0.13000);
            set_potassium(1490.00000);
            set_protein(24.37000);
