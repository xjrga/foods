 ...
 */
public class Beans_pinto_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Beans_pinto_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Beans_pinto_mature_seeds_cooked_boiled_without_salt() {
        food = new Beans_pinto_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Beans_pinto_mature_seeds_cooked_boiled_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beans_pinto_mature_seeds_cooked_boiled_without_salt_mutable() {
            ...
            set_calcium(46.00000);
            set_carbohydrate_by_difference(26.22000);
            set_cholesterol(0.00000);
            set_choline(35.30000);
            ...
            set_fat(0.65000);
            set_fiber(9.00000);
            set_fluoride(2.20000);
            set_folate(172.00000);
            set_glycemic_index(45.00000);
            set_gross_energy(143.00000);
            set_iron(2.09000);
            set_linoleic_acid(0.00000);
            set_magnesium(50.00000);
            set_manganese(0.45000);
            set_monounsaturated_fat(0.13000);
            set_niacin(0.31000);
            set_pantothenic_acid(0.21000);
            set_phosphorus(147.00000);
            set_polyunsaturated_fat(0.23000);
            set_potassium(436.00000);
            set_protein(9.01000);
            set_riboflavin(0.06000);
            set_saturated_fat(0.13000);
            set_selenium(6.20000);
            set_sodium(1.00000);
            set_thiamin(0.19000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.22000);
            set_vitamin_c(0.80000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.94000);
            set_vitamin_k(3.50000);
            set_water(62.95000);
