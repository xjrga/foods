 ...
 */
public class Peanut_butter_chunk_style_with_salt implements Food {

    private final Peanut_butter_chunk_style_with_salt_mutable food;

    public Peanut_butter_chunk_style_with_salt() {
        food = new Peanut_butter_chunk_style_with_salt_mutable();
    }
    ...
    private class Peanut_butter_chunk_style_with_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peanut_butter_chunk_style_with_salt_mutable() {
