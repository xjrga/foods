 ...
 */
public class Beans_kidney_all_types_mature_seeds_raw implements Food {

    private final Beans_kidney_all_types_mature_seeds_raw_mutable food;

    public Beans_kidney_all_types_mature_seeds_raw() {
        food = new Beans_kidney_all_types_mature_seeds_raw_mutable();
    }
    ...
    private class Beans_kidney_all_types_mature_seeds_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Beans_kidney_all_types_mature_seeds_raw_mutable() {
            ...
            set_carbohydrate_by_difference(60.01000);
            ...
            set_folate(394.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(333.00000);
            set_iron(8.20000);
            set_linoleic_acid(0.00000);
            set_magnesium(140.00000);
            set_manganese(1.02000);
            set_monounsaturated_fat(0.06000);
            set_niacin(2.06000);
            set_pantothenic_acid(0.78000);
            set_phosphorus(407.00000);
            set_polyunsaturated_fat(0.45000);
            set_potassium(1406.00000);
            set_protein(23.58000);
            set_riboflavin(0.21000);
            set_saturated_fat(0.12000);
            set_selenium(3.20000);
            set_sodium(24.00000);
            set_thiamin(0.52000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.39000);
            set_vitamin_c(4.50000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.22000);
            set_vitamin_k(19.00000);
            set_water(11.75000);
