 ...
 */
public class Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_raw implements Food {

    private final Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_raw_mutable food;

    public Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_raw() {
        food = new Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_raw_mutable();
    }
    ...
    private class Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_raw_mutable() {
            ...
            set_calcium(57.00000);
            set_carbohydrate_by_difference(62.95000);
            set_cholesterol(0.00000);
            set_choline(99.30000);
            ...
            set_folate(557.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(378.00000);
            set_iron(4.31000);
            set_linoleic_acid(0.00000);
            set_magnesium(79.00000);
            set_manganese(21.30000);
            set_monounsaturated_fat(1.37000);
            set_niacin(1.54000);
            set_pantothenic_acid(1.58000);
            set_phosphorus(252.00000);
            set_polyunsaturated_fat(2.73000);
            set_potassium(718.00000);
            set_protein(20.47000);
            set_riboflavin(0.21000);
            set_saturated_fat(0.60000);
            set_selenium(0.00000);
            set_sodium(24.00000);
            set_thiamin(0.47000);
            set_vitamin_a(3.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.53000);
            set_vitamin_c(4.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.82000);
            set_vitamin_k(9.00000);
            set_water(7.68000);
