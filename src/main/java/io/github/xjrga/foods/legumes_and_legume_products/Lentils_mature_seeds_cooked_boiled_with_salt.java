 ...
 */
public class Lentils_mature_seeds_cooked_boiled_with_salt implements Food {

    private final Lentils_mature_seeds_cooked_boiled_with_salt_mutable food;

    public Lentils_mature_seeds_cooked_boiled_with_salt() {
        food = new Lentils_mature_seeds_cooked_boiled_with_salt_mutable();
    }
    ...
    private class Lentils_mature_seeds_cooked_boiled_with_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Lentils_mature_seeds_cooked_boiled_with_salt_mutable() {
            ...
            set_carbohydrate_by_difference(19.54000);
