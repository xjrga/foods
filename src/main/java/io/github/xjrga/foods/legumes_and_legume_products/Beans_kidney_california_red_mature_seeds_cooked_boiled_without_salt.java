 ...
 */
public class Beans_kidney_california_red_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Beans_kidney_california_red_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Beans_kidney_california_red_mature_seeds_cooked_boiled_without_salt() {
        food = new Beans_kidney_california_red_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Beans_kidney_california_red_mature_seeds_cooked_boiled_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beans_kidney_california_red_mature_seeds_cooked_boiled_without_salt_mutable() {
            ...
            set_calcium(66.00000);
            set_carbohydrate_by_difference(22.41000);
            ...
            set_gross_energy(124.00000);
            set_iron(2.98000);
            set_linoleic_acid(0.00000);
            set_magnesium(48.00000);
            set_manganese(0.31000);
            set_monounsaturated_fat(0.00700);
            set_niacin(0.54000);
            set_pantothenic_acid(0.21000);
            set_phosphorus(137.00000);
            set_polyunsaturated_fat(0.05000);
            set_potassium(419.00000);
            set_protein(9.13000);
            set_riboflavin(0.06000);
            set_saturated_fat(0.01000);
            set_selenium(1.20000);
            set_sodium(4.00000);
            set_thiamin(0.12000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.10000);
