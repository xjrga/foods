 ...
 */
public class Beans_kidney_red_mature_seeds_raw implements Food {

    private final Beans_kidney_red_mature_seeds_raw_mutable food;

    public Beans_kidney_red_mature_seeds_raw() {
        food = new Beans_kidney_red_mature_seeds_raw_mutable();
    }
    ...
    private class Beans_kidney_red_mature_seeds_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beans_kidney_red_mature_seeds_raw_mutable() {
            ...
            set_calcium(83.00000);
            set_carbohydrate_by_difference(61.29000);
            set_cholesterol(0.00000);
            set_choline(65.90000);
            ...
            set_gross_energy(337.00000);
            set_iron(6.69000);
            set_linoleic_acid(0.00000);
            set_magnesium(138.00000);
            set_manganese(1.11000);
            set_monounsaturated_fat(0.08000);
            set_niacin(2.11000);
            set_pantothenic_acid(0.78000);
            set_phosphorus(406.00000);
            set_polyunsaturated_fat(0.58000);
            set_potassium(1359.00000);
            set_protein(22.53000);
