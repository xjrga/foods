 ...
 */
public class Bread_blue_corn_somiviki_hopi implements Food {

    private final Bread_blue_corn_somiviki_hopi_mutable food;

    public Bread_blue_corn_somiviki_hopi() {
        food = new Bread_blue_corn_somiviki_hopi_mutable();
    }
    ...
    private class Bread_blue_corn_somiviki_hopi_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Bread_blue_corn_somiviki_hopi_mutable() {
            set_food_name("Bread, blue corn, somiviki (Hopi)");
            set_food_label("bread_blue_corn_somiviki_hopi");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.02000);
            set_calcium(34.00000);
            set_carbohydrate_by_difference(39.84000);
            ...
            set_iron(1.58000);
            set_linoleic_acid(0.75000);
            set_magnesium(43.00000);
            set_manganese(0.40000);
            set_monounsaturated_fat(0.34000);
            set_niacin(0.55000);
            set_pantothenic_acid(0.17000);
            set_phosphorus(94.00000);
            set_polyunsaturated_fat(0.77000);
            set_potassium(114.00000);
            set_protein(3.10000);
