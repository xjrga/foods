 ...
 */
public class Blueberries_wild_raw_alaska_native implements Food {

    private final Blueberries_wild_raw_alaska_native_mutable food;

    public Blueberries_wild_raw_alaska_native() {
        food = new Blueberries_wild_raw_alaska_native_mutable();
    }
    ...
    private class Blueberries_wild_raw_alaska_native_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Blueberries_wild_raw_alaska_native_mutable() {
            ...
            set_carbohydrate_by_difference(12.31000);
            ...
            set_manganese(2.00000);
            set_monounsaturated_fat(0.00000);
            set_niacin(0.59000);
            set_pantothenic_acid(0.26000);
            ...
            set_vitamin_c(18.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.69000);
            set_vitamin_k(17.20000);
            set_water(85.48000);
