 ...
 */
public class Raspberries_wild_northern_plains_indians implements Food {

    private final Raspberries_wild_northern_plains_indians_mutable food;

    public Raspberries_wild_northern_plains_indians() {
        food = new Raspberries_wild_northern_plains_indians_mutable();
    }
    ...
    private class Raspberries_wild_northern_plains_indians_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Raspberries_wild_northern_plains_indians_mutable() {
            ...
            set_carbohydrate_by_difference(13.85000);
            ...
            set_vitamin_c(26.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.57000);
            set_vitamin_k(6.60000);
            set_water(84.48000);
