 ...
 */
public class Fish_salmon_chum_raw_alaska_native implements Food {

    private final Fish_salmon_chum_raw_alaska_native_mutable food;

    public Fish_salmon_chum_raw_alaska_native() {
        food = new Fish_salmon_chum_raw_alaska_native_mutable();
    }
    ...
    private class Fish_salmon_chum_raw_alaska_native_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_salmon_chum_raw_alaska_native_mutable() {
