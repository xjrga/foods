 ...
 */
public class Tortilla_blue_corn_sakwavikaviki_hopi implements Food {

    private final Tortilla_blue_corn_sakwavikaviki_hopi_mutable food;

    public Tortilla_blue_corn_sakwavikaviki_hopi() {
        food = new Tortilla_blue_corn_sakwavikaviki_hopi_mutable();
    }
    ...
    private class Tortilla_blue_corn_sakwavikaviki_hopi_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Tortilla_blue_corn_sakwavikaviki_hopi_mutable() {
            ...
            set_calcium(174.00000);
            set_carbohydrate_by_difference(58.12000);
