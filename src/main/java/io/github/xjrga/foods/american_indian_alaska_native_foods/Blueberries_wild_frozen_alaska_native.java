 ...
 */
public class Blueberries_wild_frozen_alaska_native implements Food {

    private final Blueberries_wild_frozen_alaska_native_mutable food;

    public Blueberries_wild_frozen_alaska_native() {
        food = new Blueberries_wild_frozen_alaska_native_mutable();
    }
    ...
    private class Blueberries_wild_frozen_alaska_native_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Blueberries_wild_frozen_alaska_native_mutable() {
            ...
            set_carbohydrate_by_difference(10.40000);
