 ...
 */
public class Chokecherries_raw_pitted_shoshone_bannock implements Food {

    private final Chokecherries_raw_pitted_shoshone_bannock_mutable food;

    public Chokecherries_raw_pitted_shoshone_bannock() {
        food = new Chokecherries_raw_pitted_shoshone_bannock_mutable();
    }
    ...
    private class Chokecherries_raw_pitted_shoshone_bannock_mutable extends Food_abstract {
         ...
         */
        public Chokecherries_raw_pitted_shoshone_bannock_mutable() {
            ...
            set_carbohydrate_by_difference(33.88000);
