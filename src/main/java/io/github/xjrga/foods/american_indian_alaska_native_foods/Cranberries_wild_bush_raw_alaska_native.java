 ...
 */
public class Cranberries_wild_bush_raw_alaska_native implements Food {

    private final Cranberries_wild_bush_raw_alaska_native_mutable food;

    public Cranberries_wild_bush_raw_alaska_native() {
        food = new Cranberries_wild_bush_raw_alaska_native_mutable();
    }
    ...
    private class Cranberries_wild_bush_raw_alaska_native_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cranberries_wild_bush_raw_alaska_native_mutable() {
            ...
            set_carbohydrate_by_difference(12.30000);
