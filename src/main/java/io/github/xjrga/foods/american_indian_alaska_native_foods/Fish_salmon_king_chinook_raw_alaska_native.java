 ...
 */
public class Fish_salmon_king_chinook_raw_alaska_native implements Food {

    private final Fish_salmon_king_chinook_raw_alaska_native_mutable food;

    public Fish_salmon_king_chinook_raw_alaska_native() {
        food = new Fish_salmon_king_chinook_raw_alaska_native_mutable();
    }
    ...
    private class Fish_salmon_king_chinook_raw_alaska_native_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_salmon_king_chinook_raw_alaska_native_mutable() {
            ...
            set_gross_energy(187.00000);
            set_iron(0.79000);
            set_linoleic_acid(0.00000);
            set_magnesium(24.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(4.09000);
            set_niacin(8.41000);
            set_pantothenic_acid(0.98000);
            set_phosphorus(208.00000);
            set_polyunsaturated_fat(1.59000);
            set_potassium(370.00000);
            set_protein(20.25000);
            set_riboflavin(0.16000);
            set_saturated_fat(1.87000);
            set_selenium(31.00000);
            set_sodium(48.00000);
            set_thiamin(0.16000);
            set_vitamin_a(136.00000);
            set_vitamin_b12(7.38000);
            set_vitamin_b6(0.27000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(1.49000);
