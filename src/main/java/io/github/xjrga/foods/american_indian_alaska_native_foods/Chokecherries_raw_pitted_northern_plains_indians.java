 ...
 */
public class Chokecherries_raw_pitted_northern_plains_indians implements Food {

    private final Chokecherries_raw_pitted_northern_plains_indians_mutable food;

    public Chokecherries_raw_pitted_northern_plains_indians() {
        food = new Chokecherries_raw_pitted_northern_plains_indians_mutable();
    }
    ...
    private class Chokecherries_raw_pitted_northern_plains_indians_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Chokecherries_raw_pitted_northern_plains_indians_mutable() {
            ...
            set_calcium(60.00000);
            set_carbohydrate_by_difference(33.62000);
            set_cholesterol(0.00000);
            set_choline(10.70000);
