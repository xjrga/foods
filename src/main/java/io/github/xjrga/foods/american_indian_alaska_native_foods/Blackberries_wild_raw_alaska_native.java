 ...
 */
public class Blackberries_wild_raw_alaska_native implements Food {

    private final Blackberries_wild_raw_alaska_native_mutable food;

    public Blackberries_wild_raw_alaska_native() {
        food = new Blackberries_wild_raw_alaska_native_mutable();
    }
    ...
    private class Blackberries_wild_raw_alaska_native_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Blackberries_wild_raw_alaska_native_mutable() {
            ...
            set_calcium(5.00000);
            set_carbohydrate_by_difference(9.84000);
            ...
            set_gross_energy(52.00000);
            set_iron(0.21000);
            set_linoleic_acid(0.00000);
            set_magnesium(4.00000);
            set_manganese(0.28000);
            set_monounsaturated_fat(0.00000);
            set_niacin(0.31000);
            set_pantothenic_acid(1.25000);
            set_phosphorus(11.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(75.00000);
            set_protein(0.84000);
            ...
            set_vitamin_c(4.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.91000);
            set_vitamin_k(5.90000);
            set_water(88.05000);
