 ...
 */
public class Prickly_pears_raw_northern_plains_indians implements Food {

    private final Prickly_pears_raw_northern_plains_indians_mutable food;

    public Prickly_pears_raw_northern_plains_indians() {
        food = new Prickly_pears_raw_northern_plains_indians_mutable();
    }
    ...
    private class Prickly_pears_raw_northern_plains_indians_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Prickly_pears_raw_northern_plains_indians_mutable() {
            ...
            set_calcium(180.00000);
            set_carbohydrate_by_difference(10.17000);
