 ...
 */
public class Plums_wild_northern_plains_indians implements Food {

    private final Plums_wild_northern_plains_indians_mutable food;

    public Plums_wild_northern_plains_indians() {
        food = new Plums_wild_northern_plains_indians_mutable();
    }
    ...
    private class Plums_wild_northern_plains_indians_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Plums_wild_northern_plains_indians_mutable() {
            ...
            set_carbohydrate_by_difference(21.95000);
            ...
            set_sodium(4.00000);
            set_thiamin(0.00500);
            set_vitamin_a(173.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.09000);
            set_vitamin_c(10.30000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.53000);
            set_vitamin_k(11.20000);
            set_water(76.68000);
