...
public class Food_mutable implements Interface_food_mutable, Interface_food {
	...
	public final Double get_energy_digestible_carbohydrate_in_kilocalories() {
		return energy_digestible_carbohydrate == -1
				? get_digestible_carbohydrate_in_grams() * get_carbohydrate_by_difference_atwater_factor()
	...
	public final Double get_energy_digestible_in_kilocalories() {
		return energy_digestible == -1
				? get_energy_protein_in_kilocalories() + get_energy_fat_in_kilocalories()
						+ get_energy_digestible_carbohydrate_in_kilocalories()
				: energy_digestible;
	}
	...
	public final Double get_food_quotient() {
		Double fq = get_energy_digestible_carbohydrate_in_kilocalories() / get_energy_digestible_in_kilocalories()
				* 1.00 + get_energy_fat_in_kilocalories() / get_energy_digestible_in_kilocalories() * 0.71
	...
	public boolean equals(Object obj) {
		...
		if (!Objects.equals(this.carbohydrate_by_difference_atwater_factor,
				other.carbohydrate_by_difference_atwater_factor)) {
			return false;
		}
