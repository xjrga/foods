 ...
 */
public interface Interface_food_mutable {
	 ...
	 * Set food label
	 *
	 * @param label The food name which uses these characters A-Z, a-z 0-9, _ only
	 */
	...
	/**
	 * Set 'protein' atwater specific energy conversion factor (Kcal / g of protein)
	 *
	 * @param quantity
	 */
	...
	/**
	 * Set carbohydrate by difference, includes digestible carbohydrate plus fiber
	 * (g)
	 *
	 * @param quantity
	 */
	...
	/**
	 * Set 'carbohydrate by difference' atwater specific energy conversion factor
	 * (Kcal / g of carbohydrate by difference)
	 *
	 * @param quantity
	 */
	...
	/**
	 * Set total fat, includes saturated, polyunsaturated and monounsaturated (g)
	 *
	 * @param quantity
	 */
	...
	/**
	 * Set 'ethyl alcohol' atwater specific energy conversion factor (Kcal / g of
	 * alcohol)
	 *
	 * @param quantity
	 */
