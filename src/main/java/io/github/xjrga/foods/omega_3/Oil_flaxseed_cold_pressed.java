 ...
 */
public class Oil_flaxseed_cold_pressed implements Food {

    private final Oil_flaxseed_cold_pressed_mutable food;

    public Oil_flaxseed_cold_pressed() {
        food = new Oil_flaxseed_cold_pressed_mutable();
    }
