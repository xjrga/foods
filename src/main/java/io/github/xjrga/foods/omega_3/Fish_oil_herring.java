 ...
 */
public class Fish_oil_herring implements Food {

    private final Fish_oil_herring_mutable food;

    public Fish_oil_herring() {
        food = new Fish_oil_herring_mutable();
    }
    ...
    private class Fish_oil_herring_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_oil_herring_mutable() {
