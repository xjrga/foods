 ...
 */
public class Fish_oil_sardine implements Food {

    private final Fish_oil_sardine_mutable food;

    public Fish_oil_sardine() {
        food = new Fish_oil_sardine_mutable();
    }
    ...
    private class Fish_oil_sardine_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Fish_oil_sardine_mutable() {
