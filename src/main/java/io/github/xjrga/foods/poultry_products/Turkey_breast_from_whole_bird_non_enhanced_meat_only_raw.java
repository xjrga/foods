 ...
 */
public class Turkey_breast_from_whole_bird_non_enhanced_meat_only_raw implements Food {

    private final Turkey_breast_from_whole_bird_non_enhanced_meat_only_raw_mutable food;

    public Turkey_breast_from_whole_bird_non_enhanced_meat_only_raw() {
        food = new Turkey_breast_from_whole_bird_non_enhanced_meat_only_raw_mutable();
    }
    ...
    private class Turkey_breast_from_whole_bird_non_enhanced_meat_only_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Turkey_breast_from_whole_bird_non_enhanced_meat_only_raw_mutable() {
            set_food_name("Turkey, breast, from whole bird, non-enhanced, meat only, raw");
            set_food_label("turkey_breast_from_whole_bird_non_enhanced_meat_only_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00900);
            set_calcium(11.00000);
            set_carbohydrate_by_difference(0.14000);
            set_cholesterol(57.00000);
            set_choline(61.30000);
            set_complete_protein(23.66000);
            set_copper(0.07000);
            set_cost(0.00000);
            set_dha(0.00200);
            set_epa(0.00000);
            ...
            set_gross_energy(114.00000);
            set_iron(0.73000);
            set_linoleic_acid(0.19000);
            set_magnesium(28.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.26000);
            set_niacin(9.92000);
            set_pantothenic_acid(0.77000);
            set_phosphorus(201.00000);
            set_polyunsaturated_fat(0.25000);
            set_potassium(242.00000);
            set_protein(23.66000);
            set_riboflavin(0.14000);
            set_saturated_fat(0.28000);
            set_selenium(22.70000);
            set_sodium(113.00000);
            set_thiamin(0.04000);
            set_vitamin_a(6.00000);
            set_vitamin_b12(0.63000);
            set_vitamin_b6(0.81000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.10000);
            set_vitamin_e(0.06000);
