 ...
 */
public class Ground_turkey_fat_free_raw implements Food {

    private final Ground_turkey_fat_free_raw_mutable food;

    public Ground_turkey_fat_free_raw() {
        food = new Ground_turkey_fat_free_raw_mutable();
    }
    ...
    private class Ground_turkey_fat_free_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Ground_turkey_fat_free_raw_mutable() {
            ...
            set_choline(47.90000);
            set_complete_protein(23.57000);
            set_copper(0.05000);
            set_cost(0.00000);
            set_dha(0.00600);
            set_epa(0.00200);
            ...
            set_iron(0.77000);
            set_linoleic_acid(0.45000);
            set_magnesium(29.00000);
            set_manganese(0.00600);
            set_monounsaturated_fat(0.51000);
            set_niacin(9.70000);
            set_pantothenic_acid(0.88000);
            set_phosphorus(227.00000);
            set_polyunsaturated_fat(0.59000);
            set_potassium(295.00000);
            set_protein(23.57000);
            set_riboflavin(0.10000);
            set_saturated_fat(0.48000);
            set_selenium(22.10000);
            set_sodium(51.00000);
            set_thiamin(0.06000);
            set_vitamin_a(7.00000);
            set_vitamin_b12(0.51000);
            set_vitamin_b6(0.85000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.40000);
