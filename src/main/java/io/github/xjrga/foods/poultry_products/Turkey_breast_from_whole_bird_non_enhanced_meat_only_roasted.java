 ...
 */
public class Turkey_breast_from_whole_bird_non_enhanced_meat_only_roasted implements Food {

    private final Turkey_breast_from_whole_bird_non_enhanced_meat_only_roasted_mutable food;

    public Turkey_breast_from_whole_bird_non_enhanced_meat_only_roasted() {
        food = new Turkey_breast_from_whole_bird_non_enhanced_meat_only_roasted_mutable();
    }
    ...
    private class Turkey_breast_from_whole_bird_non_enhanced_meat_only_roasted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Turkey_breast_from_whole_bird_non_enhanced_meat_only_roasted_mutable() {
            ...
            set_cholesterol(80.00000);
            set_choline(84.40000);
            set_complete_protein(30.13000);
            set_copper(0.06000);
            set_cost(0.00000);
            set_dha(0.00400);
            set_epa(0.00400);
            ...
            set_iron(0.71000);
            set_linoleic_acid(0.42000);
            set_magnesium(32.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.62000);
            set_niacin(11.75000);
            set_pantothenic_acid(0.90000);
            set_phosphorus(230.00000);
            set_polyunsaturated_fat(0.52000);
            set_potassium(249.00000);
            set_protein(30.13000);
            set_riboflavin(0.20000);
            set_saturated_fat(0.59000);
            set_selenium(30.20000);
            set_sodium(99.00000);
            set_thiamin(0.03000);
            set_vitamin_a(3.00000);
            set_vitamin_b12(0.39000);
            set_vitamin_b6(0.80000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.30000);
