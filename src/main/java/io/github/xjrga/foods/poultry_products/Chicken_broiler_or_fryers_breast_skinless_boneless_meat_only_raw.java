 ...
 */
public class Chicken_broiler_or_fryers_breast_skinless_boneless_meat_only_raw implements Food {

    private final Chicken_broiler_or_fryers_breast_skinless_boneless_meat_only_raw_mutable food;

    public Chicken_broiler_or_fryers_breast_skinless_boneless_meat_only_raw() {
        food = new Chicken_broiler_or_fryers_breast_skinless_boneless_meat_only_raw_mutable();
    }
    ...
    private class Chicken_broiler_or_fryers_breast_skinless_boneless_meat_only_raw_mutable extends Abstract_food {
         ...
         */
        public Chicken_broiler_or_fryers_breast_skinless_boneless_meat_only_raw_mutable() {
            ...
            set_choline(82.10000);
            set_complete_protein(22.50000);
            set_copper(0.03000);
            set_cost(0.00000);
            set_dha(0.00400);
            set_epa(0.00300);
            ...
            set_gross_energy(120.00000);
            set_iron(0.37000);
            set_linoleic_acid(0.31000);
            set_magnesium(28.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(0.68000);
            set_niacin(9.60000);
            set_pantothenic_acid(1.49000);
            set_phosphorus(213.00000);
            set_polyunsaturated_fat(0.42000);
            set_potassium(334.00000);
            set_protein(22.50000);
            set_riboflavin(0.17000);
            set_saturated_fat(0.56000);
            set_selenium(22.80000);
            set_sodium(45.00000);
            set_thiamin(0.09000);
            set_vitamin_a(9.00000);
            set_vitamin_b12(0.21000);
            set_vitamin_b6(0.81000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.56000);
