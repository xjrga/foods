 ...
 */
public class Chicken_broilers_or_fryers_breast_meat_only_cooked_roasted implements Food {

    private final Chicken_broilers_or_fryers_breast_meat_only_cooked_roasted_mutable food;

    public Chicken_broilers_or_fryers_breast_meat_only_cooked_roasted() {
        food = new Chicken_broilers_or_fryers_breast_meat_only_cooked_roasted_mutable();
    }
    ...
    private class Chicken_broilers_or_fryers_breast_meat_only_cooked_roasted_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Chicken_broilers_or_fryers_breast_meat_only_cooked_roasted_mutable() {
            ...
            set_choline(85.30000);
            set_complete_protein(31.02000);
            set_copper(0.04000);
            set_cost(0.00000);
            set_dha(0.02000);
            set_epa(0.01000);
            ...
            set_gross_energy(165.00000);
            set_iron(1.04000);
            set_linoleic_acid(0.00000);
            set_magnesium(29.00000);
            set_manganese(0.01000);
            set_monounsaturated_fat(1.24000);
            set_niacin(13.71000);
            set_pantothenic_acid(0.96000);
            set_phosphorus(228.00000);
            set_polyunsaturated_fat(0.77000);
            set_potassium(256.00000);
            set_protein(31.02000);
            set_riboflavin(0.11000);
            set_saturated_fat(1.01000);
            set_selenium(27.60000);
            set_sodium(74.00000);
            set_thiamin(0.07000);
            set_vitamin_a(6.00000);
            set_vitamin_b12(0.34000);
            set_vitamin_b6(0.60000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.10000);
            set_vitamin_e(0.27000);
            set_vitamin_k(0.30000);
            set_water(65.26000);
