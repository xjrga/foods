 ...
 */
public class Salt_table implements Food {

    private final Salt_table_mutable food;

    public Salt_table() {
        food = new Salt_table_mutable();
    }
