 ...
 */
public class Spices_pepper_black implements Food {

    private final Spices_pepper_black_mutable food;

    public Spices_pepper_black() {
        food = new Spices_pepper_black_mutable();
    }
    ...
    private class Spices_pepper_black_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Spices_pepper_black_mutable() {
            set_food_name("Spices, pepper, black");
            set_food_label("spices_pepper_black");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.15000);
            set_calcium(443.00000);
            set_carbohydrate_by_difference(63.95000);
            set_cholesterol(0.00000);
            set_choline(11.30000);
