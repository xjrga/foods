 ...
 */
public class Vinegar_balsamic implements Food {

    private final Vinegar_balsamic_mutable food;

    public Vinegar_balsamic() {
        food = new Vinegar_balsamic_mutable();
    }
