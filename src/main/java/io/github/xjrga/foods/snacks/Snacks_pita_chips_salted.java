 ...
 */
public class Snacks_pita_chips_salted implements Food {

    private final Snacks_pita_chips_salted_mutable food;

    public Snacks_pita_chips_salted() {
        food = new Snacks_pita_chips_salted_mutable();
    }
    ...
    private class Snacks_pita_chips_salted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_pita_chips_salted_mutable() {
            set_food_name("Snacks, pita chips, salted");
            set_food_label("snacks_pita_chips_salted");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.09000);
            set_calcium(17.00000);
            set_carbohydrate_by_difference(68.26000);
            ...
            set_fat(15.20000);
            set_fiber(3.80000);
            set_fluoride(0.10000);
            set_folate(215.00000);
            set_glycemic_index(0.00000);
            set_gross_energy(457.00000);
            set_iron(4.59000);
            set_linoleic_acid(2.00000);
            set_magnesium(37.00000);
            set_manganese(0.65000);
            set_monounsaturated_fat(10.84000);
            set_niacin(7.04000);
            set_pantothenic_acid(0.50000);
            set_phosphorus(124.00000);
            set_polyunsaturated_fat(2.13000);
            set_potassium(129.00000);
            set_protein(11.79000);
            set_riboflavin(0.30000);
            set_saturated_fat(1.34000);
            set_selenium(33.10000);
            set_sodium(854.00000);
            set_thiamin(0.56000);
