 ...
 */
public class Snacks_rice_cakes_brown_rice_multigrain_unsalted implements Food {

    private final Snacks_rice_cakes_brown_rice_multigrain_unsalted_mutable food;

    public Snacks_rice_cakes_brown_rice_multigrain_unsalted() {
        food = new Snacks_rice_cakes_brown_rice_multigrain_unsalted_mutable();
    }
    ...
    private class Snacks_rice_cakes_brown_rice_multigrain_unsalted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_rice_cakes_brown_rice_multigrain_unsalted_mutable() {
            ...
            set_calcium(21.00000);
            set_carbohydrate_by_difference(80.10000);
            ...
            set_gross_energy(387.00000);
            set_iron(1.96000);
            set_linoleic_acid(0.00000);
            set_magnesium(137.00000);
            set_manganese(5.22000);
            set_monounsaturated_fat(1.16000);
            set_niacin(6.60000);
            set_pantothenic_acid(1.00000);
            set_phosphorus(370.00000);
            set_polyunsaturated_fat(1.44000);
            set_potassium(294.00000);
            set_protein(8.50000);
            set_riboflavin(0.18000);
            set_saturated_fat(0.56000);
            set_selenium(20.00000);
            set_sodium(4.00000);
            set_thiamin(0.06000);
