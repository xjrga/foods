 ...
 */
public class Snacks_trail_mix_regular implements Food {

    private final Snacks_trail_mix_regular_mutable food;

    public Snacks_trail_mix_regular() {
        food = new Snacks_trail_mix_regular_mutable();
    }
    ...
    private class Snacks_trail_mix_regular_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_trail_mix_regular_mutable() {
            set_food_name("Snacks, trail mix, regular");
            set_food_label("snacks_trail_mix_regular");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(78.00000);
            set_carbohydrate_by_difference(44.90000);
            ...
            set_gross_energy(462.00000);
            set_iron(3.05000);
            set_linoleic_acid(0.00000);
            set_magnesium(158.00000);
            set_manganese(1.03000);
            set_monounsaturated_fat(12.53000);
            set_niacin(4.71000);
            set_pantothenic_acid(0.89000);
            set_phosphorus(345.00000);
            set_polyunsaturated_fat(9.65000);
            set_potassium(685.00000);
            set_protein(13.80000);
            set_riboflavin(0.19000);
            set_saturated_fat(5.55000);
            set_selenium(0.00000);
            set_sodium(229.00000);
            set_thiamin(0.46000);
