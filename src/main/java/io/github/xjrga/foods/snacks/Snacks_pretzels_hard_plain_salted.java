 ...
 */
public class Snacks_pretzels_hard_plain_salted implements Food {

    private final Snacks_pretzels_hard_plain_salted_mutable food;

    public Snacks_pretzels_hard_plain_salted() {
        food = new Snacks_pretzels_hard_plain_salted_mutable();
    }
    ...
    private class Snacks_pretzels_hard_plain_salted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_pretzels_hard_plain_salted_mutable() {
            ...
            set_carbohydrate_by_difference(80.39000);
            set_cholesterol(0.00000);
            set_choline(29.50000);
            ...
            set_folate(166.00000);
            set_glycemic_index(83.00000);
            set_gross_energy(384.00000);
            set_iron(4.58000);
            set_linoleic_acid(1.22000);
            set_magnesium(29.00000);
            set_manganese(1.01000);
            set_monounsaturated_fat(0.72000);
            set_niacin(5.27000);
            set_pantothenic_acid(0.32000);
            set_phosphorus(128.00000);
            set_polyunsaturated_fat(1.29000);
            set_potassium(223.00000);
            set_protein(10.04000);
            set_riboflavin(0.33000);
            set_saturated_fat(0.39000);
            set_selenium(4.40000);
            set_sodium(1240.00000);
            set_thiamin(0.42000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.07000);
            set_vitamin_c(2.10000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.47000);
            set_vitamin_k(2.80000);
            set_water(3.13000);
