 ...
 */
public class Snacks_tortilla_chips_light_baked_with_less_oil implements Food {

    private final Snacks_tortilla_chips_light_baked_with_less_oil_mutable food;

    public Snacks_tortilla_chips_light_baked_with_less_oil() {
        food = new Snacks_tortilla_chips_light_baked_with_less_oil_mutable();
    }
    ...
    private class Snacks_tortilla_chips_light_baked_with_less_oil_mutable extends Abstract_food {
         ...
         */
        public Snacks_tortilla_chips_light_baked_with_less_oil_mutable() {
            ...
            set_carbohydrate_by_difference(73.40000);
