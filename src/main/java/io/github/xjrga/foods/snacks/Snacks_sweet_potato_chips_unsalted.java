 ...
 */
public class Snacks_sweet_potato_chips_unsalted implements Food {

    private final Snacks_sweet_potato_chips_unsalted_mutable food;

    public Snacks_sweet_potato_chips_unsalted() {
        food = new Snacks_sweet_potato_chips_unsalted_mutable();
    }
    ...
    private class Snacks_sweet_potato_chips_unsalted_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Snacks_sweet_potato_chips_unsalted_mutable() {
            ...
            set_carbohydrate_by_difference(56.82000);
            set_cholesterol(0.00000);
            set_choline(36.60000);
            ...
            set_gross_energy(532.00000);
            set_iron(2.12000);
            set_linoleic_acid(0.00000);
            set_magnesium(65.00000);
            set_manganese(1.34000);
            set_monounsaturated_fat(9.15000);
            set_niacin(2.08000);
            set_pantothenic_acid(1.55000);
            set_phosphorus(145.00000);
            set_polyunsaturated_fat(12.22000);
            set_potassium(925.00000);
            set_protein(2.94000);
            set_riboflavin(0.16000);
            set_saturated_fat(2.94000);
            set_selenium(2.10000);
            set_sodium(35.00000);
            set_thiamin(0.08000);
            set_vitamin_a(1184.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.53000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(9.82000);
            set_vitamin_k(24.50000);
            set_water(4.51000);
