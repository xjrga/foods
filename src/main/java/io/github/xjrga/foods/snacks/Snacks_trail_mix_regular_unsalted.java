 ...
 */
public class Snacks_trail_mix_regular_unsalted implements Food {

    private final Snacks_trail_mix_regular_unsalted_mutable food;

    public Snacks_trail_mix_regular_unsalted() {
        food = new Snacks_trail_mix_regular_unsalted_mutable();
    }
    ...
    private class Snacks_trail_mix_regular_unsalted_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Snacks_trail_mix_regular_unsalted_mutable() {
