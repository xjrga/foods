 ...
 */
public class Snacks_rice_cakes_brown_rice_plain_unsalted implements Food {

    private final Snacks_rice_cakes_brown_rice_plain_unsalted_mutable food;

    public Snacks_rice_cakes_brown_rice_plain_unsalted() {
        food = new Snacks_rice_cakes_brown_rice_plain_unsalted_mutable();
    }
    ...
    private class Snacks_rice_cakes_brown_rice_plain_unsalted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_rice_cakes_brown_rice_plain_unsalted_mutable() {
            ...
            set_carbohydrate_by_difference(81.50000);
            set_cholesterol(0.00000);
            set_choline(31.60000);
            ...
            set_magnesium(131.00000);
            set_manganese(3.73000);
            set_monounsaturated_fat(1.03000);
            set_niacin(7.80000);
            set_pantothenic_acid(1.00000);
            set_phosphorus(360.00000);
            set_polyunsaturated_fat(0.99000);
            set_potassium(290.00000);
            set_protein(8.20000);
            set_riboflavin(0.16000);
            set_saturated_fat(0.57000);
            set_selenium(24.60000);
            set_sodium(26.00000);
            set_thiamin(0.06000);
