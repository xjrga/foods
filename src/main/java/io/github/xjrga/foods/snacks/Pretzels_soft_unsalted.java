 ...
 */
public class Pretzels_soft_unsalted implements Food {

    private final Pretzels_soft_unsalted_mutable food;

    public Pretzels_soft_unsalted() {
        food = new Pretzels_soft_unsalted_mutable();
    }
    ...
    private class Pretzels_soft_unsalted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Pretzels_soft_unsalted_mutable() {
            ...
            set_carbohydrate_by_difference(71.04000);
            ...
            set_gross_energy(345.00000);
            set_iron(3.92000);
            set_linoleic_acid(0.00000);
            set_magnesium(21.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(1.07000);
            set_niacin(4.27000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(79.00000);
            set_polyunsaturated_fat(0.94000);
            set_potassium(88.00000);
            set_protein(8.20000);
            set_riboflavin(0.29000);
            set_saturated_fat(0.69000);
            set_selenium(17.20000);
            set_sodium(252.00000);
            set_thiamin(0.41000);
