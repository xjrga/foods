 ...
 */
public class Snacks_popcorn_air_popped_unsalted implements Food {

    private final Snacks_popcorn_air_popped_unsalted_mutable food;

    public Snacks_popcorn_air_popped_unsalted() {
        food = new Snacks_popcorn_air_popped_unsalted_mutable();
    }
    ...
    private class Snacks_popcorn_air_popped_unsalted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_popcorn_air_popped_unsalted_mutable() {
            ...
            set_carbohydrate_by_difference(77.90000);
            ...
            set_gross_energy(382.00000);
            set_iron(2.66000);
            set_linoleic_acid(0.00000);
            set_magnesium(131.00000);
            set_manganese(0.94000);
            set_monounsaturated_fat(1.10000);
            set_niacin(1.94000);
            set_pantothenic_acid(0.42000);
            set_phosphorus(300.00000);
            set_polyunsaturated_fat(1.90000);
            set_potassium(301.00000);
            set_protein(12.00000);
            set_riboflavin(0.28000);
            set_saturated_fat(0.57000);
            set_selenium(9.90000);
            set_sodium(4.00000);
            set_thiamin(0.20000);
