 ...
 */
public class Snacks_popcorn_microwave_94_fat_free implements Food {

    private final Snacks_popcorn_microwave_94_fat_free_mutable food;

    public Snacks_popcorn_microwave_94_fat_free() {
        food = new Snacks_popcorn_microwave_94_fat_free_mutable();
    }
    ...
    private class Snacks_popcorn_microwave_94_fat_free_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_popcorn_microwave_94_fat_free_mutable() {
            set_food_name("Snacks, popcorn, microwave, 94% fat free");
            set_food_label("snacks_popcorn_microwave_94_fat_free");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.05000);
            set_calcium(14.00000);
            set_carbohydrate_by_difference(76.04000);
            set_cholesterol(0.00000);
            set_choline(13.00000);
            ...
            set_gross_energy(402.00000);
            set_iron(2.87000);
            set_linoleic_acid(2.09000);
            set_magnesium(124.00000);
            set_manganese(1.08000);
            set_monounsaturated_fat(2.76000);
            set_niacin(2.09000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(304.00000);
            set_polyunsaturated_fat(2.21000);
            set_potassium(284.00000);
            set_protein(10.72000);
            set_riboflavin(0.15000);
            set_saturated_fat(1.18000);
            set_selenium(6.90000);
            set_sodium(571.00000);
            set_thiamin(0.07000);
