 ...
 */
public class Sweetener_herbal_extract_powder_from_stevia_leaf implements Food {

    private final Sweetener_herbal_extract_powder_from_stevia_leaf_mutable food;

    public Sweetener_herbal_extract_powder_from_stevia_leaf() {
        food = new Sweetener_herbal_extract_powder_from_stevia_leaf_mutable();
    }
    ...
    private class Sweetener_herbal_extract_powder_from_stevia_leaf_mutable extends Food_abstract {
         ...
         */
        public Sweetener_herbal_extract_powder_from_stevia_leaf_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(100.00000);
