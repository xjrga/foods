 ...
 */
public class Sweeteners_tabletop_aspartame_equal_packets implements Food {

    private final Sweeteners_tabletop_aspartame_equal_packets_mutable food;

    public Sweeteners_tabletop_aspartame_equal_packets() {
        food = new Sweeteners_tabletop_aspartame_equal_packets_mutable();
    }
    ...
    private class Sweeteners_tabletop_aspartame_equal_packets_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Sweeteners_tabletop_aspartame_equal_packets_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(89.08000);
