 ...
 */
public class Chewing_gum_sugarless implements Food {

    private final Chewing_gum_sugarless_mutable food;

    public Chewing_gum_sugarless() {
        food = new Chewing_gum_sugarless_mutable();
    }
    ...
    private class Chewing_gum_sugarless_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Chewing_gum_sugarless_mutable() {
            ...
            set_carbohydrate_by_difference(94.80000);
