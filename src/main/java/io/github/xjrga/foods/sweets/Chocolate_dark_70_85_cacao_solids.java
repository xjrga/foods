 ...
 */
public class Chocolate_dark_70_85_cacao_solids implements Food {

    private final Chocolate_dark_70_85_cacao_solids_mutable food;

    public Chocolate_dark_70_85_cacao_solids() {
        food = new Chocolate_dark_70_85_cacao_solids_mutable();
    }
    ...
    private class Chocolate_dark_70_85_cacao_solids_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Chocolate_dark_70_85_cacao_solids_mutable() {
            set_food_name("Chocolate, dark, 70-85% cacao solids");
            set_food_label("chocolate_dark_70_85_cacao_solids");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.03000);
            set_calcium(73.00000);
            set_carbohydrate_by_difference(45.90000);
            set_cholesterol(3.00000);
            set_choline(0.00000);
            ...
            set_iron(11.90000);
            set_linoleic_acid(1.20000);
            set_magnesium(228.00000);
            set_manganese(1.94000);
            set_monounsaturated_fat(12.78000);
            set_niacin(1.05000);
            set_pantothenic_acid(0.41000);
            set_phosphorus(308.00000);
            set_polyunsaturated_fat(1.25000);
            set_potassium(715.00000);
            set_protein(7.79000);
            set_riboflavin(0.07000);
            set_saturated_fat(24.48000);
            set_selenium(6.80000);
            set_sodium(20.00000);
            set_thiamin(0.03000);
            set_vitamin_a(2.00000);
            set_vitamin_b12(0.28000);
            set_vitamin_b6(0.03000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.59000);
            set_vitamin_k(7.30000);
            set_water(1.37000);
