 ...
 */
public class Sugars_granulated implements Food {

    private final Sugars_granulated_mutable food;

    public Sugars_granulated() {
        food = new Sugars_granulated_mutable();
    }
    ...
    private class Sugars_granulated_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Sugars_granulated_mutable() {
            set_food_name("Sugars, granulated");
            set_food_label("sugars_granulated");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(1.00000);
            set_carbohydrate_by_difference(99.98000);
