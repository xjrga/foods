 ...
 */
public class Cocoa_dry_powder_unsweetened implements Food {

    private final Cocoa_dry_powder_unsweetened_mutable food;

    public Cocoa_dry_powder_unsweetened() {
        food = new Cocoa_dry_powder_unsweetened_mutable();
    }
    ...
    private class Cocoa_dry_powder_unsweetened_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Cocoa_dry_powder_unsweetened_mutable() {
            set_food_name("Cocoa, dry powder, unsweetened");
            set_food_label("cocoa_dry_powder_unsweetened");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(128.00000);
            set_carbohydrate_by_difference(57.90000);
            set_cholesterol(0.00000);
            set_choline(12.00000);
            ...
            set_gross_energy(228.00000);
            set_iron(13.86000);
            set_linoleic_acid(0.00000);
            set_magnesium(499.00000);
            set_manganese(3.83000);
            set_monounsaturated_fat(4.57000);
            set_niacin(2.18000);
            set_pantothenic_acid(0.25000);
            set_phosphorus(734.00000);
            set_polyunsaturated_fat(0.44000);
            set_potassium(1524.00000);
            set_protein(19.60000);
            set_riboflavin(0.24000);
            set_saturated_fat(8.07000);
            set_selenium(14.30000);
            set_sodium(21.00000);
            set_thiamin(0.07000);
