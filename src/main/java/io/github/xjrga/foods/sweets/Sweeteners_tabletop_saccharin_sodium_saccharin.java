 ...
 */
public class Sweeteners_tabletop_saccharin_sodium_saccharin implements Food {

    private final Sweeteners_tabletop_saccharin_sodium_saccharin_mutable food;

    public Sweeteners_tabletop_saccharin_sodium_saccharin() {
        food = new Sweeteners_tabletop_saccharin_sodium_saccharin_mutable();
    }
    ...
    private class Sweeteners_tabletop_saccharin_sodium_saccharin_mutable extends Food_abstract {
         ...
         */
        public Sweeteners_tabletop_saccharin_sodium_saccharin_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(89.11000);
