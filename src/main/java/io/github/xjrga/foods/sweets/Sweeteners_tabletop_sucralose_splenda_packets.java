 ...
 */
public class Sweeteners_tabletop_sucralose_splenda_packets implements Food {

    private final Sweeteners_tabletop_sucralose_splenda_packets_mutable food;

    public Sweeteners_tabletop_sucralose_splenda_packets() {
        food = new Sweeteners_tabletop_sucralose_splenda_packets_mutable();
    }
    ...
    private class Sweeteners_tabletop_sucralose_splenda_packets_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Sweeteners_tabletop_sucralose_splenda_packets_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(91.17000);
