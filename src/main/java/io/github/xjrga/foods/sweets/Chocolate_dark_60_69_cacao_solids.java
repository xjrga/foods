 ...
 */
public class Chocolate_dark_60_69_cacao_solids implements Food {

    private final Chocolate_dark_60_69_cacao_solids_mutable food;

    public Chocolate_dark_60_69_cacao_solids() {
        food = new Chocolate_dark_60_69_cacao_solids_mutable();
    }
    ...
    private class Chocolate_dark_60_69_cacao_solids_mutable extends Food_abstract {
         ...
         */
        public Chocolate_dark_60_69_cacao_solids_mutable() {
            ...
            set_calcium(62.00000);
            set_carbohydrate_by_difference(52.42000);
            set_cholesterol(6.00000);
            set_choline(0.00000);
            ...
            set_gross_energy(579.00000);
            set_iron(6.32000);
            set_linoleic_acid(1.09000);
            set_magnesium(176.00000);
            set_manganese(1.32000);
            set_monounsaturated_fat(11.52000);
            set_niacin(0.83000);
            set_pantothenic_acid(0.30000);
            set_phosphorus(260.00000);
            set_polyunsaturated_fat(1.22000);
            set_potassium(567.00000);
            set_protein(6.12000);
            set_riboflavin(0.04000);
            set_saturated_fat(22.03000);
            set_selenium(8.40000);
            set_sodium(10.00000);
            set_thiamin(0.03000);
            set_vitamin_a(3.00000);
            set_vitamin_b12(0.18000);
            set_vitamin_b6(0.03000);
            set_vitamin_c(0.00000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.59000);
            set_vitamin_k(7.20000);
            set_water(1.25000);
