 ...
 */
public class Syrups_sugar_free implements Food {

    private final Syrups_sugar_free_mutable food;

    public Syrups_sugar_free() {
        food = new Syrups_sugar_free_mutable();
    }
