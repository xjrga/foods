 ...
 */
public class Cocoa_dry_powder_unsweetened_hersheys_european_style_cocoa implements Food {

    private final Cocoa_dry_powder_unsweetened_hershey_s_european_style_cocoa_mutable food;

    public Cocoa_dry_powder_unsweetened_hersheys_european_style_cocoa() {
        food = new Cocoa_dry_powder_unsweetened_hershey_s_european_style_cocoa_mutable();
    }
    ...
    private class Cocoa_dry_powder_unsweetened_hershey_s_european_style_cocoa_mutable extends Food_abstract {
         ...
         */
        public Cocoa_dry_powder_unsweetened_hershey_s_european_style_cocoa_mutable() {
            ...
            set_calcium(0.00000);
            set_carbohydrate_by_difference(60.00000);
