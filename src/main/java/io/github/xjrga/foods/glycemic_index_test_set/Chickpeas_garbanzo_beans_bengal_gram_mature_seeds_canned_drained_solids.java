 ...
 */
public class Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_canned_drained_solids implements Food {

    private final Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_canned_drained_solids_mutable food;

    public Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_canned_drained_solids() {
        food = new Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_canned_drained_solids_mutable();
    }
    ...
    private class Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_canned_drained_solids_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Chickpeas_garbanzo_beans_bengal_gram_mature_seeds_canned_drained_solids_mutable() {
            ...
            set_carbohydrate_by_difference(22.53000);
            ...
            set_manganese(0.84000);
            set_monounsaturated_fat(0.48000);
            set_niacin(0.14000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(85.00000);
            set_polyunsaturated_fat(0.96000);
            set_potassium(126.00000);
            set_protein(7.05000);
            set_riboflavin(0.01000);
            set_saturated_fat(0.21000);
            set_selenium(3.10000);
            set_sodium(246.00000);
            set_thiamin(0.02000);
            set_vitamin_a(1.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.11000);
            set_vitamin_c(0.10000);
