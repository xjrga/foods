 ...
 */
public class Oranges_raw_all_commercial_varieties implements Food {

    private final Oranges_raw_all_commercial_varieties_mutable food;

    public Oranges_raw_all_commercial_varieties() {
        food = new Oranges_raw_all_commercial_varieties_mutable();
    }
    ...
    private class Oranges_raw_all_commercial_varieties_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Oranges_raw_all_commercial_varieties_mutable() {
            ...
            set_carbohydrate_by_difference(11.75000);
            ...
            set_vitamin_c(53.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.18000);
