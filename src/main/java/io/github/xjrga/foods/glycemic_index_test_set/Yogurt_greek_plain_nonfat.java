 ...
 */
public class Yogurt_greek_plain_nonfat implements Food {

    private final Yogurt_greek_plain_nonfat_mutable food;

    public Yogurt_greek_plain_nonfat() {
        food = new Yogurt_greek_plain_nonfat_mutable();
    }
    ...
    private class Yogurt_greek_plain_nonfat_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Yogurt_greek_plain_nonfat_mutable() {
            set_food_name("Yogurt, Greek, plain, nonfat");
            set_food_label("yogurt_greek_plain_nonfat");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00100);
            set_calcium(110.00000);
            set_carbohydrate_by_difference(3.60000);
            set_cholesterol(5.00000);
            set_choline(15.10000);
            set_complete_protein(10.19000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            ...
            set_gross_energy(59.00000);
            set_iron(0.07000);
            set_linoleic_acid(0.01000);
            set_magnesium(11.00000);
            set_manganese(0.00900);
            set_monounsaturated_fat(0.05000);
            set_niacin(0.20000);
            set_pantothenic_acid(0.33000);
            set_phosphorus(135.00000);
            set_polyunsaturated_fat(0.01000);
            set_potassium(141.00000);
            set_protein(10.19000);
            set_riboflavin(0.27000);
            set_saturated_fat(0.11000);
            set_selenium(9.70000);
            set_sodium(36.00000);
            set_thiamin(0.02000);
            set_vitamin_a(1.00000);
            set_vitamin_b12(0.75000);
