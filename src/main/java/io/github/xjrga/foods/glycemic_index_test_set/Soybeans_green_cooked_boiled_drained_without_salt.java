 ...
 */
public class Soybeans_green_cooked_boiled_drained_without_salt implements Food {

    private final Soybeans_green_cooked_boiled_drained_without_salt_mutable food;

    public Soybeans_green_cooked_boiled_drained_without_salt() {
        food = new Soybeans_green_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Soybeans_green_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Soybeans_green_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(145.00000);
            set_carbohydrate_by_difference(11.05000);
            ...
            set_folate(111.00000);
            set_glycemic_index(14.00000);
            set_gross_energy(141.00000);
            set_iron(2.50000);
            set_linoleic_acid(0.00000);
            set_magnesium(60.00000);
            set_manganese(0.50000);
            set_monounsaturated_fat(1.20000);
            set_niacin(1.25000);
            set_pantothenic_acid(0.12000);
            set_phosphorus(158.00000);
            set_polyunsaturated_fat(3.01000);
            set_potassium(539.00000);
            set_protein(12.35000);
            set_riboflavin(0.15000);
            set_saturated_fat(0.74000);
            set_selenium(1.40000);
            set_sodium(14.00000);
            set_thiamin(0.26000);
            set_vitamin_a(8.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.06000);
            set_vitamin_c(17.00000);
