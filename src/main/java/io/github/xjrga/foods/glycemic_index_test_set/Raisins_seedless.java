 ...
 */
public class Raisins_seedless implements Food {

    private final Raisins_seedless_mutable food;

    public Raisins_seedless() {
        food = new Raisins_seedless_mutable();
    }
    ...
    private class Raisins_seedless_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Raisins_seedless_mutable() {
            set_food_name("Raisins, seedless");
            set_food_label("raisins_seedless");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(50.00000);
            set_carbohydrate_by_difference(79.18000);
            ...
            set_fat(0.46000);
            set_fiber(3.70000);
            set_fluoride(233.90000);
            set_folate(5.00000);
            set_glycemic_index(64.00000);
            set_gross_energy(299.00000);
            set_iron(1.88000);
