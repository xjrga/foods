 ...
 */
public class Peaches_yellow_raw implements Food {

    private final Peaches_yellow_raw_mutable food;

    public Peaches_yellow_raw() {
        food = new Peaches_yellow_raw_mutable();
    }
    ...
    private class Peaches_yellow_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Peaches_yellow_raw_mutable() {
            set_food_name("Peaches, yellow, raw");
            set_food_label("peaches_yellow_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(9.54000);
            ...
            set_vitamin_c(6.60000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.73000);
