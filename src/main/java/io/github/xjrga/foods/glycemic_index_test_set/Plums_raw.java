 ...
 */
public class Plums_raw implements Food {

    private final Plums_raw_mutable food;

    public Plums_raw() {
        food = new Plums_raw_mutable();
    }
    ...
    private class Plums_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Plums_raw_mutable() {
            set_food_name("Plums, raw");
            set_food_label("plums_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(11.42000);
            ...
            set_vitamin_c(9.50000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.26000);
            set_vitamin_k(6.40000);
            set_water(87.23000);
