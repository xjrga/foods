 ...
 */
public class Rice_white_long_grain_regular_enriched_cooked implements Food {

    private final Rice_white_long_grain_regular_enriched_cooked_mutable food;

    public Rice_white_long_grain_regular_enriched_cooked() {
        food = new Rice_white_long_grain_regular_enriched_cooked_mutable();
    }
    ...
    private class Rice_white_long_grain_regular_enriched_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_white_long_grain_regular_enriched_cooked_mutable() {
            ...
            set_carbohydrate_by_difference(28.17000);
            ...
            set_monounsaturated_fat(0.08000);
            set_niacin(1.47000);
            set_pantothenic_acid(0.39000);
            set_phosphorus(43.00000);
            set_polyunsaturated_fat(0.07000);
            set_potassium(35.00000);
            set_protein(2.69000);
