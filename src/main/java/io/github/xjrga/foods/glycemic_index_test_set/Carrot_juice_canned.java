 ...
 */
public class Carrot_juice_canned implements Food {

    private final Carrot_juice_canned_mutable food;

    public Carrot_juice_canned() {
        food = new Carrot_juice_canned_mutable();
    }
