 ...
 */
public class Mangos_raw implements Food {

    private final Mangos_raw_mutable food;

    public Mangos_raw() {
        food = new Mangos_raw_mutable();
    }
    ...
    private class Mangos_raw_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Mangos_raw_mutable() {
            set_food_name("Mangos, raw");
            set_food_label("mangos_raw");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(11.00000);
            set_carbohydrate_by_difference(14.98000);
            ...
            set_vitamin_c(36.40000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.90000);
            set_vitamin_k(4.20000);
            set_water(83.46000);
