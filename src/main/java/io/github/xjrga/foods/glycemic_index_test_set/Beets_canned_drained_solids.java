 ...
 */
public class Beets_canned_drained_solids implements Food {

    private final Beets_canned_drained_solids_mutable food;

    public Beets_canned_drained_solids() {
        food = new Beets_canned_drained_solids_mutable();
    }
    ...
    private class Beets_canned_drained_solids_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beets_canned_drained_solids_mutable() {
            ...
            set_carbohydrate_by_difference(7.21000);
            ...
            set_fat(0.14000);
            set_fiber(1.80000);
            set_fluoride(26.30000);
            set_folate(30.00000);
            set_glycemic_index(64.00000);
            set_gross_energy(31.00000);
            set_iron(1.82000);
