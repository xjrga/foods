 ...
 */
public class Corn_sweet_yellow_cooked_boiled_drained_without_salt implements Food {

    private final Corn_sweet_yellow_cooked_boiled_drained_without_salt_mutable food;

    public Corn_sweet_yellow_cooked_boiled_drained_without_salt() {
        food = new Corn_sweet_yellow_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Corn_sweet_yellow_cooked_boiled_drained_without_salt_mutable extends Abstract_food {
         ...
         */
        public Corn_sweet_yellow_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(3.00000);
            set_carbohydrate_by_difference(20.98000);
            set_cholesterol(0.00000);
            set_choline(29.10000);
            ...
            set_vitamin_c(5.50000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.09000);
