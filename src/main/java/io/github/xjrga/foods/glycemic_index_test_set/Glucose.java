 ...
 */
public class Glucose implements Food {

    private final Glucose_mutable food;

    public Glucose() {
        food = new Glucose_mutable();
    }
    ...
    private class Glucose_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Glucose_mutable() {
