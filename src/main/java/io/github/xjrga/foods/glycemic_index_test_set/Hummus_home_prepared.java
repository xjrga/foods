 ...
 */
public class Hummus_home_prepared implements Food {

    private final Hummus_home_prepared_mutable food;

    public Hummus_home_prepared() {
        food = new Hummus_home_prepared_mutable();
    }
    ...
    private class Hummus_home_prepared_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Hummus_home_prepared_mutable() {
            ...
            set_gross_energy(177.00000);
            set_iron(1.56000);
            set_linoleic_acid(0.00000);
            set_magnesium(29.00000);
            set_manganese(0.56000);
            set_monounsaturated_fat(4.86000);
            set_niacin(0.39000);
            set_pantothenic_acid(0.28000);
            set_phosphorus(110.00000);
            set_polyunsaturated_fat(2.10000);
            set_potassium(173.00000);
            set_protein(4.86000);
            set_riboflavin(0.05000);
            set_saturated_fat(1.14000);
            set_selenium(2.40000);
            set_sodium(242.00000);
            set_thiamin(0.08000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.39000);
            set_vitamin_c(7.90000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.75000);
            set_vitamin_k(3.00000);
            set_water(64.87000);
