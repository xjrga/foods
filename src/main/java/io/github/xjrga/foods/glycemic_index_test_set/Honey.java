...
public class Honey implements Food {
    ...
    private final Honey_mutable food;

    public Honey() {
        food = new Honey_mutable();
    }
    ...
    private class Honey_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Honey_mutable() {
            set_food_name("Honey");
            set_food_label("honey");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(6.00000);
            set_carbohydrate_by_difference(82.40000);
            ...
            set_phosphorus(4.00000);
            set_polyunsaturated_fat(0.00000);
            set_potassium(52.00000);
            set_protein(0.30000);
