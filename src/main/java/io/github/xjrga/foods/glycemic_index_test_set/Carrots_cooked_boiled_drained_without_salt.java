 ...
 */
public class Carrots_cooked_boiled_drained_without_salt implements Food {

    private final Carrots_cooked_boiled_drained_without_salt_mutable food;

    public Carrots_cooked_boiled_drained_without_salt() {
        food = new Carrots_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Carrots_cooked_boiled_drained_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Carrots_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(30.00000);
            set_carbohydrate_by_difference(8.22000);
            ...
            set_phosphorus(30.00000);
            set_polyunsaturated_fat(0.08000);
            set_potassium(235.00000);
            set_protein(0.76000);
