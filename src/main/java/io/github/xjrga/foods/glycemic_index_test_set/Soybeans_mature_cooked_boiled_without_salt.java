 ...
 */
public class Soybeans_mature_cooked_boiled_without_salt implements Food {

    private final Soybeans_mature_cooked_boiled_without_salt_mutable food;

    public Soybeans_mature_cooked_boiled_without_salt() {
        food = new Soybeans_mature_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Soybeans_mature_cooked_boiled_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Soybeans_mature_cooked_boiled_without_salt_mutable() {
            ...
            set_calcium(102.00000);
            set_carbohydrate_by_difference(8.36000);
            set_cholesterol(0.00000);
            set_choline(47.50000);
            ...
            set_gross_energy(172.00000);
            set_iron(5.14000);
            set_linoleic_acid(0.00000);
            set_magnesium(86.00000);
            set_manganese(0.82000);
            set_monounsaturated_fat(1.98000);
            set_niacin(0.39000);
            set_pantothenic_acid(0.17000);
            set_phosphorus(245.00000);
            set_polyunsaturated_fat(5.06000);
            set_potassium(515.00000);
            set_protein(18.21000);
            set_riboflavin(0.28000);
            set_saturated_fat(1.29000);
            set_selenium(7.30000);
            set_sodium(1.00000);
            set_thiamin(0.15000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.23000);
            set_vitamin_c(1.70000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.35000);
            set_vitamin_k(19.20000);
            set_water(62.55000);
