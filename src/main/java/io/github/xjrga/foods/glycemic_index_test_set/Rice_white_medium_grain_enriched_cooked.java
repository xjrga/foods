 ...
 */
public class Rice_white_medium_grain_enriched_cooked implements Food {

    private final Rice_white_medium_grain_enriched_cooked_mutable food;

    public Rice_white_medium_grain_enriched_cooked() {
        food = new Rice_white_medium_grain_enriched_cooked_mutable();
    }
    ...
    private class Rice_white_medium_grain_enriched_cooked_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Rice_white_medium_grain_enriched_cooked_mutable() {
            ...
            set_calcium(3.00000);
            set_carbohydrate_by_difference(28.59000);
