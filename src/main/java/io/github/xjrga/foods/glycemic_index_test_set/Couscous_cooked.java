 ...
 */
public class Couscous_cooked implements Food {

    private final Couscous_cooked_mutable food;

    public Couscous_cooked() {
        food = new Couscous_cooked_mutable();
    }
    ...
    private class Couscous_cooked_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Couscous_cooked_mutable() {
            set_food_name("Couscous, cooked");
            set_food_label("couscous_cooked");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(8.00000);
            set_carbohydrate_by_difference(23.22000);
