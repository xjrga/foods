 ...
 */
public class Rice_brown_medium_grain_cooked implements Food {

    private final Rice_brown_medium_grain_cooked_mutable food;

    public Rice_brown_medium_grain_cooked() {
        food = new Rice_brown_medium_grain_cooked_mutable();
    }
    ...
    private class Rice_brown_medium_grain_cooked_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Rice_brown_medium_grain_cooked_mutable() {
            ...
            set_carbohydrate_by_difference(23.51000);
            ...
            set_gross_energy(112.00000);
            set_iron(0.53000);
            set_linoleic_acid(0.00000);
            set_magnesium(44.00000);
            set_manganese(1.09000);
            set_monounsaturated_fat(0.30000);
            set_niacin(1.33000);
            set_pantothenic_acid(0.39000);
            set_phosphorus(77.00000);
            set_polyunsaturated_fat(0.29000);
            set_potassium(79.00000);
            set_protein(2.32000);
