 ...
 */
public class Snacks_tortilla_chips_low_fat_unsalted implements Food {

    private final Snacks_tortilla_chips_low_fat_unsalted_mutable food;

    public Snacks_tortilla_chips_low_fat_unsalted() {
        food = new Snacks_tortilla_chips_low_fat_unsalted_mutable();
    }
    ...
    private class Snacks_tortilla_chips_low_fat_unsalted_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Snacks_tortilla_chips_low_fat_unsalted_mutable() {
            ...
            set_gross_energy(416.00000);
            set_iron(1.60000);
            set_linoleic_acid(0.00000);
            set_magnesium(97.00000);
            set_manganese(0.00000);
            set_monounsaturated_fat(1.66000);
            set_niacin(0.42000);
            set_pantothenic_acid(0.00000);
            set_phosphorus(318.00000);
            set_polyunsaturated_fat(2.87000);
            set_potassium(272.00000);
            set_protein(11.00000);
            set_riboflavin(0.28000);
            set_saturated_fat(0.85000);
            set_selenium(15.70000);
            set_sodium(15.00000);
            set_thiamin(0.22000);
            ...
            set_vitamin_e(3.53000);
            set_vitamin_k(20.90000);
            set_water(1.70000);
