 ...
 */
public class Beans_kidney_red_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Beans_kidney_red_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Beans_kidney_red_mature_seeds_cooked_boiled_without_salt() {
        food = new Beans_kidney_red_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Beans_kidney_red_mature_seeds_cooked_boiled_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Beans_kidney_red_mature_seeds_cooked_boiled_without_salt_mutable() {
            ...
            set_calcium(28.00000);
            set_carbohydrate_by_difference(22.80000);
            set_cholesterol(0.00000);
            set_choline(30.50000);
            ...
            set_folate(130.00000);
            set_glycemic_index(28.00000);
            set_gross_energy(127.00000);
            set_iron(2.94000);
            set_linoleic_acid(0.00000);
            set_magnesium(45.00000);
            set_manganese(0.47000);
            set_monounsaturated_fat(0.03000);
            set_niacin(0.57000);
            set_pantothenic_acid(0.22000);
            set_phosphorus(142.00000);
            set_polyunsaturated_fat(0.27000);
            set_potassium(403.00000);
            set_protein(8.67000);
            set_riboflavin(0.05000);
            set_saturated_fat(0.07000);
            set_selenium(1.20000);
            set_sodium(2.00000);
            set_thiamin(0.16000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.12000);
            set_vitamin_c(1.20000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.03000);
            set_vitamin_k(8.40000);
            set_water(66.94000);
