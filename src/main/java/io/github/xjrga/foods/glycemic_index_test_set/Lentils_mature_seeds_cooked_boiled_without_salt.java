 ...
 */
public class Lentils_mature_seeds_cooked_boiled_without_salt implements Food {

    private final Lentils_mature_seeds_cooked_boiled_without_salt_mutable food;

    public Lentils_mature_seeds_cooked_boiled_without_salt() {
        food = new Lentils_mature_seeds_cooked_boiled_without_salt_mutable();
    }
    ...
    private class Lentils_mature_seeds_cooked_boiled_without_salt_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Lentils_mature_seeds_cooked_boiled_without_salt_mutable() {
            ...
            set_calcium(19.00000);
            set_carbohydrate_by_difference(20.13000);
            set_cholesterol(0.00000);
            set_choline(32.70000);
            ...
            set_folate(181.00000);
            set_glycemic_index(29.00000);
            set_gross_energy(116.00000);
            set_iron(3.33000);
            set_linoleic_acid(0.00000);
            set_magnesium(36.00000);
            set_manganese(0.49000);
            set_monounsaturated_fat(0.06000);
            set_niacin(1.06000);
            set_pantothenic_acid(0.63000);
            set_phosphorus(180.00000);
            set_polyunsaturated_fat(0.17000);
            set_potassium(369.00000);
            set_protein(9.02000);
            set_riboflavin(0.07000);
            set_saturated_fat(0.05000);
            set_selenium(2.80000);
            set_sodium(2.00000);
            set_thiamin(0.16000);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.17000);
            set_vitamin_c(1.50000);
            set_vitamin_d(0.00000);
            set_vitamin_e(0.11000);
            set_vitamin_k(1.70000);
            set_water(69.64000);
