 ...
 */
public class Campbells_tomato_juice implements Food {

    private final Campbell_s_tomato_juice_mutable food;

    public Campbells_tomato_juice() {
        food = new Campbell_s_tomato_juice_mutable();
    }
    ...
    private class Campbell_s_tomato_juice_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Campbell_s_tomato_juice_mutable() {
