 ...
 */
public class Hominy_canned_white implements Food {

    private final Hominy_canned_white_mutable food;

    public Hominy_canned_white() {
        food = new Hominy_canned_white_mutable();
    }
    ...
    private class Hominy_canned_white_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Hominy_canned_white_mutable() {
            ...
            set_monounsaturated_fat(0.23000);
            set_niacin(0.03000);
            set_pantothenic_acid(0.15000);
            set_phosphorus(35.00000);
            set_polyunsaturated_fat(0.39000);
            set_potassium(9.00000);
            set_protein(1.48000);
            set_riboflavin(0.00600);
            set_saturated_fat(0.12000);
            set_selenium(3.00000);
            set_sodium(345.00000);
            set_thiamin(0.00300);
            set_vitamin_a(0.00000);
            set_vitamin_b12(0.00000);
            set_vitamin_b6(0.00500);
