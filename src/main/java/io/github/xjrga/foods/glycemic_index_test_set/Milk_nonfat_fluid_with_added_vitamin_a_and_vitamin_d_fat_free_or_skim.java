 ...
 */
public class Milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim implements Food {

    private final Milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim_mutable food;

    public Milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim() {
        food = new Milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim_mutable();
    }
    ...
    private class Milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim_mutable() {
            set_food_name("Milk, nonfat, fluid, with added vitamin A and vitamin D (fat free or skim)");
            set_food_label("milk_nonfat_fluid_with_added_vitamin_a_and_vitamin_d_fat_free_or_skim");
            set_alcohol(0.00000);
            set_alpha_linolenic_acid(0.00000);
            set_calcium(122.00000);
            set_carbohydrate_by_difference(4.96000);
            set_cholesterol(2.00000);
            set_choline(15.60000);
            set_complete_protein(3.37000);
            set_copper(0.01000);
            set_cost(0.00000);
            set_dha(0.00000);
            set_epa(0.00000);
            set_fat(0.08000);
            set_fiber(0.00000);
            set_fluoride(3.10000);
            set_folate(5.00000);
            set_glycemic_index(32.00000);
            set_gross_energy(34.00000);
            set_iron(0.03000);
            set_linoleic_acid(0.00000);
            set_magnesium(11.00000);
            set_manganese(0.00300);
            set_monounsaturated_fat(0.02000);
            set_niacin(0.09000);
            set_pantothenic_acid(0.35000);
            set_phosphorus(101.00000);
            set_polyunsaturated_fat(0.00300);
            set_potassium(156.00000);
            set_protein(3.37000);
            set_riboflavin(0.18000);
            set_saturated_fat(0.05000);
            set_selenium(3.10000);
            set_sodium(42.00000);
            set_thiamin(0.04000);
            set_vitamin_a(61.00000);
            set_vitamin_b12(0.50000);
            set_vitamin_b6(0.03000);
            set_vitamin_c(0.00000);
            set_vitamin_d(1.20000);
