 ...
 */
public class Barley_pearled_cooked implements Food {

    private final Barley_pearled_cooked_mutable food;

    public Barley_pearled_cooked() {
        food = new Barley_pearled_cooked_mutable();
    }
    ...
    private class Barley_pearled_cooked_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Barley_pearled_cooked_mutable() {
            ...
            set_carbohydrate_by_difference(28.22000);
            set_cholesterol(0.00000);
            set_choline(13.40000);
            ...
            set_potassium(93.00000);
            set_protein(2.26000);
            set_riboflavin(0.06000);
            set_saturated_fat(0.09000);
            set_selenium(8.60000);
            set_sodium(3.00000);
            set_thiamin(0.08000);
