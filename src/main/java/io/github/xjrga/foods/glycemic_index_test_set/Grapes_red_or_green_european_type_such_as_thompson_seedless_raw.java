 ...
 */
public class Grapes_red_or_green_european_type_such_as_thompson_seedless_raw implements Food {

    private final Grapes_red_or_green_european_type_such_as_thompson_seedless_raw_mutable food;

    public Grapes_red_or_green_european_type_such_as_thompson_seedless_raw() {
        food = new Grapes_red_or_green_european_type_such_as_thompson_seedless_raw_mutable();
    }
    ...
    private class Grapes_red_or_green_european_type_such_as_thompson_seedless_raw_mutable extends Food_abstract {

        /**
         * Constructs a food item
         */
        public Grapes_red_or_green_european_type_such_as_thompson_seedless_raw_mutable() {
            ...
            set_calcium(10.00000);
            set_carbohydrate_by_difference(18.10000);
