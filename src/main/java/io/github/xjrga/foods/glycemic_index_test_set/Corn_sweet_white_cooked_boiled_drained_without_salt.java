 ...
 */
public class Corn_sweet_white_cooked_boiled_drained_without_salt implements Food {

    private final Corn_sweet_white_cooked_boiled_drained_without_salt_mutable food;

    public Corn_sweet_white_cooked_boiled_drained_without_salt() {
        food = new Corn_sweet_white_cooked_boiled_drained_without_salt_mutable();
    }
    ...
    private class Corn_sweet_white_cooked_boiled_drained_without_salt_mutable extends Abstract_food {

        /**
         * Constructs a food item
         */
        public Corn_sweet_white_cooked_boiled_drained_without_salt_mutable() {
            ...
            set_calcium(2.00000);
            set_carbohydrate_by_difference(21.71000);
